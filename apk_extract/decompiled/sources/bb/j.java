...
public final /* synthetic */ class j extends FunctionReferenceImpl implements Function1 {
    public j(Object obj) {
        super(1, obj, l.class, "onSwitchToShareCall", "onSwitchToShareCall(Z)V", 0);
    }
    ...
    public final void invoke(boolean z2) {
        ...
        Intrinsics.checkNotNullParameter("onSwitchToShareCall", "log");
        if (gc.f6462a <= 4) {
            Log.i(gc.f6463b.concat("BaseSettingActivity"), "onSwitchToShareCall");
        }
        ...
        tj.w.X("iot_multi_con_settings_phonecall_switch_click", bundleD);
        if (Intrinsics.areEqual(Boolean.valueOf(z2), lVar.f1239a.n().f.getValue())) {
            return;
        }
        lb.a.e("multi_device_connection.share_call", z2);
        String log = "toggleCallSharingSwitch: newState=" + z2;
