...
public enum la implements v0 {
    ...
    CLOUD_LOGO_CLOSE(93),
    CLOUD_SAFE_SEARCH_CREATE(DeviceType.INFRARED_AIR_PURIFIER),
    CLOUD_SAFE_SEARCH_DETECT(DeviceType.INFRARED_HEATER),
    CLOUD_SAFE_SEARCH_CLOSE(DeviceType.INFRARED_ELECTRIC_HEATER),
    ...
    CUSTOM_MODEL_CREATE(DeviceType.INFRARED_TV_BOX),
    CUSTOM_MODEL_CLOSE(104),
    CUSTOM_MODEL_LOAD(DeviceType.INFRARED_AIR_CONDITION),
    ...
    AGGREGATED_CUSTOM_MODEL_INFERENCE(l5.a.CODE_SCANNER_CANCELLED),
    AGGREGATED_ON_DEVICE_BARCODE_DETECTION(l5.a.CODE_SCANNER_CAMERA_PERMISSION_NOT_GRANTED),
    AGGREGATED_ON_DEVICE_FACE_DETECTION(l5.a.CODE_SCANNER_APP_NAME_UNAVAILABLE),
    AGGREGATED_ON_DEVICE_IMAGE_LABEL_DETECTION(l5.a.CODE_SCANNER_TASK_IN_PROGRESS),
    AGGREGATED_ON_DEVICE_OBJECT_INFERENCE(l5.a.CODE_SCANNER_PIPELINE_INITIALIZATION_ERROR),
    AGGREGATED_ON_DEVICE_TEXT_DETECTION(l5.a.CODE_SCANNER_PIPELINE_INFERENCE_ERROR),
    AGGREGATED_ON_DEVICE_POSE_DETECTION(l5.a.CODE_SCANNER_GOOGLE_PLAY_SERVICES_VERSION_TOO_OLD),
