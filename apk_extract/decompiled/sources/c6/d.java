...
public final class d extends Lambda implements Function0 {
    ...
    public d(boolean z2, InvisibleFragment invisibleFragment) {
        super(0);
        this.$granted = z2;
    ...
    public final void m42invoke() {
        ...
        if (this.$granted) {
            ...
            rVar2.f1444g.remove("android.permission.ACCESS_BACKGROUND_LOCATION");
            r rVar3 = this.this$0.f2290b;
            if (rVar3 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("pb");
                rVar3 = null;
            }
            rVar3.f1445h.remove("android.permission.ACCESS_BACKGROUND_LOCATION");
