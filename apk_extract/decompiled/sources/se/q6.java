...
public final class q6 implements n6 {
    ...
    public final void a(h4 nearWifiP2pManager, i2 p2pInfo, int i8, ka.d dVar) {
        ...
        we.h.b("NearP2pManager", "TransConnectP2pDisconnectingState connect, ignore");
    }

    @Override // se.n6
    public final void b(h4 nearWifiP2pManager) {
        Intrinsics.checkNotNullParameter(nearWifiP2pManager, "nearWifiP2pManager");
        we.h.b("NearP2pManager", "TransConnectP2pDisconnectingState stopP2p, ignore");
    }

    @Override // se.n6
    public final void c(h4 nearWifiP2pManager, int i8, ka.d dVar) {
        Intrinsics.checkNotNullParameter(nearWifiP2pManager, "nearWifiP2pManager");
        we.h.b("NearP2pManager", "TransConnectP2pDisconnectingState disconnect, ignore");
    }
}
