...
public final class l6 implements n6 {
    ...
    public final void a(h4 nearWifiP2pManager, i2 p2pInfo, int i8, ka.d dVar) {
        ...
        we.h.b("NearP2pManager", "TransConnectP2pConnectedState connect, try recovery mode");
        if (dVar == null) {
    ...
    public final void b(h4 nearWifiP2pManager) {
        Intrinsics.checkNotNullParameter(nearWifiP2pManager, "nearWifiP2pManager");
        we.h.b("NearP2pManager", "TransConnectP2pConnectedState stopP2p, ignore");
    }

    @Override // se.n6
    public final void c(h4 nearWifiP2pManager, int i8, ka.d dVar) {
        Intrinsics.checkNotNullParameter(nearWifiP2pManager, "nearWifiP2pManager");
        we.h.b("NearP2pManager", "TransConnectP2pConnectedState disconnect, disconnect p2p");
        if (dVar == null) {
            dVar = new ka.d(nearWifiP2pManager);
        }
