...
public final class Api23Impl {
    ...
    @DoNotInline
    public static void setAudioSource(@NonNull AudioRecord.Builder builder, int i8) {
        builder.setAudioSource(i8);
    }

    @DoNotInline
    public static void setBufferSizeInBytes(@NonNull AudioRecord.Builder builder, int i8) {
