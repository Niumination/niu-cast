...
final class AutoValue_MediaSpec extends MediaSpec {
    ...
    public static final class Builder extends MediaSpec.Builder {
        ...
        public MediaSpec build() {
            String strB = this.videoSpec == null ? " videoSpec" : "";
            if (this.audioSpec == null) {
                strB = h0.a.B(strB, " audioSpec");
            }
            if (this.outputFormat == null) {
                strB = h0.a.B(strB, " outputFormat");
            }
            if (strB.isEmpty()) {
        ...
        @Override // androidx.camera.video.MediaSpec.Builder
        public MediaSpec.Builder setOutputFormat(int i8) {
            this.outputFormat = Integer.valueOf(i8);
            return this;
        }
    ...
    public String toString() {
        ...
        return h0.a.m(sb2, "}", this.outputFormat);
    }

    private AutoValue_MediaSpec(VideoSpec videoSpec, AudioSpec audioSpec, int i8) {
        this.videoSpec = videoSpec;
        this.audioSpec = audioSpec;
