...
final class ProcessingCaptureSession implements CaptureSessionInterface {
    ...
    /* JADX INFO: renamed from: androidx.camera.camera2.internal.ProcessingCaptureSession$2, reason: invalid class name */
    public class AnonymousClass2 implements SessionProcessor.CaptureCallback {
        ...
        public void onCaptureFailed(int i8) {
            ProcessingCaptureSession.this.mExecutor.execute(new a0(this.val$captureConfig, 1));
        }

        @Override // androidx.camera.core.impl.SessionProcessor.CaptureCallback
        public void onCaptureSequenceCompleted(int i8) {
            ProcessingCaptureSession.this.mExecutor.execute(new a0(this.val$captureConfig, 0));
        }
    }

    /* JADX INFO: renamed from: androidx.camera.camera2.internal.ProcessingCaptureSession$3, reason: invalid class name */
    public class AnonymousClass3 implements SessionProcessor.CaptureCallback {
        ...
        @Override // androidx.camera.core.impl.SessionProcessor.CaptureCallback
        public void onCaptureFailed(int i8) {
            ProcessingCaptureSession.this.mExecutor.execute(new a0(this.val$captureConfig, 3));
        }

        @Override // androidx.camera.core.impl.SessionProcessor.CaptureCallback
        public void onCaptureSequenceCompleted(int i8) {
            ProcessingCaptureSession.this.mExecutor.execute(new a0(this.val$captureConfig, 2));
        }
    }

    /* JADX INFO: renamed from: androidx.camera.camera2.internal.ProcessingCaptureSession$4, reason: invalid class name */
    ...
    public ProcessingCaptureSession(@NonNull SessionProcessor sessionProcessor, @NonNull Camera2CameraInfoImpl camera2CameraInfoImpl, @NonNull Executor executor, @NonNull ScheduledExecutorService scheduledExecutorService) {
        ...
        int i8 = sNextInstanceId;
        sNextInstanceId = i8 + 1;
        this.mInstanceId = i8;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ m4.l lambda$open$2(SessionConfig sessionConfig, CameraDevice cameraDevice, SynchronizedCaptureSessionOpener synchronizedCaptureSessionOpener, List list) throws Exception {
        ...
        try {
            ...
            for (int i8 = 0; i8 < sessionConfig.getSurfaces().size(); i8++) {
                ...
                if (Objects.equals(deferrableSurface.getContainerClass(), Preview.class)) {
                    outputSurfaceCreate = OutputSurface.create((Surface) deferrableSurface.getSurface().get(), new Size(deferrableSurface.getPrescribedSize().getWidth(), deferrableSurface.getPrescribedSize().getHeight()), deferrableSurface.getPrescribedStreamFormat());
                } else if (Objects.equals(deferrableSurface.getContainerClass(), ImageCapture.class)) {
                    outputSurfaceCreate2 = OutputSurface.create((Surface) deferrableSurface.getSurface().get(), new Size(deferrableSurface.getPrescribedSize().getWidth(), deferrableSurface.getPrescribedSize().getHeight()), deferrableSurface.getPrescribedStreamFormat());
                } else if (Objects.equals(deferrableSurface.getContainerClass(), ImageAnalysis.class)) {
                    outputSurfaceCreate3 = OutputSurface.create((Surface) deferrableSurface.getSurface().get(), new Size(deferrableSurface.getPrescribedSize().getWidth(), deferrableSurface.getPrescribedSize().getHeight()), deferrableSurface.getPrescribedStreamFormat());
                }
            }
            ...
            sessionConfigInitSession.getSurfaces().get(0).getTerminationFuture().addListener(new x(this, 0), CameraXExecutors.directExecutor());
            for (DeferrableSurface deferrableSurface2 : this.mProcessorSessionConfig.getSurfaces()) {
                ...
                deferrableSurface2.getTerminationFuture().addListener(new b(deferrableSurface2, 4), this.mExecutor);
            }
            ...
            m4.l lVarOpen = this.mCaptureSession.open(validatingBuilder.build(), (CameraDevice) Preconditions.checkNotNull(cameraDevice), synchronizedCaptureSessionOpener);
            Futures.addCallback(lVarOpen, new FutureCallback<Void>() { // from class: androidx.camera.camera2.internal.ProcessingCaptureSession.1
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ Void lambda$open$3(Void r7) {
    ...
    public void issueCaptureRequests(@NonNull List<CaptureConfig> list) {
        ...
        int i8 = AnonymousClass4.$SwitchMap$androidx$camera$camera2$internal$ProcessingCaptureSession$ProcessorState[this.mProcessorState.ordinal()];
        if (i8 == 1 || i8 == 2) {
    ...
    @Override // androidx.camera.camera2.internal.CaptureSessionInterface
    @NonNull
    public m4.l open(@NonNull final SessionConfig sessionConfig, @NonNull final CameraDevice cameraDevice, @NonNull final SynchronizedCaptureSessionOpener synchronizedCaptureSessionOpener) {
        ...
        return FutureChain.from(DeferrableSurfaces.surfaceListWithTimeout(surfaces, false, 5000L, this.mExecutor, this.mScheduledExecutorService)).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.y
            @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
            public final m4.l apply(Object obj) {
                return this.f933a.lambda$open$2(sessionConfig, cameraDevice, synchronizedCaptureSessionOpener, (List) obj);
            }
        }, this.mExecutor).transform(new Function() { // from class: androidx.camera.camera2.internal.z
            @Override // androidx.arch.core.util.Function
            public final Object apply(Object obj) {
                return this.f937a.lambda$open$3((Void) obj);
            }
        }, this.mExecutor);
    }
    ...
    public m4.l release(boolean z2) {
        ...
        m4.l lVarRelease = this.mCaptureSession.release(z2);
        int i8 = AnonymousClass4.$SwitchMap$androidx$camera$camera2$internal$ProcessingCaptureSession$ProcessorState[this.mProcessorState.ordinal()];
        if (i8 == 2 || i8 == 4) {
            lVarRelease.addListener(new x(this, 1), this.mExecutor);
        }
