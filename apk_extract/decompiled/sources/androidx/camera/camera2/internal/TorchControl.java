...
final class TorchControl {
    ...
    public TorchControl(@NonNull Camera2CameraControlImpl camera2CameraControlImpl, @NonNull CameraCharacteristicsCompat cameraCharacteristicsCompat, @NonNull Executor executor) {
        ...
        camera2CameraControlImpl.addCaptureResultListener(new Camera2CameraControlImpl.CaptureResultListener() { // from class: androidx.camera.camera2.internal.g0
            @Override // androidx.camera.camera2.internal.Camera2CameraControlImpl.CaptureResultListener
            public final boolean onCaptureResult(TotalCaptureResult totalCaptureResult) {
                return this.f885a.lambda$new$0(totalCaptureResult);
            }
        });
    }
    ...
    public /* synthetic */ Object lambda$enableTorch$2(final boolean z2, final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.h0
            ...
            public final void run() {
                this.f888a.lambda$enableTorch$1(completer, z2);
            }
        });
    ...
    private <T> void setLiveDataValue(@NonNull MutableLiveData<T> mutableLiveData, T t3) {
    ...
    public m4.l enableTorch(final boolean z2) {
        if (this.mHasFlashUnit) {
            ...
            return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.f0
                ...
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return this.f881a.lambda$enableTorch$2(z2, completer);
                }
            });
        }
