...
class SynchronizedCaptureSessionBaseImpl extends SynchronizedCaptureSession.StateCallback implements SynchronizedCaptureSession, SynchronizedCaptureSessionOpener.OpenerImpl {
    ...
    @Nullable
    @GuardedBy("mLock")
    m4.l mOpenCaptureSessionFuture;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ m4.l lambda$startWithDeferrableSurface$1(List list, List list2) throws Exception {
        ...
        return list2.isEmpty() ? Futures.immediateFailedFuture(new IllegalArgumentException("Unable to open capture session without surfaces")) : Futures.immediateFuture(list2);
    }
    ...
    public void close() {
        ...
        getExecutor().execute(new b(this, 5));
    }
    ...
    public void onClosed(@NonNull SynchronizedCaptureSession synchronizedCaptureSession) {
        ...
        synchronized (this.mLock) {
            try {
                if (this.mClosed) {
                    ...
                    lVar = this.mOpenCaptureSessionFuture;
                }
            } catch (Throwable th2) {
                throw th2;
            }
        ...
        finishClose();
        if (lVar != null) {
            lVar.addListener(new b0(this, synchronizedCaptureSession, 1), CameraXExecutors.directExecutor());
        }
    }
    ...
    public void onSessionFinished(@NonNull SynchronizedCaptureSession synchronizedCaptureSession) {
        ...
        if (lVar != null) {
            lVar.addListener(new b0(this, synchronizedCaptureSession, 0), CameraXExecutors.directExecutor());
        }
    }
    ...
    @Override // androidx.camera.camera2.internal.SynchronizedCaptureSessionOpener.OpenerImpl
    @NonNull
    public m4.l openCaptureSession(@NonNull CameraDevice cameraDevice, @NonNull final SessionConfigurationCompat sessionConfigurationCompat, @NonNull final List<DeferrableSurface> list) {
        synchronized (this.mLock) {
            try {
                ...
                m4.l future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.c0
                    @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                    public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                        return this.f833a.lambda$openCaptureSession$0(list, cameraDeviceCompat, sessionConfigurationCompat, completer);
                    }
                });
    ...
    @Override // androidx.camera.camera2.internal.SynchronizedCaptureSessionOpener.OpenerImpl
    @NonNull
    public m4.l startWithDeferrableSurface(@NonNull final List<DeferrableSurface> list, long j8) {
        synchronized (this.mLock) {
            try {
                if (this.mOpenerDisabled) {
                    return Futures.immediateFailedFuture(new CancellationException("Opener is disabled"));
                }
                FutureChain futureChainTransformAsync = FutureChain.from(DeferrableSurfaces.surfaceListWithTimeout(list, false, j8, getExecutor(), this.mScheduledExecutorService)).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.d0
                    @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
                    public final m4.l apply(Object obj) {
                        return this.f872a.lambda$startWithDeferrableSurface$1(list, (List) obj);
                    }
                }, getExecutor());
    ...
    public boolean stop() {
        ...
        try {
            synchronized (this.mLock) {
                try {
                    if (!this.mOpenerDisabled) {
                        m4.l lVar2 = this.mStartingSurface;
