    ...
    public static final class OutputConfigurationParamsApi21 {
        ...
        public boolean equals(Object obj) {
            ...
            for (int i8 = 0; i8 < iMin; i8++) {
                if (this.mSurfaces.get(i8) != outputConfigurationParamsApi21.mSurfaces.get(i8)) {
                    return false;
                }
            }
            return true;
        ...
        public int hashCode() {
            ...
            int i8 = this.mConfiguredGenerationId ^ ((iHashCode << 5) - iHashCode);
            int iHashCode2 = this.mConfiguredSize.hashCode() ^ ((i8 << 5) - i8);
            int i9 = this.mConfiguredFormat ^ ((iHashCode2 << 5) - iHashCode2);
            int i10 = (this.mIsShared ? 1 : 0) ^ ((i9 << 5) - i9);
            int i11 = (i10 << 5) - i10;
