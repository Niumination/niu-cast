...
class FocusMeteringControl {
    ...
    private void executeMeteringAction(@NonNull MeteringRectangle[] meteringRectangleArr, @NonNull MeteringRectangle[] meteringRectangleArr2, @NonNull MeteringRectangle[] meteringRectangleArr3, FocusMeteringAction focusMeteringAction, long j8) {
        ...
        Camera2CameraControlImpl.CaptureResultListener captureResultListener = new Camera2CameraControlImpl.CaptureResultListener() { // from class: androidx.camera.camera2.internal.u
            @Override // androidx.camera.camera2.internal.Camera2CameraControlImpl.CaptureResultListener
            public final boolean onCaptureResult(TotalCaptureResult totalCaptureResult) {
                return this.f925a.lambda$executeMeteringAction$2(zIsAfModeSupported, jUpdateSessionConfigSynchronous, totalCaptureResult);
            }
        };
        this.mSessionListenerForFocus = captureResultListener;
        this.mCameraControl.addCaptureResultListener(captureResultListener);
        long j10 = this.mFocusTimeoutCounter + 1;
        this.mFocusTimeoutCounter = j10;
        v vVar = new v(0, j10, this);
        ScheduledExecutorService scheduledExecutorService = this.mScheduler;
        TimeUnit timeUnit = TimeUnit.MILLISECONDS;
        this.mAutoFocusTimeoutHandle = scheduledExecutorService.schedule(vVar, j8, timeUnit);
        if (focusMeteringAction.isAutoCancelEnabled()) {
            this.mAutoCancelHandle = this.mScheduler.schedule(new v(1, j10, this), focusMeteringAction.getAutoCancelDurationInMillis(), timeUnit);
        }
    }
    ...
    private static PointF getFovAdjustedPoint(@NonNull MeteringPoint meteringPoint, @NonNull Rational rational, @NonNull Rational rational2, int i8, MeteringRegionCorrection meteringRegionCorrection) {
        if (meteringPoint.getSurfaceAspectRatio() != null) {
            rational2 = meteringPoint.getSurfaceAspectRatio();
        }
        PointF correctedPoint = meteringRegionCorrection.getCorrectedPoint(meteringPoint, i8);
    ...
    @NonNull
    private List<MeteringRectangle> getMeteringRectangles(@NonNull List<MeteringPoint> list, int i8, @NonNull Rational rational, @NonNull Rect rect, int i9) {
        ...
        for (MeteringPoint meteringPoint : list) {
            ...
            if (isValid(meteringPoint)) {
                MeteringRectangle meteringRect = getMeteringRect(meteringPoint, getFovAdjustedPoint(meteringPoint, rational2, rational, i9, this.mMeteringRegionCorrection), rect);
    ...
    public /* synthetic */ Object lambda$cancelFocusAndMetering$8(CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new a(7, this, completer));
        return "cancelFocusAndMetering";
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ boolean lambda$cancelFocusAndMeteringInternal$9(int i8, long j8, TotalCaptureResult totalCaptureResult) {
        if (((Integer) totalCaptureResult.get(CaptureResult.CONTROL_AF_MODE)).intValue() != i8 || !Camera2CameraControlImpl.isSessionUpdated(totalCaptureResult, j8)) {
            return false;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ boolean lambda$executeMeteringAction$2(boolean z2, long j8, TotalCaptureResult totalCaptureResult) {
        ...
        if (this.mIsAutoFocusCompleted && Camera2CameraControlImpl.isSessionUpdated(totalCaptureResult, j8)) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$executeMeteringAction$3(long j8) {
        if (j8 == this.mFocusTimeoutCounter) {
            this.mIsFocusSuccessful = false;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$executeMeteringAction$4(long j8) {
        this.mExecutor.execute(new v(3, j8, this));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$executeMeteringAction$5(long j8) {
        if (j8 == this.mFocusTimeoutCounter) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$executeMeteringAction$6(long j8) {
        this.mExecutor.execute(new v(2, j8, this));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ Object lambda$startFocusAndMetering$1(final FocusMeteringAction focusMeteringAction, final long j8, final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.r
            @Override // java.lang.Runnable
            public final void run() {
                this.lambda$startFocusAndMetering$0(completer, focusMeteringAction, j8);
            }
        });
        return "startFocusAndMetering";
    }

    private static int rangeLimit(int i8, int i9, int i10) {
    ...
    public m4.l cancelFocusAndMetering() {
        return CallbackToFutureAdapter.getFuture(new j(this, 3));
    }
    ...
    public void lambda$cancelFocusAndMetering$7(@Nullable CallbackToFutureAdapter.Completer<Void> completer) {
        ...
        if (this.mRunningCancelCompleter != null) {
            ...
            Camera2CameraControlImpl.CaptureResultListener captureResultListener = new Camera2CameraControlImpl.CaptureResultListener() { // from class: androidx.camera.camera2.internal.t
                @Override // androidx.camera.camera2.internal.Camera2CameraControlImpl.CaptureResultListener
                public final boolean onCaptureResult(TotalCaptureResult totalCaptureResult) {
                    return this.lambda$cancelFocusAndMeteringInternal$9(supportedAfMode, jUpdateSessionConfigSynchronous, totalCaptureResult);
                }
            };
    ...
    public void lambda$startFocusAndMetering$0(@NonNull CallbackToFutureAdapter.Completer<FocusMeteringResult> completer, @NonNull FocusMeteringAction focusMeteringAction, long j8) {
        if (!this.mIsActive) {
        ...
        MeteringRectangle[] meteringRectangleArr = EMPTY_RECTANGLES;
        executeMeteringAction((MeteringRectangle[]) meteringRectangles.toArray(meteringRectangleArr), (MeteringRectangle[]) meteringRectangles2.toArray(meteringRectangleArr), (MeteringRectangle[]) meteringRectangles3.toArray(meteringRectangleArr), focusMeteringAction, j8);
    }
    ...
    @NonNull
    @VisibleForTesting
    public m4.l startFocusAndMetering(@NonNull final FocusMeteringAction focusMeteringAction, final long j8) {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.s
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f919a.lambda$startFocusAndMetering$1(focusMeteringAction, j8, completer);
            }
        });
    }
}
