...
public class Camera2RequestProcessor implements RequestProcessor {
    ...
    public class Camera2CallbackWrapper extends CameraCaptureSession.CaptureCallback {
        ...
        public Camera2CallbackWrapper(@NonNull RequestProcessor.Request request, RequestProcessor.Callback callback, boolean z2) {
        ...
        public void onCaptureBufferLost(@NonNull CameraCaptureSession cameraCaptureSession, @NonNull CaptureRequest captureRequest, @NonNull Surface surface, long j8) {
            this.mCallback.onCaptureBufferLost(this.mRequest, j8, Camera2RequestProcessor.this.findOutputConfigId(surface));
        }
        ...
        public void onCaptureStarted(@NonNull CameraCaptureSession cameraCaptureSession, @NonNull CaptureRequest captureRequest, long j8, long j10) {
            this.mCallback.onCaptureStarted(this.mRequest, j10, j8);
        }
    }
