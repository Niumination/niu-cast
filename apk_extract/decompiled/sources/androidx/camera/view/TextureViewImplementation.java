...
final class TextureViewImplementation extends PreviewViewImplementation {
    ...
    public class AnonymousClass1 implements TextureView.SurfaceTextureListener {
        ...
        public boolean onSurfaceTextureDestroyed(@NonNull final SurfaceTexture surfaceTexture) {
            ...
            m4.l lVar = textureViewImplementation.mSurfaceReleaseFuture;
            if (lVar == null) {
                Logger.d(TextureViewImplementation.TAG, "SurfaceTexture about to be destroyed");
                return true;
            }
            Futures.addCallback(lVar, new FutureCallback<SurfaceRequest.Result>() { // from class: androidx.camera.view.TextureViewImplementation.1.1
    ...
    public /* synthetic */ Object lambda$tryToProvidePreviewSurface$1(Surface surface, CallbackToFutureAdapter.Completer completer) throws Exception {
        ...
        surfaceRequest.provideSurface(surface, executorDirectExecutor, new b0.d(completer, 0));
        return "provideSurface[request=" + this.mSurfaceRequest + " surface=" + surface + "]";
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$tryToProvidePreviewSurface$2(Surface surface, m4.l lVar, SurfaceRequest surfaceRequest) {
        Logger.d(TAG, "Safe to release surface.");
        notifySurfaceNotInUse();
        surface.release();
        if (this.mSurfaceReleaseFuture == lVar) {
            this.mSurfaceReleaseFuture = null;
        }
    ...
    public void tryToProvidePreviewSurface() {
        ...
        final m4.l future = CallbackToFutureAdapter.getFuture(new e(1, this, surface));
        this.mSurfaceReleaseFuture = future;
        future.addListener(new Runnable() { // from class: androidx.camera.view.n
            @Override // java.lang.Runnable
            public final void run() {
                this.f1071a.lambda$tryToProvidePreviewSurface$2(surface, future, surfaceRequest);
            }
    ...
    public m4.l waitForNextFrame() {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.view.m
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f1070a.lambda$waitForNextFrame$3(completer);
            }
        });
    }
}
