...
public final class AspectRatioUtil {
    ...
    private static boolean ratioIntersectsMod16Segment(int i8, int i9, Rational rational) {
        Preconditions.checkArgument(i9 % 16 == 0);
        double numerator = ((double) (rational.getNumerator() * i8)) / ((double) rational.getDenominator());
