...
public final class Exif {
    ...
    public static final class Speed {
        ...
        public static Converter fromKilometersPerHour(double d7) {
            return new Converter(d7 * 0.621371d);
        }

        public static Converter fromKnots(double d7) {
            return new Converter(d7 * 1.15078d);
        }

        public static Converter fromMilesPerHour(double d7) {
            return new Converter(d7);
        }
    }
    ...
    private static String convertToExifDateTime(long j8) {
        return DATETIME_FORMAT.get().format(new Date(j8));
    }
    ...
    private long parseTimestamp(@Nullable String str, @Nullable String str2) {
        ...
        if (str != null) {
            return parseTimestamp(d.l(str, " ", str2));
        }
        try {
    ...
    public void flipHorizontally() {
        ...
        this.mExifInterface.setAttribute(ExifInterface.TAG_ORIENTATION, String.valueOf(i8));
    }
    ...
    public Location getLocation() {
        ...
        if (attributeDouble != 0.0d) {
            ...
            if (b9 != 0) {
                metersPerSecond = b9 != 1 ? Speed.fromKilometersPerHour(attributeDouble).toMetersPerSecond() : Speed.fromKnots(attributeDouble).toMetersPerSecond();
            } else {
    ...
    public void rotate(int i8) {
        if (i8 % 90 != 0) {
            ...
            Logger.w(str, "Can only rotate in right angles (eg. 0, 90, 180, 270). " + i8 + " is unsupported.");
