...
final class HandlerScheduledExecutorService extends AbstractExecutorService implements ScheduledExecutorService {
    ...
    public static class HandlerScheduledFuture<V> implements RunnableScheduledFuture<V> {
        ...
        public HandlerScheduledFuture(final Handler handler, long j8, final Callable<V> callable) {
            this.mRunAtMillis = j8;
            this.mTask = callable;
    ...
    @Override // java.util.concurrent.ScheduledExecutorService
    @NonNull
    public ScheduledFuture<?> scheduleAtFixedRate(@NonNull Runnable runnable, long j8, long j10, @NonNull TimeUnit timeUnit) {
        throw new UnsupportedOperationException("HandlerScheduledExecutorService does not yet support fixed-rate scheduling.");
    }

    @Override // java.util.concurrent.ScheduledExecutorService
    @NonNull
    public ScheduledFuture<?> scheduleWithFixedDelay(@NonNull Runnable runnable, long j8, long j10, @NonNull TimeUnit timeUnit) {
    ...
    public <V> ScheduledFuture<V> schedule(@NonNull Callable<V> callable, long j8, @NonNull TimeUnit timeUnit) {
        long jConvert = TimeUnit.MILLISECONDS.convert(j8, timeUnit) + SystemClock.uptimeMillis();
