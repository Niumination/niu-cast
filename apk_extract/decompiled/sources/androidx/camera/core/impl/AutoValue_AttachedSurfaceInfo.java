...
final class AutoValue_AttachedSurfaceInfo extends AttachedSurfaceInfo {
    ...
    public AutoValue_AttachedSurfaceInfo(SurfaceConfig surfaceConfig, int i8, Size size, @Nullable Range<Integer> range) {
    ...
    public int hashCode() {
        ...
        Range<Integer> range = this.targetFrameRate;
        return (range == null ? 0 : range.hashCode()) ^ iHashCode;
    }
