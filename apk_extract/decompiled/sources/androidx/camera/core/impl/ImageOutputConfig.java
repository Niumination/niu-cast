...
public interface ImageOutputConfig extends ReadableConfig {
    ...
    public interface Builder<B> {
        ...
        @NonNull
        B setTargetAspectRatio(int i8);

        @NonNull
        B setTargetResolution(@NonNull Size size);

        @NonNull
        B setTargetRotation(int i8);
    }
    ...
    default int getAppTargetRotation(int i8) {
        return ((Integer) retrieveOption(OPTION_APP_TARGET_ROTATION, Integer.valueOf(i8))).intValue();
    }
