...
final class ProcessingInput2Packet implements Operation<ProcessingNode.InputPacket, Packet<ImageProxy>> {
    ...
    private static Size getRotatedSize(int i8, Size size) {
        return TransformUtils.is90or270(TransformUtils.within360(i8)) ? new Size(size.getHeight(), size.getWidth()) : size;
    }
