...
class ProcessingRequest {
    ...
    public ProcessingRequest(@NonNull CaptureBundle captureBundle, @Nullable ImageCapture.OutputFileOptions outputFileOptions, @NonNull Rect rect, int i8, int i9, @NonNull Matrix matrix, @NonNull TakePictureCallback takePictureCallback, @NonNull l lVar) {
