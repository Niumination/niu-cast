...
final class AutoValue_TakePictureRequest extends TakePictureRequest {
    ...
    public int hashCode() {
        ...
        return this.sessionConfigCameraCaptureCallbacks.hashCode() ^ ((((((((((((iHashCode3 ^ (outputFileOptions != null ? outputFileOptions.hashCode() : 0)) * 1000003) ^ this.cropRect.hashCode()) * 1000003) ^ this.sensorToBufferTransform.hashCode()) * 1000003) ^ this.rotationDegrees) * 1000003) ^ this.jpegQuality) * 1000003) ^ this.captureMode) * 1000003);
    }
