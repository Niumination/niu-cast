...
public final class CameraX {
    ...
    private final l mInitInternalFuture;
    ...
    @GuardedBy("mInitializeLock")
    private l mShutdownInternalFuture = Futures.immediateFuture(null);

    /* JADX INFO: renamed from: androidx.camera.core.CameraX$1, reason: invalid class name */
    ...
    private void initAndRetryRecursively(@NonNull final Executor executor, final long j8, @NonNull final Context context, @NonNull final CallbackToFutureAdapter.Completer<Void> completer) {
        executor.execute(new Runnable() { // from class: m.a
            @Override // java.lang.Runnable
            public final void run() {
                this.f7534a.lambda$initAndRetryRecursively$2(context, executor, completer, j8);
            }
        });
    }

    private l initInternal(@NonNull Context context) {
        l future;
        synchronized (this.mInitializeLock) {
            ...
            future = CallbackToFutureAdapter.getFuture(new u(5, this, context));
        }
        return future;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$initAndRetryRecursively$1(Executor executor, long j8, CallbackToFutureAdapter.Completer completer) {
        initAndRetryRecursively(executor, j8, this.mAppContext, completer);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$initAndRetryRecursively$2(Context context, Executor executor, CallbackToFutureAdapter.Completer completer, long j8) {
        try {
            ...
            if (SystemClock.elapsedRealtime() - j8 < 2500) {
                Logger.w(TAG, "Retry init. Start time " + j8 + " current time " + SystemClock.elapsedRealtime(), e);
                HandlerCompat.postDelayed(this.mSchedulerHandler, new e8.a(this, executor, j8, completer), RETRY_TOKEN, RETRY_SLEEP_MILLIS);
                return;
            }
            synchronized (this.mInitializeLock) {
    ...
    public /* synthetic */ Object lambda$shutdownInternal$4(CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mCameraRepository.deinit().addListener(new a0.e(19, this, completer), this.mCameraExecutor);
    ...
    @NonNull
    private l shutdownInternal() {
        synchronized (this.mInitializeLock) {
            try {
                this.mSchedulerHandler.removeCallbacksAndMessages(RETRY_TOKEN);
                int i8 = AnonymousClass1.$SwitchMap$androidx$camera$core$CameraX$InternalInitState[this.mInitState.ordinal()];
                if (i8 == 1) {
                ...
                if (i8 == 3 || i8 == 4) {
                    ...
                    this.mShutdownInternalFuture = CallbackToFutureAdapter.getFuture(new a4.b(this, 12));
                }
