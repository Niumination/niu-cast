...
public final class ImageAnalysis extends UseCase {
    ...
    public static final class Builder implements ImageOutputConfig.Builder<Builder>, ThreadConfig.Builder<Builder>, UseCaseConfig.Builder<ImageAnalysis, ImageAnalysisConfig, Builder> {
        ...
        @NonNull
        public Builder setBackpressureStrategy(int i8) {
            getMutableConfig().insertOption(ImageAnalysisConfig.OPTION_BACKPRESSURE_STRATEGY, Integer.valueOf(i8));
            return this;
        }
        ...
        @NonNull
        public Builder setImageQueueDepth(int i8) {
            getMutableConfig().insertOption(ImageAnalysisConfig.OPTION_IMAGE_QUEUE_DEPTH, Integer.valueOf(i8));
            return this;
        }
        ...
        @NonNull
        public Builder setOutputImageFormat(int i8) {
            getMutableConfig().insertOption(ImageAnalysisConfig.OPTION_OUTPUT_IMAGE_FORMAT, Integer.valueOf(i8));
            return this;
        }
    ...
    public SessionConfig.Builder createPipeline(@NonNull String str, @NonNull ImageAnalysisConfig imageAnalysisConfig, @NonNull StreamSpec streamSpec) {
        ...
        SafeCloseImageReaderProxy safeCloseImageReaderProxy2 = (z3 || z2) ? new SafeCloseImageReaderProxy(ImageReaderProxys.createIsolatedReader(height, width, i8, safeCloseImageReaderProxy.getMaxImages())) : null;
        if (safeCloseImageReaderProxy2 != null) {
        ...
        immediateSurface.getTerminationFuture().addListener(new a0.e(20, safeCloseImageReaderProxy, safeCloseImageReaderProxy2), CameraXExecutors.mainThreadExecutor());
        builderCreateFrom.addSurface(this.mDeferrableSurface);
        builderCreateFrom.addErrorListener(new m.b(this, str, imageAnalysisConfig, streamSpec, 0));
    ...
    public UseCaseConfig<?> onMergeConfig(@NonNull CameraInfoInternal cameraInfoInternal, @NonNull UseCaseConfig.Builder<?, ?, ?> builder) {
        ...
        if (defaultTargetResolution != null) {
            ...
            if (mutableConfig.containsOption(option)) {
                ResolutionSelector resolutionSelector = (ResolutionSelector) builder.getMutableConfig().retrieveOption(option);
                if (resolutionSelector.getPreferredResolution() == null) {
                    ...
                    builderFromSelector.setPreferredResolution(defaultTargetResolution);
                ...
                if (!useCaseConfig.containsOption(option2)) {
                    builder.getMutableConfig().insertOption(option2, defaultTargetResolution);
                }
            }
        }
    ...
    public StreamSpec onSuggestedStreamSpecUpdated(@NonNull StreamSpec streamSpec) {
        updateSessionConfig(createPipeline(getCameraId(), (ImageAnalysisConfig) getCurrentConfig(), streamSpec).build());
        return streamSpec;
    }
    ...
    public void setAnalyzer(@NonNull Executor executor, @NonNull Analyzer analyzer) {
        synchronized (this.mAnalysisLock) {
            try {
                this.mImageAnalysisAbstractAnalyzer.setAnalyzer(executor, new a4.b(analyzer, 13));
                if (this.mSubscribedAnalyzer == null) {
                    notifyActive();
                }
