...
class VersionedParcelStream extends VersionedParcel {
    ...
    private void readObject(int i8, String str, Bundle bundle) {
        switch (i8) {
            case 0:
            ...
            case 14:
                ...
                return;
            default:
                throw new RuntimeException(a.o(i8, "Unknown type "));
        }
    }
    ...
    public byte[] readByteArray() {
        try {
            int i8 = this.mCurrentInput.readInt();
            if (i8 <= 0) {
                return null;
            }
    ...
    public boolean readField(int i8) {
        while (true) {
            try {
                ...
                int i10 = this.mCount;
                int i11 = this.mFieldSize;
                if (i10 < i11) {
                    this.mMasterInput.skip(i11 - i10);
                }
                this.mFieldSize = -1;
    ...
    public void setOutputField(int i8) {
        closeField();
        FieldBuffer fieldBuffer = new FieldBuffer(i8, this.mMasterOutput);
    ...
    public void writeDouble(double d7) {
        try {
            this.mCurrentOutput.writeDouble(d7);
        } catch (IOException e) {
            throw new VersionedParcel.ParcelException(e);
        }
    }
    ...
    public void writeInt(int i8) {
        try {
            this.mCurrentOutput.writeInt(i8);
        } catch (IOException e) {
            throw new VersionedParcel.ParcelException(e);
        }
    }
    ...
    public void writeLong(long j8) {
        try {
            this.mCurrentOutput.writeLong(j8);
        } catch (IOException e) {
            throw new VersionedParcel.ParcelException(e);
        }
    }
    ...
    private VersionedParcelStream(InputStream inputStream, OutputStream outputStream, ArrayMap<String, Method> arrayMap, ArrayMap<String, Method> arrayMap2, ArrayMap<String, Class> arrayMap3) {
        ...
        DataInputStream dataInputStream = inputStream != null ? new DataInputStream(new FilterInputStream(inputStream) { // from class: androidx.versionedparcelable.VersionedParcelStream.1
            ...
            public int read() throws IOException {
                ...
                int i8 = versionedParcelStream.mFieldSize;
                if (i8 != -1 && versionedParcelStream.mCount >= i8) {
    ...
    public void writeByteArray(byte[] bArr, int i8, int i9) {
        try {
            if (bArr != null) {
                this.mCurrentOutput.writeInt(i9);
                this.mCurrentOutput.write(bArr, i8, i9);
            } else {
                this.mCurrentOutput.writeInt(-1);
            }
        } catch (IOException e) {
