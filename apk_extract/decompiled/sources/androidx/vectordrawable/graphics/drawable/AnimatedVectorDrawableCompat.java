...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
            ...
            if (animatedVectorDrawableCompatState != null) {
                ...
                if (arrayList != null) {
                    ...
                    for (int i8 = 0; i8 < size; i8++) {
                        Animator animator = animatedVectorDrawableCompatState.mAnimators.get(i8);
    ...
    @Nullable
    public static AnimatedVectorDrawableCompat create(@NonNull Context context, @DrawableRes int i8) {
    ...
    private void setupColorAnimator(Animator animator) {
        ...
        if ((animator instanceof AnimatorSet) && (childAnimations = ((AnimatorSet) animator).getChildAnimations()) != null) {
            for (int i8 = 0; i8 < childAnimations.size(); i8++) {
                setupColorAnimator(childAnimations.get(i8));
            }
        }
    ...
    public boolean onLevelChange(int i8) {
        Drawable drawable = this.mDelegateDrawable;
        return drawable != null ? drawable.setLevel(i8) : this.mAnimatedVectorState.mVectorDrawable.setLevel(i8);
    }
        ...
        if (this.mAnimatorListener == null) {
            this.mAnimatorListener = new AnimatorListenerAdapter() { // from class: androidx.vectordrawable.graphics.drawable.AnimatedVectorDrawableCompat.2
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    int size = arrayList.size();
                    for (int i8 = 0; i8 < size; i8++) {
                        ((Animatable2Compat.AnimationCallback) arrayList.get(i8)).onAnimationEnd(AnimatedVectorDrawableCompat.this);
                    }
                }
                ...
                public void onAnimationStart(Animator animator) {
                    ...
                    int size = arrayList.size();
                    for (int i8 = 0; i8 < size; i8++) {
                        ((Animatable2Compat.AnimationCallback) arrayList.get(i8)).onAnimationStart(AnimatedVectorDrawableCompat.this);
                    }
                }
            };
        }
    ...
    public void setAlpha(int i8) {
        ...
        if (drawable != null) {
            ...
            this.mAnimatedVectorState.mVectorDrawable.setAlpha(i8);
        }
    }
    ...
    public void setTint(int i8) {
        ...
        if (drawable != null) {
            ...
            this.mAnimatedVectorState.mVectorDrawable.setTint(i8);
        }
    }
