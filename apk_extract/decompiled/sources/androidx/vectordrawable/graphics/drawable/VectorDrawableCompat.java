...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public static int applyAlpha(int i8, float f) {
        return (i8 & ViewCompat.MEASURED_SIZE_MASK) | (((int) (Color.alpha(i8) * f)) << 24);
    }
    ...
    private void printGroupTree(VGroup vGroup, int i8) {
        ...
        StringBuilder sbT = d.t(strB, "current group is :");
        sbT.append(vGroup.getGroupName());
        sbT.append(" rotation is ");
        sbT.append(vGroup.mRotate);
        Log.v(LOGTAG, sbT.toString());
        Log.v(LOGTAG, strB + "matrix is :" + vGroup.getLocalMatrix().toString());
    ...
    public float getPixelSize() {
        ...
        float f4 = vPathRenderer.mBaseHeight;
        if (f4 == 0.0f) {
            return 1.0f;
        }
    ...
    public static abstract class VPath extends VObject {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (int i8 = 0; i8 < pathDataNodeArr.length; i8++) {
                ...
                sbS.append(pathDataNodeArr[i8].mType);
                sbS.append(":");
                string = sbS.toString();
                for (float f : pathDataNodeArr[i8].mParams) {
                    StringBuilder sbS2 = d.s(string);
                    sbS2.append(f);
                    sbS2.append(",");
        ...
        public void printVPath(int i8) {
            ...
            StringBuilder sbT = d.t(strB, "current path is :");
            sbT.append(this.mPathName);
            sbT.append(" pathData is ");
            sbT.append(nodesToString(this.mNodes));
            Log.v(VectorDrawableCompat.LOGTAG, sbT.toString());
        }
    ...
    public static class VFullPath extends VPath {
        ...
        private Paint.Cap getStrokeLineCap(int i8, Paint.Cap cap) {
            ...
            if (i8 != 1) {
                return i8 != 2 ? cap : Paint.Cap.SQUARE;
            }
        ...
        private Paint.Join getStrokeLineJoin(int i8, Paint.Join join) {
            ...
            if (i8 != 1) {
                return i8 != 2 ? join : Paint.Join.BEVEL;
            }
    ...
    public static class VPathRenderer {
        ...
        private static float cross(float f, float f4, float f10, float f11) {
            return (f * f11) - (f4 * f10);
        }
        ...
        private void drawPath(VGroup vGroup, VPath vPath, Canvas canvas, int i8, int i9, ColorFilter colorFilter) {
            float f = i8 / this.mViewportWidth;
            float f4 = i9 / this.mViewportHeight;
            float fMin = Math.min(f, f4);
            Matrix matrix = vGroup.mStackedMatrix;
            this.mFinalPathMatrix.set(matrix);
            this.mFinalPathMatrix.postScale(f, f4);
    ...
    public static class VGroup extends VObject {
        ...
        public boolean onStateChanged(int[] iArr) {
            ...
            for (int i8 = 0; i8 < this.mChildren.size(); i8++) {
                zOnStateChanged |= this.mChildren.get(i8).onStateChanged(iArr);
            }
            return zOnStateChanged;
        }
