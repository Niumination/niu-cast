...
public class ComponentDialog extends Dialog implements LifecycleOwner, OnBackPressedDispatcherOwner, SavedStateRegistryOwner {
    ...
    public /* synthetic */ ComponentDialog(Context context, int i8, int i9, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public ComponentDialog(Context context, @StyleRes int i8) {
        ...
        this.onBackPressedDispatcher = new OnBackPressedDispatcher(new a4.c(this, 5));
    }
