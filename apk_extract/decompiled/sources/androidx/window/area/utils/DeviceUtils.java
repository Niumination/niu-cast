...
public final class DeviceUtils {
    ...
    public final DisplayMetrics getRearDisplayMetrics$window_release(String manufacturer, String model) {
        ...
        while (true) {
            ...
            if (Intrinsics.areEqual(manufacturer2, a.t(locale, GeoCoderManager.DEFAULT_COUNTRY_ISO, manufacturer, locale, "this as java.lang.String).toLowerCase(locale)")) && Intrinsics.areEqual(deviceMetrics.getModel(), a.t(locale, GeoCoderManager.DEFAULT_COUNTRY_ISO, model, locale, "this as java.lang.String).toLowerCase(locale)"))) {
                break;
            }
        }
