...
public final class Version implements Comparable<Version> {
    ...
    public static final class Companion {
        ...
        public final Version parse(String versionString) {
            ...
            return new Version(i8, i9, i10, description, null);
        }
    ...
    public /* synthetic */ Version(int i8, int i9, int i10, String str, DefaultConstructorMarker defaultConstructorMarker) {
        this(i8, i9, i10, str);
    }
