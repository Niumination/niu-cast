...
public final class ActivityRule extends EmbeddingRule {
    ...
    public /* synthetic */ ActivityRule(String str, Set set, boolean z2, int i8, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, set, (i8 & 4) != 0 ? false : z2);
    }
    ...
    public ActivityRule(String str, Set<ActivityFilter> filters, boolean z2) {
        super(str);
        Intrinsics.checkNotNullParameter(filters, "filters");
        this.filters = filters;
