...
public final class EmbeddingCompat implements EmbeddingInterfaceCompat {
    ...
    public static final class Companion {
        ...
        private final ActivityEmbeddingComponent emptyActivityEmbeddingProxy() {
            Object objNewProxyInstance = Proxy.newProxyInstance(EmbeddingCompat.class.getClassLoader(), new Class[]{ActivityEmbeddingComponent.class}, new InvocationHandler() { // from class: f1.e
    ...
    public void setEmbeddingCallback(final EmbeddingInterfaceCompat.EmbeddingCallbackInterface embeddingCallback) {
        ...
        if (ExtensionsUtil.INSTANCE.getSafeVendorApiLevel() < 2) {
            ...
            this.embeddingExtension.setSplitInfoCallback(new u(3, embeddingCallback, this));
        }
    }
