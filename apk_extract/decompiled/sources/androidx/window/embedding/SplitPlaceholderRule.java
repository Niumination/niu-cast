...
public final class SplitPlaceholderRule extends SplitRule {
    ...
    public /* synthetic */ SplitPlaceholderRule(String str, Set set, Intent intent, boolean z2, SplitRule.FinishBehavior finishBehavior, int i8, int i9, int i10, EmbeddingAspectRatio embeddingAspectRatio, EmbeddingAspectRatio embeddingAspectRatio2, SplitAttributes splitAttributes, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this((i11 & 1) != 0 ? null : str, set, intent, z2, (i11 & 16) != 0 ? SplitRule.FinishBehavior.ALWAYS : finishBehavior, (i11 & 32) != 0 ? 600 : i8, (i11 & 64) != 0 ? 600 : i9, (i11 & 128) != 0 ? 600 : i10, (i11 & 256) != 0 ? SplitRule.SPLIT_MAX_ASPECT_RATIO_PORTRAIT_DEFAULT : embeddingAspectRatio, (i11 & 512) != 0 ? SplitRule.SPLIT_MAX_ASPECT_RATIO_LANDSCAPE_DEFAULT : embeddingAspectRatio2, splitAttributes);
    }
    ...
    @Override // androidx.window.embedding.SplitRule, androidx.window.embedding.EmbeddingRule
    public int hashCode() {
        return this.filters.hashCode() + ((this.finishPrimaryWithPlaceholder.hashCode() + a1.a.g(this.isSticky, (this.placeholderIntent.hashCode() + (super.hashCode() * 31)) * 31, 31)) * 31);
    }
    ...
    public SplitPlaceholderRule(String str, Set<ActivityFilter> filters, Intent placeholderIntent, boolean z2, SplitRule.FinishBehavior finishPrimaryWithPlaceholder, @IntRange(from = 0) int i8, @IntRange(from = 0) int i9, @IntRange(from = 0) int i10, EmbeddingAspectRatio maxAspectRatioInPortrait, EmbeddingAspectRatio maxAspectRatioInLandscape, SplitAttributes defaultSplitAttributes) {
