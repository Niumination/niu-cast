...
public final class RuleController {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        public final Set<EmbeddingRule> parseRules(Context context, @XmlRes int staticRuleResourceId) throws XmlPullParserException, IOException {
            Intrinsics.checkNotNullParameter(context, "context");
    ...
    @JvmStatic
    public static final Set<EmbeddingRule> parseRules(Context context, @XmlRes int i8) {
        return INSTANCE.parseRules(context, i8);
    }
