...
public final class SplitPairRule extends SplitRule {
    ...
    public /* synthetic */ SplitPairRule(Set set, SplitAttributes splitAttributes, String str, SplitRule.FinishBehavior finishBehavior, SplitRule.FinishBehavior finishBehavior2, boolean z2, int i8, int i9, int i10, EmbeddingAspectRatio embeddingAspectRatio, EmbeddingAspectRatio embeddingAspectRatio2, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this(set, splitAttributes, (i11 & 4) != 0 ? null : str, (i11 & 8) != 0 ? SplitRule.FinishBehavior.NEVER : finishBehavior, (i11 & 16) != 0 ? SplitRule.FinishBehavior.ALWAYS : finishBehavior2, (i11 & 32) != 0 ? false : z2, (i11 & 64) != 0 ? 600 : i8, (i11 & 128) != 0 ? 600 : i9, (i11 & 256) != 0 ? 600 : i10, (i11 & 512) != 0 ? SplitRule.SPLIT_MAX_ASPECT_RATIO_PORTRAIT_DEFAULT : embeddingAspectRatio, (i11 & 1024) != 0 ? SplitRule.SPLIT_MAX_ASPECT_RATIO_LANDSCAPE_DEFAULT : embeddingAspectRatio2);
    }
    ...
    public SplitPairRule(Set<SplitPairFilter> filters, SplitAttributes defaultSplitAttributes, String str, SplitRule.FinishBehavior finishPrimaryWithSecondary, SplitRule.FinishBehavior finishSecondaryWithPrimary, boolean z2, @IntRange(from = 0) int i8, @IntRange(from = 0) int i9, @IntRange(from = 0) int i10, EmbeddingAspectRatio maxAspectRatioInPortrait, EmbeddingAspectRatio maxAspectRatioInLandscape) {
