...
public class ProfileInstaller {
    ...
    static final DiagnosticsCallback LOG_DIAGNOSTICS = new DiagnosticsCallback() { // from class: androidx.profileinstaller.ProfileInstaller.2
        ...
        public void onDiagnosticReceived(int i8, @Nullable Object obj) {
            ...
            if (i8 == 1) {
                ...
                str = i8 != 5 ? "" : "DIAGNOSTIC_PROFILE_IS_COMPRESSED";
            } else {
    ...
    public static void diagnostic(@NonNull Executor executor, @NonNull DiagnosticsCallback diagnosticsCallback, int i8, @Nullable Object obj) {
        executor.execute(new x0.a(diagnosticsCallback, i8, obj, 1));
    }
    ...
    public static boolean hasAlreadyWrittenProfileForThisInstall(PackageInfo packageInfo, File file, DiagnosticsCallback diagnosticsCallback) {
        ...
        try {
            ...
            try {
                ...
                boolean z2 = j8 == packageInfo.lastUpdateTime;
                if (z2) {
    ...
    public static void result(@NonNull Executor executor, @NonNull DiagnosticsCallback diagnosticsCallback, int i8, @Nullable Object obj) {
        executor.execute(new x0.a(diagnosticsCallback, i8, obj, 0));
    }
    ...
    public static void writeProfile(@NonNull Context context) {
        writeProfile(context, new h.a(3), EMPTY_DIAGNOSTICS);
    }
    ...
    @WorkerThread
    public static void writeProfile(@NonNull Context context, @NonNull Executor executor, @NonNull DiagnosticsCallback diagnosticsCallback, boolean z2) {
        ...
        try {
            ...
            if (!z2 && hasAlreadyWrittenProfileForThisInstall(packageInfo, filesDir, diagnosticsCallback)) {
