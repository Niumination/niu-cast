...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    public void onDraw(Canvas canvas) {
        ...
        float f = height;
        canvas.drawRect(left, i8, right, f, this.mTabPaint);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (action == 2 && (Math.abs(x2 - this.mInitialMotionX) > this.mTouchSlop || Math.abs(y3 - this.mInitialMotionY) > this.mTouchSlop)) {
    ...
    public void setBackgroundColor(@ColorInt int i8) {
        ...
        this.mDrawFullUnderline = (i8 & ViewCompat.MEASURED_STATE_MASK) == 0;
    }
    ...
    public void updateTextPositions(int i8, float f, boolean z2) {
        ...
        super.updateTextPositions(i8, f, z2);
