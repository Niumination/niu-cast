...
public class DatePickerBindingAdapter {
    ...
    public static void setListeners(DatePicker datePicker, int i8, int i9, int i10, DatePicker.OnDateChangedListener onDateChangedListener, InverseBindingListener inverseBindingListener, InverseBindingListener inverseBindingListener2, InverseBindingListener inverseBindingListener3) {
        if (i8 == 0) {
        ...
        datePicker.init(i8, i9, i10, dateChangedListener);
    }
}
