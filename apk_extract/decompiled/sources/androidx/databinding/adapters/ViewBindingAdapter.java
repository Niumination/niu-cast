...
public class ViewBindingAdapter {
    ...
    public static void setClickListener(View view, View.OnClickListener onClickListener, boolean z2) {
    ...
    public static void setOnLongClick(View view, View.OnLongClickListener onLongClickListener, boolean z2) {
        view.setOnLongClickListener(onLongClickListener);
        view.setLongClickable(z2);
    }

    @BindingAdapter({"android:onLongClickListener", "android:longClickable"})
    public static void setOnLongClickListener(View view, View.OnLongClickListener onLongClickListener, boolean z2) {
        view.setOnLongClickListener(onLongClickListener);
        view.setLongClickable(z2);
    }
    ...
    public static void setRequiresFadingEdge(View view, int i8) {
        boolean z2 = (i8 & 2) != 0;
        boolean z3 = (i8 & 1) != 0;
        view.setVerticalFadingEdgeEnabled(z2);
        view.setHorizontalFadingEdgeEnabled(z3);
    }
}
