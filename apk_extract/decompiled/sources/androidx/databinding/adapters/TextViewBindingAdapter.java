...
public class TextViewBindingAdapter {
    ...
    public static void setAutoText(TextView textView, boolean z2) {
    ...
    public static void setInputMethod(TextView textView, CharSequence charSequence) {
        try {
            ...
            Log.e(TAG, "Could not create input method: " + ((Object) charSequence), e4);
    ...
    public static void setMaxLength(TextView textView, int i8) {
        ...
        if (filters == null) {
            ...
            inputFilterArr[length] = new InputFilter.LengthFilter(i8);
    ...
    public static void setNumeric(TextView textView, int i8) {
        textView.setKeyListener(DigitsKeyListener.getInstance((i8 & 3) != 0, (i8 & 5) != 0));
    }

    @BindingAdapter({"android:password"})
    public static void setPassword(TextView textView, boolean z2) {
        if (z2) {
    ...
    public static void setPhoneNumber(TextView textView, boolean z2) {
        if (z2) {
    ...
    public static void setShadowColor(TextView textView, int i8) {
        textView.setShadowLayer(textView.getShadowRadius(), textView.getShadowDx(), textView.getShadowDy(), i8);
    }
        ...
        TextWatcher textWatcher = (beforeTextChanged == null && afterTextChanged == null && onTextChanged == null && inverseBindingListener == null) ? null : new TextWatcher() { // from class: androidx.databinding.adapters.TextViewBindingAdapter.1
            ...
            public void beforeTextChanged(CharSequence charSequence, int i8, int i9, int i10) {
                ...
                if (beforeTextChanged2 != null) {
                    beforeTextChanged2.beforeTextChanged(charSequence, i8, i9, i10);
                }
            }
            ...
            public void onTextChanged(CharSequence charSequence, int i8, int i9, int i10) {
                ...
                if (onTextChanged2 != null) {
                    onTextChanged2.onTextChanged(charSequence, i8, i9, i10);
                }
    ...
    public static void setImeActionLabel(TextView textView, int i8) {
        textView.setImeActionLabel(textView.getImeActionLabel(), i8);
    }
}
