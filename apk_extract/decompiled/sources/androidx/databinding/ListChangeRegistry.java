...
public class ListChangeRegistry extends CallbackRegistry<ObservableList.OnListChangedCallback, ObservableList, ListChanges> {
    ...
    private static final CallbackRegistry.NotifierCallback<ObservableList.OnListChangedCallback, ObservableList, ListChanges> NOTIFIER_CALLBACK = new CallbackRegistry.NotifierCallback<ObservableList.OnListChangedCallback, ObservableList, ListChanges>() { // from class: androidx.databinding.ListChangeRegistry.1
        ...
        public void onNotifyCallback(ObservableList.OnListChangedCallback onListChangedCallback, ObservableList observableList, int i8, ListChanges listChanges) {
            if (i8 == 1) {
    ...
    private static ListChanges acquire(int i8, int i9, int i10) {
        ListChanges listChangesAcquire = sListChanges.acquire();
        if (listChangesAcquire == null) {
            listChangesAcquire = new ListChanges();
        }
        listChangesAcquire.start = i8;
        listChangesAcquire.to = i9;
        listChangesAcquire.count = i10;
    ...
    public void notifyInserted(@NonNull ObservableList observableList, int i8, int i9) {
        notifyCallbacks(observableList, 2, acquire(i8, 0, i9));
    }

    public void notifyMoved(@NonNull ObservableList observableList, int i8, int i9, int i10) {
        notifyCallbacks(observableList, 3, acquire(i8, i9, i10));
    }

    public void notifyRemoved(@NonNull ObservableList observableList, int i8, int i9) {
        notifyCallbacks(observableList, 4, acquire(i8, 0, i9));
    }

    @Override // androidx.databinding.CallbackRegistry
    public synchronized void notifyCallbacks(@NonNull ObservableList observableList, int i8, ListChanges listChanges) {
        super.notifyCallbacks(observableList, i8, listChanges);
        if (listChanges != null) {
            sListChanges.release(listChanges);
        }
    }

    public void notifyChanged(@NonNull ObservableList observableList, int i8, int i9) {
        notifyCallbacks(observableList, 1, acquire(i8, 0, i9));
    }
}
