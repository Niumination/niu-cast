...
class MetadataListReader {
    ...
    public static class InputStreamOpenTypeReader implements OpenTypeReader {
        ...
        public void skip(int i8) throws IOException {
            while (i8 > 0) {
                int iSkip = (int) this.mInputStream.skip(i8);
                if (iSkip < 1) {
    ...
    public static class OffsetInfo {
        ...
        public OffsetInfo(long j8, long j10) {
    ...
    private static OffsetInfo findOffsetInfo(OpenTypeReader openTypeReader) throws IOException {
        ...
        if (unsignedInt != -1) {
            ...
            for (int i9 = 0; i9 < unsignedInt2; i9++) {
    ...
    public static MetadataList read(InputStream inputStream) throws IOException {
        ...
        int i8 = inputStream.read(byteBufferAllocate.array());
        if (i8 == offsetInfoFindOffsetInfo.getLength()) {
            return MetadataList.getRootAsMetadataList(byteBufferAllocate);
        }
        throw new IOException("Needed " + offsetInfoFindOffsetInfo.getLength() + " bytes, got " + i8);
    }

    public static long toUnsignedInt(int i8) {
