...
public class EmojiCompat {
    ...
    public static final class CompatInternal19 extends CompatInternal {
        ...
        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        public CharSequence process(@NonNull CharSequence charSequence, int i8, int i9, int i10, boolean z2) {
            return this.mProcessor.process(charSequence, i8, i9, i10, z2);
        }
    ...
    public static class ListenerDispatcher implements Runnable {
        ...
        public ListenerDispatcher(@NonNull InitCallback initCallback, int i8) {
        ...
        public ListenerDispatcher(@NonNull Collection<InitCallback> collection, int i8) {
            this(collection, i8, null);
        }

        public ListenerDispatcher(@NonNull Collection<InitCallback> collection, int i8, @Nullable Throwable th2) {
    ...
    public static boolean handleDeleteSurroundingText(@NonNull InputConnection inputConnection, @NonNull Editable editable, @IntRange(from = 0) int i8, @IntRange(from = 0) int i9, boolean z2) {
        return EmojiProcessor.handleDeleteSurroundingText(inputConnection, editable, i8, i9, z2);
    }
    ...
    public CharSequence process(@Nullable CharSequence charSequence, @IntRange(from = 0) int i8, @IntRange(from = 0) int i9, @IntRange(from = 0) int i10, int i11) {
        ...
        if (i11 != 1) {
            z2 = i11 != 2 ? this.mReplaceAll : false;
        } else {
            z2 = true;
        }
        return this.mHelper.process(charSequence, i8, i9, i10, z2);
    }
