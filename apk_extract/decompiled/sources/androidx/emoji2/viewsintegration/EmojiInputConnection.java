...
final class EmojiInputConnection extends InputConnectionWrapper {
    ...
    public static class EmojiCompatDeleteHelper {
        public boolean handleDeleteSurroundingText(@NonNull InputConnection inputConnection, @NonNull Editable editable, @IntRange(from = 0) int i8, @IntRange(from = 0) int i9, boolean z2) {
            return EmojiCompat.handleDeleteSurroundingText(inputConnection, editable, i8, i9, z2);
        }
    ...
    public boolean deleteSurroundingText(int i8, int i9) {
        return this.mEmojiCompatDeleteHelper.handleDeleteSurroundingText(this, getEditable(), i8, i9, false) || super.deleteSurroundingText(i8, i9);
    }

    @Override // android.view.inputmethod.InputConnectionWrapper, android.view.inputmethod.InputConnection
    public boolean deleteSurroundingTextInCodePoints(int i8, int i9) {
        return this.mEmojiCompatDeleteHelper.handleDeleteSurroundingText(this, getEditable(), i8, i9, true) || super.deleteSurroundingTextInCodePoints(i8, i9);
    }
