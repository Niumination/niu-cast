...
public final class MutableObjectLongMap<K> extends ObjectLongMap<K> {
    ...
    private final void resizeStorage(int newCapacity) {
        ...
        while (i10 < i9) {
            if (((jArr[i10 >> 3] >> ((i10 & 7) << 3)) & 255) < 128) {
                ...
                int i16 = i15 >> 3;
                int i17 = (i15 & 7) << 3;
                jArr4[i16] = (jArr4[i16] & (~(255 << i17))) | (j8 << i17);
                objArr2[iFindFirstAvailableSlot] = obj;
                jArr3[iFindFirstAvailableSlot] = jArr2[i8];
            } else {
                i8 = i10;
            }
            i10 = i8 + 1;
        ...
        while (true) {
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i10 = 0; i10 < i9; i10++) {
                    if ((255 & j8) < 128) {
                        int i11 = (i8 << 3) + i10;
                        if (predicate.invoke(this.keys[i11], Long.valueOf(this.values[i11])).booleanValue()) {
                            removeValueAt(i11);
                        }
                    }
                    j8 >>= 8;
    ...
    public /* synthetic */ MutableObjectLongMap(int i8, int i9, DefaultConstructorMarker defaultConstructorMarker) {
        this((i9 & 1) != 0 ? 6 : i8);
    }
    ...
    public final long put(K key, long value, long j8) {
        int iFindIndex = findIndex(key);
        if (iFindIndex < 0) {
            iFindIndex = ~iFindIndex;
        } else {
            j8 = this.values[iFindIndex];
        }
        this.keys[iFindIndex] = key;
        this.values[iFindIndex] = value;
        return j8;
    ...
    public MutableObjectLongMap(int i8) {
        super(null);
        if (i8 >= 0) {
