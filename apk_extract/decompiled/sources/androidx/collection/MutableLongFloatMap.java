...
public final class MutableLongFloatMap extends LongFloatMap {
    ...
    private final void resizeStorage(int newCapacity) {
        ...
        while (i9 < i8) {
            if (((jArr[i9 >> 3] >> ((i9 & 7) << 3)) & 255) < 128) {
                ...
                fArr2[iFindFirstAvailableSlot] = fArr[i9];
            }
            i9++;
            jArr = jArr;
            jArr2 = jArr2;
        ...
        while (true) {
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i10 = 0; i10 < i9; i10++) {
                    if ((255 & j8) < 128) {
                        int i11 = (i8 << 3) + i10;
                        if (predicate.invoke(Long.valueOf(this.keys[i11]), Float.valueOf(this.values[i11])).booleanValue()) {
                            removeValueAt(i11);
                        }
                    }
                    j8 >>= 8;
    ...
    public /* synthetic */ MutableLongFloatMap(int i8, int i9, DefaultConstructorMarker defaultConstructorMarker) {
        this((i9 & 1) != 0 ? 6 : i8);
    }
    ...
    public MutableLongFloatMap(int i8) {
        super(null);
        if (i8 >= 0) {
