...
public abstract class ObjectLongMap<K> {
        ...
        while (true) {
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i10 = 0; i10 < i9; i10++) {
                    if ((255 & j8) < 128) {
                        int i11 = (i8 << 3) + i10;
                        if (!predicate.invoke(objArr[i11], Long.valueOf(jArr[i11])).booleanValue()) {
                            return false;
                        }
                    }
                    j8 >>= 8;
                ...
                if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i11 = 0; i11 < i10; i11++) {
                        if ((255 & j8) < 128) {
                            ...
                            iHashCode += (obj != null ? obj.hashCode() : 0) ^ Long.hashCode(jArr[i12]);
                        }
                        j8 >>= 8;
                    }
                    if (i10 != 8) {
    ...
    public static /* synthetic */ String joinToString$default(ObjectLongMap objectLongMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i8, CharSequence charSequence4, Function2 function2, int i9, Object obj) {
        long[] jArr;
        int i10;
        if (obj == null) {
                ...
                if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i17 < i16) {
                        if ((j8 & 255) < 128) {
                            ...
                            sbX.append((CharSequence) function2.invoke(obj2, Long.valueOf(j10)));
                            i13++;
                            i10 = 8;
                        } else {
                            i10 = i15;
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i13 < i12) {
                    if ((j8 & 255) < 128) {
                        ...
                        sbX.append(transform.invoke(obj, Long.valueOf(j10)));
                        i10++;
                        i8 = 8;
                    } else {
                        i8 = i11;
    ...
    @JvmOverloads
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence charSequence, int i8, Function2<? super K, ? super Long, ? extends CharSequence> function2) {
        long[] jArr;
        Intrinsics.checkNotNullParameter(separator, "separator");
        Intrinsics.checkNotNullParameter(prefix, "prefix");
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i13 < i12) {
                    if ((j8 & 255) < 128) {
                        ...
                        sbX.append(function2.invoke(obj, Long.valueOf(j10)));
                        i10++;
                    }
                    j8 >>= 8;
                    i13++;
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) == -9187201950435737472L) {
                ...
                while (i13 < i12) {
                    if ((j8 & 255) < 128) {
                        ...
                        sb2.append(transform.invoke(obj, Long.valueOf(j10)));
                        i10++;
                        i8 = 8;
                    } else {
                        i8 = i11;
