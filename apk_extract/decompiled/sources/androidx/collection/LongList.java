...
public abstract class LongList {
    ...
    public /* synthetic */ LongList(int i8, DefaultConstructorMarker defaultConstructorMarker) {
        this(i8);
    }
    ...
    public final <R> R fold(R initial, Function2<? super R, ? super Long, ? extends R> operation) {
        ...
        int i8 = this._size;
        for (int i9 = 0; i9 < i8; i9++) {
            initial = operation.invoke(initial, Long.valueOf(jArr[i9]));
        }
        return initial;
    }
    ...
    public final <R> R foldIndexed(R initial, Function3<? super Integer, ? super R, ? super Long, ? extends R> operation) {
        ...
        for (int i9 = 0; i9 < i8; i9++) {
            R r7 = initial;
            initial = operation.invoke(Integer.valueOf(i9), r7, Long.valueOf(jArr[i9]));
        }
        return initial;
    }
    ...
    public final <R> R foldRight(R initial, Function2<? super Long, ? super R, ? extends R> operation) {
        ...
        while (true) {
            ...
            initial = operation.invoke(Long.valueOf(jArr[i8]), initial);
        }
    }
    ...
    public final <R> R foldRightIndexed(R initial, Function3<? super Integer, ? super Long, ? super R, ? extends R> operation) {
        ...
        while (true) {
            ...
            initial = operation.invoke(Integer.valueOf(i8), Long.valueOf(jArr[i8]), initial);
        }
    }
    ...
    public int hashCode() {
        ...
        int iHashCode = 0;
        for (int i9 = 0; i9 < i8; i9++) {
            iHashCode += Long.hashCode(jArr[i9]) * 31;
        }
        return iHashCode;
    }
    ...
    public static /* synthetic */ String joinToString$default(LongList longList, CharSequence separator, CharSequence prefix, CharSequence postfix, int i8, CharSequence charSequence, Function1 function1, int i9, Object obj) {
        if (obj == null) {
            if ((i9 & 1) != 0) {
                separator = ", ";
            }
            ...
            for (int i11 = 0; i11 < i10; i11++) {
                ...
                sbW.append((CharSequence) function1.invoke(Long.valueOf(j8)));
            }
            sbW.append(postfix);
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, CharSequence truncated, Function1<? super Long, ? extends CharSequence> transform) {
        ...
        for (int i9 = 0; i9 < i8; i9++) {
            ...
            sbW.append(transform.invoke(Long.valueOf(j8)));
        }
        sbW.append(postfix);
        String string2 = sbW.toString();
        Intrinsics.checkNotNullExpressionValue(string2, "StringBuilder().apply(builderAction).toString()");
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence charSequence, int i8, Function1<? super Long, ? extends CharSequence> function1) {
        ...
        for (int i10 = 0; i10 < i9; i10++) {
            ...
            sbW.append(function1.invoke(Long.valueOf(j8)));
        }
        sbW.append(charSequence);
        String string2 = sbW.toString();
        Intrinsics.checkNotNullExpressionValue(string2, "StringBuilder().apply(builderAction).toString()");
    ...
    public final String joinToString(CharSequence separator, Function1<? super Long, ? extends CharSequence> transform) {
        ...
        for (int i9 = 0; i9 < i8; i9++) {
            ...
            sb2.append(transform.invoke(Long.valueOf(j8)));
        }
        sb2.append((CharSequence) "");
