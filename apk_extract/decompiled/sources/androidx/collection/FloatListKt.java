...
public final class FloatListKt {
    ...
    public static final FloatList floatListOf(float f, float f4) {
        return mutableFloatListOf(f, f4);
    }

    public static final FloatList floatListOf(float f, float f4, float f10) {
        return mutableFloatListOf(f, f4, f10);
    }

    public static final MutableFloatList mutableFloatListOf(float f, float f4) {
    ...
    public static final MutableFloatList mutableFloatListOf(float f, float f4, float f10) {
