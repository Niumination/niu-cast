...
public final class SparseArrayKt {
    ...
    public static final class C00201<T> implements Iterator<T>, KMappedMarker {
        final /* synthetic */ SparseArrayCompat<T> $this_valueIterator;
        private int index;

        public C00201(SparseArrayCompat<T> sparseArrayCompat) {
    ...
    public static final <T> T getOrDefault(SparseArrayCompat<T> sparseArrayCompat, int i8, T t3) {
        Intrinsics.checkNotNullParameter(sparseArrayCompat, "<this>");
        return sparseArrayCompat.get(i8, t3);
    }

    public static final <T> T getOrElse(SparseArrayCompat<T> sparseArrayCompat, int i8, Function0<? extends T> defaultValue) {
        Intrinsics.checkNotNullParameter(sparseArrayCompat, "<this>");
        Intrinsics.checkNotNullParameter(defaultValue, "defaultValue");
        T t3 = sparseArrayCompat.get(i8);
    ...
    public static final <T> void set(SparseArrayCompat<T> sparseArrayCompat, int i8, T t3) {
        Intrinsics.checkNotNullParameter(sparseArrayCompat, "<this>");
        sparseArrayCompat.put(i8, t3);
    }

    public static final <T> Iterator<T> valueIterator(SparseArrayCompat<T> sparseArrayCompat) {
        Intrinsics.checkNotNullParameter(sparseArrayCompat, "<this>");
        return new C00201(sparseArrayCompat);
    }
}
