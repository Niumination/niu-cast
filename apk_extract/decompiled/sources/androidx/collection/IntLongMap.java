...
public abstract class IntLongMap {
        ...
        while (true) {
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i10 = 0; i10 < i9; i10++) {
                    if ((255 & j8) < 128) {
                        int i11 = (i8 << 3) + i10;
                        if (!predicate.invoke(Integer.valueOf(iArr[i11]), Long.valueOf(jArr[i11])).booleanValue()) {
                            return false;
                        }
                    }
                    j8 >>= 8;
        ...
        if (length >= 0) {
            ...
            while (true) {
                ...
                if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                    int i9 = 8 - ((~(i8 - length)) >>> 31);
                    for (int i10 = 0; i10 < i9; i10++) {
                        if ((255 & j8) < 128 && value == jArr[(i8 << 3) + i10]) {
                            return true;
                        }
                        j8 >>= 8;
                    }
    ...
    public final long get(int key) {
        ...
        throw new NoSuchElementException(a.o(key, "Cannot find value for key "));
    }
            ...
            while (true) {
                ...
                if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i11 = 0; i11 < i10; i11++) {
                        if ((255 & j8) < 128) {
                            int i12 = (i9 << 3) + i11;
                            iHashCode += Integer.hashCode(iArr[i12]) ^ Long.hashCode(jArr[i12]);
                        }
                        j8 >>= 8;
                    }
                    if (i10 != 8) {
            ...
            while (true) {
                ...
                if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i12 = 0; i12 < i11; i12++) {
                        if ((255 & j8) < 128) {
                            int i13 = (i9 << 3) + i12;
                            if (predicate.invoke(Integer.valueOf(iArr[i13]), Long.valueOf(jArr[i13])).booleanValue()) {
                                i10++;
                            }
                        }
                        j8 >>= 8;
    ...
    public static /* synthetic */ String joinToString$default(IntLongMap intLongMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i8, CharSequence charSequence4, Function2 function2, int i9, Object obj) {
        long[] jArr;
        int i10;
        if (obj == null) {
                ...
                if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i17 < i16) {
                        if ((j8 & 255) < 128) {
                            ...
                            sbX.append((CharSequence) function2.invoke(Integer.valueOf(i19), Long.valueOf(j10)));
                            i13++;
                            i10 = 8;
                        } else {
                            i10 = i15;
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i12 < i11) {
                    if ((j8 & 255) < 128) {
                        ...
                        sbX.append(transform.invoke(Integer.valueOf(i14), Long.valueOf(j10)));
                        i9++;
                    }
                    j8 >>= 8;
                    i12++;
    ...
    @JvmOverloads
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence charSequence, int i8, Function2<? super Integer, ? super Long, ? extends CharSequence> function2) {
        long[] jArr;
        int i9;
        Intrinsics.checkNotNullParameter(separator, "separator");
        Intrinsics.checkNotNullParameter(prefix, "prefix");
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i14 < i13) {
                    if ((j8 & 255) < 128) {
                        ...
                        sbX.append(function2.invoke(Integer.valueOf(i16), Long.valueOf(j10)));
                        i11++;
                        i9 = 8;
                    } else {
                        i9 = i12;
    ...
    @JvmOverloads
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence charSequence, Function2<? super Integer, ? super Long, ? extends CharSequence> function2) {
        int i8;
        Intrinsics.checkNotNullParameter(separator, "separator");
        Intrinsics.checkNotNullParameter(prefix, "prefix");
        StringBuilder sbX = a.x(charSequence, "postfix", function2, "transform", prefix);
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) == -9187201950435737472L) {
                ...
                while (i13 < i12) {
                    if ((j8 & 255) < 128) {
                        ...
                        sbX.append(function2.invoke(Integer.valueOf(i15), Long.valueOf(j10)));
                        i10++;
                        i8 = 8;
                    } else {
                        i8 = i11;
    ...
    @JvmOverloads
    public final String joinToString(CharSequence separator, CharSequence charSequence, Function2<? super Integer, ? super Long, ? extends CharSequence> function2) {
        Intrinsics.checkNotNullParameter(separator, "separator");
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i11 = 0; i11 < i10; i11++) {
                    if ((255 & j8) < 128) {
                        ...
                        sbX.append(function2.invoke(Integer.valueOf(i13), Long.valueOf(j10)));
                        i9++;
                    }
                    j8 >>= 8;
                }
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) == -9187201950435737472L) {
                ...
                while (i13 < i12) {
                    if ((j8 & 255) < 128) {
                        ...
                        sb2.append(transform.invoke(Integer.valueOf(i15), Long.valueOf(j10)));
                        i10++;
                        i8 = 8;
                    } else {
                        i8 = i11;
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i11 = 0; i11 < i10; i11++) {
                    if ((255 & j8) < 128) {
                        ...
                        sb2.append(transform.invoke(Integer.valueOf(i13), Long.valueOf(j10)));
                        i9++;
                    }
                    j8 >>= 8;
                }
