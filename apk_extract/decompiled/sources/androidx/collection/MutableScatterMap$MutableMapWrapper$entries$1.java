...
public final class MutableScatterMap$MutableMapWrapper$entries$1<K, V> implements Set<Map.Entry<K, V>>, KMutableSet {
                ...
                if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i10 = 0; i10 < i9; i10++) {
                        if ((255 & j8) < 128) {
                            ...
                            while (it.hasNext()) {
                                Map.Entry entry = (Map.Entry) it.next();
                                if (Intrinsics.areEqual(entry.getKey(), mutableScatterMap.keys[i11]) && Intrinsics.areEqual(entry.getValue(), mutableScatterMap.values[i11])) {
    ...
    public boolean remove(Map.Entry<K, V> element) {
        ...
        int i9 = i8 & 127;
        int i10 = mutableScatterMap._capacity;
        int i11 = (i8 >>> 7) & i10;
        int i12 = 0;
        loop0: while (true) {
            long[] jArr = mutableScatterMap.metadata;
