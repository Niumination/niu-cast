...
public abstract class IntObjectMap<V> {
    ...
    public static /* synthetic */ String joinToString$default(IntObjectMap intObjectMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i8, CharSequence charSequence4, int i9, Object obj) {
        if (obj != null) {
        ...
        return intObjectMap.joinToString(charSequence, charSequence5, charSequence6, i10, charSequence4);
    }
        ...
        while (true) {
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i10 = 0; i10 < i9; i10++) {
                    if ((255 & j8) < 128) {
                        int i11 = (i8 << 3) + i10;
                        if (!predicate.invoke(Integer.valueOf(iArr[i11]), objArr[i11]).booleanValue()) {
                            return false;
                        }
                    }
                    j8 >>= 8;
                ...
                if ((((~j8) << 7) & j8 & (-9187201950435737472L)) == -9187201950435737472L) {
                    ...
                    for (int i10 = 0; i10 < i9; i10++) {
                        if ((255 & j8) < 128) {
                            ...
                            if (obj == null) {
                                if (intObjectMap.get(i12) != null || !intObjectMap.containsKey(i12)) {
                                    return false;
                                }
                            } else if (!Intrinsics.areEqual(obj, intObjectMap.get(i12))) {
                                return false;
                            }
                        }
                        j8 >>= 8;
        ...
        while (true) {
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i10 = 0; i10 < i9; i10++) {
                    if ((255 & j8) < 128) {
                        int i11 = (i8 << 3) + i10;
                        block.invoke(Integer.valueOf(iArr[i11]), objArr[i11]);
                    }
                    j8 >>= 8;
                }
                if (i9 != 8) {
    ...
    public static /* synthetic */ String joinToString$default(IntObjectMap intObjectMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i8, CharSequence charSequence4, Function2 function2, int i9, Object obj) {
        long[] jArr;
        int i10;
        if (obj == null) {
                ...
                if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i17 < i16) {
                        if ((j8 & 255) < 128) {
                            ...
                            sbX.append((CharSequence) function2.invoke(Integer.valueOf(i19), obj2));
                            i13++;
                            i10 = 8;
                        } else {
                            i10 = i15;
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i13 < i12) {
                    if ((j8 & 255) < 128) {
                        ...
                        sbX.append(transform.invoke(Integer.valueOf(i15), obj));
                        i10++;
                        i8 = 8;
                    } else {
                        i8 = i11;
    ...
    @JvmOverloads
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence charSequence, int i8, Function2<? super Integer, ? super V, ? extends CharSequence> function2) {
        long[] jArr;
        Intrinsics.checkNotNullParameter(separator, "separator");
        Intrinsics.checkNotNullParameter(prefix, "prefix");
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i13 < i12) {
                    if ((j8 & 255) < 128) {
                        ...
                        sbX.append(function2.invoke(Integer.valueOf(i15), obj));
                        i10++;
                    }
                    j8 >>= 8;
                    i13++;
    ...
    @JvmOverloads
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence charSequence, Function2<? super Integer, ? super V, ? extends CharSequence> function2) {
        int i8;
        Intrinsics.checkNotNullParameter(separator, "separator");
        Intrinsics.checkNotNullParameter(prefix, "prefix");
        StringBuilder sbX = a.x(charSequence, "postfix", function2, "transform", prefix);
    ...
    /* JADX WARN: Code duplicated, block: B:19:0x0072 A[DONT_INVERT, PHI: r9
      0x0072: PHI (r9v2 int) = (r9v1 int), (r9v3 int) binds: [B:6:0x0031, B:18:0x0070] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Code duplicated, block: B:20:0x0074 A[LOOP:0: B:5:0x0023->B:20:0x0074, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:26:0x0077 A[SYNTHETIC] */
    @JvmOverloads
    public final String joinToString(CharSequence separator, CharSequence charSequence, Function2<? super Integer, ? super V, ? extends CharSequence> function2) {
        Intrinsics.checkNotNullParameter(separator, "separator");
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i11 = 0; i11 < i10; i11++) {
                    if ((255 & j8) < 128) {
                        ...
                        sbX.append(function2.invoke(Integer.valueOf(i13), obj));
                        i9++;
                    }
                    j8 >>= 8;
                }
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) == -9187201950435737472L) {
                ...
                while (i13 < i12) {
                    if ((j8 & 255) < 128) {
                        ...
                        sb2.append(transform.invoke(Integer.valueOf(i15), obj));
                        i10++;
                        i8 = 8;
                    } else {
                        i8 = i11;
    ...
    /* JADX WARN: Code duplicated, block: B:19:0x006f A[DONT_INVERT, PHI: r9
      0x006f: PHI (r9v2 int) = (r9v1 int), (r9v3 int) binds: [B:6:0x002c, B:18:0x006d] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Code duplicated, block: B:20:0x0071 A[LOOP:0: B:5:0x001e->B:20:0x0071, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:26:0x0074 A[SYNTHETIC] */
    @JvmOverloads
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i11 = 0; i11 < i10; i11++) {
                    if ((255 & j8) < 128) {
                        ...
                        sb2.append(transform.invoke(Integer.valueOf(i13), obj));
                        i9++;
                    }
                    j8 >>= 8;
                }
