...
public final class MutableLongIntMap extends LongIntMap {
    ...
    private final void resizeStorage(int newCapacity) {
        ...
        while (i9 < i8) {
            if (((jArr[i9 >> 3] >> ((i9 & 7) << 3)) & 255) < 128) {
                ...
                jArr4[i11] = (jArr4[i11] & (~(255 << i12))) | (j10 << i12);
                int i13 = this._capacity;
                int i14 = ((iFindFirstAvailableSlot - 7) & i13) + (i13 & 7);
                int i15 = i14 >> 3;
                int i16 = (i14 & 7) << 3;
                jArr4[i15] = (jArr4[i15] & (~(255 << i16))) | (j10 << i16);
                jArr3[iFindFirstAvailableSlot] = j8;
                iArr2[iFindFirstAvailableSlot] = iArr[i9];
            }
            i9++;
            jArr = jArr;
            jArr2 = jArr2;
        ...
        while (true) {
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i10 = 0; i10 < i9; i10++) {
                    if ((255 & j8) < 128) {
                        int i11 = (i8 << 3) + i10;
                        if (predicate.invoke(Long.valueOf(this.keys[i11]), Integer.valueOf(this.values[i11])).booleanValue()) {
                            removeValueAt(i11);
                        }
                    }
                    j8 >>= 8;
    ...
    public /* synthetic */ MutableLongIntMap(int i8, int i9, DefaultConstructorMarker defaultConstructorMarker) {
        this((i9 & 1) != 0 ? 6 : i8);
    }
    ...
    public final int put(long key, int value, int i8) {
        int iFindInsertIndex = findInsertIndex(key);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        } else {
