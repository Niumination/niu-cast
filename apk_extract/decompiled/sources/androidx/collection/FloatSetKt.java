...
public final class FloatSetKt {
    ...
    public static final FloatSet floatSetOf(float f, float f4) {
        return mutableFloatSetOf(f, f4);
    }

    public static final FloatSet floatSetOf(float f, float f4, float f10) {
        return mutableFloatSetOf(f, f4, f10);
    }

    public static final MutableFloatSet mutableFloatSetOf(float f, float f4) {
    ...
    public static final MutableFloatSet mutableFloatSetOf(float f, float f4, float f10) {
