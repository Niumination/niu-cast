...
public final class ObjectFloatMapKt {
    ...
    public static final <K> ObjectFloatMap<K> objectFloatMapOf(K k8, float f, K k10, float f4) {
        MutableObjectFloatMap mutableObjectFloatMap = new MutableObjectFloatMap(0, 1, null);
        mutableObjectFloatMap.set(k8, f);
        mutableObjectFloatMap.set(k10, f4);
        return mutableObjectFloatMap;
    }

    public static final <K> MutableObjectFloatMap<K> mutableObjectFloatMapOf(K k8, float f, K k10, float f4) {
        MutableObjectFloatMap<K> mutableObjectFloatMap = new MutableObjectFloatMap<>(0, 1, null);
        mutableObjectFloatMap.set(k8, f);
        mutableObjectFloatMap.set(k10, f4);
        return mutableObjectFloatMap;
    ...
    public static final <K> ObjectFloatMap<K> objectFloatMapOf(K k8, float f, K k10, float f4, K k11, float f10) {
        MutableObjectFloatMap mutableObjectFloatMap = new MutableObjectFloatMap(0, 1, null);
        mutableObjectFloatMap.set(k8, f);
        mutableObjectFloatMap.set(k10, f4);
    ...
    public static final <K> MutableObjectFloatMap<K> mutableObjectFloatMapOf(K k8, float f, K k10, float f4, K k11, float f10) {
        MutableObjectFloatMap<K> mutableObjectFloatMap = new MutableObjectFloatMap<>(0, 1, null);
        mutableObjectFloatMap.set(k8, f);
        mutableObjectFloatMap.set(k10, f4);
        mutableObjectFloatMap.set(k11, f10);
    ...
    public static final <K> ObjectFloatMap<K> objectFloatMapOf(K k8, float f, K k10, float f4, K k11, float f10, K k12, float f11) {
        MutableObjectFloatMap mutableObjectFloatMap = new MutableObjectFloatMap(0, 1, null);
        mutableObjectFloatMap.set(k8, f);
        mutableObjectFloatMap.set(k10, f4);
        mutableObjectFloatMap.set(k11, f10);
    ...
    public static final <K> MutableObjectFloatMap<K> mutableObjectFloatMapOf(K k8, float f, K k10, float f4, K k11, float f10, K k12, float f11) {
        MutableObjectFloatMap<K> mutableObjectFloatMap = new MutableObjectFloatMap<>(0, 1, null);
        mutableObjectFloatMap.set(k8, f);
        mutableObjectFloatMap.set(k10, f4);
        mutableObjectFloatMap.set(k11, f10);
    ...
    public static final <K> ObjectFloatMap<K> objectFloatMapOf(K k8, float f, K k10, float f4, K k11, float f10, K k12, float f11, K k13, float f12) {
        MutableObjectFloatMap mutableObjectFloatMap = new MutableObjectFloatMap(0, 1, null);
        mutableObjectFloatMap.set(k8, f);
        mutableObjectFloatMap.set(k10, f4);
        mutableObjectFloatMap.set(k11, f10);
    ...
    public static final <K> MutableObjectFloatMap<K> mutableObjectFloatMapOf(K k8, float f, K k10, float f4, K k11, float f10, K k12, float f11, K k13, float f12) {
        MutableObjectFloatMap<K> mutableObjectFloatMap = new MutableObjectFloatMap<>(0, 1, null);
        mutableObjectFloatMap.set(k8, f);
        mutableObjectFloatMap.set(k10, f4);
        mutableObjectFloatMap.set(k11, f10);
