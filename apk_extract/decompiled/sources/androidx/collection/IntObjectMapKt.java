...
public final class IntObjectMapKt {
    ...
    public static final <V> IntObjectMap<V> intObjectMapOf(int i8, V v3) {
        MutableIntObjectMap mutableIntObjectMap = new MutableIntObjectMap(0, 1, null);
        mutableIntObjectMap.set(i8, v3);
        return mutableIntObjectMap;
    }

    public static final <V> MutableIntObjectMap<V> mutableIntObjectMapOf(int i8, V v3) {
        MutableIntObjectMap<V> mutableIntObjectMap = new MutableIntObjectMap<>(0, 1, null);
        mutableIntObjectMap.set(i8, v3);
        return mutableIntObjectMap;
    }

    public static final <V> IntObjectMap<V> intObjectMapOf(int i8, V v3, int i9, V v8) {
        MutableIntObjectMap mutableIntObjectMap = new MutableIntObjectMap(0, 1, null);
        mutableIntObjectMap.set(i8, v3);
    ...
    public static final <V> MutableIntObjectMap<V> mutableIntObjectMapOf(int i8, V v3, int i9, V v8) {
        MutableIntObjectMap<V> mutableIntObjectMap = new MutableIntObjectMap<>(0, 1, null);
        mutableIntObjectMap.set(i8, v3);
        mutableIntObjectMap.set(i9, v8);
        return mutableIntObjectMap;
    ...
    public static final <V> IntObjectMap<V> intObjectMapOf(int i8, V v3, int i9, V v8, int i10, V v10) {
        MutableIntObjectMap mutableIntObjectMap = new MutableIntObjectMap(0, 1, null);
        mutableIntObjectMap.set(i8, v3);
        mutableIntObjectMap.set(i9, v8);
    ...
    public static final <V> MutableIntObjectMap<V> mutableIntObjectMapOf(int i8, V v3, int i9, V v8, int i10, V v10) {
        MutableIntObjectMap<V> mutableIntObjectMap = new MutableIntObjectMap<>(0, 1, null);
        mutableIntObjectMap.set(i8, v3);
        mutableIntObjectMap.set(i9, v8);
        mutableIntObjectMap.set(i10, v10);
    ...
    public static final <V> IntObjectMap<V> intObjectMapOf(int i8, V v3, int i9, V v8, int i10, V v10, int i11, V v11) {
        MutableIntObjectMap mutableIntObjectMap = new MutableIntObjectMap(0, 1, null);
        mutableIntObjectMap.set(i8, v3);
        mutableIntObjectMap.set(i9, v8);
        mutableIntObjectMap.set(i10, v10);
    ...
    public static final <V> MutableIntObjectMap<V> mutableIntObjectMapOf(int i8, V v3, int i9, V v8, int i10, V v10, int i11, V v11) {
        MutableIntObjectMap<V> mutableIntObjectMap = new MutableIntObjectMap<>(0, 1, null);
        mutableIntObjectMap.set(i8, v3);
        mutableIntObjectMap.set(i9, v8);
        mutableIntObjectMap.set(i10, v10);
    ...
    public static final <V> IntObjectMap<V> intObjectMapOf(int i8, V v3, int i9, V v8, int i10, V v10, int i11, V v11, int i12, V v12) {
        MutableIntObjectMap mutableIntObjectMap = new MutableIntObjectMap(0, 1, null);
        mutableIntObjectMap.set(i8, v3);
        mutableIntObjectMap.set(i9, v8);
        mutableIntObjectMap.set(i10, v10);
    ...
    public static final <V> MutableIntObjectMap<V> mutableIntObjectMapOf(int i8, V v3, int i9, V v8, int i10, V v10, int i11, V v11, int i12, V v12) {
        MutableIntObjectMap<V> mutableIntObjectMap = new MutableIntObjectMap<>(0, 1, null);
        mutableIntObjectMap.set(i8, v3);
        mutableIntObjectMap.set(i9, v8);
        mutableIntObjectMap.set(i10, v10);
