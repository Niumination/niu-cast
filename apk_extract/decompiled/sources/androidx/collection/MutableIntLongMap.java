...
public final class MutableIntLongMap extends IntLongMap {
    ...
    private final void resizeStorage(int newCapacity) {
        ...
        while (i9 < i8) {
            if (((jArr[i9 >> 3] >> ((i9 & 7) << 3)) & 255) < 128) {
                int i10 = iArr[i9];
                int iHashCode = Integer.hashCode(i10) * ScatterMapKt.MurmurHashC1;
                ...
                jArr4[i12] = (jArr4[i12] & (~(255 << i13))) | (j8 << i13);
                int i14 = this._capacity;
                int i15 = ((iFindFirstAvailableSlot - 7) & i14) + (i14 & 7);
                int i16 = i15 >> 3;
                int i17 = (i15 & 7) << 3;
                jArr4[i16] = ((~(255 << i17)) & jArr4[i16]) | (j8 << i17);
                iArr2[iFindFirstAvailableSlot] = i10;
                jArr3[iFindFirstAvailableSlot] = jArr2[i9];
            }
            i9++;
            jArr = jArr;
            iArr = iArr;
        ...
        while (true) {
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i10 = 0; i10 < i9; i10++) {
                    if ((255 & j8) < 128) {
                        int i11 = (i8 << 3) + i10;
                        if (predicate.invoke(Integer.valueOf(this.keys[i11]), Long.valueOf(this.values[i11])).booleanValue()) {
                            removeValueAt(i11);
                        }
                    }
                    j8 >>= 8;
    ...
    public /* synthetic */ MutableIntLongMap(int i8, int i9, DefaultConstructorMarker defaultConstructorMarker) {
        this((i9 & 1) != 0 ? 6 : i8);
    }
    ...
    public final long put(int key, long value, long j8) {
        int iFindInsertIndex = findInsertIndex(key);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        } else {
            j8 = this.values[iFindInsertIndex];
        }
        this.keys[iFindInsertIndex] = key;
        this.values[iFindInsertIndex] = value;
        return j8;
