...
public final class MutableIntObjectMap<V> extends IntObjectMap<V> {
        ...
        while (true) {
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i10 = 0; i10 < i9; i10++) {
                    if ((255 & j8) < 128) {
                        int i11 = (i8 << 3) + i10;
                        if (predicate.invoke(Integer.valueOf(this.keys[i11]), this.values[i11]).booleanValue()) {
                            removeValueAt(i11);
                        }
                    }
                    j8 >>= 8;
    ...
    public /* synthetic */ MutableIntObjectMap(int i8, int i9, DefaultConstructorMarker defaultConstructorMarker) {
        this((i9 & 1) != 0 ? 6 : i8);
    }
