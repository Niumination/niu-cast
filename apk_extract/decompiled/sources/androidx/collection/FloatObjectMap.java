...
public abstract class FloatObjectMap<V> {
    ...
    public static /* synthetic */ String joinToString$default(FloatObjectMap floatObjectMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i8, CharSequence charSequence4, int i9, Object obj) {
        if (obj != null) {
        ...
        return floatObjectMap.joinToString(charSequence, charSequence5, charSequence6, i10, charSequence4);
    }
        ...
        while (true) {
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i10 = 0; i10 < i9; i10++) {
                    if ((255 & j8) < 128) {
                        int i11 = (i8 << 3) + i10;
                        if (!predicate.invoke(Float.valueOf(fArr[i11]), objArr[i11]).booleanValue()) {
                            return false;
                        }
                    }
                    j8 >>= 8;
        ...
        while (true) {
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i10 = 0; i10 < i9; i10++) {
                    if ((255 & j8) < 128) {
                        int i11 = (i8 << 3) + i10;
                        block.invoke(Float.valueOf(fArr[i11]), objArr[i11]);
                    }
                    j8 >>= 8;
                }
                if (i9 != 8) {
    ...
    public static /* synthetic */ String joinToString$default(FloatObjectMap floatObjectMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i8, CharSequence charSequence4, Function2 function2, int i9, Object obj) {
        long[] jArr;
        int i10;
        if (obj == null) {
                ...
                if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i17 < i16) {
                        if ((j8 & 255) < 128) {
                            ...
                            sbX.append((CharSequence) function2.invoke(Float.valueOf(f), obj2));
                            i13++;
                            i10 = 8;
                        } else {
                            i10 = i15;
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i13 < i12) {
                    if ((j8 & 255) < 128) {
                        ...
                        sbX.append(transform.invoke(Float.valueOf(f), obj));
                        i10++;
                        i8 = 8;
                    } else {
                        i8 = i11;
    ...
    @JvmOverloads
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence charSequence, int i8, Function2<? super Float, ? super V, ? extends CharSequence> function2) {
        long[] jArr;
        Intrinsics.checkNotNullParameter(separator, "separator");
        Intrinsics.checkNotNullParameter(prefix, "prefix");
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i13 < i12) {
                    if ((j8 & 255) < 128) {
                        ...
                        sbX.append(function2.invoke(Float.valueOf(f), obj));
                        i10++;
                    }
                    j8 >>= 8;
                    i13++;
    ...
    @JvmOverloads
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence charSequence, Function2<? super Float, ? super V, ? extends CharSequence> function2) {
        int i8;
        Intrinsics.checkNotNullParameter(separator, "separator");
        Intrinsics.checkNotNullParameter(prefix, "prefix");
        StringBuilder sbX = a.x(charSequence, "postfix", function2, "transform", prefix);
    ...
    @JvmOverloads
    public final String joinToString(CharSequence separator, CharSequence charSequence, Function2<? super Float, ? super V, ? extends CharSequence> function2) {
        Intrinsics.checkNotNullParameter(separator, "separator");
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) == -9187201950435737472L) {
                ...
                while (i13 < i12) {
                    if ((j8 & 255) < 128) {
                        ...
                        sb2.append(transform.invoke(Float.valueOf(f), obj));
                        i10++;
                        i8 = 8;
                    } else {
                        i8 = i11;
