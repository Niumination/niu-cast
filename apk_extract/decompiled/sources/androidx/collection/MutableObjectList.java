...
public final class MutableObjectList<E> extends ObjectList<E> {
    ...
    public static final class SubList<T> implements List<T>, KMutableList {
        ...
        public boolean contains(Object element) {
            ...
            for (int i9 = this.start; i9 < i8; i9++) {
                if (Intrinsics.areEqual(this.list.get(i9), element)) {
                    return true;
                }
            }
            return false;
        ...
        public int lastIndexOf(Object element) {
            ...
            while (!Intrinsics.areEqual(this.list.get(i8), element)) {
                if (i8 == i9) {
                    return -1;
                }
                i8--;
    ...
    public final boolean addAll(@IntRange(from = 0) int index, E[] elements) {
        ...
        int i9 = this._size;
        if (index != i9) {
            ArraysKt___ArraysJvmKt.copyInto(objArr, objArr, elements.length + index, index, i9);
        }
    ...
    public final void clear() {
        ArraysKt___ArraysJvmKt.fill((b2[]) this.content, (b2) null, 0, this._size);
        this._size = 0;
    }
    ...
    public final E removeAt(@IntRange(from = 0) int index) {
        ...
        E e = (E) objArr[index];
        if (index != i8 - 1) {
            ArraysKt___ArraysJvmKt.copyInto(objArr, objArr, index, index + 1, i8);
        }
        int i9 = this._size - 1;
        this._size = i9;
        objArr[i9] = null;
    ...
    public final void removeIf(Function1<? super E, Boolean> predicate) {
        ...
        Object[] objArr = this.content;
        int i9 = 0;
        kotlin.ranges.IntRange intRangeUntil = RangesKt.until(0, i8);
        ...
        ArraysKt___ArraysJvmKt.fill((b2[]) objArr, (b2) null, i8 - i9, i8);
        this._size -= i9;
    }
    ...
    public final void removeRange(@IntRange(from = 0) int start, @IntRange(from = 0) int end) {
        ...
        if (end != start) {
            if (end < i8) {
                Object[] objArr = this.content;
                ArraysKt___ArraysJvmKt.copyInto(objArr, objArr, start, end, i8);
            }
            int i9 = this._size;
            int i10 = i9 - (end - start);
            ArraysKt___ArraysJvmKt.fill((b2[]) this.content, (b2) null, i10, i9);
            this._size = i10;
        }
    }
    ...
    public final boolean retainAll(E[] elements) {
        ...
        for (int i9 = i8 - 1; -1 < i9; i9--) {
            if (ArraysKt.indexOf(elements, objArr[i9]) < 0) {
                removeAt(i9);
            }
        }
        return i8 != this._size;
    ...
    public /* synthetic */ MutableObjectList(int i8, int i9, DefaultConstructorMarker defaultConstructorMarker) {
        this((i9 & 1) != 0 ? 16 : i8);
    }
    ...
    public final void add(@IntRange(from = 0) int index, E element) {
        ...
        if (index >= 0 && index <= (i8 = this._size)) {
            ...
            int i9 = this._size;
            if (index != i9) {
                ArraysKt___ArraysJvmKt.copyInto(objArr, objArr, index + 1, index, i9);
            }
            objArr[index] = element;
            this._size++;
            return;
    ...
    public final boolean retainAll(Iterable<? extends E> elements) {
        ...
        Object[] objArr = this.content;
        for (int i9 = i8 - 1; -1 < i9; i9--) {
            if (!CollectionsKt.contains(elements, objArr[i9])) {
                removeAt(i9);
            }
        }
        return i8 != this._size;
    ...
    public final boolean retainAll(Sequence<? extends E> elements) {
        ...
        Object[] objArr = this.content;
        for (int i9 = i8 - 1; -1 < i9; i9--) {
            if (!SequencesKt.contains(elements, objArr[i9])) {
                removeAt(i9);
            }
        }
        return i8 != this._size;
    ...
    public final boolean addAll(@IntRange(from = 0) int index, ObjectList<E> elements) {
        ...
        if (index >= 0 && index <= this._size) {
            ...
            int i8 = this._size;
            if (index != i8) {
                ArraysKt___ArraysJvmKt.copyInto(objArr, objArr, elements._size + index, index, i8);
            }
