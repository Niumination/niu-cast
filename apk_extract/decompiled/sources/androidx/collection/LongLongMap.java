...
public abstract class LongLongMap {
            ...
            while (true) {
                ...
                if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i10 = 0; i10 < i9; i10++) {
                        if ((255 & j8) < 128) {
                            int i11 = (i8 << 3) + i10;
                            if (jArr2[i11] != longLongMap.get(jArr[i11])) {
                                return false;
                            }
                        }
                        j8 >>= 8;
            ...
            while (true) {
                ...
                if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i11 = 0; i11 < i10; i11++) {
                        if ((255 & j8) < 128) {
                            int i12 = (i9 << 3) + i11;
                            iHashCode += Long.hashCode(jArr[i12]) ^ Long.hashCode(jArr2[i12]);
                        }
                        j8 >>= 8;
                    }
                    if (i10 != 8) {
    ...
    public static /* synthetic */ String joinToString$default(LongLongMap longLongMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i8, CharSequence charSequence4, Function2 function2, int i9, Object obj) {
        long[] jArr;
        int i10;
        if (obj == null) {
                ...
                if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i17 < i16) {
                        if ((j8 & 255) < 128) {
                            ...
                            sbX.append((CharSequence) function2.invoke(Long.valueOf(j10), Long.valueOf(j11)));
                            i13++;
                            i10 = 8;
                        } else {
                            i10 = i15;
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i12 < i11) {
                    if ((j8 & 255) < 128) {
                        ...
                        sbX.append(transform.invoke(Long.valueOf(j10), Long.valueOf(j11)));
                        i9++;
                    }
                    j8 >>= 8;
                    i12++;
    ...
    @JvmOverloads
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence charSequence, int i8, Function2<? super Long, ? super Long, ? extends CharSequence> function2) {
        long[] jArr;
        int i9;
        Intrinsics.checkNotNullParameter(separator, "separator");
        Intrinsics.checkNotNullParameter(prefix, "prefix");
            ...
            if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i14 < i13) {
                    if ((j8 & 255) < 128) {
                        ...
                        sbX.append(function2.invoke(Long.valueOf(j10), Long.valueOf(j11)));
                        i11++;
                        i9 = 8;
                    } else {
                        i9 = i12;
