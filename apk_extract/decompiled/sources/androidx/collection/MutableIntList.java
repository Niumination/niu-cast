...
public final class MutableIntList extends IntList {
    ...
    public final boolean addAll(@IntRange(from = 0) int index, int[] elements) {
        ...
        int i9 = this._size;
        if (index != i9) {
            ArraysKt___ArraysJvmKt.copyInto(iArr, iArr, elements.length + index, index, i9);
        }
        ArraysKt___ArraysJvmKt.copyInto$default(elements, iArr, index, 0, 0, 12, (Object) null);
    ...
    public final int removeAt(@IntRange(from = 0) int index) {
        ...
        int i9 = iArr[index];
        if (index != i8 - 1) {
            ArraysKt___ArraysJvmKt.copyInto(iArr, iArr, index, index + 1, i8);
        }
        this._size--;
        return i9;
    }
    ...
    public final void removeRange(@IntRange(from = 0) int start, @IntRange(from = 0) int end) {
        ...
        if (end != start) {
            if (end < i8) {
                int[] iArr = this.content;
                ArraysKt___ArraysJvmKt.copyInto(iArr, iArr, start, end, i8);
            }
    ...
    public /* synthetic */ MutableIntList(int i8, int i9, DefaultConstructorMarker defaultConstructorMarker) {
        this((i9 & 1) != 0 ? 16 : i8);
    }
    ...
    public final void add(@IntRange(from = 0) int index, int element) {
        ...
        if (index >= 0 && index <= (i8 = this._size)) {
            ...
            int i9 = this._size;
            if (index != i9) {
                ArraysKt___ArraysJvmKt.copyInto(iArr, iArr, index + 1, index, i9);
            }
            iArr[index] = element;
            this._size++;
            return;
    ...
    public final boolean addAll(@IntRange(from = 0) int index, IntList elements) {
        ...
        if (index >= 0 && index <= this._size) {
            ...
            int i8 = this._size;
            if (index != i8) {
                ArraysKt___ArraysJvmKt.copyInto(iArr, iArr, elements._size + index, index, i8);
            }
            ArraysKt___ArraysJvmKt.copyInto(elements.content, iArr, index, 0, elements._size);
