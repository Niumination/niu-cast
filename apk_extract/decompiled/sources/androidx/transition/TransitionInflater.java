...
public class TransitionInflater {
    ...
    private Object createCustom(AttributeSet attributeSet, Class<?> cls, String str) {
        ...
        if (attributeValue == null) {
            throw new InflateException(h0.a.B(str, " tag must have a 'class' attribute"));
        }
        try {
                            ...
                            if (namedString2 != null) {
                                ...
                                if (namedString3 != null) {
                                    try {
                                        ...
                                        throw new RuntimeException(h0.a.i("Could not create ", namedString3), e);
                                    }
                                } else {
    ...
    private void loadTransition(AttributeSet attributeSet, XmlPullParser xmlPullParser, @NonNull ViewGroup viewGroup, TransitionManager transitionManager) throws Resources.NotFoundException {
        ...
        if (namedResourceId >= 0 && (transitionInflateTransition = inflateTransition(namedResourceId)) != null) {
            if (sceneForLayout2 == null) {
                throw new RuntimeException(a1.a.o(namedResourceId, "No toScene for transition ID "));
            }
    ...
    @Nullable
    public Transition inflateTransition(int i8) {
        XmlResourceParser xml = this.mContext.getResources().getXml(i8);
        try {
            try {
    ...
    @Nullable
    public TransitionManager inflateTransitionManager(int i8, @NonNull ViewGroup viewGroup) {
        XmlResourceParser xml = this.mContext.getResources().getXml(i8);
        try {
            try {
