...
public class TransitionSet extends Transition {
    ...
    public Transition excludeTarget(@NonNull View view, boolean z2) {
        for (int i8 = 0; i8 < this.mTransitions.size(); i8++) {
            this.mTransitions.get(i8).excludeTarget(view, z2);
        }
    ...
    public void setCanRemoveViews(boolean z2) {
        ...
        int size = this.mTransitions.size();
        for (int i8 = 0; i8 < size; i8++) {
            this.mTransitions.get(i8).setCanRemoveViews(z2);
        }
    }
    ...
    public void setCurrentPlayTimeMillis(long j8, long j10) {
        ...
        if ((j8 >= 0 && j10 < 0) || (j8 <= totalDurationMillis && j10 > totalDurationMillis)) {
            this.mEnded = false;
            notifyListeners(Transition.TransitionNotification.ON_START, z3);
        }
        if (!this.mPlayTogether) {
            int iIndexOfTransition = indexOfTransition(j10);
            if (j8 >= j10) {
                while (true) {
        ...
        for (int i8 = 0; i8 < this.mTransitions.size(); i8++) {
            this.mTransitions.get(i8).setCurrentPlayTimeMillis(j8, j10);
        }
        z2 = z3;
        if (this.mParent != null) {
            if (j8 > totalDurationMillis) {
    ...
    public TransitionSet setOrdering(int i8) {
        if (i8 == 0) {
            ...
            if (i8 != 1) {
                throw new AndroidRuntimeException(a1.a.o(i8, "Invalid parameter for TransitionSet ordering: "));
            }
    ...
    public String toString(String str) {
        ...
        for (int i8 = 0; i8 < this.mTransitions.size(); i8++) {
            ...
            sbT.append(this.mTransitions.get(i8).toString(str + "  "));
            string = sbT.toString();
        }
        return string;
    }
    ...
    public Transition mo41clone() {
        ...
        int size = this.mTransitions.size();
        for (int i8 = 0; i8 < size; i8++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i8).mo41clone());
        }
    ...
    public Transition excludeTarget(@NonNull String str, boolean z2) {
        for (int i8 = 0; i8 < this.mTransitions.size(); i8++) {
            this.mTransitions.get(i8).excludeTarget(str, z2);
        }
    ...
    @Override // androidx.transition.Transition
    @NonNull
    public Transition excludeTarget(int i8, boolean z2) {
        for (int i9 = 0; i9 < this.mTransitions.size(); i9++) {
            this.mTransitions.get(i9).excludeTarget(i8, z2);
        }
        return super.excludeTarget(i8, z2);
    }
    ...
    public Transition excludeTarget(@NonNull Class<?> cls, boolean z2) {
        for (int i8 = 0; i8 < this.mTransitions.size(); i8++) {
            this.mTransitions.get(i8).excludeTarget(cls, z2);
        }
