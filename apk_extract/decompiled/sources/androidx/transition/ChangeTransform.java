...
public class ChangeTransform extends Transition {
    ...
    public static class Listener extends AnimatorListenerAdapter {
        ...
        public Listener(View view, Transforms transforms, PathAnimatorMatrix pathAnimatorMatrix, Matrix matrix, boolean z2, boolean z3) {
            this.mHandleParentChange = z2;
            this.mUseOverlay = z3;
            this.mView = view;
    ...
    public static class Transforms {
        ...
        public int hashCode() {
            ...
            int iFloatToIntBits3 = (iFloatToIntBits2 + (f10 != 0.0f ? Float.floatToIntBits(f10) : 0)) * 31;
            float f11 = this.mScaleX;
            int iFloatToIntBits4 = (iFloatToIntBits3 + (f11 != 0.0f ? Float.floatToIntBits(f11) : 0)) * 31;
            float f12 = this.mScaleY;
            int iFloatToIntBits5 = (iFloatToIntBits4 + (f12 != 0.0f ? Float.floatToIntBits(f12) : 0)) * 31;
            float f13 = this.mRotationX;
            int iFloatToIntBits6 = (iFloatToIntBits5 + (f13 != 0.0f ? Float.floatToIntBits(f13) : 0)) * 31;
            float f14 = this.mRotationY;
            int iFloatToIntBits7 = (iFloatToIntBits6 + (f14 != 0.0f ? Float.floatToIntBits(f14) : 0)) * 31;
            float f15 = this.mRotationZ;
            return iFloatToIntBits7 + (f15 != 0.0f ? Float.floatToIntBits(f15) : 0);
        }
    ...
    private void createGhostView(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        ?? r7 = this;
        while (true) {
            TransitionSet transitionSet = r7.mParent;
        ...
        r7.addListener(new GhostListener(view, ghostViewAddGhost));
    ...
    private ObjectAnimator createTransformAnimator(TransitionValues transitionValues, TransitionValues transitionValues2, boolean z2) {
        ...
        Listener listener = new Listener(view, transforms, pathAnimatorMatrix, matrix3, z2, this.mUseOverlay);
    ...
    public static void setTransforms(View view, float f, float f4, float f10, float f11, float f12, float f13, float f14, float f15) {
