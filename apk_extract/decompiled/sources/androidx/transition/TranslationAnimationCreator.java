...
class TranslationAnimationCreator {
    ...
    @Nullable
    public static Animator createAnimation(@NonNull View view, @NonNull TransitionValues transitionValues, int i8, int i9, float f, float f4, float f10, float f11, @Nullable TimeInterpolator timeInterpolator, @NonNull Transition transition) {
        float f12;
        float f13;
        ...
        if (iArr != null) {
            f12 = (iArr[0] - i8) + translationX;
            f13 = (iArr[1] - i9) + translationY;
        } else {
            f12 = f;
            f13 = f4;
        }
        ...
        ObjectAnimator objectAnimatorOfPropertyValuesHolder = ObjectAnimator.ofPropertyValuesHolder(view, PropertyValuesHolder.ofFloat((Property<?, Float>) View.TRANSLATION_X, f12, f10), PropertyValuesHolder.ofFloat((Property<?, Float>) View.TRANSLATION_Y, f13, f11));
    ...
    public static class TransitionPositionListener extends AnimatorListenerAdapter implements Transition.TransitionListener {
        ...
        public TransitionPositionListener(View view, View view2, float f, float f4) {
