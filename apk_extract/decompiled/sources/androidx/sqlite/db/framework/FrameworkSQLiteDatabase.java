...
class FrameworkSQLiteDatabase implements SupportSQLiteDatabase {
    ...
    public int delete(String str, String str2, Object[] objArr) {
        ...
        sb2.append(str);
        sb2.append(TextUtils.isEmpty(str2) ? "" : a.i(" WHERE ", str2));
    ...
    public long insert(String str, int i8, ContentValues contentValues) throws SQLException {
        return this.mDelegate.insertWithOnConflict(str, null, contentValues, i8);
    }
    ...
    public boolean needUpgrade(int i8) {
        return this.mDelegate.needUpgrade(i8);
    }
    ...
    public void setMaxSqlCacheSize(int i8) {
        this.mDelegate.setMaxSqlCacheSize(i8);
    }

    @Override // androidx.sqlite.db.SupportSQLiteDatabase
    public long setMaximumSize(long j8) {
        return this.mDelegate.setMaximumSize(j8);
    }

    @Override // androidx.sqlite.db.SupportSQLiteDatabase
    public void setPageSize(long j8) {
        this.mDelegate.setPageSize(j8);
    }
    ...
    public boolean yieldIfContendedSafely(long j8) {
        return this.mDelegate.yieldIfContendedSafely(j8);
    }
