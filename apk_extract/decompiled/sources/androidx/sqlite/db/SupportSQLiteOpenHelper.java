...
public interface SupportSQLiteOpenHelper extends Closeable {
    ...
    public static abstract class Callback {
        ...
        public void onDowngrade(@NonNull SupportSQLiteDatabase supportSQLiteDatabase, int i8, int i9) {
            throw new SQLiteException(d.f(i8, i9, "Can't downgrade database from version ", " to "));
        }

        public void onOpen(@NonNull SupportSQLiteDatabase supportSQLiteDatabase) {
        }

        public abstract void onUpgrade(@NonNull SupportSQLiteDatabase supportSQLiteDatabase, int i8, int i9);
    }
