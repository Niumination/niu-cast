...
public final class SparseArrayKt {
    ...
    @Metadata(d1 = {"\u0000\u001b\n\u0000\n\u0002\u0010(\n\u0000\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\b\u0004*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00028\u00000\u0001J\t\u0010\b\u001a\u00020\tH\u0096\u0002J\u0016\u0010\n\u001a\n \u000b*\u0004\u0018\u00018\u00008\u0000H\u0096\u0002¢\u0006\u0002\u0010\fR\u001a\u0010\u0002\u001a\u00020\u0003X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0004\u0010\u0005\"\u0004\b\u0006\u0010\u0007¨\u0006\r"}, d2 = {"androidx/core/util/SparseArrayKt$valueIterator$1", "", "index", "", "getIndex", "()I", "setIndex", "(I)V", "hasNext", "", "next", "kotlin.jvm.PlatformType", "()Ljava/lang/Object;", "core-ktx_release"}, k = 1, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    public static final class C00251<T> implements Iterator<T>, KMappedMarker {
        final /* synthetic */ SparseArray<T> $this_valueIterator;
        private int index;

        public C00251(SparseArray<T> sparseArray) {
    ...
    public static final <T> T getOrDefault(SparseArray<T> sparseArray, int i8, T t3) {
        T t8 = sparseArray.get(i8);
        return t8 == null ? t3 : t8;
    }

    public static final <T> T getOrElse(SparseArray<T> sparseArray, int i8, Function0<? extends T> function0) {
        T t3 = sparseArray.get(i8);
    ...
    public static final <T> boolean remove(SparseArray<T> sparseArray, int i8, T t3) {
        int iIndexOfKey = sparseArray.indexOfKey(i8);
        if (iIndexOfKey < 0 || !Intrinsics.areEqual(t3, sparseArray.valueAt(iIndexOfKey))) {
            return false;
        }
    ...
    public static final <T> void set(SparseArray<T> sparseArray, int i8, T t3) {
        sparseArray.put(i8, t3);
    }

    public static final <T> Iterator<T> valueIterator(SparseArray<T> sparseArray) {
        return new C00251(sparseArray);
    }
}
