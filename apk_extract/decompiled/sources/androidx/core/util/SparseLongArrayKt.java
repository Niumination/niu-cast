...
public final class SparseLongArrayKt {
    ...
    public static final long getOrElse(SparseLongArray sparseLongArray, int i8, Function0<Long> function0) {
        int iIndexOfKey = sparseLongArray.indexOfKey(i8);
    ...
    public static final boolean remove(SparseLongArray sparseLongArray, int i8, long j8) {
        int iIndexOfKey = sparseLongArray.indexOfKey(i8);
        if (iIndexOfKey < 0 || j8 != sparseLongArray.valueAt(iIndexOfKey)) {
            return false;
        }
