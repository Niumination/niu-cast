...
class DatagramSocketWrapper extends Socket {
    ...
    public static class DatagramSocketImplWrapper extends SocketImpl {
        ...
        @Override // java.net.SocketImpl
        public void bind(InetAddress inetAddress, int i8) throws IOException {
            throw new UnsupportedOperationException();
        }
        ...
        @Override // java.net.SocketImpl
        public void connect(String str, int i8) throws IOException {
            throw new UnsupportedOperationException();
        }
        ...
        @Override // java.net.SocketImpl
        public void sendUrgentData(int i8) throws IOException {
            throw new UnsupportedOperationException();
        }
        ...
        @Override // java.net.SocketImpl
        public void connect(InetAddress inetAddress, int i8) throws IOException {
            throw new UnsupportedOperationException();
        }

        @Override // java.net.SocketImpl
        public void connect(SocketAddress socketAddress, int i8) throws IOException {
            throw new UnsupportedOperationException();
        }
    }
