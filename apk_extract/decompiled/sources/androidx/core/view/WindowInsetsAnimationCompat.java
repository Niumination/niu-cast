...
public final class WindowInsetsAnimationCompat {
    ...
    public static class Impl21 extends Impl {
        ...
        public Impl21(int i8, @Nullable Interpolator interpolator, long j8) {
        ...
        @NonNull
        public static BoundsCompat computeAnimationBounds(@NonNull WindowInsetsCompat windowInsetsCompat, @NonNull WindowInsetsCompat windowInsetsCompat2, int i8) {
        ...
        public static Interpolator createInsetInterpolator(int i8, WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2) {
            if ((i8 & 8) != 0) {
                return windowInsetsCompat.getInsets(WindowInsetsCompat.Type.ime()).bottom > windowInsetsCompat2.getInsets(WindowInsetsCompat.Type.ime()).bottom ? SHOW_IME_INTERPOLATOR : HIDE_IME_INTERPOLATOR;
            }
        ...
        public static void dispatchOnPrepare(View view, WindowInsetsAnimationCompat windowInsetsAnimationCompat, WindowInsets windowInsets, boolean z2) {
            ...
            if (view instanceof ViewGroup) {
                ViewGroup viewGroup = (ViewGroup) view;
                for (int i8 = 0; i8 < viewGroup.getChildCount(); i8++) {
                    dispatchOnPrepare(viewGroup.getChildAt(i8), windowInsetsAnimationCompat, windowInsets, z2);
                }
            }
        }
        ...
        public static WindowInsetsCompat interpolateInsets(WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2, float f, int i8) {
            ...
            for (int i9 = 1; i9 <= 256; i9 <<= 1) {
                if ((i8 & i9) == 0) {
                    ...
                    float f4 = 1.0f - f;
                    builder.setInsets(i9, WindowInsetsCompat.insetInsets(insets, (int) (((double) ((insets.left - insets2.left) * f4)) + 0.5d), (int) (((double) ((insets.top - insets2.top) * f4)) + 0.5d), (int) (((double) ((insets.right - insets2.right) * f4)) + 0.5d), (int) (((double) ((insets.bottom - insets2.bottom) * f4)) + 0.5d)));
                }
            }
    ...
    public void setAlpha(@FloatRange(from = 0.0d, to = Contrast.RATIO_MIN) float f) {
        this.mImpl.setAlpha(f);
    }

    public void setFraction(@FloatRange(from = 0.0d, to = Contrast.RATIO_MIN) float f) {
    ...
    public static class Impl30 extends Impl {
        ...
        public Impl30(int i8, Interpolator interpolator, long j8) {
