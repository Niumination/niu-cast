...
public class AccessibilityDelegateCompat {
    ...
    public static final class AccessibilityDelegateAdapter extends View.AccessibilityDelegate {
        ...
        public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            for (int i8 = 0; i8 < actionList.size(); i8++) {
                accessibilityNodeInfoCompatWrap.addAction(actionList.get(i8));
            }
        }
    ...
    public boolean performAccessibilityAction(@NonNull View view, int i8, @Nullable Bundle bundle) {
        ...
        if (!zPerformAccessibilityAction) {
            zPerformAccessibilityAction = this.mOriginalDelegate.performAccessibilityAction(view, i8, bundle);
        }
        return (zPerformAccessibilityAction || i8 != R.id.accessibility_action_clickable_span || bundle == null) ? zPerformAccessibilityAction : performClickableSpanAction(bundle.getInt(AccessibilityClickableSpanCompat.SPAN_ID, -1), view);
    }
