...
public final class MotionEventCompat {
    ...
    @Deprecated
    public static int findPointerIndex(MotionEvent motionEvent, int i8) {
    ...
    @Deprecated
    public static float getAxisValue(MotionEvent motionEvent, int i8) {
        return motionEvent.getAxisValue(i8);
    }
    ...
    @Deprecated
    public static int getPointerId(MotionEvent motionEvent, int i8) {
    ...
    @Deprecated
    public static float getX(MotionEvent motionEvent, int i8) {
        return motionEvent.getX(i8);
    }

    @ReplaceWith(expression = "event.getY(pointerIndex)")
    @Deprecated
    public static float getY(MotionEvent motionEvent, int i8) {
        return motionEvent.getY(i8);
    }

    public static boolean isFromSource(@NonNull MotionEvent motionEvent, int i8) {
        return (motionEvent.getSource() & i8) == i8;
    }

    @ReplaceWith(expression = "event.getAxisValue(axis, pointerIndex)")
    @Deprecated
    public static float getAxisValue(MotionEvent motionEvent, int i8, int i9) {
        return motionEvent.getAxisValue(i8, i9);
    }
}
