...
public class WindowInsetsCompat {
    ...
    public static class BuilderImpl {
        ...
        public void setInsets(int i8, @NonNull Insets insets) {
            if (this.mInsetsTypeMask == null) {
                this.mInsetsTypeMask = new Insets[9];
            }
            for (int i9 = 1; i9 <= 256; i9 <<= 1) {
                if ((i8 & i9) != 0) {
                    this.mInsetsTypeMask[Type.indexOf(i9)] = insets;
                }
            }
        }

        public void setInsetsIgnoringVisibility(int i8, @NonNull Insets insets) {
            if (i8 == 8) {
        ...
        public void setVisible(int i8, boolean z2) {
        }
    ...
    public static class BuilderImpl30 extends BuilderImpl29 {
        ...
        public void setInsets(int i8, @NonNull Insets insets) {
            this.mPlatBuilder.setInsets(TypeImpl30.toPlatformType(i8), insets.toPlatformInsets());
        }

        @Override // androidx.core.view.WindowInsetsCompat.BuilderImpl
        public void setInsetsIgnoringVisibility(int i8, @NonNull Insets insets) {
            this.mPlatBuilder.setInsetsIgnoringVisibility(TypeImpl30.toPlatformType(i8), insets.toPlatformInsets());
        }

        @Override // androidx.core.view.WindowInsetsCompat.BuilderImpl
        public void setVisible(int i8, boolean z2) {
            this.mPlatBuilder.setVisible(TypeImpl30.toPlatformType(i8), z2);
        }
    ...
    public static class Impl20 extends Impl {
        ...
        @NonNull
        public Insets getInsetsForType(int i8, boolean z2) {
            Insets stableInsets;
            int i9;
            if (i8 == 1) {
            ...
            return (insets == null || insets.equals(Insets.NONE) || (i9 = this.mRootViewVisibleInsets.bottom) <= rootStableInsets2.bottom) ? Insets.NONE : Insets.of(0, 0, 0, i9);
        }
        ...
        public WindowInsetsCompat inset(int i8, int i9, int i10, int i11) {
            ...
            builder.setSystemWindowInsets(WindowInsetsCompat.insetInsets(getSystemWindowInsets(), i8, i9, i10, i11));
            builder.setStableInsets(WindowInsetsCompat.insetInsets(getStableInsets(), i8, i9, i10, i11));
        ...
        public boolean isTypeVisible(int i8) {
            if (i8 != 1 && i8 != 2) {
                if (i8 == 4) {
                    return false;
                }
            ...
            return !getInsetsForType(i8, false).equals(Insets.NONE);
        }
        ...
        @NonNull
        private Insets getInsets(int i8, boolean z2) {
            Insets insetsMax = Insets.NONE;
            for (int i9 = 1; i9 <= 256; i9 <<= 1) {
                if ((i8 & i9) != 0) {
                    insetsMax = Insets.max(insetsMax, getInsetsForType(i9, z2));
                }
            }
            return insetsMax;
        }
    ...
    public static class Impl30 extends Impl29 {
        ...
        @NonNull
        public Insets getInsets(int i8) {
            return Insets.toCompatInsets(this.mPlatformInsets.getInsets(TypeImpl30.toPlatformType(i8)));
        }

        @Override // androidx.core.view.WindowInsetsCompat.Impl20, androidx.core.view.WindowInsetsCompat.Impl
        @NonNull
        public Insets getInsetsIgnoringVisibility(int i8) {
            return Insets.toCompatInsets(this.mPlatformInsets.getInsetsIgnoringVisibility(TypeImpl30.toPlatformType(i8)));
        }
    ...
    public static final class Type {
        ...
        public static int indexOf(int i8) {
            if (i8 == 1) {
                return 0;
            }
            if (i8 == 2) {
            ...
            throw new IllegalArgumentException(a1.a.o(i8, "type needs to be >= FIRST and <= LAST, type="));
        }
    ...
    public static final class TypeImpl30 {
        ...
        public static int toPlatformType(int i8) {
            int iStatusBars;
            int i9 = 0;
    ...
    public static Insets insetInsets(@NonNull Insets insets, int i8, int i9, int i10, int i11) {
        int iMax = Math.max(0, insets.left - i8);
        int iMax2 = Math.max(0, insets.top - i9);
        int iMax3 = Math.max(0, insets.right - i10);
        int iMax4 = Math.max(0, insets.bottom - i11);
        return (iMax == i8 && iMax2 == i9 && iMax3 == i10 && iMax4 == i11) ? insets : Insets.of(iMax, iMax2, iMax3, iMax4);
    }
    ...
    @NonNull
    public Insets getInsets(int i8) {
        return this.mImpl.getInsets(i8);
    }

    @NonNull
    public Insets getInsetsIgnoringVisibility(int i8) {
        return this.mImpl.getInsetsIgnoringVisibility(i8);
    }
    ...
    public boolean isVisible(int i8) {
        return this.mImpl.isVisible(i8);
    }
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder setInsets(int i8, @NonNull Insets insets) {
            this.mImpl.setInsets(i8, insets);
            return this;
        }

        @NonNull
        public Builder setInsetsIgnoringVisibility(int i8, @NonNull Insets insets) {
            this.mImpl.setInsetsIgnoringVisibility(i8, insets);
            return this;
        }
        ...
        @NonNull
        public Builder setVisible(int i8, boolean z2) {
            this.mImpl.setVisible(i8, z2);
            return this;
        }
    ...
    public WindowInsetsCompat inset(@IntRange(from = 0) int i8, @IntRange(from = 0) int i9, @IntRange(from = 0) int i10, @IntRange(from = 0) int i11) {
        return this.mImpl.inset(i8, i9, i10, i11);
    }
    ...
    public static class Impl29 extends Impl28 {
        ...
        @NonNull
        public WindowInsetsCompat inset(int i8, int i9, int i10, int i11) {
            return WindowInsetsCompat.toWindowInsetsCompat(this.mPlatformInsets.inset(i8, i9, i10, i11));
        }
