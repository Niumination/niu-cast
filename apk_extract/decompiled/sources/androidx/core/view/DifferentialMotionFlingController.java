...
public class DifferentialMotionFlingController {
    ...
    public DifferentialMotionFlingController(@NonNull Context context, @NonNull DifferentialMotionFlingTarget differentialMotionFlingTarget) {
        this(context, differentialMotionFlingTarget, new a(), new a());
    }
    ...
    public void onMotionEvent(@NonNull MotionEvent motionEvent, int i8) {
        boolean zCalculateFlingVelocityThresholds = calculateFlingVelocityThresholds(motionEvent, i8);
        ...
        float scaledScrollFactor = this.mTarget.getScaledScrollFactor() * getCurrentVelocity(motionEvent, i8);
        ...
        int i9 = iArr[1];
        float fMax = Math.max(-i9, Math.min(scaledScrollFactor, i9));
