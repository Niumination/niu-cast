...
public class NestedScrollingChildHelper {
    ...
    public boolean dispatchNestedFling(float f, float f4, boolean z2) {
        ...
        return ViewParentCompat.onNestedFling(nestedScrollingParentForType, this.mView, f, f4, z2);
    }
    ...
    public boolean dispatchNestedPreFling(float f, float f4) {
        ...
        return ViewParentCompat.onNestedPreFling(nestedScrollingParentForType, this.mView, f, f4);
    }
