...
public final class WindowInsetsAnimationControllerCompat {
    ...
    public static class Impl {
        ...
        public void setInsetsAndAlpha(@Nullable Insets insets, @FloatRange(from = 0.0d, to = Contrast.RATIO_MIN) float f, @FloatRange(from = 0.0d, to = Contrast.RATIO_MIN) float f4) {
        }
    }
    ...
    public static class Impl30 extends Impl {
        ...
        @Override // androidx.core.view.WindowInsetsAnimationControllerCompat.Impl
        public void setInsetsAndAlpha(@Nullable Insets insets, float f, float f4) {
            this.mController.setInsetsAndAlpha(insets == null ? null : insets.toPlatformInsets(), f, f4);
        }
    }
    ...
    public void setInsetsAndAlpha(@Nullable Insets insets, @FloatRange(from = 0.0d, to = Contrast.RATIO_MIN) float f, @FloatRange(from = 0.0d, to = Contrast.RATIO_MIN) float f4) {
        this.mImpl.setInsetsAndAlpha(insets, f, f4);
    }
}
