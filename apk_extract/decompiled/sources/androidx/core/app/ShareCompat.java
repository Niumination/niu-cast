...
public final class ShareCompat {
    ...
    public static class IntentBuilder {
        ...
        @NonNull
        public IntentBuilder setChooserTitle(@StringRes int i8) {
            return setChooserTitle(this.mContext.getText(i8));
        }
    ...
    public static class IntentReader {
        ...
        public Uri getStream(int i8) {
            ...
            throw new IndexOutOfBoundsException("Stream items available: " + getStreamCount() + " index requested: " + i8);
        }
    }
    ...
    @Deprecated
    public static void configureMenuItem(@NonNull Menu menu, @IdRes int i8, @NonNull IntentBuilder intentBuilder) {
        MenuItem menuItemFindItem = menu.findItem(i8);
        if (menuItemFindItem != null) {
            configureMenuItem(menuItemFindItem, intentBuilder);
            return;
        }
        throw new IllegalArgumentException(h0.a.h(i8, "Could not find menu item with id ", " in the supplied menu"));
    }
}
