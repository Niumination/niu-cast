...
public abstract class JobIntentService extends Service {
    ...
    public static abstract class WorkEnqueuer {
        ...
        public void ensureJobId(int i8) {
            if (!this.mHasJobId) {
                ...
                StringBuilder sbU = a1.a.u(i8, "Given job ID ", " is different than previous ");
                sbU.append(this.mJobId);
    ...
    public static WorkEnqueuer getWorkEnqueuer(Context context, ComponentName componentName, boolean z2, int i8) {
        ...
        JobWorkEnqueuer jobWorkEnqueuer = new JobWorkEnqueuer(context, componentName, i8);
    ...
    public static void enqueueWork(@NonNull Context context, @NonNull ComponentName componentName, int i8, @NonNull Intent intent) {
        ...
        synchronized (sLock) {
            WorkEnqueuer workEnqueuer = getWorkEnqueuer(context, componentName, true, i8);
