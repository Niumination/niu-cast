...
public class FrameMetricsAggregator {
    ...
    public static class FrameMetricsApi24Impl extends FrameMetricsBaseImpl {
        ...
        public FrameMetricsApi24Impl(int i8) {
            this.mTrackingFlags = i8;
        }
        ...
        public void add(Activity activity) {
            ...
            for (int i8 = 0; i8 <= 8; i8++) {
                ...
                if (sparseIntArrayArr[i8] == null && (this.mTrackingFlags & (1 << i8)) != 0) {
        ...
        public void addDurationItem(SparseIntArray sparseIntArray, long j8) {
    ...
    public FrameMetricsAggregator(int i8) {
        this.mInstance = new FrameMetricsApi24Impl(i8);
    }
}
