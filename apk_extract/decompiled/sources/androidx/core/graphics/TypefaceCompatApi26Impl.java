...
public class TypefaceCompatApi26Impl extends TypefaceCompatApi21Impl {
    ...
    public Typeface createFromFontInfo(Context context, @Nullable CancellationSignal cancellationSignal, @NonNull FontsContractCompat.FontInfo[] fontInfoArr, int i8) {
        ...
        if (freeze(objNewFamily) && (typefaceCreateFromFamiliesWithDefault = createFromFamiliesWithDefault(objNewFamily)) != null) {
            return Typeface.create(typefaceCreateFromFamiliesWithDefault, i8);
        }
        return null;
    }
    ...
    @Nullable
    @RequiresApi(29)
    public /* bridge */ /* synthetic */ Typeface createFromFontInfoWithFallback(@NonNull Context context, @Nullable CancellationSignal cancellationSignal, @NonNull List list, int i8) {
        return super.createFromFontInfoWithFallback(context, cancellationSignal, list, i8);
    }
    ...
    public Typeface createWeightStyle(@NonNull Context context, @NonNull Typeface typeface, int i8, boolean z2) {
        ...
        try {
            typefaceCreateWeightStyle = WeightTypefaceApi26.createWeightStyle(typeface, i8, z2);
