...
public final class BitmapKt {
    ...
    public static final Bitmap scale(Bitmap bitmap, int i8, int i9, boolean z2) {
        return Bitmap.createScaledBitmap(bitmap, i8, i9, z2);
    }

    public static /* synthetic */ Bitmap scale$default(Bitmap bitmap, int i8, int i9, boolean z2, int i10, Object obj) {
        if ((i10 & 4) != 0) {
            z2 = true;
        }
        return Bitmap.createScaledBitmap(bitmap, i8, i9, z2);
    ...
    @RequiresApi(26)
    public static final Bitmap createBitmap(int i8, int i9, Bitmap.Config config, boolean z2, ColorSpace colorSpace) {
        return Bitmap.createBitmap(i8, i9, config, z2, colorSpace);
    }

    public static /* synthetic */ Bitmap createBitmap$default(int i8, int i9, Bitmap.Config config, boolean z2, ColorSpace colorSpace, int i10, Object obj) {
        if ((i10 & 4) != 0) {
            config = Bitmap.Config.ARGB_8888;
        }
        if ((i10 & 8) != 0) {
