...
class TypefaceCompatApi21Impl extends TypefaceCompatBaseImpl {
    ...
    private static boolean addFontWeightStyle(Object obj, String str, int i8, boolean z2) throws NoSuchMethodException {
        init();
        try {
            return ((Boolean) sAddFontWeightStyle.invoke(obj, str, Integer.valueOf(i8), Boolean.valueOf(z2))).booleanValue();
    ...
    public Typeface createFromFontFamilyFilesResourceEntry(Context context, FontResourcesParserCompat.FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, Resources resources, int i8) throws NoSuchMethodException {
    ...
    public Typeface createFromFontInfo(Context context, CancellationSignal cancellationSignal, @NonNull FontsContractCompat.FontInfo[] fontInfoArr, int i8) {
        ...
        FontsContractCompat.FontInfo fontInfoFindBestInfo = findBestInfo(fontInfoArr, i8);
        try {
    ...
    public Typeface createWeightStyle(@NonNull Context context, @NonNull Typeface typeface, int i8, boolean z2) {
        ...
        try {
            typefaceCreateWeightStyle = WeightTypefaceApi21.createWeightStyle(typeface, i8, z2);
        } catch (RuntimeException unused) {
            typefaceCreateWeightStyle = null;
        }
        return typefaceCreateWeightStyle == null ? super.createWeightStyle(context, typeface, i8, z2) : typefaceCreateWeightStyle;
    }
}
