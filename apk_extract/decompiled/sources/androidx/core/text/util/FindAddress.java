...
class FindAddress {
    ...
    public static class ZipRange {
        ...
        public ZipRange(int i8, int i9, int i10, int i11) {
            this.mLow = i8;
            this.mHigh = i9;
            this.mException1 = i10;
            this.mException2 = i11;
        }

        public boolean matches(String str) {
            int i8 = Integer.parseInt(str.substring(0, 2));
            return (this.mLow <= i8 && i8 <= this.mHigh) || i8 == this.mException1 || i8 == this.mException2;
        }
    }
            ...
            if (!matcher.find(iEnd)) {
                ...
                if (matchHouseNumber(str, iEnd) == null) {
                    if (!isValidLocationName(matcher.group(0))) {
                        ...
                        if (z3 && i10 > 4 && (matchResultMatchState = matchState(str, iEnd)) != null) {
    ...
    private static boolean checkHouseNumber(String str) {
        ...
        int i11 = i10 % 10;
        if (i11 == 1) {
            return lowerCase.equals(i10 % 100 != 11 ? "st" : "th");
        }
        if (i11 == 2) {
            return lowerCase.equals(i10 % 100 != 12 ? "nd" : "th");
        }
        if (i11 != 3) {
            return lowerCase.equals("th");
        }
        return lowerCase.equals(i10 % 100 != 13 ? "rd" : "th");
    }
    ...
    @VisibleForTesting
    public static MatchResult matchHouseNumber(String str, int i8) {
        if (i8 > 0 && HOUSE_PRE_DELIM.indexOf(str.charAt(i8 - 1)) == -1) {
            return null;
        }
        Matcher matcherRegion = sHouseNumberRe.matcher(str).region(i8, str.length());
    ...
    @VisibleForTesting
    public static MatchResult matchState(String str, int i8) {
        if (i8 > 0 && WORD_DELIM.indexOf(str.charAt(i8 - 1)) == -1) {
            return null;
        }
        Matcher matcherRegion = sStateRe.matcher(str).region(i8, str.length());
        if (matcherRegion.lookingAt()) {
