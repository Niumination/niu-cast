...
public class ShortcutInfoCompat {
    ...
    public static class Api33Impl {
        ...
        public static void setExcludedFromSurfaces(@NonNull ShortcutInfo.Builder builder, int i8) {
    ...
    public static class Builder {
            ...
            if (this.mCapabilityBindingParams != null) {
                ...
                for (String str : this.mCapabilityBindingParams.keySet()) {
                    ...
                    for (String str2 : map.keySet()) {
                        ...
                        this.mInfo.mExtras.putStringArray(d.l(str, "/", str2), list == null ? new String[0] : (String[]) list.toArray(new String[0]));
                    }
                }
            }
        ...
        public Builder setExcludedFromSurfaces(int i8) {
            this.mInfo.mExcludedSurfaces = i8;
            return this;
        }
    ...
    private PersistableBundle buildLegacyExtrasBundle() {
        ...
        if (personArr != null && personArr.length > 0) {
            ...
            int i8 = 0;
            while (i8 < this.mPersons.length) {
                PersistableBundle persistableBundle = this.mExtras;
                StringBuilder sb2 = new StringBuilder(EXTRA_PERSON_);
                int i9 = i8 + 1;
                sb2.append(i9);
                persistableBundle.putPersistableBundle(sb2.toString(), this.mPersons[i8].toPersistableBundle());
                i8 = i9;
            }
        }
    ...
    public static Person[] getPersonsFromExtra(@NonNull PersistableBundle persistableBundle) {
        ...
        while (i9 < i8) {
            ...
            int i10 = i9 + 1;
            sb2.append(i10);
            personArr[i9] = Person.fromPersistableBundle(persistableBundle.getPersistableBundle(sb2.toString()));
            i9 = i10;
        }
        return personArr;
    }
    ...
    public boolean isExcludedFromSurfaces(int i8) {
        return (this.mExcludedSurfaces & i8) != 0;
    }
