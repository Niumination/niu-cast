...
public class IntentSanitizer {
    ...
    public static class Api31Impl {
        ...
        public static void checkOtherMembers(int i8, ClipData.Item item, Consumer<String> consumer) {
            if (item.getHtmlText() == null && item.getIntent() == null && item.getTextLinks() == null) {
                return;
            }
            consumer.accept("ClipData item at position " + i8 + " contains htmlText, textLinks or intent: " + item);
        }
    }
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder allowFlags(int i8) {
            this.mAllowedFlags = i8 | this.mAllowedFlags;
            return this;
        }
        ...
        public <T> Builder allowExtra(@NonNull String str, @NonNull Class<T> cls, @NonNull Predicate<T> predicate) {
            ...
            Preconditions.checkNotNull(predicate);
            return allowExtra(str, new a(cls, predicate));
        }
    ...
    private static void checkOtherMembers(int i8, ClipData.Item item, Consumer<String> consumer) {
    ...
    public static void sanitizeClipData(@NonNull Intent intent, Intent intent2, Predicate<ClipData> predicate, boolean z2, Predicate<Uri> predicate2, Consumer<String> consumer) {
        CharSequence text;
        Uri uri;
        ...
        for (int i8 = 0; i8 < clipData.getItemCount(); i8++) {
            ...
            Api31Impl.checkOtherMembers(i8, itemAt, consumer);
            if (z2) {
                text = itemAt.getText();
            } else {
                if (itemAt.getText() != null) {
                    StringBuilder sbU = a1.a.u(i8, "Item text cannot contain value. Item position: ", ". Text: ");
                    sbU.append((Object) itemAt.getText());
                    consumer.accept(sbU.toString());
                }
                text = null;
            }
            if (predicate2 != null) {
                if (itemAt.getUri() == null || predicate2.test(itemAt.getUri())) {
                    ...
                    StringBuilder sbU2 = a1.a.u(i8, "Item URI is not allowed. Item position: ", ". URI: ");
                    sbU2.append(itemAt.getUri());
                    consumer.accept(sbU2.toString());
                }
                ...
                StringBuilder sbU3 = a1.a.u(i8, "Item URI is not allowed. Item position: ", ". URI: ");
                sbU3.append(itemAt.getUri());
                consumer.accept(sbU3.toString());
            }
            uri = null;
            if (text == null) {
                if (clipData2 == null) {
    ...
    public Intent sanitize(@NonNull Intent intent, @NonNull Consumer<String> consumer) {
        ...
        int i8 = this.mAllowedFlags;
        if (flags == i8) {
            intent2.setFlags(intent.getFlags());
        } else {
            intent2.setFlags(intent.getFlags() & i8);
    ...
    public Intent sanitizeByFiltering(@NonNull Intent intent) {
        return sanitize(intent, new i0.a(1));
    }

    @NonNull
    public Intent sanitizeByThrowing(@NonNull Intent intent) {
        return sanitize(intent, new i0.a(0));
    }
