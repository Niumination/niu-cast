...
public class FileProvider extends ContentProvider {
    ...
    private static String[] copyOf(String[] strArr, int i8) {
    ...
    @VisibleForTesting
    public static XmlResourceParser getFileProviderPathsMetaData(Context context, String str, @Nullable ProviderInfo providerInfo, int i8) {
        if (providerInfo == null) {
            throw new IllegalArgumentException(a.i("Couldn't find meta-data for provider with authority ", str));
        }
    ...
    private static PathStrategy getPathStrategy(Context context, String str, int i8) {
        PathStrategy pathStrategy;
        ...
        synchronized (map) {
            try {
                ...
                if (pathStrategy == null) {
                    try {
                        try {
                            pathStrategy = parsePathStrategy(context, str, i8);
    ...
    private static int modeToMode(String str) {
        ...
        throw new IllegalArgumentException(a.i("Invalid mode: ", str));
    }

    private static PathStrategy parsePathStrategy(Context context, String str, int i8) throws XmlPullParserException, IOException {
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] strArr, @Nullable String str, @Nullable String[] strArr2, @Nullable String str2) {
        ...
        String[] strArrCopyOf = copyOf(strArr3, i9);
        Object[] objArrCopyOf = copyOf(objArr, i9);
    ...
    public FileProvider(@XmlRes int i8) {
        this.mLock = new Object();
        this.mResourceId = i8;
    }

    private static Object[] copyOf(Object[] objArr, int i8) {
