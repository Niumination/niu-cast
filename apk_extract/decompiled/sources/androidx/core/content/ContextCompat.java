...
public class ContextCompat {
    ...
    public static class Api26Impl {
        ...
        public static Intent registerReceiver(Context context, @Nullable BroadcastReceiver broadcastReceiver, IntentFilter intentFilter, String str, Handler handler, int i8) {
            return ((i8 & 4) == 0 || str != null) ? context.registerReceiver(broadcastReceiver, intentFilter, str, handler, i8 & 1) : context.registerReceiver(broadcastReceiver, intentFilter, ContextCompat.obtainAndCheckReceiverPermission(context), handler);
        }
    ...
    public static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            map.put(ActivityManager.class, AtomicIntentType.ACTIVITY);
            ...
            map.put(InputMethodManager.class, TCCPSourceApi.KEY_FEATURE_INPUT_METHOD);
    ...
    public static String obtainAndCheckReceiverPermission(Context context) {
        ...
        throw new RuntimeException(a.j("Permission ", str, " is required by your application to receive broadcasts, please add it to your manifest"));
    }
