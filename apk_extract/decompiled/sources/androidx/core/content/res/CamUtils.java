...
final class CamUtils {
    ...
    public static int intFromLStar(float f) {
        ...
        float f10 = f > 8.0f ? f4 * f4 * f4 : f / 903.2963f;
        float f11 = f4 * f4 * f4;
        boolean z2 = f11 > 0.008856452f;
        float f12 = z2 ? f11 : ((f4 * 116.0f) - 16.0f) / 903.2963f;
        if (!z2) {
            f11 = ((f4 * 116.0f) - 16.0f) / 903.2963f;
        }
        float[] fArr = WHITE_POINT_D65;
        return ColorUtils.XYZToColor(f12 * fArr[0], f10 * fArr[1], f11 * fArr[2]);
    }
    ...
    public static float linearized(int i8) {
        float f = i8 / 255.0f;
        return (f <= 0.04045f ? f / 12.92f : (float) Math.pow((f + 0.055f) / 1.055f, 2.4000000953674316d)) * 100.0f;
    }

    public static void xyzFromInt(int i8, @NonNull float[] fArr) {
        float fLinearized = linearized(Color.red(i8));
        float fLinearized2 = linearized(Color.green(i8));
        float fLinearized3 = linearized(Color.blue(i8));
    ...
    public static float yFromInt(int i8) {
        float fLinearized = linearized(Color.red(i8));
        float fLinearized2 = linearized(Color.green(i8));
        float fLinearized3 = linearized(Color.blue(i8));
