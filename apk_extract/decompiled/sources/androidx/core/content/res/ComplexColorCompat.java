...
public final class ComplexColorCompat {
    ...
    private ComplexColorCompat(Shader shader, ColorStateList colorStateList, @ColorInt int i8) {
        this.mShader = shader;
    ...
    @NonNull
    private static ComplexColorCompat createFromXml(@NonNull Resources resources, @ColorRes int i8, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        int next;
    ...
    public static ComplexColorCompat inflate(@NonNull Resources resources, @ColorRes int i8, @Nullable Resources.Theme theme) {
        try {
            return createFromXml(resources, i8, theme);
        } catch (Exception e) {
    ...
    public static ComplexColorCompat from(@ColorInt int i8) {
