...
final class GradientColorInflaterCompat {
    ...
    private static ColorStops checkColors(@Nullable ColorStops colorStops, @ColorInt int i8, @ColorInt int i9, boolean z2, @ColorInt int i10) {
        if (colorStops != null) {
            return colorStops;
        }
        return z2 ? new ColorStops(i8, i10, i9) : new ColorStops(i8, i9);
    }
    ...
    public static Shader createFromXmlInner(@NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        int namedInt = TypedArrayUtils.getNamedInt(typedArrayObtainAttributes, xmlPullParser, MessageBank.KEY_TYPE, R.styleable.GradientColor_android_type, 0);
    ...
    private static Shader.TileMode parseTileMode(int i8) {
        if (i8 != 1) {
            return i8 != 2 ? Shader.TileMode.CLAMP : Shader.TileMode.MIRROR;
        }
    ...
    public static final class ColorStops {
        ...
        public ColorStops(@NonNull List<Integer> list, @NonNull List<Float> list2) {
            ...
            for (int i8 = 0; i8 < size; i8++) {
                this.mColors[i8] = list.get(i8).intValue();
                this.mOffsets[i8] = list2.get(i8).floatValue();
            }
        }

        public ColorStops(@ColorInt int i8, @ColorInt int i9) {
            this.mColors = new int[]{i8, i9};
            this.mOffsets = new float[]{0.0f, 1.0f};
        }

        public ColorStops(@ColorInt int i8, @ColorInt int i9, @ColorInt int i10) {
            this.mColors = new int[]{i8, i9, i10};
