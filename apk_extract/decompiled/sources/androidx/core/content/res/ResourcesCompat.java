...
public final class ResourcesCompat {
    ...
    public static abstract class FontCallback {
        ...
        public final void callbackFailAsync(int i8, @Nullable Handler handler) {
            getHandler(handler).post(new b(i8, 2, this));
        }

        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public final void callbackSuccessAsync(@NonNull Typeface typeface, @Nullable Handler handler) {
            getHandler(handler).post(new e(16, this, typeface));
        }
    ...
    public static final class ThemeCompat {
        ...
        public static class Api23Impl {
            ...
            /* JADX WARN: Code duplicated, block: B:29:0x0027 A[EXC_TOP_SPLITTER, SYNTHETIC] */
                    ...
                    if (sRebaseMethodFetched) {
                        ...
                        if (method != null) {
                            try {
                                ...
                                Log.i(ResourcesCompat.TAG, "Failed to invoke rebase() method via reflection", e4);
                                sRebaseMethod = null;
                            }
                        }
                    }
    ...
    */
    ...
    public static ColorStateList getColorStateList(@NonNull Resources resources, @ColorRes int i8, @Nullable Resources.Theme theme) throws Resources.NotFoundException {
        ...
        ColorStateList colorStateListInflateColorStateList = inflateColorStateList(resources, i8, theme);
        if (colorStateListInflateColorStateList == null) {
            return Api23Impl.getColorStateList(resources, i8, theme);
        }
        addColorStateListToCache(colorStateListCacheKey, i8, colorStateListInflateColorStateList, theme);
    ...
    private static Typeface loadFont(@NonNull Context context, int i8, @NonNull TypedValue typedValue, int i9, @Nullable FontCallback fontCallback, @Nullable Handler handler, boolean z2, boolean z3) {
        Resources resources = context.getResources();
        resources.getValue(i8, typedValue, true);
        Typeface typefaceLoadFont = loadFont(context, resources, typedValue, i8, i9, fontCallback, handler, z2, z3);
    ...
    private static Typeface loadFont(@NonNull Context context, Resources resources, @NonNull TypedValue typedValue, int i8, int i9, @Nullable FontCallback fontCallback, @Nullable Handler handler, boolean z2, boolean z3) {
        ...
        if (charSequence != null) {
            ...
            Typeface typefaceFindFromCache = TypefaceCompat.findFromCache(resources, i8, string, typedValue.assetCookie, i9);
            ...
            try {
                try {
                    if (string.toLowerCase().endsWith(".xml")) {
                        FontResourcesParserCompat.FamilyResourceEntry familyResourceEntry = FontResourcesParserCompat.parse(resources.getXml(i8), resources);
                        ...
                        return TypefaceCompat.createFromResourcesFamilyXml(context, familyResourceEntry, resources, i8, string, typedValue.assetCookie, i9, fontCallback, handler, z2);
                    }
                    Typeface typefaceCreateFromResourcesFontFile = TypefaceCompat.createFromResourcesFontFile(context, resources, i8, string, typedValue.assetCookie, i9);
                    if (fontCallback != null) {
