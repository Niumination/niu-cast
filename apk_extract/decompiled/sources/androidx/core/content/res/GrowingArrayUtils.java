...
final class GrowingArrayUtils {
    ...
    public static <T> T[] append(T[] tArr, int i8, T t3) {
        if (i8 + 1 > tArr.length) {
            Object[] objArr = (Object[]) Array.newInstance(tArr.getClass().getComponentType(), growSize(i8));
    ...
    public static <T> T[] insert(T[] tArr, int i8, int i9, T t3) {
        if (i8 + 1 <= tArr.length) {
    ...
    public static boolean[] append(boolean[] zArr, int i8, boolean z2) {
        if (i8 + 1 > zArr.length) {
    ...
    public static boolean[] insert(boolean[] zArr, int i8, int i9, boolean z2) {
        if (i8 + 1 <= zArr.length) {
