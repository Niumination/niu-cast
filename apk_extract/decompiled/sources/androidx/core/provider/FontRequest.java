...
public final class FontRequest {
    ...
    public String toString() {
        ...
        for (int i8 = 0; i8 < this.mCertificates.size(); i8++) {
            sb2.append(" [");
            List<byte[]> list = this.mCertificates.get(i8);
    ...
    public FontRequest(@NonNull String str, @NonNull String str2, @NonNull String str3, @ArrayRes int i8) {
        this.mProviderAuthority = (String) Preconditions.checkNotNull(str);
        this.mProviderPackage = (String) Preconditions.checkNotNull(str2);
        this.mQuery = (String) Preconditions.checkNotNull(str3);
        this.mCertificates = null;
        Preconditions.checkArgument(i8 != 0);
        this.mCertificatesArray = i8;
        this.mIdentifier = createIdentifier(str, str2, str3);
    }
}
