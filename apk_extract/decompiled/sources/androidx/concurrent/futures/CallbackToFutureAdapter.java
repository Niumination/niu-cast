...
public final class CallbackToFutureAdapter {
    ...
    public static final class Completer<T> {
        ...
        public boolean set(T t3) {
            ...
            SafeFuture<T> safeFuture = this.future;
            boolean z2 = safeFuture != null && safeFuture.set(t3);
            if (z2) {
        ...
        public boolean setException(@NonNull Throwable th2) {
            this.attemptedSetting = true;
            SafeFuture<T> safeFuture = this.future;
            boolean z2 = safeFuture != null && safeFuture.setException(th2);
            if (z2) {
                setCompletedNormally();
            }
            return z2;
    ...
    public static final class SafeFuture<T> implements l {
        ...
        @Override // java.util.concurrent.Future
        public T get(long j8, @NonNull TimeUnit timeUnit) throws ExecutionException, InterruptedException, TimeoutException {
    ...
    @NonNull
    public static <T> l getFuture(@NonNull Resolver<T> resolver) {
