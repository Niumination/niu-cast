...
public abstract class AbstractResolvableFuture<V> implements l {
    ...
    public static final class Cancellation {
        ...
        public Cancellation(boolean z2, @Nullable Throwable th2) {
    ...
    public static final class SetFuture<V> implements Runnable {
        ...
        public SetFuture(AbstractResolvableFuture<V> abstractResolvableFuture, l lVar) {
    ...
    public static Object getFutureValue(l lVar) {
        if (lVar instanceof AbstractResolvableFuture) {
            Object obj = ((AbstractResolvableFuture) lVar).value;
            if (!(obj instanceof Cancellation)) {
                return obj;
            }
        ...
        boolean zIsCancelled = lVar.isCancelled();
        if ((!GENERATE_CANCELLATION_CAUSES) && zIsCancelled) {
            return Cancellation.CAUSELESS_CANCELLED;
        }
        try {
            Object uninterruptibly = getUninterruptibly(lVar);
    ...
    public final boolean cancel(boolean z2) {
        ...
        while (true) {
            if (ATOMIC_HELPER.casValue(this, obj, cancellation)) {
                ...
                l lVar = ((SetFuture) obj).future;
                if (!(lVar instanceof AbstractResolvableFuture)) {
                    lVar.cancel(z2);
                    return true;
                }
                this = (AbstractResolvableFuture) lVar;
                obj = this.value;
                if (!(obj == null) && !(obj instanceof SetFuture)) {
                    return true;
                }
    ...
    @Override // java.util.concurrent.Future
    public final V get(long j8, TimeUnit timeUnit) throws ExecutionException, InterruptedException, TimeoutException {
        ...
        if (nanos + SPIN_THRESHOLD_NANOS < 0) {
            ...
            strB = a.B(strB2, "delay)");
        }
        if (isDone()) {
            throw new TimeoutException(a.B(strB, " but future completed as timeout expired"));
        }
        throw new TimeoutException(d.l(strB, " for ", string));
    }
    ...
    public String pendingToString() {
        Object obj = this.value;
        if (obj instanceof SetFuture) {
            return a.n(new StringBuilder("setFuture=["), userObjectToString(((SetFuture) obj).future), "]");
        }
    ...
    public boolean setFuture(l lVar) {
        ...
        if (obj == null) {
            if (lVar.isDone()) {
                if (!ATOMIC_HELPER.casValue(this, null, getFutureValue(lVar))) {
                    return false;
                }
                complete(this);
                return true;
        ...
        if (obj instanceof Cancellation) {
            lVar.cancel(((Cancellation) obj).wasInterrupted);
        }
        return false;
    }
