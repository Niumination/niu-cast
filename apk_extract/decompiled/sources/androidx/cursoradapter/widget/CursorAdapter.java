...
public abstract class CursorAdapter extends BaseAdapter implements Filterable, CursorFilter.CursorFilterClient {
    ...
    public long getItemId(int i8) {
        Cursor cursor;
        if (this.mDataValid && (cursor = this.mCursor) != null && cursor.moveToPosition(i8)) {
    ...
    public View getView(int i8, View view, ViewGroup viewGroup) {
        ...
        if (!this.mCursor.moveToPosition(i8)) {
            throw new IllegalStateException(a.o(i8, "couldn't move cursor to position "));
        }
        if (view == null) {
    ...
    public void init(Context context, Cursor cursor, int i8) {
        if ((i8 & 1) == 1) {
            i8 |= 2;
    ...
    public CursorAdapter(Context context, Cursor cursor, int i8) {
        init(context, cursor, i8);
    }
}
