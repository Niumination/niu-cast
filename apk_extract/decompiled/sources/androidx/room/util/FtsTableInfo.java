...
public class FtsTableInfo {
    ...
    public static Set<String> parseOptions(String str) {
        ...
        for (int i9 = 0; i9 < strSubstring.length(); i9++) {
            ...
            if (cCharAt == '\"' || cCharAt == '\'') {
                ...
                arrayList.add(strSubstring.substring(i8 + 1, i9).trim());
                i8 = i9;
            }
        }
        arrayList.add(strSubstring.substring(i8 + 1).trim());
    ...
    public boolean equals(Object obj) {
        ...
        if (set2 != null) {
            return set2.equals(ftsTableInfo.options);
        }
        return ftsTableInfo.options == null;
    }
