...
public class TableInfo {
    ...
    public static class Column {
        ...
        @Deprecated
        public Column(String str, String str2, boolean z2, int i8) {
            this(str, str2, z2, i8, null, 0);
        }
        ...
        public boolean equals(Object obj) {
            ...
            int i8 = this.mCreatedFrom;
            return (i8 == 0 || i8 != column.mCreatedFrom || ((str = this.defaultValue) == null ? column.defaultValue == null : str.equals(column.defaultValue))) && this.affinity == column.affinity;
        }
        ...
        public String toString() {
            ...
            return a.n(sb2, this.defaultValue, "'}");
        }

        public Column(String str, String str2, boolean z2, int i8, String str3, int i9) {
            this.name = str;
            this.type = str2;
            this.notNull = z2;
    ...
    public static class ForeignKey {
        ...
        public int hashCode() {
            return this.referenceColumnNames.hashCode() + ((this.columnNames.hashCode() + a1.a.e(a1.a.e(this.referenceTable.hashCode() * 31, 31, this.onDelete), 31, this.onUpdate)) * 31);
        }
    ...
    public static class ForeignKeyWithSequence implements Comparable<ForeignKeyWithSequence> {
        ...
        public int compareTo(@NonNull ForeignKeyWithSequence foreignKeyWithSequence) {
            int i8 = this.mId - foreignKeyWithSequence.mId;
            return i8 == 0 ? this.mSequence - foreignKeyWithSequence.mSequence : i8;
        }
    }
    ...
    private static Map<String, Column> readColumns(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
        ...
        try {
            if (cursorQuery.getColumnCount() > 0) {
                ...
                int columnIndex2 = cursorQuery.getColumnIndex(MessageBank.KEY_TYPE);
            ...
            for (int i8 = 0; i8 < count; i8++) {
                ...
                if (cursorQuery.getInt(columnIndex2) == 0) {
                    ...
                    for (ForeignKeyWithSequence foreignKeyWithSequence : foreignKeyFieldMappings) {
                        if (foreignKeyWithSequence.mId == i9) {
