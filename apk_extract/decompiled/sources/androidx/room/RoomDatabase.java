...
public abstract class RoomDatabase {
    ...
    public static class Builder<T extends RoomDatabase> {
        ...
        public T build() {
            ...
            T t3 = (T) Room.getGeneratedImplementation(this.mDatabaseClass, RoomDatabase.DB_IMPL_SUFFIX);
        ...
        public Builder<T> fallbackToDestructiveMigrationFrom(int... iArr) {
            ...
            for (int i8 : iArr) {
                this.mMigrationsNotRequiredFrom.add(Integer.valueOf(i8));
            }
            return this;
        }
    ...
    public static class MigrationContainer {
        ...
        private void addMigration(Migration migration) {
            ...
            TreeMap<Integer, Migration> treeMap = this.mMigrations.get(Integer.valueOf(i8));
            if (treeMap == null) {
                treeMap = new TreeMap<>();
                this.mMigrations.put(Integer.valueOf(i8), treeMap);
            }
        ...
        private List<Migration> findUpMigrationPath(List<Migration> list, boolean z2, int i8, int i9) {
            ...
            while (true) {
                if (z2) {
                    ...
                    treeMap = this.mMigrations.get(Integer.valueOf(i8));
                    if (treeMap == null) {
                        return null;
                    }
                    if (z2) {
                    ...
                    while (true) {
                        ...
                        if (!z2) {
                            if (iIntValue >= i9 && iIntValue < i8) {
                                list.add(treeMap.get(next));
                                z3 = true;
                                break;
                            }
                        } else if (iIntValue <= i9 && iIntValue > i8) {
                            list.add(treeMap.get(next));
                            z3 = true;
                            break;
                        }
        ...
        public List<Migration> findMigrationPath(int i8, int i9) {
            ...
            return findUpMigrationPath(new ArrayList(), i9 > i8, i8, i9);
        }
    }
