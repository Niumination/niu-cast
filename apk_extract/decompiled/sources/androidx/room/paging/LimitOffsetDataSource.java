...
public abstract class LimitOffsetDataSource<T> extends PositionalDataSource<T> {
    ...
    private RoomSQLiteQuery getSQLiteQuery(int i8, int i9) {
        ...
        roomSQLiteQueryAcquire.bindLong(roomSQLiteQueryAcquire.getArgCount() - 1, i9);
        roomSQLiteQueryAcquire.bindLong(roomSQLiteQueryAcquire.getArgCount(), i8);
        ...
        try {
            ...
            if (iCountItems != 0) {
                ...
                try {
                    ...
                    roomSQLiteQuery = sQLiteQuery;
                    i8 = iComputeInitialLoadPosition;
            ...
            loadInitialCallback.onResult(listEmptyList, i8, iCountItems);
        } catch (Throwable th3) {
            th = th3;
            sQLiteQuery = null;
        }
    ...
    public List<T> loadRange(int i8, int i9) {
        RoomSQLiteQuery sQLiteQuery = getSQLiteQuery(i8, i9);
