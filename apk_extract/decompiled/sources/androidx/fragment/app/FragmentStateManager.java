...
class FragmentStateManager {
    ...
    public void attach() {
        ...
        if (fragment2 != null) {
            ...
            if (str != null && (fragmentStateManager = this.mFragmentStore.getFragmentStateManager(str)) == null) {
                ...
                throw new IllegalStateException(a.n(sb2, this.mFragment.mTargetWho, " that does not belong to this FragmentManager!"));
            }
        }
    ...
    public int computeExpectedState() {
        ...
        int i8 = AnonymousClass2.$SwitchMap$androidx$lifecycle$Lifecycle$State[fragment.mMaxState.ordinal()];
        if (i8 != 1) {
            if (i8 == 2) {
                iMin = Math.min(iMin, 5);
            } else if (i8 != 3) {
                iMin = i8 != 4 ? Math.min(iMin, -1) : Math.min(iMin, 0);
            } else {
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            StringBuilder sbU = a1.a.u(iMin, "computeExpectedState() of ", " for ");
    ...
    public void moveToExpectedState() {
        ...
        try {
            ...
            while (true) {
                ...
                if (iComputeExpectedState == i8) {
                    if (!z2 && i8 == -1 && fragment.mRemoving && !fragment.isInBackStack() && !this.mFragment.mBeingSaved) {
                        if (FragmentManager.isLoggingEnabled(3)) {
    ...
    public void saveState() {
        ...
        if (fragment.mState <= -1 || fragmentState.mSavedFragmentState != null) {
            ...
            if (this.mFragment.mTargetWho != null) {
                ...
                int i8 = this.mFragment.mTargetRequestCode;
                if (i8 != 0) {
