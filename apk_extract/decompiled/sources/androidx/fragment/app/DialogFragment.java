...
public class DialogFragment extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    private void dismissInternal(boolean z2, boolean z3, boolean z5) {
        if (this.mDismissed) {
            return;
        }
        ...
        if (this.mBackStackId >= 0) {
            if (z5) {
                ...
                getParentFragmentManager().popBackStack(this.mBackStackId, 1, z2);
            }
            this.mBackStackId = -1;
            return;
        }
    ...
    public FragmentContainer createFragmentContainer() {
        ...
        return new FragmentContainer() { // from class: androidx.fragment.app.DialogFragment.5
            ...
            public View onFindViewById(int i8) {
                return fragmentContainerCreateFragmentContainer.onHasView() ? fragmentContainerCreateFragmentContainer.onFindViewById(i8) : DialogFragment.this.onFindViewById(i8);
            }
    ...
    public LayoutInflater onGetLayoutInflater(@Nullable Bundle bundle) {
        ...
        if (!this.mShowsDialog || this.mCreatingDialog) {
            if (FragmentManager.isLoggingEnabled(2)) {
                ...
                if (this.mShowsDialog) {
                    d.B("mCreatingDialog = true: ", str, FragmentManager.TAG);
                } else {
                    d.B("mShowsDialog = false: ", str, FragmentManager.TAG);
                }
            }
