...
abstract class SpecialEffectsController {
            ...
            try {
                ...
                for (Operation operation2 : new ArrayList(this.mPendingOperations)) {
                    if (FragmentManager.isLoggingEnabled(2)) {
                        ...
                        sb3.append(zIsAttachedToWindow ? "" : "Container " + this.mContainer + " is not attached to window. ");
    ...
    public static class Operation {
        ...
        public final void mergeWith(@NonNull State state, @NonNull LifecycleImpact lifecycleImpact) {
            int i8 = AnonymousClass3.$SwitchMap$androidx$fragment$app$SpecialEffectsController$Operation$LifecycleImpact[lifecycleImpact.ordinal()];
            if (i8 == 1) {
            ...
            if (i8 == 3 && this.mFinalState != State.REMOVED) {
                if (FragmentManager.isLoggingEnabled(2)) {
        ...
        public enum State {
            ...
            public void applyState(@NonNull View view) {
                int i8 = AnonymousClass3.$SwitchMap$androidx$fragment$app$SpecialEffectsController$Operation$State[ordinal()];
                if (i8 == 1) {
            ...
            public static State from(int i8) {
                ...
                throw new IllegalArgumentException(a.o(i8, "Unknown visibility "));
            }
        }
    }
