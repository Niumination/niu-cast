...
public class FragmentActivity extends ComponentActivity implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
    ...
    private void init() {
        getSavedStateRegistry().registerSavedStateProvider(LIFECYCLE_TAG, new b(this, 1));
        final int i8 = 0;
        addOnConfigurationChangedListener(new Consumer(this) { // from class: u0.a

            /* JADX INFO: renamed from: b, reason: collision with root package name */
            public final /* synthetic */ FragmentActivity f10266b;
            ...
            public final void accept(Object obj) {
                int i9 = i8;
                FragmentActivity fragmentActivity = this.f10266b;
                switch (i9) {
                    case 0:
        ...
        final int i9 = 1;
        addOnNewIntentListener(new Consumer(this) { // from class: u0.a
        ...
        addOnContextAvailableListener(new c(this, i9));
    }
    ...
    public void startActivityFromFragment(@NonNull Fragment fragment, Intent intent, int i8) {
        startActivityFromFragment(fragment, intent, i8, (Bundle) null);
    }

    @Deprecated
    public void startIntentSenderFromFragment(@NonNull Fragment fragment, IntentSender intentSender, int i8, @Nullable Intent intent, int i9, int i10, int i11, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        if (i8 == -1) {
    ...
    public void startActivityFromFragment(@NonNull Fragment fragment, Intent intent, int i8, @Nullable Bundle bundle) {
        if (i8 == -1) {
    ...
    @ContentView
    public FragmentActivity(@LayoutRes int i8) {
        super(i8);
        this.mFragments = FragmentController.createController(new HostCallbacks());
        this.mFragmentLifecycleRegistry = new LifecycleRegistry(this);
        this.mStopped = true;
