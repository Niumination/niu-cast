...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManager.OpGenerator {
    ...
    public void bumpBackStackNesting(int i8) {
        if (this.mAddToBackStack) {
            ...
            for (int i9 = 0; i9 < size; i9++) {
                FragmentTransaction.Op op = this.mOps.get(i9);
        ...
        while (size >= 0) {
            ...
            if (op.mFromExpandedOp) {
                if (op.mCmd == 8) {
                    ...
                    int i8 = op.mFragment.mContainerId;
                    op.mCmd = 2;
                    op.mFromExpandedOp = false;
                    for (int i9 = size - 1; i9 >= 0; i9--) {
                        FragmentTransaction.Op op2 = this.mOps.get(i9);
                        if (op2.mFromExpandedOp && op2.mFragment.mContainerId == i8) {
                            this.mOps.remove(i9);
                            size--;
                        }
                    }
    ...
    public void doAddOp(int i8, Fragment fragment, @Nullable String str, int i9) {
        super.doAddOp(i8, fragment, str, i9);
    ...
    public void executeOps() {
        ...
        for (int i8 = 0; i8 < size; i8++) {
            FragmentTransaction.Op op = this.mOps.get(i8);
            Fragment fragment = op.mFragment;
            if (fragment != null) {
        ...
        while (i8 < this.mOps.size()) {
            ...
            if (i9 == 1) {
                    ...
                    if (fragment4.mContainerId == i10) {
                        if (fragment4 == fragment3) {
                            ...
                            if (fragment4 == fragment2) {
                                this.mOps.add(i8, new FragmentTransaction.Op(9, fragment4, true));
                                i8++;
                                fragment2 = null;
                            }
                ...
                if (fragment5 == fragment2) {
                    this.mOps.add(i8, new FragmentTransaction.Op(9, fragment5));
                    i8++;
                    fragment2 = null;
                }
            } else if (i9 == 7) {
                ...
                this.mOps.add(i8, new FragmentTransaction.Op(9, fragment2, true));
                op.mFromExpandedOp = true;
                i8++;
    ...
    public void runOnCommitRunnables() {
        if (this.mCommitRunnables != null) {
            for (int i8 = 0; i8 < this.mCommitRunnables.size(); i8++) {
                this.mCommitRunnables.get(i8).run();
            }
