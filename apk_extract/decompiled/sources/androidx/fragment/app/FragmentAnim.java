...
class FragmentAnim {
    ...
    private static int getNextAnim(Fragment fragment, boolean z2, boolean z3) {
        if (z3) {
            return z2 ? fragment.getPopEnterAnim() : fragment.getPopExitAnim();
        }
        return z2 ? fragment.getEnterAnim() : fragment.getExitAnim();
    }
    ...
    private static int toActivityTransitResId(@NonNull Context context, int i8) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(android.R.style.Animation.Activity, new int[]{i8});
    ...
    @AnimRes
    private static int transitToAnimResourceId(@NonNull Context context, int i8, boolean z2) {
        if (i8 == 4097) {
    ...
    public static class EndViewTransitionAnimation extends AnimationSet implements Runnable {
        ...
        public boolean getTransformation(long j8, @NonNull Transformation transformation, float f) {
            this.mAnimating = true;
            if (this.mEnded) {
                return !this.mTransitionEnded;
            }
