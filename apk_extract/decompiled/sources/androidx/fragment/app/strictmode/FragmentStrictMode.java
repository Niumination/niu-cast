...
public final class FragmentStrictMode {
    ...
    private final void handlePolicyViolation(Policy policy, Violation violation) {
        ...
        if (policy.getListener() != null) {
            runOnHostThread(fragment, new e(18, policy, violation));
        }
        if (policy.getFlags$fragment_release().contains(Flag.PENALTY_DEATH)) {
            runOnHostThread(fragment, new e(19, name, violation));
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: handlePolicyViolation$lambda-0, reason: not valid java name */
    public static final void m37handlePolicyViolation$lambda0(Policy policy, Violation violation) {
    ...
    public static final void m38handlePolicyViolation$lambda1(String str, Violation violation) {
        Intrinsics.checkNotNullParameter(violation, "$violation");
