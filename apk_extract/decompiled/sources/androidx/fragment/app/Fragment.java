...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    private <I, O> ActivityResultLauncher<I> prepareCallInternal(@NonNull final ActivityResultContract<I, O> activityResultContract, @NonNull final Function<Void, ActivityResultRegistry> function, @NonNull final ActivityResultCallback<O> activityResultCallback) {
        if (this.mState > 1) {
            throw new IllegalStateException(d.k("Fragment ", this, " is attempting to registerForActivityResult after being created. Fragments must call registerForActivityResult() before they are created (i.e. initialization, onAttach(), or onCreate())."));
        }
    ...
    public void dump(@NonNull String str, @Nullable FileDescriptor fileDescriptor, @NonNull PrintWriter printWriter, @Nullable String[] strArr) {
        ...
        this.mChildFragmentManager.dump(a.B(str, "  "), fileDescriptor, printWriter, strArr);
    }
    ...
    public final FragmentManager getChildFragmentManager() {
        ...
        throw new IllegalStateException(d.k("Fragment ", this, " has not been attached yet."));
    }
    ...
    public final FragmentManager getParentFragmentManager() {
        ...
        throw new IllegalStateException(d.k("Fragment ", this, " not associated with a fragment manager."));
    }
    ...
    @NonNull
    public final CharSequence getText(@StringRes int i8) {
    ...
    public void onActivityResult(int i8, int i9, @Nullable Intent intent) {
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.v(FragmentManager.TAG, "Fragment " + this + " received the following in onActivityResult(): requestCode: " + i8 + " resultCode: " + i9 + " data: " + intent);
        }
    }
    ...
    @Nullable
    @MainThread
    public Animation onCreateAnimation(int i8, boolean z2, int i9) {
        return null;
    }

    @Nullable
    @MainThread
    public Animator onCreateAnimator(int i8, boolean z2, int i9) {
        return null;
    }
    ...
    public void performActivityCreated(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(d.k("Fragment ", this, " did not call through to super.onActivityCreated()"));
        }
        restoreViewState();
    ...
    public void performAttach() {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(d.k("Fragment ", this, " did not call through to super.onAttach()"));
        }
    ...
    public void performCreate(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(d.k("Fragment ", this, " did not call through to super.onCreate()"));
        }
    ...
    public void performDestroy() {
        ...
        onDestroy();
        if (!this.mCalled) {
            throw new SuperNotCalledException(d.k("Fragment ", this, " did not call through to super.onDestroy()"));
        }
    }
    ...
    public void performDestroyView() {
        ...
        onDestroyView();
        if (!this.mCalled) {
            throw new SuperNotCalledException(d.k("Fragment ", this, " did not call through to super.onDestroyView()"));
        }
    ...
    public void performDetach() {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(d.k("Fragment ", this, " did not call through to super.onDetach()"));
        }
    ...
    public void performPause() {
        ...
        onPause();
        if (!this.mCalled) {
            throw new SuperNotCalledException(d.k("Fragment ", this, " did not call through to super.onPause()"));
        }
    }
    ...
    public void performResume() {
        ...
        onResume();
        if (!this.mCalled) {
            throw new SuperNotCalledException(d.k("Fragment ", this, " did not call through to super.onResume()"));
        }
    ...
    public void performSaveInstanceState(Bundle bundle) {
        ...
        Bundle bundleSaveAllStateInternal = this.mChildFragmentManager.lambda$attachController$4();
        if (bundleSaveAllStateInternal != null) {
            bundle.putParcelable("android:support:fragments", bundleSaveAllStateInternal);
        }
    }
    ...
    public void performStart() {
        ...
        onStart();
        if (!this.mCalled) {
            throw new SuperNotCalledException(d.k("Fragment ", this, " did not call through to super.onStart()"));
        }
        LifecycleRegistry lifecycleRegistry = this.mLifecycleRegistry;
    ...
    public void performStop() {
        ...
        onStop();
        if (!this.mCalled) {
            throw new SuperNotCalledException(d.k("Fragment ", this, " did not call through to super.onStop()"));
        }
    }
    ...
    public final void requestPermissions(@NonNull String[] strArr, int i8) {
        if (this.mHost == null) {
            throw new IllegalStateException(d.k("Fragment ", this, " not attached to Activity"));
        }
    ...
    public final FragmentActivity requireActivity() {
        ...
        if (fragmentActivityA != null) {
            return fragmentActivityA;
        }
        throw new IllegalStateException(d.k("Fragment ", this, " not attached to an activity."));
    }
    ...
    public final Bundle requireArguments() {
        ...
        throw new IllegalStateException(d.k("Fragment ", this, " does not have any arguments."));
    }
    ...
    public final Context requireContext() {
        ...
        throw new IllegalStateException(d.k("Fragment ", this, " not attached to a context."));
    }
    ...
    public final Object requireHost() {
        ...
        throw new IllegalStateException(d.k("Fragment ", this, " not attached to a host."));
    }
    ...
    public final Fragment requireParentFragment() {
        ...
        if (getContext() == null) {
            throw new IllegalStateException(d.k("Fragment ", this, " is not attached to any Fragment or host"));
        }
    ...
    public final View requireView() {
        ...
        throw new IllegalStateException(d.k("Fragment ", this, " did not return a View from onCreateView() or this was called before onCreateView()."));
    }
    ...
    public final void restoreViewState(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(d.k("Fragment ", this, " did not call through to super.onViewStateRestored()"));
        }
        if (this.mView != null) {
    ...
    public void setAnimations(@AnimRes int i8, @AnimRes int i9, @AnimRes int i10, @AnimRes int i11) {
        if (this.mAnimationInfo == null && i8 == 0 && i9 == 0 && i10 == 0 && i11 == 0) {
            return;
        }
        ensureAnimationInfo().mEnterAnim = i8;
        ensureAnimationInfo().mExitAnim = i9;
        ensureAnimationInfo().mPopEnterAnim = i10;
        ensureAnimationInfo().mPopExitAnim = i11;
    }
    ...
    public void setNextTransition(int i8) {
        ...
        ensureAnimationInfo();
        this.mAnimationInfo.mNextTransition = i8;
    }
    ...
    @Deprecated
    public void setTargetFragment(@Nullable Fragment fragment, int i8) {
        if (fragment != null) {
            FragmentStrictMode.onSetTargetFragmentUsage(this, fragment, i8);
        }
        FragmentManager fragmentManager = this.mFragmentManager;
        FragmentManager fragmentManager2 = fragment != null ? fragment.mFragmentManager : null;
        if (fragmentManager != null && fragmentManager2 != null && fragmentManager != fragmentManager2) {
            throw new IllegalArgumentException(d.k("Fragment ", fragment, " must share the same FragmentManager to be set as a target fragment"));
        }
    ...
    @Deprecated
    public void startIntentSenderForResult(IntentSender intentSender, int i8, @Nullable Intent intent, int i9, int i10, int i11, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        if (this.mHost == null) {
            throw new IllegalStateException(d.k("Fragment ", this, " not attached to Activity"));
        }
        if (FragmentManager.isLoggingEnabled(2)) {
        ...
        getParentFragmentManager().launchStartIntentSenderForResult(this, intentSender, i8, intent, i9, i10, i11, bundle);
    }
    ...
    public static Fragment instantiate(@NonNull Context context, @NonNull String str, @Nullable Bundle bundle) {
        try {
            ...
            throw new InstantiationException(a.j("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e);
        } catch (java.lang.InstantiationException e4) {
            throw new InstantiationException(a.j("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e4);
        } catch (NoSuchMethodException e10) {
            throw new InstantiationException(a.j("Unable to instantiate fragment ", str, ": could not find Fragment constructor"), e10);
        } catch (InvocationTargetException e11) {
            throw new InstantiationException(a.j("Unable to instantiate fragment ", str, ": calling Fragment constructor caused an exception"), e11);
        }
    }

    @NonNull
    public final String getString(@StringRes int i8, @Nullable Object... objArr) {
