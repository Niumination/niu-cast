...
public abstract class FragmentHostCallback<E> extends FragmentContainer {
    ...
    public void onStartActivityFromFragment(@NonNull Fragment fragment, Intent intent, int i8) {
        onStartActivityFromFragment(fragment, intent, i8, null);
    }

    @Deprecated
    public void onStartIntentSenderFromFragment(@NonNull Fragment fragment, IntentSender intentSender, int i8, @Nullable Intent intent, int i9, int i10, int i11, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        if (i8 != -1) {
    ...
    public void onStartActivityFromFragment(@NonNull Fragment fragment, Intent intent, int i8, @Nullable Bundle bundle) {
        if (i8 != -1) {
    ...
    public FragmentHostCallback(@Nullable Activity activity, @NonNull Context context, @NonNull Handler handler, int i8) {
