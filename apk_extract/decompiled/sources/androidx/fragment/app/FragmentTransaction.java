...
public abstract class FragmentTransaction {
    ...
    public static final class Op {
        ...
        public Op(int i8, Fragment fragment, boolean z2) {
            this.mCmd = i8;
            this.mFragment = fragment;
        ...
        public Op(int i8, @NonNull Fragment fragment, Lifecycle.State state) {
            this.mCmd = i8;
            this.mFragment = fragment;
            this.mFromExpandedOp = false;
        ...
        if (FragmentTransition.supportsTransition()) {
            ...
            if (this.mSharedElementSourceNames == null) {
                ...
                if (this.mSharedElementTargetNames.contains(str)) {
                    throw new IllegalArgumentException(a.j("A shared element with the target name '", str, "' has already been added to the transaction."));
                }
                if (this.mSharedElementSourceNames.contains(transitionName)) {
                    throw new IllegalArgumentException(a.j("A shared element with the source name '", transitionName, "' has already been added to the transaction."));
                }
            }
