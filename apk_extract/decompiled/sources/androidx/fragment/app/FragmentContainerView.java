...
public final class FragmentContainerView extends FrameLayout {
    ...
    public static final class Api20Impl {
        ...
        public final WindowInsets onApplyWindowInsets(View.OnApplyWindowInsetsListener onApplyWindowInsetsListener, View v3, WindowInsets insets) {
            ...
            WindowInsets windowInsetsOnApplyWindowInsets = onApplyWindowInsetsListener.onApplyWindowInsets(v3, insets);
    ...
    private final void addDisappearingFragmentView(View v3) {
        if (this.transitioningFragmentViews.contains(v3)) {
            this.disappearingFragmentChildren.add(v3);
        }
    }
    ...
    public WindowInsets dispatchApplyWindowInsets(WindowInsets insets) {
        ...
        if (!windowInsetsCompatOnApplyWindowInsets.isConsumed()) {
            ...
            for (int i8 = 0; i8 < childCount; i8++) {
                ViewCompat.dispatchApplyWindowInsets(getChildAt(i8), windowInsetsCompatOnApplyWindowInsets);
            }
        }
        return insets;
    }
