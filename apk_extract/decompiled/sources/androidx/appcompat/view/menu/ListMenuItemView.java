...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView, AbsListView.SelectionBoundsAdjuster {
    ...
    public void setShortcut(boolean z2, char c9) {
        int i8 = (z2 && this.mItemData.shouldShowShortcut()) ? 0 : 8;
        if (i8 == 0) {
    ...
    public ListMenuItemView(Context context, AttributeSet attributeSet, int i8) {
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(getContext(), attributeSet, R.styleable.MenuView, i8, 0);
