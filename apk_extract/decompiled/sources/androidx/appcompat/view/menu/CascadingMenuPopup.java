...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
        ...
        public void onItemHoverEnter(@NonNull final MenuBuilder menuBuilder, @NonNull final MenuItem menuItem) {
            ...
            while (true) {
                if (i8 >= size) {
                    i8 = -1;
                    break;
                } else if (menuBuilder == CascadingMenuPopup.this.mShowingMenus.get(i8).menu) {
                    break;
                } else {
                    i8++;
                }
            ...
            int i9 = i8 + 1;
            final CascadingMenuInfo cascadingMenuInfo = i9 < CascadingMenuPopup.this.mShowingMenus.size() ? CascadingMenuPopup.this.mShowingMenus.get(i9) : null;
    ...
    public CascadingMenuPopup(@NonNull Context context, @NonNull View view, @AttrRes int i8, @StyleRes int i9, boolean z2) {
    ...
    private View findParentViewForSubmenu(@NonNull CascadingMenuInfo cascadingMenuInfo, @NonNull MenuBuilder menuBuilder) {
        ...
        while (true) {
            ...
            if (menuItemFindMenuItemForSubmenu == menuAdapter.getItem(i8)) {
                break;
            }
            i8++;
        }
    ...
    private int getNextMenuPosition(int i8) {
        ListView listView = ((CascadingMenuInfo) a.j(1, this.mShowingMenus)).getListView();
        int[] iArr = new int[2];
        listView.getLocationOnScreen(iArr);
        Rect rect = new Rect();
        this.mShownAnchorView.getWindowVisibleDisplayFrame(rect);
        if (this.mLastPosition == 1) {
            return (listView.getWidth() + iArr[0]) + i8 > rect.right ? 0 : 1;
        }
        return iArr[0] - i8 < 0 ? 1 : 0;
    }
    ...
    private void showMenu(@NonNull MenuBuilder menuBuilder) {
        ...
        if (this.mShowingMenus.size() > 0) {
            cascadingMenuInfo = (CascadingMenuInfo) a.j(1, this.mShowingMenus);
    ...
    public ListView getListView() {
        ...
        return ((CascadingMenuInfo) a.j(1, this.mShowingMenus)).getListView();
    }
    ...
    public void onCloseMenu(MenuBuilder menuBuilder, boolean z2) {
        ...
        int i8 = iFindIndexOfAddedMenu + 1;
