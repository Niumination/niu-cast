...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    private static void appendModifier(StringBuilder sb2, int i8, int i9, String str) {
        if ((i8 & i9) == i9) {
            sb2.append(str);
        }
    }
    ...
    public String getShortcutLabel() {
        ...
        int i8 = this.mMenu.isQwertyMode() ? this.mShortcutAlphabeticModifiers : this.mShortcutNumericModifiers;
        appendModifier(sb2, i8, 65536, resources.getString(R.string.abc_menu_meta_shortcut_label));
        appendModifier(sb2, i8, 4096, resources.getString(R.string.abc_menu_ctrl_shortcut_label));
        appendModifier(sb2, i8, 2, resources.getString(R.string.abc_menu_alt_shortcut_label));
        appendModifier(sb2, i8, 1, resources.getString(R.string.abc_menu_shift_shortcut_label));
        appendModifier(sb2, i8, 4, resources.getString(R.string.abc_menu_sym_shortcut_label));
        appendModifier(sb2, i8, 8, resources.getString(R.string.abc_menu_function_shortcut_label));
        if (shortcut == '\b') {
    ...
    public MenuItem setAlphabeticShortcut(char c9, int i8) {
        if (this.mShortcutAlphabeticChar == c9 && this.mShortcutAlphabeticModifiers == i8) {
            return this;
        }
        this.mShortcutAlphabeticChar = Character.toLowerCase(c9);
    ...
    public MenuItem setNumericShortcut(char c9, int i8) {
        if (this.mShortcutNumericChar == c9 && this.mShortcutNumericModifiers == i8) {
            return this;
        }
        this.mShortcutNumericChar = c9;
