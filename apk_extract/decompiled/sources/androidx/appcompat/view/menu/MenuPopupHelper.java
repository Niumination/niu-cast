...
public class MenuPopupHelper implements MenuHelper {
    ...
    private void showPopup(int i8, int i9, boolean z2, boolean z3) {
        ...
        if (z2) {
            ...
            int i10 = (int) ((this.mContext.getResources().getDisplayMetrics().density * 48.0f) / 2.0f);
    ...
    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menuBuilder, @NonNull View view, boolean z2, @AttrRes int i8) {
        this(context, menuBuilder, view, z2, i8, 0);
    }
    ...
    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menuBuilder, @NonNull View view, boolean z2, @AttrRes int i8, @StyleRes int i9) {
