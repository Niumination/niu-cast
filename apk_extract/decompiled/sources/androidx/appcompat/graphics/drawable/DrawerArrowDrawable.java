...
public class DrawerArrowDrawable extends Drawable {
    ...
    private static float lerp(float f, float f4, float f10) {
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        float f10 = this.mBarGap;
        canvas.translate(bounds.centerX(), (strokeWidth * 1.5f) + f10 + ((((int) (fHeight - (2.0f * f10))) / 4) * 2));
        if (this.mSpin) {
