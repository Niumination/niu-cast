...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class Api29Impl {
        ...
        @DoNotInline
        public static void setInputMethodMode(SearchAutoComplete searchAutoComplete, int i8) {
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public void setImeVisibility(boolean z2) {
            InputMethodManager inputMethodManager = (InputMethodManager) getContext().getSystemService(TCCPSourceApi.KEY_FEATURE_INPUT_METHOD);
            if (!z2) {
        ...
        public void showSoftInputIfNecessary() {
            if (this.mHasPendingShowSoftInputRequest) {
                ((InputMethodManager) getContext().getSystemService(TCCPSourceApi.KEY_FEATURE_INPUT_METHOD)).showSoftInput(this, 0);
                this.mHasPendingShowSoftInputRequest = false;
            }
        }
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (action != 0) {
                if (action == 1 || action == 2) {
                    ...
                    if (z3 && !this.mSlopBounds.contains(x2, y3)) {
                        z5 = z3;
                        z2 = false;
                    }
                } else if (action != 3) {
                ...
                z5 = z3;
                z2 = true;
            } else if (this.mTargetBounds.contains(x2, y3)) {
            ...
            if (!z2 || this.mActualBounds.contains(x2, y3)) {
    ...
    private Intent createIntentFromSuggestion(Cursor cursor, int i8, String str) {
        ...
        try {
            ...
            return createIntent(str2, columnString3 == null ? null : Uri.parse(columnString3), SuggestionsAdapter.getColumnString(cursor, "suggest_intent_extra_data"), SuggestionsAdapter.getColumnString(cursor, "suggest_intent_query"), i8, str);
    ...
    public void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            if (this.mIconifiedByDefault) {
                dimensionPixelSize = resources.getDimensionPixelSize(androidx.appcompat.R.dimen.abc_dropdownitem_text_padding_left) + resources.getDimensionPixelSize(androidx.appcompat.R.dimen.abc_dropdownitem_icon_width);
            } else {
    ...
    public void launchQuerySearch(int i8, String str, String str2) {
    ...
    public boolean onItemClicked(int i8, int i9, String str) {
    ...
    public boolean onItemSelected(int i8) {
        OnSuggestionListener onSuggestionListener = this.mOnSuggestionListener;
    ...
    public void onMeasure(int i8, int i9) {
        ...
        } else if (mode == 1073741824 && (i10 = this.mMaxWidth) > 0) {
    ...
    public boolean onSuggestionsKey(View view, int i8, KeyEvent keyEvent) {
        if (this.mSearchable != null && this.mSuggestionsAdapter != null && keyEvent.getAction() == 0 && keyEvent.hasNoModifiers()) {
            if (i8 == 66 || i8 == 84 || i8 == 61) {
                return onItemClicked(this.mSearchSrcTextView.getListSelection(), 0, null);
            }
            if (i8 == 21 || i8 == 22) {
                this.mSearchSrcTextView.setSelection(i8 == 21 ? 0 : this.mSearchSrcTextView.length());
    ...
    public boolean requestFocus(int i8, Rect rect) {
        ...
        boolean zRequestFocus = this.mSearchSrcTextView.requestFocus(i8, rect);
        if (zRequestFocus) {
            updateViewsVisibility(false);
        }
    ...
    public SearchView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i8) {
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, androidx.appcompat.R.styleable.SearchView, i8, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, androidx.appcompat.R.styleable.SearchView, attributeSet, tintTypedArrayObtainStyledAttributes.getWrappedTypeArray(), i8, 0);
        ...
        int i9 = tintTypedArrayObtainStyledAttributes.getInt(androidx.appcompat.R.styleable.SearchView_android_imeOptions, -1);
        if (i9 != -1) {
            setImeOptions(i9);
        }
        int i10 = tintTypedArrayObtainStyledAttributes.getInt(androidx.appcompat.R.styleable.SearchView_android_inputType, -1);
        if (i10 != -1) {
            setInputType(i10);
        }
