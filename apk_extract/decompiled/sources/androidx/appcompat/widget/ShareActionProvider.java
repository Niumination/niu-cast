...
public class ShareActionProvider extends ActionProvider {
    ...
    public void onPrepareSubMenu(SubMenu subMenu) {
        ...
        for (int i8 = 0; i8 < iMin; i8++) {
            ResolveInfo activity = activityChooserModel.getActivity(i8);
            subMenu.add(0, i8, i8, activity.loadLabel(packageManager)).setIcon(activity.loadIcon(packageManager)).setOnMenuItemClickListener(this.mOnMenuItemClickListener);
        }
        if (iMin < activityCount) {
            ...
            for (int i9 = 0; i9 < activityCount; i9++) {
                ResolveInfo activity2 = activityChooserModel.getActivity(i9);
                subMenuAddSubMenu.add(0, i9, i9, activity2.loadLabel(packageManager)).setIcon(activity2.loadIcon(packageManager)).setOnMenuItemClickListener(this.mOnMenuItemClickListener);
            }
        }
    }
