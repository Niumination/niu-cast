...
class TooltipPopup {
    ...
    private void computePosition(View view, int i8, int i9, boolean z2, WindowManager.LayoutParams layoutParams) {
        int height;
        int i10;
        ...
        layoutParams.x = (i12 + i8) - (appRootView.getWidth() / 2);
        ...
        if (measuredHeight + i15 <= this.mTmpDisplayFrame.height()) {
            layoutParams.y = i15;
        } else {
            layoutParams.y = i14;
        }
    ...
    public void show(View view, int i8, int i9, boolean z2, CharSequence charSequence) {
        if (isShowing()) {
            hide();
        }
        this.mMessageView.setText(charSequence);
        computePosition(view, i8, i9, z2, this.mLayoutParams);
