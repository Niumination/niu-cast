...
public class AppCompatCheckedTextView extends CheckedTextView implements TintableCheckedTextView, TintableBackgroundView, EmojiCompatConfigurationView, TintableCompoundDrawablesView {
    ...
    public AppCompatCheckedTextView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i8) {
        ...
        appCompatCheckedTextViewHelper.loadFromAttributes(attributeSet, i8);
        getEmojiTextViewHelper().loadFromAttributes(attributeSet, i8);
    }

    @Override // android.widget.CheckedTextView
    public void setCheckMarkDrawable(@DrawableRes int i8) {
        setCheckMarkDrawable(AppCompatResources.getDrawable(getContext(), i8));
    }
}
