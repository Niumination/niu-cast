...
public final class ResourceManagerInternal {
    ...
    public static class ColorFilterLruCache extends LruCache<Integer, PorterDuffColorFilter> {
        ...
        public PorterDuffColorFilter get(int i8, PorterDuff.Mode mode) {
            return get(Integer.valueOf(generateCacheKey(i8, mode)));
        }

        public PorterDuffColorFilter put(int i8, PorterDuff.Mode mode, PorterDuffColorFilter porterDuffColorFilter) {
    ...
    private Drawable createDrawableIfNeeded(@NonNull Context context, @DrawableRes int i8) {
        ...
        Drawable drawableCreateDrawableFor = resourceManagerHooks == null ? null : resourceManagerHooks.createDrawableFor(this, context, i8);
    ...
    private Drawable tintDrawable(@NonNull Context context, @DrawableRes int i8, boolean z2, @NonNull Drawable drawable) {
        ...
        ResourceManagerHooks resourceManagerHooks = this.mHooks;
        if ((resourceManagerHooks == null || !resourceManagerHooks.tintDrawable(context, i8, drawable)) && !tintDrawableUsingColorFilter(context, i8, drawable) && z2) {
            return null;
        }
        return drawable;
    }
    ...
    public synchronized ColorStateList getTintList(@NonNull Context context, @DrawableRes int i8) {
        ...
        if (tintListFromCache == null) {
            ResourceManagerHooks resourceManagerHooks = this.mHooks;
            tintListFromCache = resourceManagerHooks == null ? null : resourceManagerHooks.getTintListForDrawableRes(context, i8);
            if (tintListFromCache != null) {
    ...
    public PorterDuff.Mode getTintMode(int i8) {
        ResourceManagerHooks resourceManagerHooks = this.mHooks;
    ...
    public synchronized Drawable onDrawableLoadedFromResources(@NonNull Context context, @NonNull VectorEnabledTintResources vectorEnabledTintResources, @DrawableRes int i8) {
        try {
            Drawable drawableLoadDrawableFromDelegates = loadDrawableFromDelegates(context, i8);
            if (drawableLoadDrawableFromDelegates == null) {
                drawableLoadDrawableFromDelegates = vectorEnabledTintResources.getDrawableCanonical(i8);
            }
            if (drawableLoadDrawableFromDelegates == null) {
                return null;
            }
            return tintDrawable(context, i8, false, drawableLoadDrawableFromDelegates);
        } catch (Throwable th2) {
            throw th2;
        }
    }
    ...
    public boolean tintDrawableUsingColorFilter(@NonNull Context context, @DrawableRes int i8, @NonNull Drawable drawable) {
        ResourceManagerHooks resourceManagerHooks = this.mHooks;
        return resourceManagerHooks != null && resourceManagerHooks.tintDrawableUsingColorFilter(context, i8, drawable);
    }

    public synchronized Drawable getDrawable(@NonNull Context context, @DrawableRes int i8, boolean z2) {
        Drawable drawableLoadDrawableFromDelegates;
        try {
            checkVectorDrawableSetup(context);
            drawableLoadDrawableFromDelegates = loadDrawableFromDelegates(context, i8);
            if (drawableLoadDrawableFromDelegates == null) {
                drawableLoadDrawableFromDelegates = createDrawableIfNeeded(context, i8);
            }
            if (drawableLoadDrawableFromDelegates == null) {
                drawableLoadDrawableFromDelegates = ContextCompat.getDrawable(context, i8);
            }
            if (drawableLoadDrawableFromDelegates != null) {
                drawableLoadDrawableFromDelegates = tintDrawable(context, i8, z2, drawableLoadDrawableFromDelegates);
            }
            if (drawableLoadDrawableFromDelegates != null) {
