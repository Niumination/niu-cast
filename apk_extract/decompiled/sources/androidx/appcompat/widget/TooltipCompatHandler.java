...
class TooltipCompatHandler implements View.OnLongClickListener, View.OnHoverListener, View.OnAttachStateChangeListener {
    ...
    private TooltipCompatHandler(View view, CharSequence charSequence) {
        final int i8 = 0;
        this.mShowRunnable = new Runnable(this) { // from class: androidx.appcompat.widget.a

            /* JADX INFO: renamed from: b, reason: collision with root package name */
            public final /* synthetic */ TooltipCompatHandler f818b;
            ...
            public final void run() {
                int i9 = i8;
                TooltipCompatHandler tooltipCompatHandler = this.f818b;
                switch (i9) {
                    case 0:
        ...
        final int i9 = 1;
        this.mHideRunnable = new Runnable(this) { // from class: androidx.appcompat.widget.a
    ...
    private boolean updateAnchorPos(MotionEvent motionEvent) {
        ...
        if (!this.mForceNextChangeSignificant && Math.abs(x2 - this.mAnchorX) <= this.mHoverSlop && Math.abs(y3 - this.mAnchorY) <= this.mHoverSlop) {
            return false;
        }
        this.mAnchorX = x2;
        this.mAnchorY = y3;
