...
public abstract class ForwardingListener implements View.OnTouchListener, View.OnAttachStateChangeListener {
    ...
    private static boolean pointInView(View view, float f, float f4, float f10) {
        float f11 = -f10;
        return f >= f11 && f4 >= f11 && f < ((float) (view.getRight() - view.getLeft())) + f10 && f4 < ((float) (view.getBottom() - view.getTop())) + f10;
    }
