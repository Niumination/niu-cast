...
abstract class AbsActionBarView extends ViewGroup {
    ...
    public class VisibilityAnimListener implements ViewPropertyAnimatorListener {
        ...
        public VisibilityAnimListener withFinalVisibility(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, int i8) {
    ...
    public static int next(int i8, int i9, boolean z2) {
    ...
    public int measureChildView(View view, int i8, int i9, int i10) {
    ...
    public int positionChild(View view, int i8, int i9, int i10, boolean z2) {
        int measuredWidth = view.getMeasuredWidth();
        int measuredHeight = view.getMeasuredHeight();
        int iD = a1.a.d(i10, measuredHeight, 2, i9);
        if (z2) {
            view.layout(i8 - measuredWidth, iD, i8, measuredHeight + iD);
        } else {
            view.layout(i8, iD, i8 + measuredWidth, measuredHeight + iD);
        }
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(int i8, long j8) {
        ViewPropertyAnimatorCompat viewPropertyAnimatorCompat = this.mVisibilityAnim;
        if (viewPropertyAnimatorCompat != null) {
            viewPropertyAnimatorCompat.cancel();
        }
        if (i8 != 0) {
            ...
            viewPropertyAnimatorCompatAlpha.setDuration(j8);
            viewPropertyAnimatorCompatAlpha.setListener(this.mVisAnimListener.withFinalVisibility(viewPropertyAnimatorCompatAlpha, i8));
        ...
        viewPropertyAnimatorCompatAlpha2.setDuration(j8);
        viewPropertyAnimatorCompatAlpha2.setListener(this.mVisAnimListener.withFinalVisibility(viewPropertyAnimatorCompatAlpha2, i8));
    ...
    public AbsActionBarView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i8) {
