...
public class AppCompatImageHelper {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i8) {
        int resourceId;
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), attributeSet, R.styleable.AppCompatImageView, i8, 0);
        ImageView imageView = this.mView;
        ViewCompat.saveAttributeDataForStyleable(imageView, imageView.getContext(), R.styleable.AppCompatImageView, attributeSet, tintTypedArrayObtainStyledAttributes.getWrappedTypeArray(), i8, 0);
        try {
            Drawable drawable = this.mView.getDrawable();
    ...
    public void setImageResource(int i8) {
        if (i8 != 0) {
            Drawable drawable = AppCompatResources.getDrawable(this.mView.getContext(), i8);
            if (drawable != null) {
                DrawableUtils.fixDrawable(drawable);
            }
            this.mView.setImageDrawable(drawable);
