...
public class ThemeUtils {
    ...
    public static ColorStateList createDisabledStateList(int i8, int i9) {
        return new ColorStateList(new int[][]{DISABLED_STATE_SET, EMPTY_STATE_SET}, new int[]{i9, i8});
    }
    ...
    public static int getThemeAttrColor(@NonNull Context context, int i8, float f) {
        int themeAttrColor = getThemeAttrColor(context, i8);
