...
public final class AppCompatDrawableManager {
    ...
    public static synchronized PorterDuffColorFilter getPorterDuffColorFilter(int i8, PorterDuff.Mode mode) {
        return ResourceManagerInternal.getPorterDuffColorFilter(i8, mode);
    }
        ...
        if (INSTANCE == null) {
            ...
            INSTANCE.mResourceManager.setHooks(new ResourceManagerInternal.ResourceManagerHooks() { // from class: androidx.appcompat.widget.AppCompatDrawableManager.1
                ...
                private void setPorterDuffColorFilter(Drawable drawable, int i8, PorterDuff.Mode mode) {
                    ...
                    drawableMutate.setColorFilter(AppCompatDrawableManager.getPorterDuffColorFilter(i8, mode));
                }
                    ...
                    if (arrayContains(this.COLORFILTER_TINT_COLOR_CONTROL_NORMAL, i8)) {
                        ...
                        if (!arrayContains(this.COLORFILTER_COLOR_BACKGROUND_MULTIPLY, i8)) {
                            if (i8 == R.drawable.abc_list_divider_mtrl_alpha) {
                                ...
                                if (i8 != R.drawable.abc_dialog_material_background) {
                                    i9 = 0;
                                    z2 = false;
                                }
                                iRound = -1;
                            ...
                            drawableMutate.setColorFilter(AppCompatDrawableManager.getPorterDuffColorFilter(ThemeUtils.getThemeAttrColor(context, i9), mode));
                            if (iRound != -1) {
    ...
    public synchronized Drawable getDrawable(@NonNull Context context, @DrawableRes int i8, boolean z2) {
        return this.mResourceManager.getDrawable(context, i8, z2);
    }
}
