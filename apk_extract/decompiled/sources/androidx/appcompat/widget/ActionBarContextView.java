...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public void onLayout(boolean z2, int i8, int i9, int i10, int i11) {
        ...
        if (view != null && view.getVisibility() != 8) {
            ...
            int next = AbsActionBarView.next(paddingRight, i12, zIsLayoutRtl);
            paddingRight = AbsActionBarView.next(next + positionChild(this.mClose, next, paddingTop, paddingTop2, zIsLayoutRtl), i13, zIsLayoutRtl);
        }
        ...
        int i14 = iPositionChild;
        View view2 = this.mCustomView;
        if (view2 != null) {
            positionChild(view2, i14, paddingTop, paddingTop2, zIsLayoutRtl);
        }
    ...
    public void onMeasure(int i8, int i9) {
        ...
        if (view2 != null) {
            ...
            this.mCustomView.measure(View.MeasureSpec.makeMeasureSpec(paddingLeft, i12), View.MeasureSpec.makeMeasureSpec(iMin, i10));
        }
    ...
    public ActionBarContextView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i8) {
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, R.styleable.ActionMode, i8, 0);
