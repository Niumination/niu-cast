...
class AppCompatTextViewAutoSizeHelper {
    ...
    public static final class Api23Impl {
        ...
        @NonNull
        @DoNotInline
        public static StaticLayout createStaticLayoutForMeasuring(@NonNull CharSequence charSequence, @NonNull Layout.Alignment alignment, int i8, int i9, @NonNull TextView textView, @NonNull TextPaint textPaint, @NonNull Impl impl) {
        ...
        if (supportsAutoSizeText() && this.mAutoSizeTextType == 1) {
            if (!this.mHasPresetAutoSizeValues || this.mAutoSizeTextSizesInPx.length == 0) {
                ...
                for (int i8 = 0; i8 < iFloor; i8++) {
                    iArr[i8] = Math.round((i8 * this.mAutoSizeStepGranularityInPx) + this.mAutoSizeMinTextSizeInPx);
                }
    ...
    private void validateAndSetAutoSizeTextTypeUniformConfiguration(float f, float f4, float f10) throws IllegalArgumentException {
        if (f <= 0.0f) {
        ...
        this.mAutoSizeMaxTextSizeInPx = f4;
    ...
    @NonNull
    @VisibleForTesting
    public StaticLayout createLayout(@NonNull CharSequence charSequence, @NonNull Layout.Alignment alignment, int i8, int i9) {
    ...
    @VisibleForTesting
    public void initTempTextPaint(int i8) {
    ...
    public void loadFromAttributes(@Nullable AttributeSet attributeSet, int i8) {
        int resourceId;
        TypedArray typedArrayObtainStyledAttributes = this.mContext.obtainStyledAttributes(attributeSet, R.styleable.AppCompatTextView, i8, 0);
        TextView textView = this.mTextView;
        ViewCompat.saveAttributeDataForStyleable(textView, textView.getContext(), R.styleable.AppCompatTextView, attributeSet, typedArrayObtainStyledAttributes, i8, 0);
    ...
    public void setAutoSizeTextTypeWithDefaults(int i8) {
        if (supportsAutoSizeText()) {
            ...
            if (i8 != 1) {
                throw new IllegalArgumentException(a1.a.o(i8, "Unknown auto-size text type: "));
            }
            DisplayMetrics displayMetrics = this.mContext.getResources().getDisplayMetrics();
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public void setTextSizeInternal(int i8, float f) {
        Context context = this.mContext;
        setRawTextSize(TypedValue.applyDimension(i8, f, (context == null ? Resources.getSystem() : context.getResources()).getDisplayMetrics()));
    }
}
