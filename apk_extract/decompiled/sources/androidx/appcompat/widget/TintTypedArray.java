...
public class TintTypedArray {
    ...
    public boolean getBoolean(int i8, boolean z2) {
        return this.mWrapped.getBoolean(i8, z2);
    }
    ...
    public ColorStateList getColorStateList(int i8) {
        ...
        return (!this.mWrapped.hasValue(i8) || (resourceId = this.mWrapped.getResourceId(i8, 0)) == 0 || (colorStateList = AppCompatResources.getColorStateList(this.mContext, resourceId)) == null) ? this.mWrapped.getColorStateList(i8) : colorStateList;
    }

    public float getDimension(int i8, float f) {
        return this.mWrapped.getDimension(i8, f);
    }
    ...
    public Drawable getDrawable(int i8) {
        int resourceId;
        return (!this.mWrapped.hasValue(i8) || (resourceId = this.mWrapped.getResourceId(i8, 0)) == 0) ? this.mWrapped.getDrawable(i8) : AppCompatResources.getDrawable(this.mContext, resourceId);
    }
    ...
    public float getFloat(int i8, float f) {
        return this.mWrapped.getFloat(i8, f);
    }
    ...
    public float getFraction(int i8, int i9, int i10, float f) {
        return this.mWrapped.getFraction(i8, i9, i10, f);
    }
