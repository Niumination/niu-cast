...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public void animateToVisibility(int i8) {
        ViewPropertyAnimatorCompat viewPropertyAnimatorCompat = setupAnimatorToVisibility(i8, DEFAULT_FADE_DURATION_MS);
    ...
    public void setDefaultNavigationContentDescription(int i8) {
        if (i8 == this.mDefaultNavigationContentDescription) {
            return;
        }
        this.mDefaultNavigationContentDescription = i8;
    ...
    public void setDisplayOptions(int i8) {
        View view;
        int i9 = this.mDisplayOpts ^ i8;
        this.mDisplayOpts = i8;
        if (i9 != 0) {
            if ((i9 & 4) != 0) {
                if ((i8 & 4) != 0) {
    ...
    public void setLogo(int i8) {
        setLogo(i8 != 0 ? AppCompatResources.getDrawable(getContext(), i8) : null);
    }
    ...
    public void setNavigationMode(int i8) {
        ...
        if (i8 != i9) {
            ...
            } else if (i9 == 2 && (view = this.mTabView) != null) {
            ...
            if (i8 != 0) {
                if (i8 == 1) {
                    ...
                    if (i8 != 2) {
                        throw new IllegalArgumentException(a1.a.o(i8, "Invalid navigation mode "));
                    }
    ...
    @Override // androidx.appcompat.widget.DecorToolbar
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(final int i8, long j8) {
        return ViewCompat.animate(this.mToolbar).alpha(i8 == 0 ? 1.0f : 0.0f).setDuration(j8).setListener(new ViewPropertyAnimatorListenerAdapter() { // from class: androidx.appcompat.widget.ToolbarWidgetWrapper.2
            ...
            public void onAnimationEnd(View view) {
                ...
                ToolbarWidgetWrapper.this.mToolbar.setVisibility(i8);
            }
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean z2, int i8, int i9) {
        Drawable drawable;
    ...
    public void setNavigationIcon(int i8) {
        setNavigationIcon(i8 != 0 ? AppCompatResources.getDrawable(getContext(), i8) : null);
    }
}
