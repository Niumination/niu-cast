...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private Drawable getActivityIcon(ComponentName componentName) {
        ...
        try {
            ...
            StringBuilder sbU = a1.a.u(iconResource, "Invalid icon resource ", " for ");
            sbU.append(componentName.flattenToShortString());
            Log.w(LOG_TAG, sbU.toString());
            return null;
    ...
    private Drawable getDrawable(Uri uri) {
        try {
            ...
            Log.w(LOG_TAG, "Icon not found: " + uri + ", " + e10.getMessage());
            return null;
        }
        Log.w(LOG_TAG, "Icon not found: " + uri + ", " + e10.getMessage());
        return null;
    ...
    private Drawable getDrawableFromResourceValue(String str) {
        ...
        try {
            ...
            String str2 = "android.resource://" + this.mProviderContext.getPackageName() + "/" + i8;
            Drawable drawableCheckIconCache = checkIconCache(str2);
            if (drawableCheckIconCache != null) {
                return drawableCheckIconCache;
            }
            Drawable drawable = ContextCompat.getDrawable(this.mProviderContext, i8);
    ...
    private Drawable getIcon1(Cursor cursor) {
        int i8 = this.mIconName1Col;
        if (i8 == -1) {
            return null;
        }
        Drawable drawableFromResourceValue = getDrawableFromResourceValue(cursor.getString(i8));
        return drawableFromResourceValue != null ? drawableFromResourceValue : getDefaultIcon1();
    }

    private Drawable getIcon2(Cursor cursor) {
        int i8 = this.mIconName2Col;
        if (i8 == -1) {
            return null;
        }
        return getDrawableFromResourceValue(cursor.getString(i8));
    }

    private static String getStringOrNull(Cursor cursor, int i8) {
        if (i8 == -1) {
            return null;
        }
        try {
    ...
    private void setViewDrawable(ImageView imageView, Drawable drawable, int i8) {
    ...
    public Cursor getSearchManagerSuggestions(SearchableInfo searchableInfo, String str, int i8) {
