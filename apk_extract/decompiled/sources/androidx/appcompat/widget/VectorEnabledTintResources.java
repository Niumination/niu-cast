...
public class VectorEnabledTintResources extends ResourcesWrapper {
    ...
    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ void getValue(int i8, TypedValue typedValue, boolean z2) throws Resources.NotFoundException {
        super.getValue(i8, typedValue, z2);
    }

    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ void getValueForDensity(int i8, int i9, TypedValue typedValue, boolean z2) throws Resources.NotFoundException {
        super.getValueForDensity(i8, i9, typedValue, z2);
    }
    ...
    public Drawable getDrawable(int i8) throws Resources.NotFoundException {
        ...
        return context != null ? ResourceManagerInternal.get().onDrawableLoadedFromResources(context, this, i8) : getDrawableCanonical(i8);
    }
