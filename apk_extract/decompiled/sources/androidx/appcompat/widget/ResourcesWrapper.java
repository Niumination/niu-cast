...
class ResourcesWrapper extends Resources {
    ...
    @Override // android.content.res.Resources
    public void getValue(int i8, TypedValue typedValue, boolean z2) throws Resources.NotFoundException {
        this.mResources.getValue(i8, typedValue, z2);
    }

    @Override // android.content.res.Resources
    public void getValueForDensity(int i8, int i9, TypedValue typedValue, boolean z2) throws Resources.NotFoundException {
        this.mResources.getValueForDensity(i8, i9, typedValue, z2);
    }
