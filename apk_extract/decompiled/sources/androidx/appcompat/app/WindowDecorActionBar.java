...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    public static boolean checkShowingFlags(boolean z2, boolean z3, boolean z5) {
        if (z5) {
            return true;
        }
    ...
    public void animateToMode(boolean z2) {
        ...
        if (z2) {
            ...
            ViewPropertyAnimatorCompat viewPropertyAnimatorCompat3 = this.mDecorToolbar.setupAnimatorToVisibility(0, FADE_IN_DURATION_MS);
    ...
    public void dispatchMenuVisibilityChanged(boolean z2) {
        ...
        for (int i8 = 0; i8 < size; i8++) {
            this.mMenuVisibilityListeners.get(i8).onMenuVisibilityChanged(z2);
        }
    }
    ...
    public void removeTabAt(int i8) {
        ...
        TabImpl tabImplRemove = this.mTabs.remove(i8);
        if (tabImplRemove != null) {
            tabImplRemove.setPosition(-1);
        }
        int size = this.mTabs.size();
        for (int i9 = i8; i9 < size; i9++) {
            this.mTabs.get(i9).setPosition(i9);
        }
        if (position == i8) {
    ...
    public void setNavigationMode(int i8) {
        ...
        this.mDecorToolbar.setCollapsible(i8 == 2 && !this.mHasEmbeddedTabs);
    ...
    @Override // androidx.appcompat.app.ActionBar
    public void addTab(ActionBar.Tab tab, int i8, boolean z2) {
        ensureTabsExist();
        this.mTabScrollView.addTab(tab, i8, z2);
        configureTab(tab, i8);
        if (z2) {
            selectTab(tab);
        }
