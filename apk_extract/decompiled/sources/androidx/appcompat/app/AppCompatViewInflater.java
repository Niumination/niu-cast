...
public class AppCompatViewInflater {
    ...
    private View createViewFromTag(Context context, String str, AttributeSet attributeSet) {
        ...
        try {
            ...
            while (true) {
                ...
                View viewCreateViewByPrefix = createViewByPrefix(context, str, strArr[i8]);
    ...
    @Nullable
    public final View createView(@Nullable View view, @NonNull String str, @NonNull Context context, @NonNull AttributeSet attributeSet, boolean z2, boolean z3, boolean z5, boolean z10) {
        View viewCreateRatingBar;
        Context context2 = (!z2 || view == null) ? context : view.getContext();
        if (z3 || z5) {
            context2 = themifyContext(context2, attributeSet, z3, z5);
        }
        if (z10) {
