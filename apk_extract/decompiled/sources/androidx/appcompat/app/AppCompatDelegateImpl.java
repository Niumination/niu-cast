...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public class AppCompatWindowCallback extends WindowCallbackWrapper {
        ...
        public View onCreatePanelView(int i8) {
            ...
            return (actionBarMenuCallback == null || (viewOnCreatePanelView = actionBarMenuCallback.onCreatePanelView(i8)) == null) ? super.onCreatePanelView(i8) : viewOnCreatePanelView;
        }
        ...
        public boolean onPreparePanel(int i8, View view, Menu menu) {
            ...
            ActionBarMenuCallback actionBarMenuCallback = this.mActionBarCallback;
            boolean zOnPreparePanel = actionBarMenuCallback != null && actionBarMenuCallback.onPreparePanel(i8);
            if (!zOnPreparePanel) {
                zOnPreparePanel = super.onPreparePanel(i8, view, menu);
            }
            if (menuBuilder != null) {
        ...
        @Override // androidx.appcompat.view.WindowCallbackWrapper, android.view.Window.Callback
        @RequiresApi(23)
        public android.view.ActionMode onWindowStartingActionMode(android.view.ActionMode.Callback callback, int i8) {
            return (AppCompatDelegateImpl.this.isHandleNativeActionModesEnabled() && i8 == 0) ? startAsSupportActionMode(callback) : super.onWindowStartingActionMode(callback, i8);
        }
    }
    ...
    @NonNull
    private Configuration createOverrideAppConfiguration(@NonNull Context context, int i8, @Nullable LocaleListCompat localeListCompat, @Nullable Configuration configuration, boolean z2) {
        int i9;
        if (i8 == 1) {
            i9 = 16;
        } else if (i8 != 2) {
            i9 = z2 ? 0 : context.getApplicationContext().getResources().getConfiguration().uiMode & 48;
        } else {
            i9 = 32;
        }
    ...
    private static Configuration generateConfigDelta(@NonNull Configuration configuration, @Nullable Configuration configuration2) {
        ...
        if (configuration2 != null && configuration.diff(configuration2) != 0) {
            ...
            int i30 = configuration.screenLayout & com.google.android.material.internal.ViewUtils.EDGE_TO_EDGE_FLAGS;
            int i31 = configuration2.screenLayout;
            if (i30 != (i31 & com.google.android.material.internal.ViewUtils.EDGE_TO_EDGE_FLAGS)) {
                configuration3.screenLayout |= i31 & com.google.android.material.internal.ViewUtils.EDGE_TO_EDGE_FLAGS;
            }
    ...
    private void openPanel(PanelFeatureState panelFeatureState, KeyEvent keyEvent) {
        ...
        if (windowManager != null && preparePanel(panelFeatureState, keyEvent)) {
            ...
            if (viewGroup != null && !panelFeatureState.refreshDecorView) {
                ...
                WindowManager.LayoutParams layoutParams2 = new WindowManager.LayoutParams(i8, -2, panelFeatureState.f810x, panelFeatureState.f811y, PointerIconCompat.TYPE_HAND, 8519680, -3);
            ...
            i8 = -2;
            panelFeatureState.isHandled = false;
            WindowManager.LayoutParams layoutParams4 = new WindowManager.LayoutParams(i8, -2, panelFeatureState.f810x, panelFeatureState.f811y, PointerIconCompat.TYPE_HAND, 8519680, -3);
    ...
    private boolean performPanelShortcut(PanelFeatureState panelFeatureState, int i8, KeyEvent keyEvent, int i9) {
        ...
        if ((panelFeatureState.isPrepared || preparePanel(panelFeatureState, keyEvent)) && (menuBuilder = panelFeatureState.menu) != null) {
            zPerformShortcut = menuBuilder.performShortcut(i8, keyEvent, i9);
        }
        if (zPerformShortcut && (i9 & 1) == 0 && this.mDecorContentParent == null) {
            closePanel(panelFeatureState, true);
        }
    ...
    private boolean updateAppConfiguration(int i8, @Nullable LocaleListCompat localeListCompat, boolean z2) {
        boolean z3;
        Configuration configurationCreateOverrideAppConfiguration = createOverrideAppConfiguration(this.mContext, i8, localeListCompat, null, false);
        ...
        int i10 = configurationCreateOverrideAppConfiguration.uiMode & 48;
        ...
        boolean z5 = true;
        if (((~activityHandlesConfigChangesFlags) & i11) != 0 && z2 && this.mBaseContextAttached && (sCanReturnDifferentContext || this.mCreated)) {
            Object obj = this.mHost;
    ...
    private void updateResourcesConfiguration(int i8, @Nullable LocaleListCompat localeListCompat, boolean z2, @Nullable Configuration configuration) {
        ...
        int i9 = this.mThemeResId;
        if (i9 != 0) {
            this.mContext.setTheme(i9);
    ...
    public void callOnPanelClosed(int i8, PanelFeatureState panelFeatureState, Menu menu) {
        if (menu == null) {
    ...
    public void doInvalidatePanelMenu(int i8) {
    ...
    public PanelFeatureState getPanelState(int i8, boolean z2) {
        PanelFeatureState[] panelFeatureStateArr = this.mPanels;
    ...
    public boolean hasWindowFeature(int i8) {
        boolean z2;
        int iSanitizeWindowFeatureId = sanitizeWindowFeatureId(i8);
        ...
        return z2 || this.mWindow.hasFeature(i8);
    }
    ...
    public int mapNightMode(@NonNull Context context, int i8) {
        if (i8 == -100) {
            return -1;
        }
        if (i8 != -1) {
    ...
    public void onMenuOpened(int i8) {
        ActionBar supportActionBar;
    ...
    public void onPanelClosed(int i8) {
        if (i8 == 108) {
            ActionBar supportActionBar = getSupportActionBar();
            if (supportActionBar != null) {
    ...
    private boolean applyApplicationSpecificConfig(boolean z2, boolean z3) {
        if (this.mDestroyed) {
            return false;
        }
        int iCalculateNightMode = calculateNightMode();
        boolean zUpdateAppConfiguration = updateAppConfiguration(mapNightMode(this.mContext, iCalculateNightMode), null, z2);
