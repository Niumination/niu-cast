...
class AlertController {
    ...
    public static class AlertParams {
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (this.mIsMultiChoice) {
                checkedItemAdapter = this.mCursor == null ? new ArrayAdapter<CharSequence>(this.mContext, alertController.mMultiChoiceItemLayout, R.id.text1, this.mItems) { // from class: androidx.appcompat.app.AlertController.AlertParams.1
                    ...
                    public View getView(int i8, View view, ViewGroup viewGroup) {
                        ...
                        if (zArr != null && zArr[i8]) {
                            recycleListView.setItemChecked(i8, true);
                        }
                        return view2;
                    }
                ...
                int i8 = this.mIsSingleChoice ? alertController.mSingleChoiceItemLayout : alertController.mListItemLayout;
                if (this.mCursor != null) {
                    checkedItemAdapter = new SimpleCursorAdapter(this.mContext, i8, this.mCursor, new String[]{this.mLabelColumn}, new int[]{R.id.text1});
                } else {
                    checkedItemAdapter = this.mAdapter;
                    if (checkedItemAdapter == null) {
                        checkedItemAdapter = new CheckedItemAdapter(this.mContext, i8, R.id.text1, this.mItems);
                    }
                }
            }
            ...
            if (this.mOnClickListener != null) {
                recycleListView.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: androidx.appcompat.app.AlertController.AlertParams.3
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i9, long j8) {
                        AlertParams.this.mOnClickListener.onClick(alertController.mDialog, i9);
                ...
                recycleListView.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: androidx.appcompat.app.AlertController.AlertParams.4
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i9, long j8) {
                        ...
                        AlertParams.this.mOnCheckboxClickListener.onClick(alertController.mDialog, i9, recycleListView.isItemChecked(i9));
                    }
                });
            }
    ...
    private int selectContentView() {
        ...
        return (i8 != 0 && this.mButtonPanelLayoutHint == 1) ? i8 : this.mAlertDialogLayout;
    }
    ...
    private void setupView() {
        ...
        if (!z2) {
            ...
            if (view != null) {
                setScrollIndicators(viewGroupResolvePanel2, view, z3 | (z5 ? 2 : 0), 3);
            }
        }
