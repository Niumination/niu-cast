...
public abstract class AppCompatDelegate {
                ...
                try {
                    this.mTasks.add(new Runnable() { // from class: androidx.appcompat.app.a
                        ...
                        public final void run() {
                            this.f812a.lambda$execute$0(runnable);
                        }
                    });
    ...
    public static void syncRequestedAndStoredLocales(Context context) {
        if (isAutoStorageOptedIn(context) && !sIsFrameworkSyncChecked) {
            sSerialExecutorForLocalesStorage.execute(new d.a(context, 0));
        }
    }
    ...
    public void asyncExecuteSyncRequestedAndStoredLocales(Context context) {
        sSerialExecutorForLocalesStorage.execute(new d.a(context, 1));
    }
    ...
    @Nullable
    public abstract <T extends View> T findViewById(@IdRes int i8);
    ...
    public abstract void setContentView(@LayoutRes int i8);
