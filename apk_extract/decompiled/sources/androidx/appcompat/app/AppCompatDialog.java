...
public class AppCompatDialog extends ComponentDialog implements AppCompatCallback {
    ...
    public AppCompatDialog(@NonNull Context context, int i8) {
        ...
        this.mKeyDispatcher = new KeyEventDispatcher.Component() { // from class: d.b
            @Override // androidx.core.view.KeyEventDispatcher.Component
            public final boolean superDispatchKeyEvent(KeyEvent keyEvent) {
                return this.f4253a.superDispatchKeyEvent(keyEvent);
            }
        };
        AppCompatDelegate delegate = getDelegate();
        delegate.setTheme(getThemeResId(context, i8));
    ...
    public AppCompatDialog(@NonNull Context context, boolean z2, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        super(context);
        this.mKeyDispatcher = new KeyEventDispatcher.Component() { // from class: d.b
            @Override // androidx.core.view.KeyEventDispatcher.Component
            public final boolean superDispatchKeyEvent(KeyEvent keyEvent) {
