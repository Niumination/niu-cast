...
public abstract class AsyncTaskLoader<D> extends Loader<D> {
    ...
    public final class LoadTask extends ModernAsyncTask<Void, Void, D> implements Runnable {
        ...
        public void onCancelled(D d7) {
            try {
                AsyncTaskLoader.this.dispatchOnCancelled(this, d7);
            } finally {
        ...
        public void onPostExecute(D d7) {
            try {
                AsyncTaskLoader.this.dispatchOnLoadComplete(this, d7);
            } finally {
                this.mDone.countDown();
            }
        }
    ...
    public void dispatchOnCancelled(AsyncTaskLoader<D>.LoadTask loadTask, D d7) {
        onCanceled(d7);
    ...
    public void dispatchOnLoadComplete(AsyncTaskLoader<D>.LoadTask loadTask, D d7) {
        if (this.mTask != loadTask) {
            dispatchOnCancelled(loadTask, d7);
            return;
        }
        if (isAbandoned()) {
            onCanceled(d7);
