...
public class Loader<D> {
    ...
    public interface OnLoadCompleteListener<D> {
        void onLoadComplete(@NonNull Loader<D> loader, @Nullable D d7);
    }
    ...
    @NonNull
    public String dataToString(@Nullable D d7) {
        StringBuilder sb2 = new StringBuilder(64);
        DebugUtils.buildShortClassTag(d7, sb2);
        sb2.append("}");
        return sb2.toString();
    }
    ...
    @MainThread
    public void deliverResult(@Nullable D d7) {
        OnLoadCompleteListener<D> onLoadCompleteListener = this.mListener;
        if (onLoadCompleteListener != null) {
            onLoadCompleteListener.onLoadComplete(this, d7);
        }
    }
