...
class LoaderManagerImpl extends LoaderManager {
    ...
    public static class LoaderInfo<D> extends MutableLiveData<D> implements Loader.OnLoadCompleteListener<D> {
        ...
        public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
            ...
            this.mLoader.dump(a.B(str, "  "), fileDescriptor, printWriter, strArr);
            if (this.mObserver != null) {
                printWriter.print(str);
                printWriter.print("mCallbacks=");
                printWriter.println(this.mObserver);
                this.mObserver.dump(a.B(str, "  "), printWriter);
            }
            printWriter.print(str);
    ...
    public static class LoaderObserver<D> implements Observer<D> {
        ...
        public void onChanged(@Nullable D d7) {
            if (LoaderManagerImpl.DEBUG) {
                Log.v(LoaderManagerImpl.TAG, "  onLoadFinished in " + this.mLoader + ": " + this.mLoader.dataToString(d7));
            }
    ...
    public static class LoaderViewModel extends ViewModel {
        ...
        public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
            if (this.mLoaders.size() > 0) {
                ...
                for (int i8 = 0; i8 < this.mLoaders.size(); i8++) {
                    LoaderInfo loaderInfoValueAt = this.mLoaders.valueAt(i8);
                    printWriter.print(str);
                    printWriter.print("  #");
        ...
        public <D> LoaderInfo<D> getLoader(int i8) {
        ...
        public void putLoader(int i8, @NonNull LoaderInfo loaderInfo) {
    ...
    private <D> Loader<D> createAndInstallLoader(int i8, @Nullable Bundle bundle, @NonNull LoaderManager.LoaderCallbacks<D> loaderCallbacks, @Nullable Loader<D> loader) {
        try {
            ...
            Loader<D> loaderOnCreateLoader = loaderCallbacks.onCreateLoader(i8, bundle);
            ...
            LoaderInfo loaderInfo = new LoaderInfo(i8, bundle, loaderOnCreateLoader, loader);
            if (DEBUG) {
    ...
    public <D> Loader<D> restartLoader(int i8, @Nullable Bundle bundle, @NonNull LoaderManager.LoaderCallbacks<D> loaderCallbacks) {
        ...
        LoaderInfo<D> loader = this.mLoaderViewModel.getLoader(i8);
        return createAndInstallLoader(i8, bundle, loaderCallbacks, loader != null ? loader.destroy(false) : null);
    }
