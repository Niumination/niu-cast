...
public class NetworkUnmeteredController extends ConstraintController<NetworkState> {
    ...
    public boolean hasConstraint(@NonNull WorkSpec workSpec) {
        return workSpec.constraints.getRequiredNetworkType() == NetworkType.UNMETERED || workSpec.constraints.getRequiredNetworkType() == NetworkType.TEMPORARILY_UNMETERED;
    }
