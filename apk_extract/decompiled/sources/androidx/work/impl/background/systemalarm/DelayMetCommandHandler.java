...
public class DelayMetCommandHandler implements WorkConstraintsCallback, ExecutionListener, WorkTimer.TimeLimitExceededListener {
    ...
    public void handleProcessWork() {
        ...
        if (zHasConstraints) {
            ...
            Logger.get().debug(str, a.i("No constraints for ", this.mWorkSpecId), new Throwable[0]);
    ...
    public void onExecuted(@NonNull String str, boolean z2) {
        Logger.get().debug(TAG, "onExecuted " + str + ", " + z2, new Throwable[0]);
        cleanUp();
        if (z2) {
            Intent intentCreateScheduleWorkIntent = CommandHandler.createScheduleWorkIntent(this.mContext, this.mWorkSpecId);
            SystemAlarmDispatcher systemAlarmDispatcher = this.mDispatcher;
    ...
    public void onTimeLimitExceeded(@NonNull String str) {
        Logger.get().debug(TAG, a.i("Exceeded time limits on execution for ", str), new Throwable[0]);
        stopWork();
    }
}
