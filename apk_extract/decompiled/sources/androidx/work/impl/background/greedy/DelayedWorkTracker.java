...
public class DelayedWorkTracker {
    ...
    public void schedule(@NonNull final WorkSpec workSpec) {
        Runnable runnableRemove = this.mRunnables.remove(workSpec.f1155id);
        ...
        Runnable runnable = new Runnable() { // from class: androidx.work.impl.background.greedy.DelayedWorkTracker.1
            ...
            public void run() {
                Logger.get().debug(DelayedWorkTracker.TAG, a.i("Scheduling work ", workSpec.f1155id), new Throwable[0]);
                DelayedWorkTracker.this.mGreedyScheduler.schedule(workSpec);
            }
        };
        this.mRunnables.put(workSpec.f1155id, runnable);
