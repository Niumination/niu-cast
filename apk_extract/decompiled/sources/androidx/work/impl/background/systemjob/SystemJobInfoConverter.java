...
class SystemJobInfoConverter {
    ...
    public static int convertNetworkType(NetworkType networkType) {
        ...
        Logger.get().debug(TAG, "API version too low. Cannot convert network type value " + networkType, new Throwable[0]);
        return 1;
    }
    ...
    public JobInfo convert(WorkSpec workSpec, int i8) {
        ...
        persistableBundle.putString(EXTRA_WORK_SPEC_ID, workSpec.f1155id);
        ...
        boolean z3 = jMax > 0;
        if (BuildCompat.isAtLeastS() && workSpec.expedited && !z2 && !z3) {
