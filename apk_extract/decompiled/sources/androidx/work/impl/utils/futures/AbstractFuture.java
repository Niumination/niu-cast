...
public abstract class AbstractFuture<V> implements l {
    ...
    public static final class SetFuture<V> implements Runnable {
        ...
        public SetFuture(AbstractFuture<V> abstractFuture, l lVar) {
    ...
    public static Object getFutureValue(l lVar) {
        if (lVar instanceof AbstractFuture) {
            Object obj = ((AbstractFuture) lVar).value;
            if (!(obj instanceof Cancellation)) {
                return obj;
            }
