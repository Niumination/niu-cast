...
public final class PeriodicWorkRequest extends WorkRequest {
    ...
    public static final class Builder extends WorkRequest.Builder<Builder, PeriodicWorkRequest> {
        public Builder(@NonNull Class<? extends ListenableWorker> cls, long j8, @NonNull TimeUnit timeUnit) {
            super(cls);
            this.mWorkSpec.setPeriodic(timeUnit.toMillis(j8));
        }
        ...
        public Builder(@NonNull Class<? extends ListenableWorker> cls, long j8, @NonNull TimeUnit timeUnit, long j10, @NonNull TimeUnit timeUnit2) {
            super(cls);
            this.mWorkSpec.setPeriodic(timeUnit.toMillis(j8), timeUnit2.toMillis(j10));
        }
