...
public abstract class WorkManager {
    ...
    @NonNull
    public abstract l getLastCancelAllTimeMillis();

    @NonNull
    public abstract LiveData<Long> getLastCancelAllTimeMillisLiveData();

    @NonNull
    public abstract l getWorkInfoById(@NonNull UUID uuid);
    ...
    @NonNull
    public abstract l getWorkInfosByTag(@NonNull String str);

    @NonNull
    public abstract LiveData<List<WorkInfo>> getWorkInfosByTagLiveData(@NonNull String str);

    @NonNull
    public abstract l getWorkInfosForUniqueWork(@NonNull String str);
