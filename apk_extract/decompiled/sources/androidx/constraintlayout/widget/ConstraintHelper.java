...
public abstract class ConstraintHelper extends View {
    ...
    public void setIds(String str) {
        ...
        while (true) {
            ...
            if (iIndexOf == -1) {
                ...
                addID(str.substring(i8, iIndexOf));
                i8 = iIndexOf + 1;
            }
        }
    }
    ...
    public void setReferenceTags(String str) {
        ...
        while (true) {
            ...
            if (iIndexOf == -1) {
                ...
                addTag(str.substring(i8, iIndexOf));
                i8 = iIndexOf + 1;
            }
        }
    }
    ...
    public void updatePreLayout(ConstraintLayout constraintLayout) {
        ...
        for (int i8 = 0; i8 < this.mCount; i8++) {
            ...
            if (viewById == null && (iFindId = findId(constraintLayout, (str = this.mMap.get(Integer.valueOf(i9))))) != 0) {
                this.mIds[i8] = iFindId;
