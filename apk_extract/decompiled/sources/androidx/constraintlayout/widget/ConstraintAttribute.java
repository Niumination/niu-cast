        ...
        for (String str : map.keySet()) {
            ...
            try {
                switch (AnonymousClass1.$SwitchMap$androidx$constraintlayout$widget$ConstraintAttribute$AttributeType[constraintAttribute.mType.ordinal()]) {
                    case 1:
                        cls.getMethod(strI, Integer.TYPE).invoke(view, Integer.valueOf(constraintAttribute.mIntegerValue));
                        break;
                    case 2:
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        cls.getMethod(strI, Integer.TYPE).invoke(view, Integer.valueOf(constraintAttribute.mColorValue));
                        break;
                    case 5:
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        cls.getMethod(strI, Float.TYPE).invoke(view, Float.valueOf(constraintAttribute.mFloatValue));
                        break;
                    case 8:
                        cls.getMethod(strI, Float.TYPE).invoke(view, Float.valueOf(constraintAttribute.mFloatValue));
                        break;
                ...
                StringBuilder sbY = a1.a.y(" Custom Attribute \"", str, "\" not found on ");
                ...
                Log.e(TAG, cls.getName() + " must have a method " + strI);
            } catch (InvocationTargetException e10) {
                StringBuilder sbY2 = a1.a.y(" Custom Attribute \"", str, "\" not found on ");
    ...
    public void applyCustom(View view) {
        ...
        try {
            switch (AnonymousClass1.$SwitchMap$androidx$constraintlayout$widget$ConstraintAttribute$AttributeType[this.mType.ordinal()]) {
                case 1:
                case 6:
                    cls.getMethod(strI, Integer.TYPE).invoke(view, Integer.valueOf(this.mIntegerValue));
                    break;
                case 2:
                ...
                case 3:
                    ...
                    break;
                case 4:
                    cls.getMethod(strI, Integer.TYPE).invoke(view, Integer.valueOf(this.mColorValue));
                    break;
                case 5:
                    Method method = cls.getMethod(strI, Drawable.class);
                    ColorDrawable colorDrawable = new ColorDrawable();
                    ...
                    break;
                case 7:
                    cls.getMethod(strI, Float.TYPE).invoke(view, Float.valueOf(this.mFloatValue));
                    break;
                case 8:
                    cls.getMethod(strI, Float.TYPE).invoke(view, Float.valueOf(this.mFloatValue));
                    break;
