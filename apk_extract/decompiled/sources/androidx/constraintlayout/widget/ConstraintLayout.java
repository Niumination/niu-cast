...
public class ConstraintLayout extends ViewGroup {
    ...
    public class Measurer implements BasicMeasure.Measurer {
        ...
        private boolean isSimilarSpec(int i8, int i9, int i10) {
            if (i8 == i9) {
                return true;
            }
        ...
        public void captureLayoutInfo(int i8, int i9, int i10, int i11, int i12, int i13) {
            this.paddingTop = i10;
            this.paddingBottom = i11;
            this.paddingWidth = i12;
            this.paddingHeight = i13;
            this.layoutWidthSpec = i8;
            this.layoutHeightSpec = i9;
        }
        ...
        public final void didMeasures() {
            ...
            for (int i8 = 0; i8 < childCount; i8++) {
                View childAt = this.layout.getChildAt(i8);
            ...
            if (size > 0) {
                for (int i9 = 0; i9 < size; i9++) {
                    ((ConstraintHelper) this.layout.mConstraintHelpers.get(i9)).updatePostMeasure(this.layout);
                }
            }
        }
        ...
        public final void measure(ConstraintWidget constraintWidget, BasicMeasure.Measure measure) {
            ...
            if (i15 == 1) {
                iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(i10, BasicMeasure.EXACTLY);
            } else if (i15 == 2) {
                ...
                if (i16 == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || i16 == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS) {
                    boolean z10 = view.getMeasuredWidth() == constraintWidget.getWidth();
                    if (measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || !z5 || ((z5 && z10) || (view instanceof Placeholder) || constraintWidget.isResolvedVertically())) {
            ...
            if (i17 != BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS && i17 != BasicMeasure.Measure.USE_GIVEN_DIMENSIONS && z11 && constraintWidget.mMatchConstraintDefaultWidth == 0 && z12 && constraintWidget.mMatchConstraintDefaultHeight == 0) {
                i8 = -1;
                iMax2 = 0;
                baseline = 0;
                iMax = 0;
    ...
    private final ConstraintWidget getTargetWidget(int i8) {
        if (i8 == 0) {
            return this.mLayoutWidget;
        }
        View viewFindViewById = this.mChildrenByIds.get(i8);
    ...
    private void init(AttributeSet attributeSet, int i8, int i9) {
        ...
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, R.styleable.ConstraintLayout_Layout, i8, i9);
    ...
    private void setWidgetBaseline(ConstraintWidget constraintWidget, LayoutParams layoutParams, SparseArray<ConstraintWidget> sparseArray, int i8, ConstraintAnchor.Type type) {
    ...
    public void applyConstraintsFromLayoutParams(boolean z2, View view, ConstraintWidget constraintWidget, LayoutParams layoutParams, SparseArray<ConstraintWidget> sparseArray) {
        ...
        int i17 = layoutParams.circleConstraint;
        if (i17 != -1) {
            ...
            if (i11 != -1) {
                ...
                if (constraintWidget7 != null) {
                    ...
                    constraintWidget.immediateConnect(type, constraintWidget7, type, ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin, i15);
                }
            } else if (i12 != -1 && (constraintWidget2 = sparseArray.get(i12)) != null) {
                constraintWidget.immediateConnect(ConstraintAnchor.Type.LEFT, constraintWidget2, ConstraintAnchor.Type.RIGHT, ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin, i15);
            }
            if (i13 != -1) {
                ConstraintWidget constraintWidget8 = sparseArray.get(i13);
                if (constraintWidget8 != null) {
                    constraintWidget.immediateConnect(ConstraintAnchor.Type.RIGHT, constraintWidget8, ConstraintAnchor.Type.LEFT, ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin, i16);
                }
            } else if (i14 != -1 && (constraintWidget3 = sparseArray.get(i14)) != null) {
                ConstraintAnchor.Type type2 = ConstraintAnchor.Type.RIGHT;
                constraintWidget.immediateConnect(type2, constraintWidget3, type2, ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin, i16);
            }
            int i18 = layoutParams.topToTop;
            if (i18 != -1) {
                ...
                int i19 = layoutParams.topToBottom;
            ...
            int i20 = layoutParams.bottomToTop;
            if (i20 != -1) {
                ...
                int i21 = layoutParams.bottomToBottom;
            ...
            int i22 = layoutParams.baselineToBaseline;
            if (i22 != -1) {
                setWidgetBaseline(constraintWidget, layoutParams, sparseArray, i22, ConstraintAnchor.Type.BASELINE);
            } else {
                int i23 = layoutParams.baselineToTop;
                if (i23 != -1) {
                    setWidgetBaseline(constraintWidget, layoutParams, sparseArray, i23, ConstraintAnchor.Type.TOP);
                } else {
                    int i24 = layoutParams.baselineToBottom;
                    if (i24 != -1) {
                        setWidgetBaseline(constraintWidget, layoutParams, sparseArray, i24, ConstraintAnchor.Type.BOTTOM);
                    }
                }
            }
            if (f4 >= 0.0f) {
            ...
            if (f10 >= 0.0f) {
                constraintWidget.setVerticalBiasPercent(f10);
            }
        }
        if (z2 && ((i8 = layoutParams.editorAbsoluteX) != -1 || layoutParams.editorAbsoluteY != -1)) {
            constraintWidget.setOrigin(i8, layoutParams.editorAbsoluteY);
        }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (arrayList != null && (size = arrayList.size()) > 0) {
            for (int i8 = 0; i8 < size; i8++) {
                this.mConstraintHelpers.get(i8).updatePreDraw(this);
            }
        }
            ...
            for (int i9 = 0; i9 < childCount; i9++) {
                ...
                if (childAt.getVisibility() != 8 && (tag = childAt.getTag()) != null && (tag instanceof String)) {
                    ...
                    if (strArrSplit.length == 4) {
                        ...
                        int i15 = (int) ((Integer.parseInt(strArrSplit[3]) / 1920.0f) * height);
    ...
    public void loadLayoutDescription(int i8) {
        ...
        try {
            this.mConstraintLayoutSpec = new ConstraintLayoutStates(getContext(), this, i8);
        } catch (Resources.NotFoundException unused) {
            this.mConstraintLayoutSpec = null;
        }
    }
    ...
    public void onLayout(boolean z2, int i8, int i9, int i10, int i11) {
        ...
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if ((childAt.getVisibility() != 8 || layoutParams.isGuideline || layoutParams.isHelper || layoutParams.isVirtualGroup || zIsInEditMode) && !layoutParams.isInPlaceholder) {
                ...
                childAt.layout(x2, y3, width, height);
                if ((childAt instanceof Placeholder) && (content = ((Placeholder) childAt).getContent()) != null) {
                    content.setVisibility(0);
                    content.layout(x2, y3, width, height);
                }
            }
        }
        int size = this.mConstraintHelpers.size();
    ...
    public void onMeasure(int i8, int i9) {
        ...
        resolveMeasuredDimension(i8, i9, this.mLayoutWidget.getWidth(), this.mLayoutWidget.getHeight(), this.mLayoutWidget.isWidthMeasuredTooSmall(), this.mLayoutWidget.isHeightMeasuredTooSmall());
    }
    ...
    public void resolveMeasuredDimension(int i8, int i9, int i10, int i11, boolean z2, boolean z3) {
        Measurer measurer = this.mMeasurer;
        int i12 = measurer.paddingHeight;
        int iResolveSizeAndState = ViewGroup.resolveSizeAndState(i10 + measurer.paddingWidth, i8, 0);
        int iResolveSizeAndState2 = ViewGroup.resolveSizeAndState(i11 + i12, i9, 0);
    ...
    public void resolveSystem(ConstraintWidgetContainer constraintWidgetContainer, int i8, int i9, int i10) {
        ...
        this.mMeasurer.captureLayoutInfo(i9, i10, iMax, iMax2, paddingWidth, i11);
        ...
        constraintWidgetContainer.measure(i8, mode, i12, mode2, i13, this.mLastMeasureWidth, this.mLastMeasureHeight, iMax4, iMax);
    }
    ...
    public void setOptimizationLevel(int i8) {
        ...
        this.mLayoutWidget.setOptimizationLevel(i8);
    }
    ...
    public void setSelfDimensionBehaviour(ConstraintWidgetContainer constraintWidgetContainer, int i8, int i9, int i10, int i11) {
        ConstraintWidget.DimensionBehaviour dimensionBehaviour;
        Measurer measurer = this.mMeasurer;
        int i12 = measurer.paddingHeight;
        int i13 = measurer.paddingWidth;
        ...
        if (i8 == Integer.MIN_VALUE) {
            ...
            dimensionBehaviour = ConstraintWidget.DimensionBehaviour.WRAP_CONTENT;
            i9 = childCount == 0 ? Math.max(0, this.mMinWidth) : 0;
        ...
        if (i9 != constraintWidgetContainer.getWidth() || i11 != constraintWidgetContainer.getHeight()) {
            constraintWidgetContainer.invalidateMeasures();
        }
        constraintWidgetContainer.setX(0);
        constraintWidgetContainer.setY(0);
        constraintWidgetContainer.setMaxWidth(this.mMaxWidth - i13);
        constraintWidgetContainer.setMaxHeight(this.mMaxHeight - i12);
        ...
        constraintWidgetContainer.setMinWidth(this.mMinWidth - i13);
        constraintWidgetContainer.setMinHeight(this.mMinHeight - i12);
    }
    ...
    public ConstraintLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i8, int i9) {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public void resolveLayoutDirection(int i8) {
            int i9;
            int i10;
            int i11;
            int i12;
            ...
            super.resolveLayoutDirection(i8);
            boolean z2 = false;
            ...
            int i15 = this.guideBegin;
            this.resolvedGuideBegin = i15;
            int i16 = this.guideEnd;
            this.resolvedGuideEnd = i16;
            float f4 = this.guidePercent;
            this.resolvedGuidePercent = f4;
            if (z3) {
                int i17 = this.startToEnd;
                if (i17 != -1) {
                    this.resolvedRightToLeft = i17;
                } else {
                    int i18 = this.startToStart;
                    if (i18 != -1) {
                        ...
                        i11 = this.goneStartMargin;
                        if (i11 != Integer.MIN_VALUE) {
                            this.resolveGoneRightMargin = i11;
                        }
                        i12 = this.goneEndMargin;
                        ...
                        if (this.isGuideline && this.orientation == 1 && this.guidelineUseRtl) {
                            if (f4 != -1.0f) {
                                this.resolvedGuidePercent = 1.0f - f4;
                                this.resolvedGuideBegin = -1;
                                this.resolvedGuideEnd = -1;
                            } else if (i15 != -1) {
                                this.resolvedGuideEnd = i15;
                                this.resolvedGuideBegin = -1;
                                this.resolvedGuidePercent = -1.0f;
                            } else if (i16 != -1) {
                                this.resolvedGuideBegin = i16;
                                this.resolvedGuideEnd = -1;
                                this.resolvedGuidePercent = -1.0f;
                            }
                        }
                ...
                int i19 = this.startToEnd;
                if (i19 != -1) {
                    this.resolvedLeftToRight = i19;
                }
                int i20 = this.startToStart;
                if (i20 != -1) {
                    this.resolvedLeftToLeft = i20;
                }
                int i21 = this.endToStart;
                if (i21 != -1) {
                    this.resolvedRightToLeft = i21;
                }
                int i22 = this.endToEnd;
                if (i22 != -1) {
                    this.resolvedRightToRight = i22;
                }
                int i23 = this.goneStartMargin;
                if (i23 != Integer.MIN_VALUE) {
                    this.resolveGoneLeftMargin = i23;
                }
                int i24 = this.goneEndMargin;
                if (i24 != Integer.MIN_VALUE) {
                    this.resolveGoneRightMargin = i24;
                }
            }
            if (this.endToStart == -1 && this.endToEnd == -1 && this.startToStart == -1 && this.startToEnd == -1) {
                int i25 = this.rightToLeft;
                if (i25 != -1) {
                    this.resolvedRightToLeft = i25;
                    if (((ViewGroup.MarginLayoutParams) this).rightMargin <= 0 && i14 > 0) {
                        ((ViewGroup.MarginLayoutParams) this).rightMargin = i14;
                    }
                } else {
                    int i26 = this.rightToRight;
                    if (i26 != -1) {
                        this.resolvedRightToRight = i26;
                        if (((ViewGroup.MarginLayoutParams) this).rightMargin <= 0 && i14 > 0) {
                            ((ViewGroup.MarginLayoutParams) this).rightMargin = i14;
                        }
                    }
                }
                int i27 = this.leftToLeft;
                if (i27 != -1) {
                    this.resolvedLeftToLeft = i27;
                ...
                int i28 = this.leftToRight;
                if (i28 != -1) {
                    this.resolvedLeftToRight = i28;
                    if (((ViewGroup.MarginLayoutParams) this).leftMargin > 0 || i13 <= 0) {
                        return;
                    }
                    ((ViewGroup.MarginLayoutParams) this).leftMargin = i13;
