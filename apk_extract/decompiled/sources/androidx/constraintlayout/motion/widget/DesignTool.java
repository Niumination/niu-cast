...
public class DesignTool implements ProxyInterface {
    ...
    private static void Connect(int i8, ConstraintSet constraintSet, View view, HashMap<String, String> map, int i9, int i10) {
        String str = allAttributes.get(Pair.create(Integer.valueOf(i9), Integer.valueOf(i10)));
        String str2 = map.get(str);
        if (str2 != null) {
            String str3 = allMargins.get(str);
            constraintSet.connect(view.getId(), i9, Integer.parseInt(str2), i10, str3 != null ? GetPxFromDp(i8, map.get(str3)) : 0);
        }
    }
    ...
    private static void SetAbsolutePositions(int i8, ConstraintSet constraintSet, View view, HashMap<String, String> map) {
    ...
    private static void SetBias(ConstraintSet constraintSet, View view, HashMap<String, String> map, int i8) {
        String str = map.get(i8 == 1 ? "layout_constraintVertical_bias" : "layout_constraintHorizontal_bias");
        if (str != null) {
            if (i8 == 0) {
    ...
    private static void SetDimensions(int i8, ConstraintSet constraintSet, View view, HashMap<String, String> map, int i9) {
        String str = map.get(i9 == 1 ? "layout_height" : "layout_width");
        if (str != null) {
            int iGetPxFromDp = !str.equalsIgnoreCase("wrap_content") ? GetPxFromDp(i8, str) : -2;
            if (i9 == 0) {
    ...
    @Override // androidx.constraintlayout.motion.widget.ProxyInterface
    public float getKeyFramePosition(Object obj, int i8, float f, float f4) {
        MotionController motionController;
        if ((obj instanceof View) && (motionController = this.mMotionLayout.mFrameArrayList.get((View) obj)) != null) {
            return motionController.getKeyFrameParameter(i8, f, f4);
        }
        return 0.0f;
    }
    ...
    @Override // androidx.constraintlayout.motion.widget.ProxyInterface
    public Object getKeyframeAtLocation(Object obj, float f, float f4) {
        MotionController motionController;
        View view = (View) obj;
        MotionLayout motionLayout = this.mMotionLayout;
        if (motionLayout.mScene == null) {
        ...
        return motionController.getPositionKeyframe(viewGroup.getWidth(), viewGroup.getHeight(), f, f4);
    }

    @Override // androidx.constraintlayout.motion.widget.ProxyInterface
    public Boolean getPositionKeyframe(Object obj, Object obj2, float f, float f4, String[] strArr, float[] fArr) {
        if (!(obj instanceof KeyPositionBase)) {
            return Boolean.FALSE;
        }
        View view = (View) obj2;
        this.mMotionLayout.mFrameArrayList.get(view).positionKeyframe(view, (KeyPositionBase) obj, f, f4, strArr, fArr);
    ...
    public void setAttributes(int i8, String str, Object obj, Object obj2) {
        ...
        SetDimensions(i8, constraintSet, view, map, 0);
        SetDimensions(i8, constraintSet, view, map, 1);
        Connect(i8, constraintSet, view, map, 6, 6);
        Connect(i8, constraintSet, view, map, 6, 7);
        Connect(i8, constraintSet, view, map, 7, 7);
        Connect(i8, constraintSet, view, map, 7, 6);
        Connect(i8, constraintSet, view, map, 1, 1);
        Connect(i8, constraintSet, view, map, 1, 2);
        Connect(i8, constraintSet, view, map, 2, 2);
        Connect(i8, constraintSet, view, map, 2, 1);
        Connect(i8, constraintSet, view, map, 3, 3);
        Connect(i8, constraintSet, view, map, 3, 4);
        Connect(i8, constraintSet, view, map, 4, 3);
        Connect(i8, constraintSet, view, map, 4, 4);
        Connect(i8, constraintSet, view, map, 5, 5);
        SetBias(constraintSet, view, map, 0);
        SetBias(constraintSet, view, map, 1);
        SetAbsolutePositions(i8, constraintSet, view, map);
    ...
    @Override // androidx.constraintlayout.motion.widget.ProxyInterface
    public boolean setKeyFramePosition(Object obj, int i8, int i9, float f, float f4) {
        ...
        if (motionLayout.mScene != null) {
            ...
            if (motionController != null) {
                ...
                if (motionLayout2.mScene.hasKeyFramePosition(view, i10)) {
                    float keyFrameParameter = motionController.getKeyFrameParameter(2, f, f4);
                    float keyFrameParameter2 = motionController.getKeyFrameParameter(5, f, f4);
    ...
    public Object getKeyframe(Object obj, int i8, int i9) {
        ...
        MotionLayout motionLayout = this.mMotionLayout;
        return motionLayout.mScene.getKeyFrame(motionLayout.getContext(), i8, id2, i9);
    }
}
