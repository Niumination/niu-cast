...
public class State {
    ...
    private String createHelperKey() {
        ...
        int i8 = this.numHelpers;
        this.numHelpers = i8 + 1;
        return a.m(sb2, "__", i8);
    }
    ...
    public GuidelineReference guideline(Object obj, int i8) {
        ConstraintReference constraintReferenceConstraints = constraints(obj);
        if (constraintReferenceConstraints.getFacade() == null || !(constraintReferenceConstraints.getFacade() instanceof GuidelineReference)) {
            ...
            guidelineReference.setOrientation(i8);
    ...
    public HelperReference helper(Object obj, Helper helper) {
        ...
        if (helperReference == null) {
            int i8 = AnonymousClass1.$SwitchMap$androidx$constraintlayout$core$state$State$Helper[helper.ordinal()];
            if (i8 == 1) {
    ...
    public boolean sameFixedHeight(int i8) {
        return this.mParent.getHeight().equalsFixedValue(i8);
    }

    public boolean sameFixedWidth(int i8) {
        return this.mParent.getWidth().equalsFixedValue(i8);
    }
