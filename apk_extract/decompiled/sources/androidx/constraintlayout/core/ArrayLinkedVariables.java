...
public class ArrayLinkedVariables implements ArrayRow.ArrayRowVariables {
    ...
    public void add(SolverVariable solverVariable, float f, boolean z2) {
        ...
        if (f <= (-f4) || f >= f4) {
            ...
            if (i8 == -1) {
                ...
                this.mArrayIndices[0] = solverVariable.f1075id;
            ...
            this.mArrayIndices[length] = solverVariable.f1075id;
    ...
    public boolean contains(SolverVariable solverVariable) {
        ...
        for (int i9 = 0; i8 != -1 && i9 < this.currentSize; i9++) {
            if (this.mArrayIndices[i8] == solverVariable.f1075id) {
                return true;
            }
            i8 = this.mArrayNextIndices[i8];
        }
    ...
    public String toString() {
        ...
        String string = "";
        for (int i9 = 0; i8 != -1 && i9 < this.currentSize; i9++) {
            StringBuilder sbS = d.s(a.B(string, " -> "));
            sbS.append(this.mArrayValues[i8]);
            sbS.append(" : ");
            StringBuilder sbS2 = d.s(sbS.toString());
            sbS2.append(this.mCache.mIndexedVariables[this.mArrayIndices[i8]]);
