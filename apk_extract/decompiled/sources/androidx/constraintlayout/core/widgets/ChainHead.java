...
public class ChainHead {
    ...
    public ChainHead(ConstraintWidget constraintWidget, int i8, boolean z2) {
    ...
    private void defineChainProperties() {
        ...
        while (!z2) {
            ...
            if (constraintWidget.getVisibility() != 8) {
                ...
                int margin = constraintWidget.mListAnchors[i8].getMargin() + this.mTotalSize;
                this.mTotalSize = margin;
                int i10 = i8 + 1;
                this.mTotalSize = constraintWidget.mListAnchors[i10].getMargin() + margin;
                int margin2 = constraintWidget.mListAnchors[i8].getMargin() + this.mTotalMargins;
                this.mTotalMargins = margin2;
                this.mTotalMargins = constraintWidget.mListAnchors[i10].getMargin() + margin2;
                ...
                if (dimensionBehaviourArr[i11] == dimensionBehaviour2) {
                    ...
                    if (i12 == 0 || i12 == 3 || i12 == 2) {
                        ...
                        float f = constraintWidget.mWeight[i11];
                        if (f > 0.0f) {
                            this.mTotalWeight += f;
                        }
