...
public class Grouping {
    ...
    public static WidgetGroup findDependents(ConstraintWidget constraintWidget, int i8, ArrayList<WidgetGroup> arrayList, WidgetGroup widgetGroup) {
        ...
        int i9 = i8 == 0 ? constraintWidget.horizontalGroup : constraintWidget.verticalGroup;
        if (i9 != -1 && (widgetGroup == null || i9 != widgetGroup.f1087id)) {
        ...
        if (widgetGroup == null) {
            if ((constraintWidget instanceof HelperWidget) && (iFindGroupInDependents = ((HelperWidget) constraintWidget).findGroupInDependents(i8)) != -1) {
    ...
    public static boolean simpleSolvingPass(ConstraintWidgetContainer constraintWidgetContainer, BasicMeasure.Measurer measurer) {
        ...
        while (i10 < size) {
            ...
            if (!validInGroup(constraintWidgetContainer.getHorizontalDimensionBehaviour(), constraintWidgetContainer.getVerticalDimensionBehaviour(), constraintWidget2.getHorizontalDimensionBehaviour(), constraintWidget2.getVerticalDimensionBehaviour())) {
                ConstraintWidgetContainer.measure(i8, constraintWidget2, measurer, constraintWidgetContainer.mMeasure, BasicMeasure.Measure.SELF_DIMENSIONS);
            }
            boolean z5 = constraintWidget2 instanceof Guideline;
            if (z5) {
            ...
            if (constraintWidget2.mLeft.mTarget == null && constraintWidget2.mRight.mTarget == null && !z5 && !(constraintWidget2 instanceof Barrier)) {
                if (arrayList5 == null) {
                    arrayList5 = new ArrayList();
                }
                arrayList5.add(constraintWidget2);
            }
            if (constraintWidget2.mTop.mTarget == null && constraintWidget2.mBottom.mTarget == null && constraintWidget2.mBaseline.mTarget == null && !z5 && !(constraintWidget2 instanceof Barrier)) {
                if (arrayList6 == null) {
        ...
        if (arrayList2 != null) {
            for (HelperWidget helperWidget2 : arrayList2) {
                WidgetGroup widgetGroupFindDependents = findDependents(helperWidget2, i11, arrayList7, widgetGroup3);
                helperWidget2.addDependents(arrayList7, i11, widgetGroupFindDependents);
        ...
        if (arrayList4 != null) {
            for (HelperWidget helperWidget3 : arrayList4) {
                WidgetGroup widgetGroupFindDependents2 = findDependents(helperWidget3, i12, arrayList7, widgetGroup4);
                helperWidget3.addDependents(arrayList7, i12, widgetGroupFindDependents2);
        ...
        if (constraintWidgetContainer.getVerticalDimensionBehaviour() == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) {
            ...
            return (widgetGroup == null || widgetGroup2 != null) ? z3 : z2;
        }
        z2 = false;
        z3 = true;
        widgetGroup2 = null;
