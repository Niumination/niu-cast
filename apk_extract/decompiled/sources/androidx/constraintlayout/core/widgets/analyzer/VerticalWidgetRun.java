...
public class VerticalWidgetRun extends WidgetRun {
    ...
    public void apply() {
        ...
        if (z2 || this.dimensionBehavior != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            ...
            int i8 = constraintWidget3.mMatchConstraintDefaultHeight;
            if (i8 == 2) {
    ...
    public void update(Dependency dependency) {
        ...
        int dimensionRatio2;
        int i8 = AnonymousClass1.$SwitchMap$androidx$constraintlayout$core$widgets$analyzer$WidgetRun$RunType[this.mRunType.ordinal()];
        if (i8 == 1) {
            ...
            if (i9 == 2) {
                ...
                if (parent != null) {
                    ...
                    if (dimensionDependency2.resolved) {
                        this.dimension.resolve((int) ((dimensionDependency2.value * this.widget.mMatchConstraintPercentHeight) + 0.5f));
                    }
                }
            } else if (i9 == 3 && constraintWidget2.horizontalRun.dimension.resolved) {
                int dimensionRatioSide = constraintWidget2.getDimensionRatioSide();
                if (dimensionRatioSide != -1) {
                    if (dimensionRatioSide == 0) {
                        ConstraintWidget constraintWidget3 = this.widget;
                        dimensionRatio2 = (int) ((constraintWidget3.getDimensionRatio() * constraintWidget3.horizontalRun.dimension.value) + 0.5f);
            ...
            if (dependencyNode2.readyToSolve) {
                ...
                if (!this.dimension.resolved && this.dimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
                    ...
                    if (constraintWidget6.mMatchConstraintDefaultWidth == 0 && !constraintWidget6.isInVerticalChain()) {
                        ...
                        int i11 = i10 + dependencyNode5.margin;
                ...
                if (!this.dimension.resolved && this.dimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && this.matchConstraintsType == 1 && this.start.targets.size() > 0 && this.end.targets.size() > 0) {
                    ...
                    int i13 = (this.end.targets.get(0).value + this.end.margin) - (dependencyNode6.value + this.start.margin);
                    DimensionDependency dimensionDependency3 = this.dimension;
                ...
                if (this.dimension.resolved && this.start.targets.size() > 0 && this.end.targets.size() > 0) {
                    ...
                    int i15 = dependencyNode7.value + this.start.margin;
                    int i16 = dependencyNode8.value + this.end.margin;
                    ...
                    this.start.resolve((int) ((((i16 - i15) - this.dimension.value) * verticalBiasPercent) + i15 + 0.5f));
