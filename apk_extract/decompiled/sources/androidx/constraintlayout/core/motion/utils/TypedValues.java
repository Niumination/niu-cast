...
public interface TypedValues {
    ...
    public interface TransitionType {
        ...
        public static final String[] KEY_WORDS = {S_DURATION, "from", "to", S_PATH_MOTION_ARC, S_AUTO_TRANSITION, S_INTERPOLATOR, S_STAGGERED, "from", S_TRANSITION_FLAGS};
    ...
    boolean setValue(int i8, float f);

    boolean setValue(int i8, int i9);

    boolean setValue(int i8, String str);

    boolean setValue(int i8, boolean z2);
}
