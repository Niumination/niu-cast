...
public class KeyCache {
    ...
    public float getFloatValue(Object obj, String str, int i8) {
        ...
        float[] fArr;
        if (this.map.containsKey(obj) && (map = this.map.get(obj)) != null && map.containsKey(str) && (fArr = map.get(str)) != null && fArr.length > i8) {
            return fArr[i8];
        }
        return Float.NaN;
    }

    public void setFloatValue(Object obj, String str, int i8, float f) {
