...
public abstract class CurveFit {
    ...
    public static CurveFit get(int i8, double[] dArr, double[][] dArr2) {
        ...
        if (i8 != 0) {
            return i8 != 2 ? new LinearCurveFit(dArr, dArr2) : new Constant(dArr[0], dArr2[0]);
        }
