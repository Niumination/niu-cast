...
public class MotionWidget implements TypedValues {
    ...
    public void setCustomAttribute(String str, int i8, float f) {
        this.widgetFrame.setCustomAttribute(str, i8, f);
    }
    ...
    public boolean setValueAttributes(int i8, float f) {
        switch (i8) {
            case 303:
    ...
    public void setCustomAttribute(String str, int i8, boolean z2) {
        this.widgetFrame.setCustomAttribute(str, i8, z2);
    }

    @Override // androidx.constraintlayout.core.motion.utils.TypedValues
    public boolean setValue(int i8, float f) {
        if (setValueAttributes(i8, f)) {
            return true;
        }
        return setValueMotion(i8, f);
    }
    ...
    public boolean setValueMotion(int i8, float f) {
        switch (i8) {
            case 600:
