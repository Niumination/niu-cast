...
public class Carousel extends MotionHelper {
    ...
    private boolean enableTransition(int i8, boolean z2) {
        MotionLayout motionLayout;
        MotionScene.Transition transition;
        if (i8 == -1 || (motionLayout = this.mMotionLayout) == null || (transition = motionLayout.getTransition(i8)) == null || z2 == transition.isEnabled()) {
            return false;
        }
    ...
    public void updateItems() {
        ...
        for (int i8 = 0; i8 < size; i8++) {
            ...
            int iCount = (this.mIndex + i8) - this.startIndex;
            if (this.infiniteCarousel) {
                if (iCount < 0) {
                    int i9 = this.emptyViewBehavior;
                    if (i9 != 4) {
                        updateViewVisibility(view, i9);
                    } else {
        ...
        if (i11 != -1 && i11 != this.mIndex) {
            this.mMotionLayout.post(new c(this, 18));
    ...
    private boolean updateViewVisibility(View view, int i8) {
        ...
        for (int i9 : motionLayout.getConstraintSetIds()) {
            zUpdateViewVisibility |= updateViewVisibility(i9, view, i8);
        }
    ...
    public void onTransitionChange(MotionLayout motionLayout, int i8, int i9, float f) {
