...
public class MockView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.mDrawDiagonals) {
            ...
            float f = width;
            float f4 = height;
            canvas.drawLine(0.0f, 0.0f, f, f4, this.mPaintDiagonals);
            canvas.drawLine(0.0f, f4, f, 0.0f, this.mPaintDiagonals);
            canvas.drawLine(0.0f, 0.0f, f, 0.0f, this.mPaintDiagonals);
            canvas.drawLine(f, 0.0f, f, f4, this.mPaintDiagonals);
            canvas.drawLine(f, f4, 0.0f, f4, this.mPaintDiagonals);
            canvas.drawLine(0.0f, f4, 0.0f, 0.0f, this.mPaintDiagonals);
        }
