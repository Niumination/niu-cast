...
public class ImageFilterView extends AppCompatImageView {
    ...
    public static class ImageMatrix {
        ...
        private void warmth(float f) {
            ...
            if (f4 < 66.0f) {
                fLog2 = f4 > 19.0f ? (((float) Math.log(f4 - 10.0f)) * 138.51773f) - 305.0448f : 0.0f;
            } else {
                fLog2 = 255.0f;
            }
        ...
        public void updateMatrix(ImageView imageView) {
            ...
            if (f != 1.0f) {
                saturation(f);
                this.mColorMatrix.set(this.f1092m);
                z2 = true;
            } else {
                z2 = false;
            }
            ...
            if (f4 != 1.0f) {
                this.mTmpColorMatrix.setScale(f4, f4, f4, 1.0f);
            ...
            if (f10 != 1.0f) {
                warmth(f10);
                this.mTmpColorMatrix.set(this.f1092m);
                this.mColorMatrix.postConcat(this.mTmpColorMatrix);
                z2 = true;
            }
    ...
    private void setMatrix() {
        ...
        float f10 = Float.isNaN(this.mZoom) ? 1.0f : this.mZoom;
        float f11 = Float.isNaN(this.mRotate) ? 0.0f : this.mRotate;
        ...
        matrix.postTranslate(((((width - f13) * f) + width) - f13) * 0.5f, ((((height - f14) * f4) + height) - f14) * 0.5f);
    ...
    public void setAltImageResource(int i8) {
        Drawable drawableMutate = AppCompatResources.getDrawable(getContext(), i8).mutate();
