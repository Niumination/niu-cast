...
public class MotionLabel extends View implements FloatLayout {
    ...
    private void adjustTexture(float f, float f4, float f10, float f11) {
        if (this.mTextShaderMatrix == null) {
            return;
        }
        this.mFloatWidth = f10 - f;
        this.mFloatHeight = f11 - f4;
        updateShaderMatrix();
    }
    ...
    private float getVerticalOffset() {
        ...
        return (((1.0f - this.mTextPanY) * (measuredHeight - ((f4 - f10) * f))) / 2.0f) - (f * f10);
    }
    ...
    private void setTypefaceFromAttrs(String str, int i8, int i9) {
        ...
        if (str != null) {
            typefaceCreate = Typeface.create(str, i9);
        ...
        if (i9 <= 0) {
            ...
            Typeface typefaceDefaultFromStyle = typefaceCreate == null ? Typeface.defaultFromStyle(i9) : Typeface.create(typefaceCreate, i9);
    ...
    private void updateShaderMatrix() {
        ...
        float f12 = Float.isNaN(this.mTextureWidth) ? this.mFloatWidth : this.mTextureWidth;
        float f13 = Float.isNaN(this.mTextureHeight) ? this.mFloatHeight : this.mTextureHeight;
        float f14 = f10 * (width * f13 < height * f12 ? f12 / width : f13 / height);
        this.mTextShaderMatrix.postScale(f14, f14);
        float f15 = width * f14;
        float f16 = f12 - f15;
        float f17 = f14 * height;
        float f18 = f13 - f17;
        if (!Float.isNaN(this.mTextureHeight)) {
            f18 = this.mTextureHeight / 2.0f;
        }
        if (!Float.isNaN(this.mTextureWidth)) {
            f16 = this.mTextureWidth / 2.0f;
        }
        this.mTextShaderMatrix.postTranslate((((f * f16) + f12) - f15) * 0.5f, (((f4 * f18) + f13) - f17) * 0.5f);
        this.mTextShaderMatrix.postRotate(f11, f12 / 2.0f, f13 / 2.0f);
        this.mTextShader.setLocalMatrix(this.mTextShaderMatrix);
    }

    public Bitmap blur(Bitmap bitmap, int i8) {
        System.nanoTime();
    ...
    public void layout(int i8, int i9, int i10, int i11) {
        ...
        if (this.mAutoSize) {
            ...
            float f4 = (this.mFloatWidth - this.mPaddingRight) - this.mPaddingLeft;
            float f10 = (this.mFloatHeight - this.mPaddingBottom) - this.mPaddingTop;
            if (zIsNaN) {
                float f11 = iWidth;
                float f12 = iHeight;
                if (f11 * f10 > f12 * f4) {
                    this.mPaint.setTextSize((this.paintTextSize * f4) / f11);
                } else {
                ...
                float f13 = iWidth;
                float f14 = iHeight;
                f = f13 * f10 > f14 * f4 ? f4 / f13 : f10 / f14;
            }
        }
    ...
    public void layout(float f, float f4, float f10, float f11) {
        int i8 = (int) (f + 0.5f);
        this.mDeltaLeft = f - i8;
        int i9 = (int) (f10 + 0.5f);
        int i10 = i9 - i8;
        ...
        if (this.mAutoSize) {
            ...
            float f16 = iWidth;
            if (f16 * f15 > fHeight * f14) {
                this.mPaint.setTextSize((this.paintTextSize * f14) / f16);
            } else {
                this.mPaint.setTextSize((this.paintTextSize * f15) / fHeight);
            }
