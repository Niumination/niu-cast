...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private int fixLayoutEndGap(int i8, RecyclerView.Recycler recycler, RecyclerView.State state, boolean z2) {
        int endAfterPadding;
    ...
    private int fixLayoutStartGap(int i8, RecyclerView.Recycler recycler, RecyclerView.State state, boolean z2) {
    ...
    private void updateLayoutState(int i8, int i9, boolean z2, RecyclerView.State state) {
        int startAfterPadding;
        ...
        layoutState7.mAvailable = i9;
        if (z2) {
            layoutState7.mAvailable = i9 - startAfterPadding;
        }
    ...
    public View findOneVisibleChild(int i8, int i9, boolean z2, boolean z3) {
        ensureLayoutState();
    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LayoutState layoutState, LayoutChunkResult layoutChunkResult) {
        ...
        if (this.mOrientation == 1) {
            ...
            if (layoutState.mLayoutDirection == -1) {
                ...
                i8 = i12;
                i9 = decoratedMeasurementInOther;
                i10 = layoutChunkResult.mConsumed + i12;
            }
        } else {
            ...
            if (layoutState.mLayoutDirection == -1) {
                ...
                paddingLeft = i13 - layoutChunkResult.mConsumed;
            } else {
                int i14 = layoutState.mOffset;
                i8 = paddingTop;
                i9 = layoutChunkResult.mConsumed + i14;
                i10 = decoratedMeasurementInOther2;
                paddingLeft = i14;
            }
        }
        layoutDecoratedWithMargins(next, paddingLeft, i8, i9, i10);
    ...
    public void prepareForDrop(@NonNull View view, @NonNull View view2, int i8, int i9) {
        ...
        byte b9 = position < position2 ? (byte) 1 : (byte) -1;
        if (this.mShouldReverseLayout) {
            if (b9 == 1) {
    ...
    public int scrollBy(int i8, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        updateLayoutState(i9, iAbs, true, state);
        LayoutState layoutState = this.mLayoutState;
    ...
    public void setOrientation(int i8) {
        ...
        if (i8 != this.mOrientation || this.mOrientationHelper == null) {
            OrientationHelper orientationHelperCreateOrientationHelper = OrientationHelper.createOrientationHelper(this, i8);
