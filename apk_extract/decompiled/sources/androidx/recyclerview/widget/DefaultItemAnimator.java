...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public static class MoveInfo {
        ...
        public MoveInfo(RecyclerView.ViewHolder viewHolder, int i8, int i9, int i10, int i11) {
    ...
    public boolean animateChange(RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder viewHolder2, int i8, int i9, int i10, int i11) {
        ...
        this.mPendingChanges.add(new ChangeInfo(viewHolder, viewHolder2, i8, i9, i10, i11));
        return true;
    }
    ...
    public boolean animateMove(RecyclerView.ViewHolder viewHolder, int i8, int i9, int i10, int i11) {
        ...
        this.mPendingMoves.add(new MoveInfo(viewHolder, translationX, translationY, i10, i11));
        return true;
    }

    public void animateMoveImpl(final RecyclerView.ViewHolder viewHolder, int i8, int i9, int i10, int i11) {
        final View view = viewHolder.itemView;
    ...
    public void runPendingAnimations() {
        ...
        if (zIsEmpty && zIsEmpty2 && zIsEmpty3) {
            ...
            ViewCompat.postOnAnimationDelayed(arrayList3.get(0).itemView, runnable3, Math.max(!zIsEmpty2 ? getMoveDuration() : 0L, zIsEmpty3 ? 0L : getChangeDuration()) + (!zIsEmpty ? getRemoveDuration() : 0L));
        }
    }
    ...
    public static class ChangeInfo {
        ...
        public String toString() {
            ...
            sb2.append(this.toX);
            sb2.append(", toY=");
            return a.r(sb2, this.toY, '}');
        }

        public ChangeInfo(RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder viewHolder2, int i8, int i9, int i10, int i11) {
