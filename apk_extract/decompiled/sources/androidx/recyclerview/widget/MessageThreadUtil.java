...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    public static class MessageQueue {
        ...
        public synchronized void removeMessages(int i8) {
    ...
    public static class SyncQueueItem {
        ...
        public static SyncQueueItem obtainMessage(int i8, int i9, int i10, int i11, int i12, int i13, Object obj) {
            SyncQueueItem syncQueueItem;
        ...
        public static SyncQueueItem obtainMessage(int i8, int i9, int i10) {
            return obtainMessage(i8, i9, i10, 0, 0, 0, null);
        }

        public static SyncQueueItem obtainMessage(int i8, int i9, Object obj) {
            return obtainMessage(i8, i9, 0, 0, 0, 0, obj);
        }
    }
}
