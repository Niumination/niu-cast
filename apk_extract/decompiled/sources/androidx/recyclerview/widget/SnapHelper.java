...
public abstract class SnapHelper extends RecyclerView.OnFlingListener {
    ...
    private boolean snapFromFling(@NonNull RecyclerView.LayoutManager layoutManager, int i8, int i9) {
        RecyclerView.SmoothScroller smoothScrollerCreateScroller;
        int iFindTargetSnapPosition;
        if (!(layoutManager instanceof RecyclerView.SmoothScroller.ScrollVectorProvider) || (smoothScrollerCreateScroller = createScroller(layoutManager)) == null || (iFindTargetSnapPosition = findTargetSnapPosition(layoutManager, i8, i9)) == -1) {
            return false;
        }
    ...
    public abstract int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager, int i8, int i9);
    ...
    public boolean onFling(int i8, int i9) {
        ...
        return (Math.abs(i9) > minFlingVelocity || Math.abs(i8) > minFlingVelocity) && snapFromFling(layoutManager, i8, i9);
    }
