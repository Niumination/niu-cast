...
final class FakeDrag {
    ...
    private void addFakeMotionEvent(long j8, int i8, float f, float f4) {
        MotionEvent motionEventObtain = MotionEvent.obtain(this.mFakeDragBeginTime, j8, i8, f, f4, 0);
    ...
    public boolean fakeDragBy(float f) {
        ...
        int iRound = Math.round(f4 - this.mActualDraggedDistance);
        this.mActualDraggedDistance += iRound;
        long jUptimeMillis = SystemClock.uptimeMillis();
        boolean z2 = this.mViewPager.getOrientation() == 0;
        int i8 = z2 ? iRound : 0;
        int i9 = z2 ? 0 : iRound;
        float f10 = z2 ? this.mRequestedDragDistance : 0.0f;
        float f11 = z2 ? 0.0f : this.mRequestedDragDistance;
        this.mRecyclerView.scrollBy(i8, i9);
        addFakeMotionEvent(jUptimeMillis, 2, f10, f11);
        return true;
    }
