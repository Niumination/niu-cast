...
public final class ViewPager2 extends ViewGroup {
    ...
    public class LinearLayoutManagerImpl extends LinearLayoutManager {
        ...
        public boolean performAccessibilityAction(@NonNull RecyclerView.Recycler recycler, @NonNull RecyclerView.State state, int i8, @Nullable Bundle bundle) {
            return ViewPager2.this.mAccessibilityProvider.handlesLmPerformAccessibilityAction(i8) ? ViewPager2.this.mAccessibilityProvider.onLmPerformAccessibilityAction(i8) : super.performAccessibilityAction(recycler, state, i8, bundle);
        }
    ...
    public static abstract class OnPageChangeCallback {
        ...
        public void onPageScrolled(int i8, float f, @Px int i9) {
        }
    ...
    public class PageAwareAccessibilityProvider extends AccessibilityProvider {
        ...
        public boolean onPerformAccessibilityAction(int i8, Bundle bundle) {
            ...
            setCurrentItemFromAccessibilityCommand(i8 == 8192 ? ViewPager2.this.getCurrentItem() - 1 : ViewPager2.this.getCurrentItem() + 1);
            return true;
        }
        ...
        public void setCurrentItemFromAccessibilityCommand(int i8) {
            if (ViewPager2.this.isUserInputEnabled()) {
        ...
        public void updatePageAccessibilityActions() {
            ...
            int i9 = zIsRtl ? 16908360 : 16908361;
            if (zIsRtl) {
                i8 = 16908361;
            }
            if (ViewPager2.this.mCurrentItem < itemCount - 1) {
    ...
    public boolean fakeDragBy(@Px float f) {
    ...
    public boolean performAccessibilityAction(int i8, Bundle bundle) {
        return this.mAccessibilityProvider.handlesPerformAccessibilityAction(i8, bundle) ? this.mAccessibilityProvider.onPerformAccessibilityAction(i8, bundle) : super.performAccessibilityAction(i8, bundle);
    }
    ...
    public void requestTransform() {
        ...
        float f = (float) (relativeScrollPosition - ((double) i8));
        this.mPageTransformerAdapter.onPageScrolled(i8, f, Math.round(getPageSize() * f));
    }
    ...
    public void setCurrentItemInternal(int i8, boolean z2) {
        ...
        double relativeScrollPosition = i9;
        ...
        double d7 = iMin;
        if (Math.abs(d7 - relativeScrollPosition) <= 3.0d) {
            this.mRecyclerView.smoothScrollToPosition(iMin);
            return;
        }
        this.mRecyclerView.scrollToPosition(d7 > relativeScrollPosition ? iMin - 3 : iMin + 3);
        RecyclerView recyclerView = this.mRecyclerView;
    ...
    public void snapToPage() {
        ...
        this.mRecyclerView.smoothScrollBy(i8, iArrCalculateDistanceToFinalSnap[1]);
    }
