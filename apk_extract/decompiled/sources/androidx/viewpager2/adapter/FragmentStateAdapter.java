...
public abstract class FragmentStateAdapter extends RecyclerView.Adapter<FragmentViewHolder> implements StatefulAdapter {
        ...
        public void updateFragmentMaxLifecycle(boolean z2) {
            ...
            if ((itemId != this.mPrimaryItemId || z2) && (fragment = FragmentStateAdapter.this.mFragments.get(itemId)) != null && fragment.isAdded()) {
                ...
                for (int i8 = 0; i8 < FragmentStateAdapter.this.mFragments.size(); i8++) {
                    long jKeyAt = FragmentStateAdapter.this.mFragments.keyAt(i8);
                    Fragment fragmentValueAt = FragmentStateAdapter.this.mFragments.valueAt(i8);
    ...
    private Long itemForViewHolder(int i8) {
        ...
        for (int i9 = 0; i9 < this.mItemIdToViewHolder.size(); i9++) {
            if (this.mItemIdToViewHolder.valueAt(i9).intValue() == i8) {
                ...
                lValueOf = Long.valueOf(this.mItemIdToViewHolder.keyAt(i9));
            }
        }
        return lValueOf;
    }
    ...
    private void removeFragment(long j8) {
        ...
        if (fragment.isAdded() && containsItem(j8)) {
            this.mSavedStates.put(j8, this.mFragmentManager.saveFragmentInstanceState(fragment));
        }
    ...
    public void gcFragments() {
        ...
        for (int i8 = 0; i8 < this.mFragments.size(); i8++) {
            long jKeyAt = this.mFragments.keyAt(i8);
        ...
        if (!this.mIsInGracePeriod) {
            ...
            for (int i9 = 0; i9 < this.mFragments.size(); i9++) {
                long jKeyAt2 = this.mFragments.keyAt(i9);
        ...
        for (String str : bundle.keySet()) {
            if (isValidKey(str, KEY_PREFIX_FRAGMENT)) {
                ...
                if (!isValidKey(str, KEY_PREFIX_STATE)) {
                    throw new IllegalArgumentException(a.i("Unexpected key in savedState: ", str));
                }
    ...
    public final Parcelable saveState() {
        ...
        for (int i9 = 0; i9 < this.mSavedStates.size(); i9++) {
            long jKeyAt2 = this.mSavedStates.keyAt(i9);
    ...
    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public final void onBindViewHolder(@NonNull final FragmentViewHolder fragmentViewHolder, int i8) {
