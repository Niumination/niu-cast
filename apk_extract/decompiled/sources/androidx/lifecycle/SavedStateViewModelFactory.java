    ...
    public final <T extends ViewModel> T create(String key, Class<T> modelClass) {
        ...
        if (lifecycle != null) {
            ...
            if (zIsAssignableFrom && (application = this.application) != null) {
                ...
                t3 = (T) SavedStateViewModelFactoryKt.newInstance(modelClass, constructorFindMatchingConstructor, application, savedStateHandleControllerCreate.getHandle());
            } else {
                t3 = (T) SavedStateViewModelFactoryKt.newInstance(modelClass, constructorFindMatchingConstructor, savedStateHandleControllerCreate.getHandle());
            }
            t3.setTagIfAbsent("androidx.lifecycle.savedstate.vm.tag", savedStateHandleControllerCreate);
            return t3;
        }
