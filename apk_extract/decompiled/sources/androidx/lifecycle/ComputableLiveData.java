...
public abstract class ComputableLiveData<T> {
    ...
    public ComputableLiveData(Executor executor) {
        ...
        this.refreshRunnable = new Runnable(this) { // from class: w0.a

            /* JADX INFO: renamed from: b, reason: collision with root package name */
            public final /* synthetic */ ComputableLiveData f10626b;
            ...
            public final void run() {
                int i9 = i8;
                ComputableLiveData computableLiveData = this.f10626b;
                switch (i9) {
                    case 0:
        ...
        final int i9 = 1;
        this.invalidationRunnable = new Runnable(this) { // from class: w0.a
    ...
    public /* synthetic */ ComputableLiveData(Executor executor, int i8, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i8 & 1) != 0) {
