...
public final class SpringAnimation extends DynamicAnimation<SpringAnimation> {
    ...
    public float getAcceleration(float f, float f4) {
        return this.mSpring.getAcceleration(f, f4);
    }
    ...
    public boolean isAtEquilibrium(float f, float f4) {
        return this.mSpring.isAtEquilibrium(f, f4);
    }
    ...
    public boolean updateValueAndVelocity(long j8) {
        ...
        if (this.mPendingPosition != Float.MAX_VALUE) {
            ...
            long j10 = j8 / 2;
            DynamicAnimation.MassState massStateUpdateValues = this.mSpring.updateValues(this.mValue, this.mVelocity, j10);
            this.mSpring.setFinalPosition(this.mPendingPosition);
            this.mPendingPosition = Float.MAX_VALUE;
            DynamicAnimation.MassState massStateUpdateValues2 = this.mSpring.updateValues(massStateUpdateValues.mValue, massStateUpdateValues.mVelocity, j10);
            this.mValue = massStateUpdateValues2.mValue;
            this.mVelocity = massStateUpdateValues2.mVelocity;
        } else {
            DynamicAnimation.MassState massStateUpdateValues3 = this.mSpring.updateValues(this.mValue, this.mVelocity, j8);
    ...
    public <K> SpringAnimation(K k8, FloatPropertyCompat<K> floatPropertyCompat, float f) {
        super(k8, floatPropertyCompat);
        this.mSpring = null;
        this.mPendingPosition = Float.MAX_VALUE;
        this.mEndRequested = false;
