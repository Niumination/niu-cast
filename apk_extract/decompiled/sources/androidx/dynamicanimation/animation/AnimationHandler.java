...
class AnimationHandler {
    ...
    private boolean isCallbackDue(AnimationFrameCallback animationFrameCallback, long j8) {
        Long l4 = this.mDelayedCallbackStartTime.get(animationFrameCallback);
        if (l4 == null) {
            return true;
        }
        if (l4.longValue() >= j8) {
    ...
    public void addAnimationFrameCallback(AnimationFrameCallback animationFrameCallback, long j8) {
    ...
    public void doAnimationFrame(long j8) {
