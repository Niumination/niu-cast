...
public abstract class DynamicAnimation<T extends DynamicAnimation<T>> implements AnimationHandler.AnimationFrameCallback {
    ...
    public interface OnAnimationEndListener {
        void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z2, float f, float f4);
    }

    public interface OnAnimationUpdateListener {
        void onAnimationUpdate(DynamicAnimation dynamicAnimation, float f, float f4);
    }
    ...
    private void endAnimationInternal(boolean z2) {
        ...
        for (int i8 = 0; i8 < this.mEndListeners.size(); i8++) {
            if (this.mEndListeners.get(i8) != null) {
                this.mEndListeners.get(i8).onAnimationEnd(this, z2, this.mValue, this.mVelocity);
            }
        }
    ...
    public boolean doAnimationFrame(long j8) {
        ...
        this.mLastFrameTime = j8;
        boolean zUpdateValueAndVelocity = updateValueAndVelocity(j8 - j10);
    ...
    public abstract float getAcceleration(float f, float f4);
    ...
    public abstract boolean isAtEquilibrium(float f, float f4);
    ...
    public abstract boolean updateValueAndVelocity(long j8);
