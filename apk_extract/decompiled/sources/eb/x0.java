...
public final class x0 extends SuspendLambda implements Function2 {
    ...
    public x0(li.j jVar, Continuation<? super x0> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new x0(this.$it, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        Intrinsics.checkNotNullParameter("openWifi fail, listener timeout", "log");
        if (gc.f6462a <= 4) {
            Log.i(gc.f6463b.concat("PCConnectSwitchManager"), "openWifi fail, listener timeout");
        }
