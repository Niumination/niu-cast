...
public final class a2 extends SuspendLambda implements Function2 {
    ...
    public a2(String str, Continuation<? super a2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new a2(this.$reason, continuation);
    }
    ...
    public final Object invoke(li.g0 g0Var, Continuation<? super Unit> continuation) {
        return ((a2) create(g0Var, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
