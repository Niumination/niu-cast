...
public final class e0 extends SuspendLambda implements Function2 {
    ...
    public e0(Device device, boolean z2, Continuation<? super e0> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new e0(this.$device, this.$enable, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        dc.i.f4411a.a(new b0(this.$device, this.$enable, 2));
