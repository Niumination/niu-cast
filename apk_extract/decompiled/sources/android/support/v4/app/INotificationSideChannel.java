...
public interface INotificationSideChannel extends IInterface {
    ...
    void cancel(String str, int i8, String str2) throws RemoteException;

    void cancelAll(String str) throws RemoteException;

    void notify(String str, int i8, String str2, Notification notification) throws RemoteException;
}
