...
class PathsKt__PathRecursiveFunctionsKt extends PathsKt__PathReadWriteKt {
    ...
    @ExperimentalPathApi
    public static final Path copyToRecursively(Path path, Path target, Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult> onError, boolean z2, boolean z3) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(target, "target");
        Intrinsics.checkNotNullParameter(onError, "onError");
        return z3 ? copyToRecursively(path, target, onError, z2, new a(z2, 1)) : copyToRecursively$default(path, target, onError, z2, (Function3) null, 8, (Object) null);
    }
    ...
    public static /* synthetic */ Path copyToRecursively$default(Path path, Path path2, Function3 function3, boolean z2, boolean z3, int i8, Object obj) {
        if ((i8 & 2) != 0) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final CopyActionResult copyToRecursively$lambda$0$PathsKt__PathRecursiveFunctionsKt(boolean z2, CopyActionContext copyToRecursively, Path src, Path dst) throws FileSystemException {
    ...
    private static final List<Exception> deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt(Path path) {
        ...
        int i8 = 0;
        int i9 = 1;
        ExceptionsCollector exceptionsCollector = new ExceptionsCollector(i8, i9, null);
        ...
        if (secureDirectoryStreamNewDirectoryStream != null) {
            try {
                ...
                try {
                    ...
                    CloseableKt.closeFinally(secureDirectoryStreamNewDirectoryStream, th2);
                    throw th3;
                }
            }
        }
    ...
    /* JADX WARN: Code duplicated, block: B:11:0x002e A[Catch: Exception -> 0x0013, NoSuchFileException -> 0x003d, TRY_ENTER, TryCatch #0 {NoSuchFileException -> 0x003d, blocks: (B:11:0x002e, B:12:0x0034), top: B:19:0x001f }] */
    /* JADX WARN: Code duplicated, block: B:12:0x0034 A[Catch: Exception -> 0x0013, NoSuchFileException -> 0x003d, TRY_LEAVE, TryCatch #0 {NoSuchFileException -> 0x003d, blocks: (B:11:0x002e, B:12:0x0034), top: B:19:0x001f }] */
    /* JADX WARN: Code duplicated, block: B:9:0x0021 A[Catch: Exception -> 0x0013, TRY_LEAVE, TryCatch #1 {Exception -> 0x0013, blocks: (B:4:0x0005, B:7:0x0015, B:9:0x0021, B:11:0x002e, B:12:0x0034), top: B:21:0x0005 }] */
    ...
    @SinceKotlin(version = "1.8")
    @ExperimentalPathApi
    public static final Path copyToRecursively(final Path path, final Path target, final Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult> onError, boolean z2, final Function3<? super CopyActionContext, ? super Path, ? super Path, ? extends CopyActionResult> copyAction) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(target, "target");
        Intrinsics.checkNotNullParameter(onError, "onError");
        ...
        if (Files.exists(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))) {
            ...
            PathsKt__PathUtilsKt.visitFileTree$default(path, 0, z2, new Function1() { // from class: kotlin.io.path.b
                ...
                public final Object invoke(Object obj) {
                    ...
                    Path path2 = target;
                    Path path3 = pathNormalize;
                    return PathsKt__PathRecursiveFunctionsKt.copyToRecursively$lambda$6$PathsKt__PathRecursiveFunctionsKt(arrayList2, copyAction, path, path2, path3, onError, (FileVisitorBuilder) obj);
                }
            }, 1, (Object) null);
            return target;
        }
    ...
    public static /* synthetic */ Path copyToRecursively$default(Path path, Path path2, Function3 function3, boolean z2, Function3 function4, int i8, Object obj) {
        if ((i8 & 2) != 0) {
        ...
        if ((i8 & 8) != 0) {
            function4 = new a(z2, 0);
        }
        return copyToRecursively(path, path2, (Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult>) function3, z2, (Function3<? super CopyActionContext, ? super Path, ? super Path, ? extends CopyActionResult>) function4);
    }
