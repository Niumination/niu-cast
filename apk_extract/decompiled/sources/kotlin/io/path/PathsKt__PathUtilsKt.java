...
class PathsKt__PathUtilsKt extends PathsKt__PathRecursiveFunctionsKt {
    ...
    public static /* synthetic */ Path copyTo$default(Path path, Path target, boolean z2, int i8, Object obj) throws IOException {
        if ((i8 & 2) != 0) {
            z2 = false;
        }
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    public static /* synthetic */ Path createTempDirectory$default(String str, FileAttribute[] attributes, int i8, Object obj) throws IOException {
        if ((i8 & 1) != 0) {
            str = null;
        }
        Intrinsics.checkNotNullParameter(attributes, "attributes");
    ...
    public static /* synthetic */ Path createTempFile$default(String str, String str2, FileAttribute[] attributes, int i8, Object obj) throws IOException {
        if ((i8 & 1) != 0) {
            str = null;
        }
        if ((i8 & 2) != 0) {
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesView(Path path, LinkOption... options) {
        ...
        V v3 = (V) Files.getFileAttributeView(path, FileAttributeView.class, (LinkOption[]) Arrays.copyOf(options, options.length));
        if (v3 != null) {
            return v3;
        }
        Intrinsics.reifiedOperationMarker(4, ExifInterface.GPS_MEASUREMENT_INTERRUPTED);
    ...
    public static /* synthetic */ void forEachDirectoryEntry$default(Path path, String glob, Function1 action, int i8, Object obj) throws IOException {
        if ((i8 & 1) != 0) {
            glob = e.ANY_MARKER;
        }
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    public static final String getInvariantSeparatorsPathString(Path path) {
        ...
        boolean zAreEqual = Intrinsics.areEqual(separator, "/");
    ...
    public static final String getNameWithoutExtension(Path path) {
        ...
        Intrinsics.checkNotNullParameter(path, "<this>");
        Path fileName = path.getFileName();
        return (fileName == null || (string = fileName.toString()) == null || (strSubstringBeforeLast$default = StringsKt__StringsKt.substringBeforeLast$default(string, ".", (String) null, 2, (Object) null)) == null) ? "" : strSubstringBeforeLast$default;
    }
    ...
    public static /* synthetic */ List listDirectoryEntries$default(Path path, String str, int i8, Object obj) throws IOException {
        if ((i8 & 1) != 0) {
            str = e.ANY_MARKER;
        }
    ...
    public static /* synthetic */ Path moveTo$default(Path path, Path target, boolean z2, int i8, Object obj) throws IOException {
        if ((i8 & 2) != 0) {
            z2 = false;
        }
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    private static final /* synthetic */ <A extends BasicFileAttributes> A readAttributes(Path path, LinkOption... options) throws IOException {
        ...
        A a6 = (A) Files.readAttributes(path, BasicFileAttributes.class, (LinkOption[]) Arrays.copyOf(options, options.length));
        Intrinsics.checkNotNullExpressionValue(a6, "readAttributes(...)");
        return a6;
    }
    ...
    private static final <T> T useDirectoryEntries(Path path, String glob, Function1<? super Sequence<? extends Path>, ? extends T> block) throws IOException {
        ...
        try {
            Intrinsics.checkNotNull(directoryStreamNewDirectoryStream);
            T tInvoke = block.invoke(CollectionsKt.asSequence(directoryStreamNewDirectoryStream));
            InlineMarker.finallyStart(1);
            if (PlatformImplementationsKt.apiVersionIsAtLeast(1, 1, 0)) {
                CloseableKt.closeFinally(directoryStreamNewDirectoryStream, null);
            } else if (directoryStreamNewDirectoryStream != null) {
    ...
    public static /* synthetic */ Object useDirectoryEntries$default(Path path, String glob, Function1 block, int i8, Object obj) throws IOException {
        if ((i8 & 1) != 0) {
            glob = e.ANY_MARKER;
        }
        Intrinsics.checkNotNullParameter(path, "<this>");
        ...
        try {
            Intrinsics.checkNotNull(directoryStreamNewDirectoryStream);
            Object objInvoke = block.invoke(CollectionsKt.asSequence(directoryStreamNewDirectoryStream));
            InlineMarker.finallyStart(1);
            if (PlatformImplementationsKt.apiVersionIsAtLeast(1, 1, 0)) {
                CloseableKt.closeFinally(directoryStreamNewDirectoryStream, null);
            } else if (directoryStreamNewDirectoryStream != null) {
    ...
    @SinceKotlin(version = "2.1")
    @WasExperimental(markerClass = {ExperimentalPathApi.class})
    public static final void visitFileTree(Path path, FileVisitor<Path> visitor, int i8, boolean z2) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(visitor, "visitor");
        Files.walkFileTree(path, z2 ? SetsKt.setOf(FileVisitOption.FOLLOW_LINKS) : SetsKt.emptySet(), i8, visitor);
    }

    public static /* synthetic */ void visitFileTree$default(Path path, FileVisitor fileVisitor, int i8, boolean z2, int i9, Object obj) throws IOException {
        if ((i9 & 2) != 0) {
        ...
        visitFileTree(path, (FileVisitor<Path>) fileVisitor, i8, z2);
    }
    ...
    public static /* synthetic */ void visitFileTree$default(Path path, int i8, boolean z2, Function1 function1, int i9, Object obj) throws IOException {
        if ((i9 & 1) != 0) {
            i8 = Integer.MAX_VALUE;
        }
        if ((i9 & 2) != 0) {
        ...
        visitFileTree(path, i8, z2, (Function1<? super FileVisitorBuilder, Unit>) function1);
    }
    ...
    public static /* synthetic */ Path createTempDirectory$default(Path path, String str, FileAttribute[] fileAttributeArr, int i8, Object obj) throws IOException {
        if ((i8 & 2) != 0) {
            str = null;
        }
    ...
    public static /* synthetic */ Path createTempFile$default(Path path, String str, String str2, FileAttribute[] fileAttributeArr, int i8, Object obj) throws IOException {
        if ((i8 & 2) != 0) {
            str = null;
        }
        if ((i8 & 4) != 0) {
    ...
    @SinceKotlin(version = "2.1")
    @WasExperimental(markerClass = {ExperimentalPathApi.class})
    public static final void visitFileTree(Path path, int i8, boolean z2, Function1<? super FileVisitorBuilder, Unit> builderAction) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(builderAction, "builderAction");
        visitFileTree(path, fileVisitor(builderAction), i8, z2);
    }
}
