...
@Metadata(d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0012\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\r\b\u0003\u0018\u00002\u00020\u0001B\u0017\u0012\u0006\u0010\u0002\u001a\u00020\u0001\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0004\b\u0005\u0010\u0006J\u0010\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\nH\u0016J \u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0012\u001a\u00020\f2\u0006\u0010\u0013\u001a\u00020\n2\u0006\u0010\u0014\u001a\u00020\nH\u0016J\b\u0010\u0015\u001a\u00020\u0010H\u0016J\b\u0010\u0016\u001a\u00020\u0010H\u0016J \u0010\u0017\u001a\u00020\n2\u0006\u0010\u0012\u001a\u00020\f2\u0006\u0010\u0018\u001a\u00020\n2\u0006\u0010\u0019\u001a\u00020\nH\u0002J\b\u0010\u001a\u001a\u00020\u0010H\u0002J \u0010\u001b\u001a\u00020\n2\u0006\u0010\u0012\u001a\u00020\f2\u0006\u0010\u0018\u001a\u00020\n2\u0006\u0010\u0019\u001a\u00020\nH\u0002J\b\u0010\u001c\u001a\u00020\u0010H\u0002R\u000e\u0010\u0002\u001a\u00020\u0001X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\bX\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\nX\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u000b\u001a\u00020\fX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\r\u001a\u00020\fX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u000e\u001a\u00020\nX\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u001d"}, d2 = {"Lkotlin/io/encoding/EncodeOutputStream;", "Ljava/io/OutputStream;", "output", "base64", "Lkotlin/io/encoding/Base64;", "<init>", "(Ljava/io/OutputStream;Lkotlin/io/encoding/Base64;)V", "isClosed", "", "lineLength", "", "symbolBuffer", "", "byteBuffer", "byteBufferLength", "write", "", "b", TranssionPoolExecutor.DEFAULT_SOURCE_EXECUTOR_NAME, TypedValues.CycleType.S_WAVE_OFFSET, "length", "flush", "close", "copyIntoByteBuffer", "startIndex", "endIndex", "encodeByteBufferIntoOutput", "encodeIntoOutput", "checkOpen", "kotlin-stdlib"}, k = 1, mv = {2, 1, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
final class EncodeOutputStream extends OutputStream {
    ...
    private final int copyIntoByteBuffer(byte[] source, int startIndex, int endIndex) {
        ...
        int i8 = this.byteBufferLength + iMin;
        this.byteBufferLength = i8;
        if (i8 == 3) {
    ...
    public void write(int b9) throws IOException {
        checkOpen();
        byte[] bArr = this.byteBuffer;
        int i8 = this.byteBufferLength;
        int i9 = i8 + 1;
    ...
    public void write(byte[] source, int offset, int length) throws IOException {
        ...
        checkOpen();
        if (offset < 0 || length < 0 || (i8 = offset + length) > source.length) {
            StringBuilder sbR = d.r(offset, length, "offset: ", ", length: ", ", source size: ");
            sbR.append(source.length);
            throw new IndexOutOfBoundsException(sbR.toString());
        }
        if (length == 0) {
            return;
        }
        int i9 = this.byteBufferLength;
        if (i9 < 3) {
            if (i9 != 0) {
                offset += copyIntoByteBuffer(source, offset, i8);
                if (this.byteBufferLength != 0) {
                    return;
                }
            }
            while (offset + 3 <= i8) {
                int iMin = Math.min((this.base64.getIsMimeScheme() ? this.lineLength : this.symbolBuffer.length) / 4, (i8 - offset) / 3);
                int i10 = (iMin * 3) + offset;
                if (encodeIntoOutput(source, offset, i10) != iMin * 4) {
                    throw new IllegalStateException("Check failed.");
                }
                offset = i10;
            }
            ArraysKt.copyInto(source, this.byteBuffer, 0, offset, i8);
            this.byteBufferLength = i8 - offset;
            return;
        }
        throw new IllegalStateException("Check failed.");
    }
