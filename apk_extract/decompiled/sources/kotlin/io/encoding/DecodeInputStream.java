...
final class DecodeInputStream extends InputStream {
    ...
    private final void copyByteBufferInto(byte[] dst, int dstOffset, int length) {
        ...
        int i8 = this.byteBufferStartIndex;
        ArraysKt.copyInto(bArr, dst, dstOffset, i8, i8 + length);
    ...
    private final int decodeSymbolBufferInto(byte[] dst, int dstOffset, int dstEndIndex, int symbolBufferLength) {
        int i8 = this.byteBufferEndIndex;
        this.byteBufferEndIndex = i8 + this.base64.decodeIntoByteArray(this.symbolBuffer, this.byteBuffer, i8, 0, symbolBufferLength);
    ...
    private final int readNextSymbol() throws IOException {
        ...
        } while (!Base64Kt.isInMimeAlphabet(i8));
        return i8;
    }
    ...
    private final void shiftByteBufferToStartIfNeeded() {
        ...
        int i8 = this.byteBufferEndIndex;
        if ((this.symbolBuffer.length / 4) * 3 > length - i8) {
            ArraysKt.copyInto(bArr, bArr, 0, this.byteBufferStartIndex, i8);
    ...
    public int read() throws IOException {
        int i8 = this.byteBufferStartIndex;
        if (i8 < this.byteBufferEndIndex) {
            int i9 = this.byteBuffer[i8] & UByte.MAX_VALUE;
            this.byteBufferStartIndex = i8 + 1;
            resetByteBufferIfEmpty();
            return i9;
        }
        int i10 = read(this.singleByteBuffer, 0, 1);
        if (i10 == -1) {
            return -1;
        }
        if (i10 == 1) {
    ...
    public int read(byte[] destination, int offset, int length) throws IOException {
        ...
        if (offset >= 0 && length >= 0 && (i8 = offset + length) <= destination.length) {
            if (!this.isClosed) {
                if (this.isEOF) {
                    return -1;
                }
                ...
                while (true) {
                    ...
                    while (true) {
                        z3 = this.isEOF;
                        if (z3 || iHandlePaddingSymbol >= iMin) {
                            break;
                        }
                        int nextSymbol = readNextSymbol();
                        if (nextSymbol == -1) {
                    ...
                    iDecodeSymbolBufferInto += decodeSymbolBufferInto(destination, iDecodeSymbolBufferInto, i8, iHandlePaddingSymbol);
                }
                if (iDecodeSymbolBufferInto == offset && z2) {
                    return -1;
                }
        ...
        StringBuilder sbR = d.r(offset, length, "offset: ", ", length: ", ", buffer size: ");
        sbR.append(destination.length);
