...
public final class TextStreamsKt {
    ...
    public static /* synthetic */ BufferedReader buffered$default(Reader reader, int i8, int i9, Object obj) {
        if ((i9 & 1) != 0) {
            i8 = 8192;
        }
        Intrinsics.checkNotNullParameter(reader, "<this>");
    ...
    public static final byte[] readBytes(URL url) throws IOException {
        ...
        try {
            ...
            try {
                ...
                CloseableKt.closeFinally(inputStreamOpenStream, th2);
                throw th3;
            }
        }
    }
    ...
    public static final List<String> readLines(Reader reader) {
        ...
        forEachLine(reader, new d0(arrayList, 3));
        return arrayList;
    }
    ...
    public static /* synthetic */ String readText$default(URL url, Charset charset, int i8, Object obj) {
        if ((i8 & 1) != 0) {
    ...
    public static /* synthetic */ BufferedWriter buffered$default(Writer writer, int i8, int i9, Object obj) {
        if ((i9 & 1) != 0) {
            i8 = 8192;
        }
        Intrinsics.checkNotNullParameter(writer, "<this>");
