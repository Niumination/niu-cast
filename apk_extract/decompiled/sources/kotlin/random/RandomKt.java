...
public final class RandomKt {
    ...
    public static final void checkRangeBounds(long j8, long j10) {
        if (j10 <= j8) {
            throw new IllegalArgumentException(boundsErrorMessage(Long.valueOf(j8), Long.valueOf(j10)).toString());
        }
    }
