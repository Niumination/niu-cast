...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
    ...
    public static final class Companion {
        ...
        public final String getClassSimpleName(Class<?> jClass) {
            ...
            if (enclosingMethod != null) {
                ...
                String strSubstringAfter$default = StringsKt__StringsKt.substringAfter$default(simpleName, enclosingMethod.getName() + Typography.dollar, (String) null, 2, (Object) null);
    ...
    static {
        ...
        ArrayList arrayList = new ArrayList(CollectionsKt.i(listListOf));
        int i8 = 0;
        for (Object obj : listListOf) {
            ...
            arrayList.add(TuplesKt.to((Class) obj, Integer.valueOf(i8)));
            i8 = i9;
        }
