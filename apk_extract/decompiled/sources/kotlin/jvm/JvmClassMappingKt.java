...
public final class JvmClassMappingKt {
    ...
    private static final <E extends Enum<E>> Class<E> getDeclaringJavaClass(Enum<E> r7) {
    ...
    @InlineOnly
    public static /* synthetic */ void getDeclaringJavaClass$annotations(Enum r7) {
    }
    ...
    public static final <T> Class<T> getJavaClass(T t3) {
        Intrinsics.checkNotNullParameter(t3, "<this>");
