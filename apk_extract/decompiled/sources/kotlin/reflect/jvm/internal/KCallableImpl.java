...
public abstract class KCallableImpl<R> implements KCallable<R>, KTypeParameterOwnerImpl {
    ...
    public static final Object[] _absentArguments$lambda$14(KCallableImpl kCallableImpl) {
        ...
        int i8 = (parameterTypeSize + 31) / 32;
    ...
    public static final ArrayList _parameters$lambda$5(KCallableImpl kCallableImpl) {
        ...
        if (kCallableImpl.isBound()) {
            ...
            if (extensionReceiverParameter != null) {
                arrayList.add(new KParameterImpl(kCallableImpl, i8, KParameter.Kind.EXTENSION_RECEIVER, new Function0(extensionReceiverParameter) { // from class: kotlin.reflect.jvm.internal.KCallableImpl$$Lambda$7
                    private final ReceiverParameterDescriptor arg$0;
        ...
        while (i9 < size) {
            arrayList.add(new KParameterImpl(kCallableImpl, i8, KParameter.Kind.VALUE, new Function0(descriptor, i9) { // from class: kotlin.reflect.jvm.internal.KCallableImpl$$Lambda$8
        ...
        if (kCallableImpl.isAnnotationConstructor() && (descriptor instanceof JavaCallableMemberDescriptor) && arrayList.size() > 1) {
            CollectionsKt.sortWith(arrayList, new Comparator() { // from class: kotlin.reflect.jvm.internal.KCallableImpl$_parameters$lambda$5$$inlined$sortBy$1
                ...
                public final int compare(T t3, T t8) {
                    return ComparisonsKt.compareValues(((KParameter) t3).getName(), ((KParameter) t8).getName());
                }
            });
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final ParameterDescriptor _parameters$lambda$5$lambda$3(CallableMemberDescriptor callableMemberDescriptor, int i8) {
        ValueParameterDescriptor valueParameterDescriptor = callableMemberDescriptor.getValueParameters().get(i8);
    ...
    public final R callDefaultMethod$kotlin_reflection(Map<KParameter, ? extends Object> args, Continuation<?> continuationArgument) throws IllegalCallableAccessException {
        ...
        for (KParameter kParameter : parameters) {
            ...
            if (args.containsKey(kParameter)) {
                ...
                if (zBooleanValue) {
                    int i9 = i8 + parameterTypeSize;
                    for (int i10 = i8; i10 < i9; i10++) {
                        int i11 = (i10 / 32) + size;
                        Object obj = absentArguments[i11];
                        Intrinsics.checkNotNull(obj, "null cannot be cast to non-null type kotlin.Int");
                        absentArguments[i11] = Integer.valueOf(((Integer) obj).intValue() | (1 << (i10 % 32)));
                    }
                } else {
                    int i12 = (i8 / 32) + size;
                    Object obj2 = absentArguments[i12];
                    Intrinsics.checkNotNull(obj2, "null cannot be cast to non-null type kotlin.Int");
                    absentArguments[i12] = Integer.valueOf(((Integer) obj2).intValue() | (1 << (i8 % 32)));
                }
                z2 = true;
