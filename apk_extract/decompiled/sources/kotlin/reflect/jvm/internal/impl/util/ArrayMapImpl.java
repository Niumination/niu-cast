...
public final class ArrayMapImpl<T> extends ArrayMap<T> {
    ...
    private ArrayMapImpl(Object[] objArr, int i8) {
        super(null);
        this.data = objArr;
        this.size = i8;
    }
    ...
    public T get(int i8) {
        return (T) ArraysKt.getOrNull(this.data, i8);
    }
        ...
        return new AbstractIterator<T>(this) { // from class: kotlin.reflect.jvm.internal.impl.util.ArrayMapImpl.iterator.1
            ...
            public void computeNext() {
                do {
                    int i8 = this.index + 1;
                    this.index = i8;
                    if (i8 >= ((ArrayMapImpl) this.this$0).data.length) {
                        break;
                    }
    ...
    @Override // kotlin.reflect.jvm.internal.impl.util.ArrayMap
    public void set(int i8, T value) {
