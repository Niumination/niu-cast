...
public interface TypeSystemContext extends TypeSystemOptimizationContext {
    ...
    TypeArgumentMarker get(TypeArgumentListMarker typeArgumentListMarker, int i8);

    TypeArgumentMarker getArgument(KotlinTypeMarker kotlinTypeMarker, int i8);

    TypeArgumentMarker getArgumentOrNull(SimpleTypeMarker simpleTypeMarker, int i8);

    List<TypeArgumentMarker> getArguments(KotlinTypeMarker kotlinTypeMarker);

    TypeParameterMarker getParameter(TypeConstructorMarker typeConstructorMarker, int i8);
