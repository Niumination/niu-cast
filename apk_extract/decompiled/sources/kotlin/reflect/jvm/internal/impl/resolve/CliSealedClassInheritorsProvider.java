...
public final class CliSealedClassInheritorsProvider extends SealedClassInheritorsProvider {
        ...
        for (DeclarationDescriptor declarationDescriptor : ResolutionScope.DefaultImpls.getContributedDescriptors$default(memberScope, DescriptorKindFilter.CLASSIFIERS, null, 2, null)) {
            if (declarationDescriptor instanceof ClassDescriptor) {
                ...
                if (classDescriptor2.isExpect()) {
                    ...
                    ClassifierDescriptor classifierDescriptorMo1439getContributedClassifier = memberScope.mo1439getContributedClassifier(name, NoLookupLocation.WHEN_GET_ALL_DESCRIPTORS);
                    classDescriptor2 = classifierDescriptorMo1439getContributedClassifier instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo1439getContributedClassifier : classifierDescriptorMo1439getContributedClassifier instanceof TypeAliasDescriptor ? ((TypeAliasDescriptor) classifierDescriptorMo1439getContributedClassifier).getClassDescriptor() : null;
                }
    ...
    public Collection<ClassDescriptor> computeSealedSubclasses(ClassDescriptor sealedClass, boolean z2) {
