...
public final class LazyJavaClassDescriptor extends ClassDescriptorBase implements JavaClassDescriptor {
    ...
    private final LazyJavaResolverContext f7036c;
    ...
    public final class LazyJavaClassTypeConstructor extends AbstractClassTypeConstructor {
        ...
        public LazyJavaClassTypeConstructor() {
            super(LazyJavaClassDescriptor.this.f7036c.getStorageManager());
            this.parameters = LazyJavaClassDescriptor.this.f7036c.getStorageManager().createLazyValue(new Function0(LazyJavaClassDescriptor.this) { // from class: kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaClassDescriptor$LazyJavaClassTypeConstructor$$Lambda$0
        ...
        private final KotlinType getPurelyImplementedSupertype() {
            ...
            ClassDescriptor classDescriptorResolveTopLevelClass = DescriptorUtilsKt.resolveTopLevelClass(LazyJavaClassDescriptor.this.f7036c.getModule(), purelyImplementedInterface, NoLookupLocation.FROM_JAVA_LOADER);
        ...
        private final FqName getPurelyImplementsFqNameFromAnnotation() {
            ...
            AnnotationDescriptor annotationDescriptorMo1432findAnnotation = annotations.mo1432findAnnotation(PURELY_IMPLEMENTS_ANNOTATION);
        ...
        public Collection<KotlinType> computeSupertypes() {
            ...
            while (true) {
                ...
                KotlinType kotlinTypeEnhanceSuperType = LazyJavaClassDescriptor.this.f7036c.getComponents().getSignatureEnhancement().enhanceSuperType(LazyJavaClassDescriptor.this.f7036c.getTypeResolver().transformJavaType(next, JavaTypeAttributesKt.toAttributes$default(TypeUsage.SUPERTYPE, false, false, null, 7, null)), LazyJavaClassDescriptor.this.f7036c);
                if (kotlinTypeEnhanceSuperType.getConstructor().mo1437getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor) {
                    arrayList2.add(next);
                }
            ...
            if (!arrayList2.isEmpty()) {
                ErrorReporter errorReporter = LazyJavaClassDescriptor.this.f7036c.getComponents().getErrorReporter();
                ClassDescriptor classDescriptorMo1437getDeclarationDescriptor = mo1437getDeclarationDescriptor();
                ...
                errorReporter.reportIncompleteHierarchy(classDescriptorMo1437getDeclarationDescriptor, arrayList3);
            }
            return !arrayList.isEmpty() ? CollectionsKt.toList(arrayList) : CollectionsKt.listOf(LazyJavaClassDescriptor.this.f7036c.getModule().getBuiltIns().getAnyType());
        }
        ...
        public SupertypeLoopChecker getSupertypeLoopChecker() {
            return LazyJavaClassDescriptor.this.f7036c.getComponents().getSupertypeLoopChecker();
        }
        ...
        public ClassDescriptor mo1437getDeclarationDescriptor() {
    ...
    public static final List declaredParameters$lambda$5(LazyJavaClassDescriptor lazyJavaClassDescriptor) {
        ...
        for (JavaTypeParameter javaTypeParameter : typeParameters) {
            TypeParameterDescriptor typeParameterDescriptorResolveTypeParameter = lazyJavaClassDescriptor.f7036c.getTypeParameterResolver().resolveTypeParameter(javaTypeParameter);
    ...
    public static final LazyJavaClassMemberScope scopeHolder$lambda$3(LazyJavaClassDescriptor lazyJavaClassDescriptor, KotlinTypeRefiner it) {
        ...
        return new LazyJavaClassMemberScope(lazyJavaClassDescriptor.f7036c, lazyJavaClassDescriptor, lazyJavaClassDescriptor.jClass, lazyJavaClassDescriptor.additionalSupertypeClassDescriptor != null, lazyJavaClassDescriptor.unsubstitutedMemberScope);
    }
    ...
    public final LazyJavaClassDescriptor copy$descriptors_jvm(JavaResolverCache javaResolverCache, ClassDescriptor classDescriptor) {
        ...
        LazyJavaResolverContext lazyJavaResolverContext = this.f7036c;
    ...
    public Collection<ClassDescriptor> getSealedSubclasses() {
        ...
        while (it.hasNext()) {
            ClassifierDescriptor classifierDescriptorMo1437getDeclarationDescriptor = this.f7036c.getTypeResolver().transformJavaType(it.next(), attributes$default).getConstructor().mo1437getDeclarationDescriptor();
        ...
        return CollectionsKt.sortedWith(arrayList, new Comparator() { // from class: kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaClassDescriptor$getSealedSubclasses$$inlined$sortedBy$1
            ...
            public final int compare(T t3, T t8) {
                return ComparisonsKt.compareValues(DescriptorUtilsKt.getFqNameSafe((ClassDescriptor) t3).asString(), DescriptorUtilsKt.getFqNameSafe((ClassDescriptor) t8).asString());
            }
        });
    }
    ...
    public LazyJavaClassDescriptor(LazyJavaResolverContext outerContext, DeclarationDescriptor containingDeclaration, JavaClass jClass, ClassDescriptor classDescriptor) {
        ...
        this.f7036c = lazyJavaResolverContextChildForClassOrPackage$default;
