...
public final class OverridingUtilTypeSystemContext implements ClassicTypeSystemContext {
    ...
    public boolean areEqualTypeConstructors(TypeConstructorMarker c9, TypeConstructorMarker c10) {
        ...
        if (c10 instanceof TypeConstructor) {
            return ClassicTypeSystemContext.DefaultImpls.areEqualTypeConstructors(this, c9, c10) || areEqualTypeConstructorsByAxioms((TypeConstructor) c9, (TypeConstructor) c10);
        }
        throw new IllegalArgumentException("Failed requirement.");
    }
    ...
    @Override // kotlin.reflect.jvm.internal.impl.types.model.TypeSystemContext
    public TypeArgumentMarker get(TypeArgumentListMarker typeArgumentListMarker, int i8) {
        Intrinsics.checkNotNullParameter(typeArgumentListMarker, "<this>");
        if (typeArgumentListMarker instanceof SimpleTypeMarker) {
            return getArgument((KotlinTypeMarker) typeArgumentListMarker, i8);
        }
    ...
    @Override // kotlin.reflect.jvm.internal.impl.types.model.TypeSystemContext
    public TypeArgumentMarker getArgument(KotlinTypeMarker kotlinTypeMarker, int i8) {
        return ClassicTypeSystemContext.DefaultImpls.getArgument(this, kotlinTypeMarker, i8);
    }

    @Override // kotlin.reflect.jvm.internal.impl.types.model.TypeSystemContext
    public TypeArgumentMarker getArgumentOrNull(SimpleTypeMarker simpleTypeMarker, int i8) {
        Intrinsics.checkNotNullParameter(simpleTypeMarker, "<this>");
        if (i8 < 0 || i8 >= argumentsCount(simpleTypeMarker)) {
            return null;
        }
        return getArgument(simpleTypeMarker, i8);
    }
    ...
    @Override // kotlin.reflect.jvm.internal.impl.types.model.TypeSystemContext
    public TypeParameterMarker getParameter(TypeConstructorMarker typeConstructorMarker, int i8) {
        return ClassicTypeSystemContext.DefaultImpls.getParameter(this, typeConstructorMarker, i8);
    }
    ...
    @Override // kotlin.reflect.jvm.internal.impl.types.model.TypeSystemContext
    public KotlinTypeMarker makeDefinitelyNotNullOrNotNull(KotlinTypeMarker kotlinTypeMarker, boolean z2) {
    ...
    public TypeCheckerState newTypeCheckerState(boolean z2, boolean z3) {
        if (this.customSubtype != null) {
            return new TypeCheckerState(z2, z3, this, this.kotlinTypePreparator, this.kotlinTypeRefiner) { // from class: kotlin.reflect.jvm.internal.impl.resolve.OverridingUtilTypeSystemContext.newTypeCheckerState.1
        ...
        return ClassicTypeCheckerStateKt.createClassicTypeCheckerState(z2, z3, this, this.kotlinTypePreparator, this.kotlinTypeRefiner);
    }
    ...
    @Override // kotlin.reflect.jvm.internal.impl.types.model.TypeSystemContext
    public KotlinTypeMarker withNullability(KotlinTypeMarker kotlinTypeMarker, boolean z2) {
    ...
    public SimpleTypeMarker withNullability(SimpleTypeMarker simpleTypeMarker, boolean z2) {
        return ClassicTypeSystemContext.DefaultImpls.withNullability((ClassicTypeSystemContext) this, simpleTypeMarker, z2);
    }
