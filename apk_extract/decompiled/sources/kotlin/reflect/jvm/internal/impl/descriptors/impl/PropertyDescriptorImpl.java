...
public class PropertyDescriptorImpl extends VariableDescriptorWithInitializerImpl implements PropertyDescriptor {
    ...
    private static /* synthetic */ void $$$reportNull$$$0(int i8) {
        String str;
        int i9;
        if (i8 != 28 && i8 != 38 && i8 != 39 && i8 != 41 && i8 != 42) {
            switch (i8) {
                case 21:
                case 22:
                case 23:
    ...
    public static PropertyDescriptorImpl create(DeclarationDescriptor declarationDescriptor, Annotations annotations, Modality modality, DescriptorVisibility descriptorVisibility, boolean z2, Name name, CallableMemberDescriptor.Kind kind, SourceElement sourceElement, boolean z3, boolean z5, boolean z10, boolean z11, boolean z12, boolean z13) {
        ...
        return new PropertyDescriptorImpl(declarationDescriptor, null, annotations, modality, descriptorVisibility, z2, name, kind, sourceElement, z3, z5, z10, z11, z12, z13);
    }

    private SourceElement getSourceToUseForCopy(boolean z2, PropertyDescriptor propertyDescriptor) {
    ...
    public <R, D> R accept(DeclarationDescriptorVisitor<R, D> declarationDescriptorVisitor, D d7) {
        return declarationDescriptorVisitor.visitPropertyDescriptor(this, d7);
    }
    ...
    public PropertyDescriptor doSubstitute(CopyConfiguration copyConfiguration) {
        ...
        propertyDescriptorImplCreateSubstitutedCopy.initialize(propertyGetterDescriptorImpl2, propertySetterDescriptorImpl, fieldDescriptorImpl, fieldDescriptor2 != null ? new FieldDescriptorImpl(fieldDescriptor2.getAnnotations(), propertyDescriptorImplCreateSubstitutedCopy) : null);
