...
public final class JavaTypeQualifiers {
    ...
    public static /* synthetic */ JavaTypeQualifiers copy$default(JavaTypeQualifiers javaTypeQualifiers, NullabilityQualifier nullabilityQualifier, MutabilityQualifier mutabilityQualifier, boolean z2, boolean z3, int i8, Object obj) {
        if ((i8 & 1) != 0) {
    ...
    public int hashCode() {
        ...
        return Boolean.hashCode(this.isNullabilityQualifierForWarning) + a.g(this.definitelyNotNull, (iHashCode + (mutabilityQualifier != null ? mutabilityQualifier.hashCode() : 0)) * 31, 31);
    }
    ...
    public /* synthetic */ JavaTypeQualifiers(NullabilityQualifier nullabilityQualifier, MutabilityQualifier mutabilityQualifier, boolean z2, boolean z3, int i8, DefaultConstructorMarker defaultConstructorMarker) {
        this(nullabilityQualifier, mutabilityQualifier, z2, (i8 & 8) != 0 ? false : z3);
    }
}
