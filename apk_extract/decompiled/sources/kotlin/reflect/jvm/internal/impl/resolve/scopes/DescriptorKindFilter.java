...
public final class DescriptorKindFilter {
    ...
    public static final class Companion {
        ...
        public static final class MaskToName {
            ...
            public MaskToName(int i8, String name) {
        ...
        public final int nextMask() {
            int i8 = DescriptorKindFilter.nextMaskValue;
    ...
    static {
        ...
        int i8 = iNextMask | iNextMask2 | iNextMask3;
        CLASSIFIERS_MASK = i8;
        int i9 = iNextMask2 | iNextMask5 | iNextMask6;
        VALUES_MASK = i9;
        int i10 = iNextMask5 | iNextMask6;
        CALLABLES_MASK = i10;
        int i11 = 2;
        ALL = new DescriptorKindFilter(iNextMask7, 0 == true ? 1 : 0, i11, 0 == true ? 1 : 0);
        CALLABLES = new DescriptorKindFilter(i10, 0 == true ? 1 : 0, i11, 0 == true ? 1 : 0);
        NON_SINGLETON_CLASSIFIERS = new DescriptorKindFilter(iNextMask, 0 == true ? 1 : 0, i11, 0 == true ? 1 : 0);
        SINGLETON_CLASSIFIERS = new DescriptorKindFilter(iNextMask2, 0 == true ? 1 : 0, i11, 0 == true ? 1 : 0);
        TYPE_ALIASES = new DescriptorKindFilter(iNextMask3, 0 == true ? 1 : 0, i11, 0 == true ? 1 : 0);
        CLASSIFIERS = new DescriptorKindFilter(i8, 0 == true ? 1 : 0, i11, 0 == true ? 1 : 0);
        PACKAGES = new DescriptorKindFilter(iNextMask4, 0 == true ? 1 : 0, i11, 0 == true ? 1 : 0);
        FUNCTIONS = new DescriptorKindFilter(iNextMask5, 0 == true ? 1 : 0, i11, 0 == true ? 1 : 0);
        VARIABLES = new DescriptorKindFilter(iNextMask6, 0 == true ? 1 : 0, i11, 0 == true ? 1 : 0);
        VALUES = new DescriptorKindFilter(i9, 0 == true ? 1 : 0, i11, 0 == true ? 1 : 0);
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public DescriptorKindFilter(int i8, List<? extends DescriptorKindExclude> excludes) {
        Intrinsics.checkNotNullParameter(excludes, "excludes");
        this.excludes = excludes;
        Iterator it = excludes.iterator();
        while (it.hasNext()) {
            i8 &= ~((DescriptorKindExclude) it.next()).getFullyExcludedDescriptorKinds();
        }
        this.kindMask = i8;
    }

    public final boolean acceptsKinds(int i8) {
        return (this.kindMask & i8) != 0;
    }
    ...
    public final DescriptorKindFilter restrictedToKindsOrNull(int i8) {
        int i9 = i8 & this.kindMask;
        if (i9 == 0) {
            return null;
        }
        return new DescriptorKindFilter(i9, this.excludes);
    }
    ...
    public String toString() {
        ...
        StringBuilder sbY = a.y("DescriptorKindFilter(", name, ", ");
        sbY.append(this.excludes);
        sbY.append(')');
        return sbY.toString();
    }

    public /* synthetic */ DescriptorKindFilter(int i8, List list, int i9, DefaultConstructorMarker defaultConstructorMarker) {
        this(i8, (i9 & 2) != 0 ? CollectionsKt.emptyList() : list);
    }
}
