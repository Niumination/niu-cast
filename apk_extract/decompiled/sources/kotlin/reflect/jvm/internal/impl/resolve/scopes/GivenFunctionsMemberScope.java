...
public abstract class GivenFunctionsMemberScope extends MemberScopeImpl {
    ...
    private final List<DeclarationDescriptor> createFakeOverrides(List<? extends FunctionDescriptor> list) {
        ...
        Collection<KotlinType> collectionMo1438getSupertypes = this.containingClass.getTypeConstructor().mo1438getSupertypes();
        Intrinsics.checkNotNullExpressionValue(collectionMo1438getSupertypes, "getSupertypes(...)");
        ArrayList arrayList2 = new ArrayList();
        Iterator it = collectionMo1438getSupertypes.iterator();
        while (it.hasNext()) {
