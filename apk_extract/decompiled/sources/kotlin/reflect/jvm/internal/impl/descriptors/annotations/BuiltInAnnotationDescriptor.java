...
public final class BuiltInAnnotationDescriptor implements AnnotationDescriptor {
    ...
    public BuiltInAnnotationDescriptor(KotlinBuiltIns builtIns, FqName fqName, Map<Name, ? extends ConstantValue<?>> allValueArguments, boolean z2) {
        ...
        this.forcePropagationDeprecationToOverrides = z2;
    ...
    public /* synthetic */ BuiltInAnnotationDescriptor(KotlinBuiltIns kotlinBuiltIns, FqName fqName, Map map, boolean z2, int i8, DefaultConstructorMarker defaultConstructorMarker) {
        this(kotlinBuiltIns, fqName, map, (i8 & 8) != 0 ? false : z2);
    }
}
