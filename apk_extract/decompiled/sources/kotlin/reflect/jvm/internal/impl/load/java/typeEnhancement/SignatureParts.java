...
final class SignatureParts extends AbstractSignatureParts<AnnotationDescriptor> {
    ...
    public /* synthetic */ SignatureParts(Annotated annotated, boolean z2, LazyJavaResolverContext lazyJavaResolverContext, AnnotationQualifierApplicabilityType annotationQualifierApplicabilityType, boolean z3, int i8, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotated, z2, lazyJavaResolverContext, annotationQualifierApplicabilityType, (i8 & 16) != 0 ? false : z3);
    }
    ...
    @Override // kotlin.reflect.jvm.internal.impl.load.java.typeEnhancement.AbstractSignatureParts
    public NullabilityQualifierWithMigrationStatus getDefaultNullability(NullabilityQualifierWithMigrationStatus nullabilityQualifierWithMigrationStatus, JavaDefaultQualifiers javaDefaultQualifiers) {
    ...
    public SignatureParts(Annotated annotated, boolean z2, LazyJavaResolverContext containerContext, AnnotationQualifierApplicabilityType containerApplicabilityType, boolean z3) {
