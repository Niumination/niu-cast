...
public final class JavaTargetAnnotationDescriptor extends JavaAnnotationDescriptor {
    ...
    public JavaTargetAnnotationDescriptor(JavaAnnotation annotation, LazyJavaResolverContext c9) {
        ...
        this.allValueArguments$delegate = c9.getStorageManager().createLazyValue(new Function0(this) { // from class: kotlin.reflect.jvm.internal.impl.load.java.components.JavaTargetAnnotationDescriptor$$Lambda$0
