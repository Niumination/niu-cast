...
public final class CapitalizeDecapitalizeKt {
    ...
    public static final String decapitalizeSmartForCompiler(String str, boolean z2) {
        ...
        do {
            ...
            next = it.next();
        } while (isUpperCaseCharAt(str, next.intValue(), z2));
        Integer num = next;
        if (num == null) {
        ...
        sb2.append(toLowerCase(strSubstring2, z2));
    ...
    private static final boolean isUpperCaseCharAt(String str, int i8, boolean z2) {
