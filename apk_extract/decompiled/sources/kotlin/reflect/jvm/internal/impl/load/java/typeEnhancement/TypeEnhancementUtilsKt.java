...
public final class TypeEnhancementUtilsKt {
    public static final JavaTypeQualifiers computeQualifiersForOverride(JavaTypeQualifiers javaTypeQualifiers, Collection<JavaTypeQualifiers> superQualifiers, boolean z2, boolean z3, boolean z5) {
        ...
        if (nullabilityQualifierSelect != null && !z5 && (!z3 || nullabilityQualifierSelect != NullabilityQualifier.NULLABLE)) {
            nullabilityQualifier = nullabilityQualifierSelect;
        }
        boolean z11 = false;
    ...
    private static final <T> T select(Set<? extends T> set, T t3, T t8, T t10, boolean z2) {
        Set<? extends T> set2;
        T t11;
        if (!z2) {
            if (t10 != null && (set2 = CollectionsKt.toSet(SetsKt.plus(set, t10))) != null) {
                set = set2;
            }
        ...
        if (set.contains(t3)) {
            ...
            t11 = set.contains(t8) ? t8 : null;
        }
        if (Intrinsics.areEqual(t11, t3) && Intrinsics.areEqual(t10, t8)) {
            return null;
        }
