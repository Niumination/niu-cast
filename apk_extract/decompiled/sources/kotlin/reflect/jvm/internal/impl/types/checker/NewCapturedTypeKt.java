            ...
            while (it.hasNext()) {
                if (((TypeProjection) it.next()).getProjectionKind() != Variance.INVARIANT) {
                    ...
                    for (int i8 = 0; i8 < size; i8++) {
                        TypeProjection typeProjection = arguments.get(i8);
                        TypeProjection typeProjection2 = (TypeProjection) arrayList.get(i8);
                        if (typeProjection.getProjectionKind() != Variance.INVARIANT) {
                            List<KotlinType> upperBounds = unwrappedType.getConstructor().getParameters().get(i8).getUpperBounds();
