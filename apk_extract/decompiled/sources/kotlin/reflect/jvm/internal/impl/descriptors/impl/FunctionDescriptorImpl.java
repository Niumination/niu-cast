...
public abstract class FunctionDescriptorImpl extends DeclarationDescriptorNonRootImpl implements FunctionDescriptor {
    ...
    public class CopyConfiguration implements FunctionDescriptor.CopyBuilder<FunctionDescriptor> {
        ...
        @Override // kotlin.reflect.jvm.internal.impl.descriptors.FunctionDescriptor.CopyBuilder
        public <V> FunctionDescriptor.CopyBuilder<FunctionDescriptor> putUserData(CallableDescriptor.UserDataKey<V> userDataKey, V v3) {
            if (userDataKey == null) {
                $$$reportNull$$$0(39);
            }
        ...
        public CopyConfiguration setHasSynthesizedParameterNames(boolean z2) {
            this.newHasSynthesizedParameterNames = Boolean.valueOf(z2);
            return this;
        }

        public CopyConfiguration setJustForTypeSubstitution(boolean z2) {
            this.justForTypeSubstitution = z2;
            return this;
        }
    ...
    private SourceElement getSourceToUseForCopy(boolean z2, FunctionDescriptor functionDescriptor) {
    ...
    public <R, D> R accept(DeclarationDescriptorVisitor<R, D> declarationDescriptorVisitor, D d7) {
        return declarationDescriptorVisitor.visitFunctionDescriptor(this, d7);
    }
    ...
    public FunctionDescriptor doSubstitute(CopyConfiguration copyConfiguration) {
        ...
        FunctionDescriptorImpl functionDescriptorImplCreateSubstitutedCopy = createSubstitutedCopy(declarationDescriptor, functionDescriptor, copyConfiguration.kind, copyConfiguration.name, annotationsComposeAnnotations, getSourceToUseForCopy(copyConfiguration.preserveSourceElement, functionDescriptor));
        ...
        if (!copyConfiguration.newContextReceiverParameters.isEmpty()) {
            ...
            for (ReceiverParameterDescriptor receiverParameterDescriptor2 : copyConfiguration.newContextReceiverParameters) {
                ...
                int i9 = i8 + 1;
                arrayList2.add(DescriptorFactory.createContextReceiverParameterForCallable(functionDescriptorImplCreateSubstitutedCopy, kotlinTypeSubstitute2, ((ImplicitContextReceiver) receiverParameterDescriptor2.getValue()).getCustomLabelName(), receiverParameterDescriptor2.getAnnotations(), i8));
        ...
        boolean z2 = zArr[0] | (kotlinTypeSubstitute != copyConfiguration.newReturnType);
        zArr[0] = z2;
    ...
    public FunctionDescriptor copy(DeclarationDescriptor declarationDescriptor, Modality modality, DescriptorVisibility descriptorVisibility, CallableMemberDescriptor.Kind kind, boolean z2) {
        FunctionDescriptor functionDescriptorBuild = newCopyBuilder().setOwner(declarationDescriptor).setModality(modality).setVisibility(descriptorVisibility).setKind(kind).setCopyOverrides(z2).build();
