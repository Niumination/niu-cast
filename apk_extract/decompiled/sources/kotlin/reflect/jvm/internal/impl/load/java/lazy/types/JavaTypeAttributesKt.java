...
public final class JavaTypeAttributesKt {
    ...
    public static /* synthetic */ JavaTypeAttributes toAttributes$default(TypeUsage typeUsage, boolean z2, boolean z3, TypeParameterDescriptor typeParameterDescriptor, int i8, Object obj) {
        if ((i8 & 1) != 0) {
            z2 = false;
        }
        if ((i8 & 2) != 0) {
