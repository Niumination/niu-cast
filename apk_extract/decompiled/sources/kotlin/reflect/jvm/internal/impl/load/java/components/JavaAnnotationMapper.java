...
public final class JavaAnnotationMapper {
    ...
    public static /* synthetic */ AnnotationDescriptor mapOrResolveJavaAnnotation$default(JavaAnnotationMapper javaAnnotationMapper, JavaAnnotation javaAnnotation, LazyJavaResolverContext lazyJavaResolverContext, boolean z2, int i8, Object obj) {
        if ((i8 & 4) != 0) {
            z2 = false;
        }
    ...
    public final AnnotationDescriptor mapOrResolveJavaAnnotation(JavaAnnotation annotation, LazyJavaResolverContext c9, boolean z2) {
        ...
        return new LazyJavaAnnotationDescriptor(c9, annotation, z2);
    }
}
