...
public class JavaMethodDescriptor extends SimpleFunctionDescriptorImpl implements JavaCallableMemberDescriptor {
    ...
    public enum ParameterNamesStatus {
        ...
        public static ParameterNamesStatus get(boolean z2, boolean z3) {
            ...
            if (z2) {
                parameterNamesStatus = z3 ? STABLE_SYNTHESIZED : STABLE_DECLARED;
            } else {
                parameterNamesStatus = z3 ? NON_STABLE_SYNTHESIZED : NON_STABLE_DECLARED;
            }
    ...
    public static JavaMethodDescriptor createJavaMethod(DeclarationDescriptor declarationDescriptor, Annotations annotations, Name name, SourceElement sourceElement, boolean z2) {
        if (declarationDescriptor == null) {
            $$$reportNull$$$0(5);
        }
        if (annotations == null) {
