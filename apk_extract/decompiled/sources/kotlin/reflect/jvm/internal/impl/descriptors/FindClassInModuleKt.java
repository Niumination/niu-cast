...
public final class FindClassInModuleKt {
    ...
    public static final ClassifierDescriptor findClassifierAcrossModuleDependencies(ModuleDescriptor moduleDescriptor, ClassId classId) {
        ClassifierDescriptor classifierDescriptorMo1439getContributedClassifier;
        Intrinsics.checkNotNullParameter(moduleDescriptor, "<this>");
        Intrinsics.checkNotNullParameter(classId, "classId");
        ...
        if (resolutionAnchorIfAny == null) {
            ...
            classifierDescriptorMo1439getContributedClassifier = memberScope.mo1439getContributedClassifier((Name) objFirst, NoLookupLocation.FROM_DESERIALIZATION);
            if (classifierDescriptorMo1439getContributedClassifier == null) {
                return null;
            }
            for (Name name : listPathSegments.subList(1, listPathSegments.size())) {
                ...
                MemberScope unsubstitutedInnerClassesScope = ((ClassDescriptor) classifierDescriptorMo1439getContributedClassifier).getUnsubstitutedInnerClassesScope();
                Intrinsics.checkNotNull(name);
                ClassifierDescriptor classifierDescriptorMo1439getContributedClassifier2 = unsubstitutedInnerClassesScope.mo1439getContributedClassifier(name, NoLookupLocation.FROM_DESERIALIZATION);
                classifierDescriptorMo1439getContributedClassifier = classifierDescriptorMo1439getContributedClassifier2 instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo1439getContributedClassifier2 : null;
                if (classifierDescriptorMo1439getContributedClassifier == null) {
                    return null;
                }
            }
            ...
            ClassifierDescriptor classifierDescriptorMo1439getContributedClassifier3 = memberScope2.mo1439getContributedClassifier((Name) objFirst2, NoLookupLocation.FROM_DESERIALIZATION);
            if (classifierDescriptorMo1439getContributedClassifier3 == null) {
                classifierDescriptorMo1439getContributedClassifier3 = null;
                break;
            }
            for (Name name2 : listPathSegments2.subList(1, listPathSegments2.size())) {
                if (classifierDescriptorMo1439getContributedClassifier3 instanceof ClassDescriptor) {
                    MemberScope unsubstitutedInnerClassesScope2 = ((ClassDescriptor) classifierDescriptorMo1439getContributedClassifier3).getUnsubstitutedInnerClassesScope();
                    Intrinsics.checkNotNull(name2);
                    ClassifierDescriptor classifierDescriptorMo1439getContributedClassifier4 = unsubstitutedInnerClassesScope2.mo1439getContributedClassifier(name2, NoLookupLocation.FROM_DESERIALIZATION);
                    classifierDescriptorMo1439getContributedClassifier3 = classifierDescriptorMo1439getContributedClassifier4 instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo1439getContributedClassifier4 : null;
                    if (classifierDescriptorMo1439getContributedClassifier3 != null) {
                    }
                }
                classifierDescriptorMo1439getContributedClassifier3 = null;
            ...
            if (classifierDescriptorMo1439getContributedClassifier3 != null) {
                return classifierDescriptorMo1439getContributedClassifier3;
            }
            ...
            classifierDescriptorMo1439getContributedClassifier = memberScope3.mo1439getContributedClassifier((Name) objFirst3, NoLookupLocation.FROM_DESERIALIZATION);
            if (classifierDescriptorMo1439getContributedClassifier == null) {
                return null;
            }
            for (Name name3 : listPathSegments3.subList(1, listPathSegments3.size())) {
                ...
                MemberScope unsubstitutedInnerClassesScope3 = ((ClassDescriptor) classifierDescriptorMo1439getContributedClassifier).getUnsubstitutedInnerClassesScope();
                Intrinsics.checkNotNull(name3);
                ClassifierDescriptor classifierDescriptorMo1439getContributedClassifier5 = unsubstitutedInnerClassesScope3.mo1439getContributedClassifier(name3, NoLookupLocation.FROM_DESERIALIZATION);
                classifierDescriptorMo1439getContributedClassifier = classifierDescriptorMo1439getContributedClassifier5 instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo1439getContributedClassifier5 : null;
                if (classifierDescriptorMo1439getContributedClassifier == null) {
                    return null;
                }
            }
        }
        return classifierDescriptorMo1439getContributedClassifier;
    }
