...
public final class LazyJavaPackageFragmentProvider implements PackageFragmentProviderOptimized {
    ...
    private final LazyJavaResolverContext f7032c;
    ...
    public LazyJavaPackageFragmentProvider(JavaResolverComponents components) {
        ...
        this.f7032c = lazyJavaResolverContext;
    ...
    private final LazyJavaPackageFragment getPackageFragment(FqName fqName) {
        final JavaPackage javaPackageFindPackage$default = JavaClassFinder$$Util.findPackage$default(this.f7032c.getComponents().getFinder(), fqName, false, 2, null);
    ...
    public static final LazyJavaPackageFragment getPackageFragment$lambda$0(LazyJavaPackageFragmentProvider lazyJavaPackageFragmentProvider, JavaPackage javaPackage) {
        return new LazyJavaPackageFragment(lazyJavaPackageFragmentProvider.f7032c, javaPackage);
    }
    ...
    public boolean isEmpty(FqName fqName) {
        Intrinsics.checkNotNullParameter(fqName, "fqName");
        return JavaClassFinder$$Util.findPackage$default(this.f7032c.getComponents().getFinder(), fqName, false, 2, null) == null;
    }

    public String toString() {
        return "LazyJavaPackageFragmentProvider of module " + this.f7032c.getComponents().getModule();
    }
