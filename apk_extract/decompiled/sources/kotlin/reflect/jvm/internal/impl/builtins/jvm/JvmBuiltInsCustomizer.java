...
public final class JvmBuiltInsCustomizer implements AdditionalClassPartsProvider, PlatformDependentDeclarationFilter {
    ...
    public static final Annotations deprecationForSomeOfTheListMethods$lambda$2(JvmBuiltInsCustomizer jvmBuiltInsCustomizer, Pair pair) {
        ...
        return Annotations.Companion.create(CollectionsKt.listOf(AnnotationUtilKt.createDeprecatedAnnotation(jvmBuiltInsCustomizer.moduleDescriptor.getBuiltIns(), a.l("'", str, "()' member of List is redundant in Kotlin and might be removed soon. Please use '", str2, "()' stdlib extension instead"), a.B(str2, "()"), "HIDDEN", false)));
    }
    ...
    private final Collection<SimpleFunctionDescriptor> getAdditionalFunctions(ClassDescriptor classDescriptor, Function1<? super MemberScope, ? extends Collection<? extends SimpleFunctionDescriptor>> function1) {
        ...
        ArrayList arrayList = new ArrayList(CollectionsKt.i(collectionMapPlatformClass));
    ...
    public static final Iterable getJdkMethodStatus$lambda$16(JvmBuiltInsCustomizer jvmBuiltInsCustomizer, ClassDescriptor classDescriptor) {
        ...
        while (it.hasNext()) {
            ClassifierDescriptor classifierDescriptorMo1437getDeclarationDescriptor = ((KotlinType) it.next()).getConstructor().mo1437getDeclarationDescriptor();
            ClassDescriptor javaAnalogue = null;
            ClassifierDescriptor original = classifierDescriptorMo1437getDeclarationDescriptor != null ? classifierDescriptorMo1437getDeclarationDescriptor.getOriginal() : null;
    ...
    private final boolean isTrivialCopyConstructorFor(ConstructorDescriptor constructorDescriptor, ClassDescriptor classDescriptor) {
        if (constructorDescriptor.getValueParameters().size() == 1) {
            ...
            ClassifierDescriptor classifierDescriptorMo1437getDeclarationDescriptor = ((ValueParameterDescriptor) CollectionsKt.single((List) valueParameters)).getType().getConstructor().mo1437getDeclarationDescriptor();
            if (Intrinsics.areEqual(classifierDescriptorMo1437getDeclarationDescriptor != null ? DescriptorUtilsKt.getFqNameUnsafe(classifierDescriptorMo1437getDeclarationDescriptor) : null, DescriptorUtilsKt.getFqNameUnsafe(classDescriptor))) {
                return true;
            }
        }
        return false;
    ...
    public Collection<SimpleFunctionDescriptor> getFunctions(final Name name, ClassDescriptor classDescriptor) {
        ...
        for (SimpleFunctionDescriptor simpleFunctionDescriptor : additionalFunctions) {
            ...
            copyBuilderNewCopyBuilder.setPreserveSourceElement();
            int i8 = WhenMappings.$EnumSwitchMapping$0[getJdkMethodStatus(simpleFunctionDescriptor).ordinal()];
