...
public final class DescriptorRendererImpl extends DescriptorRenderer implements DescriptorRendererOptions {
    ...
    public final class RenderDeclarationDescriptorVisitor implements DeclarationDescriptorVisitor<Unit, StringBuilder> {
        ...
        private final void visitPropertyAccessorDescriptor(PropertyAccessorDescriptor propertyAccessorDescriptor, StringBuilder sb2, String str) throws IOException {
            int i8 = WhenMappings.$EnumSwitchMapping$0[DescriptorRendererImpl.this.getPropertyAccessorRenderingPolicy().ordinal()];
            if (i8 != 1) {
                if (i8 == 2) {
    ...
    private final void appendTypeProjections(StringBuilder sb2, List<? extends TypeProjection> list) throws IOException {
        CollectionsKt___CollectionsKt.joinTo(list, sb2, (OSLiquidSearchBar.LIQUID_SEARCHBAR_EXIT_SPRING_FINAL_POSITION & 2) != 0 ? ", " : ", ", (OSLiquidSearchBar.LIQUID_SEARCHBAR_EXIT_SPRING_FINAL_POSITION & 4) != 0 ? "" : null, (OSLiquidSearchBar.LIQUID_SEARCHBAR_EXIT_SPRING_FINAL_POSITION & 8) == 0 ? null : "", (OSLiquidSearchBar.LIQUID_SEARCHBAR_EXIT_SPRING_FINAL_POSITION & 16) != 0 ? -1 : 0, (OSLiquidSearchBar.LIQUID_SEARCHBAR_EXIT_SPRING_FINAL_POSITION & 32) != 0 ? "..." : null, (OSLiquidSearchBar.LIQUID_SEARCHBAR_EXIT_SPRING_FINAL_POSITION & 64) != 0 ? null : new Function1(this) { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$$Lambda$2
            private final DescriptorRendererImpl arg$0;
    ...
    private final String arrow() {
        int i8 = WhenMappings.$EnumSwitchMapping$0[getTextFormat().ordinal()];
        if (i8 == 1) {
            return escape("->");
        }
        if (i8 == 2) {
    ...
    private final void renderAdditionalModifiers(FunctionDescriptor functionDescriptor, StringBuilder sb2) {
        ...
        renderModifier(sb2, z3, "infix");
        renderModifier(sb2, z2, "operator");
    }
    ...
    private final List<String> renderAndSortAnnotationArguments(AnnotationDescriptor annotationDescriptor) {
        ClassConstructorDescriptor classConstructorDescriptorMo1431getUnsubstitutedPrimaryConstructor;
        ...
        if (annotationClass != null && (classConstructorDescriptorMo1431getUnsubstitutedPrimaryConstructor = annotationClass.mo1431getUnsubstitutedPrimaryConstructor()) != null && (valueParameters = classConstructorDescriptorMo1431getUnsubstitutedPrimaryConstructor.getValueParameters()) != null) {
            ...
            listEmptyList = new ArrayList(CollectionsKt.i(arrayList));
        ...
        while (it2.hasNext()) {
            arrayList3.add(((Name) it2.next()).asString() + " = ...");
        }
        Set<Map.Entry<Name, ConstantValue<?>>> setEntrySet = allValueArguments.entrySet();
        ArrayList arrayList4 = new ArrayList(CollectionsKt.i(setEntrySet));
    ...
    public static /* synthetic */ void renderAnnotations$default(DescriptorRendererImpl descriptorRendererImpl, StringBuilder sb2, Annotated annotated, AnnotationUseSiteTarget annotationUseSiteTarget, int i8, Object obj) {
        if ((i8 & 2) != 0) {
    ...
    public final void renderClass(ClassDescriptor classDescriptor, StringBuilder sb2) throws IOException {
        ...
        if (!classDescriptor.getKind().isSingleton() && getClassWithPrimaryConstructor() && (classConstructorDescriptorMo1431getUnsubstitutedPrimaryConstructor = classDescriptor.mo1431getUnsubstitutedPrimaryConstructor()) != null) {
            sb2.append(" ");
            renderAnnotations$default(this, sb2, classConstructorDescriptorMo1431getUnsubstitutedPrimaryConstructor, null, 2, null);
            DescriptorVisibility visibility2 = classConstructorDescriptorMo1431getUnsubstitutedPrimaryConstructor.getVisibility();
            ...
            List<ValueParameterDescriptor> valueParameters = classConstructorDescriptorMo1431getUnsubstitutedPrimaryConstructor.getValueParameters();
            Intrinsics.checkNotNullExpressionValue(valueParameters, "getValueParameters(...)");
            renderValueParameters(valueParameters, classConstructorDescriptorMo1431getUnsubstitutedPrimaryConstructor.hasSynthesizedParameterNames(), sb2);
        }
    ...
    public final void renderConstructor(ConstructorDescriptor constructorDescriptor, StringBuilder sb2) throws IOException {
        ...
        if (getRenderConstructorDelegation() && !constructorDescriptor.isPrimary() && (containingDeclaration instanceof ClassDescriptor) && (classConstructorDescriptorMo1431getUnsubstitutedPrimaryConstructor = ((ClassDescriptor) containingDeclaration).mo1431getUnsubstitutedPrimaryConstructor()) != null) {
            List<ValueParameterDescriptor> valueParameters2 = classConstructorDescriptorMo1431getUnsubstitutedPrimaryConstructor.getValueParameters();
            ...
            if (!arrayList.isEmpty()) {
                ...
                sb2.append(CollectionsKt___CollectionsKt.joinToString$default(arrayList, ", ", "(", ")", 0, null, new Function1() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$$Lambda$3
                    @Override // kotlin.jvm.functions.Function1
    ...
    private final String renderError(String str) {
        ...
        if (i8 == 2) {
            return a.j("<font color=red><b>", str, "</b></font>");
        }
        throw new NoWhenBranchMatchedException();
    }
    ...
    private final void renderFunctionType(StringBuilder sb2, KotlinType kotlinType) {
        ...
        if (receiverTypeFromFunctionType != null) {
            boolean z5 = (shouldRenderAsPrettyFunctionType(receiverTypeFromFunctionType) && !receiverTypeFromFunctionType.isMarkedNullable()) || hasModifiersOrAnnotations(receiverTypeFromFunctionType) || (receiverTypeFromFunctionType instanceof DefinitelyNotNullType);
            if (z5) {
                sb2.append("(");
            }
    ...
    private final void renderInitializer(VariableDescriptor variableDescriptor, StringBuilder sb2) {
        ConstantValue<?> constantValueMo1433getCompileTimeInitializer;
        String strRenderConstant;
        if (!getIncludePropertyConstant() || (constantValueMo1433getCompileTimeInitializer = variableDescriptor.mo1433getCompileTimeInitializer()) == null || (strRenderConstant = renderConstant(constantValueMo1433getCompileTimeInitializer)) == null) {
            return;
        }
        sb2.append(" = ");
    ...
    private final String renderKeyword(String str) {
        ...
        if (i8 == 2) {
            return getBoldOnlyForNamesInHtml() ? str : a.j("<b>", str, "</b>");
        }
        throw new NoWhenBranchMatchedException();
    }
    ...
    private final void renderModifier(StringBuilder sb2, boolean z2, String str) {
        if (z2) {
    ...
    public final void renderProperty(PropertyDescriptor propertyDescriptor, StringBuilder sb2) throws IOException {
        if (!getStartFromName()) {
            if (!getStartFromDeclarationKeyword()) {
                ...
                renderModifier(sb2, z2, "lateinit");
    ...
    private final void renderSuperTypes(ClassDescriptor classDescriptor, StringBuilder sb2) throws IOException {
        ...
        if (collectionMo1438getSupertypes.isEmpty()) {
            return;
        }
        if (collectionMo1438getSupertypes.size() == 1 && KotlinBuiltIns.isAnyOrNullableAny(collectionMo1438getSupertypes.iterator().next())) {
            return;
        }
        renderSpaceIfNeeded(sb2);
        sb2.append(": ");
        CollectionsKt___CollectionsKt.joinTo(collectionMo1438getSupertypes, sb2, (OSLiquidSearchBar.LIQUID_SEARCHBAR_EXIT_SPRING_FINAL_POSITION & 2) != 0 ? ", " : ", ", (OSLiquidSearchBar.LIQUID_SEARCHBAR_EXIT_SPRING_FINAL_POSITION & 4) != 0 ? "" : null, (OSLiquidSearchBar.LIQUID_SEARCHBAR_EXIT_SPRING_FINAL_POSITION & 8) == 0 ? null : "", (OSLiquidSearchBar.LIQUID_SEARCHBAR_EXIT_SPRING_FINAL_POSITION & 16) != 0 ? -1 : 0, (OSLiquidSearchBar.LIQUID_SEARCHBAR_EXIT_SPRING_FINAL_POSITION & 32) != 0 ? "..." : null, (OSLiquidSearchBar.LIQUID_SEARCHBAR_EXIT_SPRING_FINAL_POSITION & 64) != 0 ? null : new Function1(this) { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$$Lambda$4
            private final DescriptorRendererImpl arg$0;
    ...
    public static /* synthetic */ void renderTypeConstructorAndArguments$default(DescriptorRendererImpl descriptorRendererImpl, StringBuilder sb2, KotlinType kotlinType, TypeConstructor typeConstructor, int i8, Object obj) {
        if ((i8 & 2) != 0) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final void renderTypeParameter(TypeParameterDescriptor typeParameterDescriptor, StringBuilder sb2, boolean z2) {
        if (z2) {
            sb2.append(lt());
        }
        if (getVerbose()) {
        ...
        renderName(typeParameterDescriptor, sb2, z2);
    ...
    private final void renderTypeParameters(List<? extends TypeParameterDescriptor> list, StringBuilder sb2, boolean z2) {
    ...
    private final void renderValVarPrefix(VariableDescriptor variableDescriptor, StringBuilder sb2, boolean z2) {
    ...
    public static /* synthetic */ void renderValVarPrefix$default(DescriptorRendererImpl descriptorRendererImpl, VariableDescriptor variableDescriptor, StringBuilder sb2, boolean z2, int i8, Object obj) {
        if ((i8 & 4) != 0) {
            z2 = false;
        }
        descriptorRendererImpl.renderValVarPrefix(variableDescriptor, sb2, z2);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Code duplicated, block: B:17:0x0060  */
    public final void renderValueParameter(ValueParameterDescriptor valueParameterDescriptor, boolean z2, StringBuilder sb2, boolean z3) {
        boolean z5;
        if (z3) {
        ...
        renderVariable(valueParameterDescriptor, z2, sb2, z3, z5);
    ...
    private final void renderValueParameters(Collection<? extends ValueParameterDescriptor> collection, boolean z2, StringBuilder sb2) {
        ...
        for (ValueParameterDescriptor valueParameterDescriptor : collection) {
            getValueParametersHandler().appendBeforeValueParameter(valueParameterDescriptor, i8, size, sb2);
            renderValueParameter(valueParameterDescriptor, zShouldRenderParameterNames, sb2, false);
            getValueParametersHandler().appendAfterValueParameter(valueParameterDescriptor, i8, size, sb2);
            i8++;
        }
        getValueParametersHandler().appendAfterValueParameters(size, sb2);
    }

    private final void renderVariable(VariableDescriptor variableDescriptor, boolean z2, StringBuilder sb2, boolean z3, boolean z5) {
        ...
        if (z5 || (z3 && !getStartFromName())) {
            renderValVarPrefix(variableDescriptor, sb2, z5);
        }
        if (z2) {
            renderName(variableDescriptor, sb2, z3);
            sb2.append(": ");
        }
        sb2.append(renderType(kotlinType));
    ...
    private final void renderWhereSuffix(List<? extends TypeParameterDescriptor> list, StringBuilder sb2) throws IOException {
        ...
        sb2.append(" ");
        CollectionsKt___CollectionsKt.joinTo(arrayList, sb2, (OSLiquidSearchBar.LIQUID_SEARCHBAR_EXIT_SPRING_FINAL_POSITION & 2) != 0 ? ", " : ", ", (OSLiquidSearchBar.LIQUID_SEARCHBAR_EXIT_SPRING_FINAL_POSITION & 4) != 0 ? "" : null, (OSLiquidSearchBar.LIQUID_SEARCHBAR_EXIT_SPRING_FINAL_POSITION & 8) == 0 ? null : "", (OSLiquidSearchBar.LIQUID_SEARCHBAR_EXIT_SPRING_FINAL_POSITION & 16) != 0 ? -1 : 0, (OSLiquidSearchBar.LIQUID_SEARCHBAR_EXIT_SPRING_FINAL_POSITION & 32) != 0 ? "..." : null, (OSLiquidSearchBar.LIQUID_SEARCHBAR_EXIT_SPRING_FINAL_POSITION & 64) != 0 ? null : null);
    }
    ...
    private final boolean shouldRenderParameterNames(boolean z2) {
        int i8 = WhenMappings.$EnumSwitchMapping$1[getParameterNameRenderingPolicy().ordinal()];
        if (i8 == 1) {
            return true;
        }
        if (i8 != 2) {
    ...
    public String renderAnnotation(AnnotationDescriptor annotation, AnnotationUseSiteTarget annotationUseSiteTarget) throws IOException {
        ...
        if (getIncludeAnnotationArguments()) {
            ...
            if (getIncludeEmptyAnnotationArguments() || !listRenderAndSortAnnotationArguments.isEmpty()) {
                CollectionsKt___CollectionsKt.joinTo(listRenderAndSortAnnotationArguments, sb2, (OSLiquidSearchBar.LIQUID_SEARCHBAR_EXIT_SPRING_FINAL_POSITION & 2) != 0 ? ", " : ", ", (OSLiquidSearchBar.LIQUID_SEARCHBAR_EXIT_SPRING_FINAL_POSITION & 4) != 0 ? "" : "(", (OSLiquidSearchBar.LIQUID_SEARCHBAR_EXIT_SPRING_FINAL_POSITION & 8) == 0 ? ")" : "", (OSLiquidSearchBar.LIQUID_SEARCHBAR_EXIT_SPRING_FINAL_POSITION & 16) != 0 ? -1 : 0, (OSLiquidSearchBar.LIQUID_SEARCHBAR_EXIT_SPRING_FINAL_POSITION & 32) != 0 ? "..." : null, (OSLiquidSearchBar.LIQUID_SEARCHBAR_EXIT_SPRING_FINAL_POSITION & 64) != 0 ? null : null);
            }
        }
        if (getVerbose() && (KotlinTypeKt.isError(type) || (type.getConstructor().mo1437getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor))) {
    ...
    public String renderFlexibleType(String lowerRendered, String upperRendered, KotlinBuiltIns builtIns) {
        ...
        String strReplacePrefixesInTypeRepresentations = RenderingUtilsKt.replacePrefixesInTypeRepresentations(lowerRendered, a.B(strSubstringBefore$default, "Mutable"), upperRendered, strSubstringBefore$default, a.B(strSubstringBefore$default, "(Mutable)"));
        if (strReplacePrefixesInTypeRepresentations != null) {
            return strReplacePrefixesInTypeRepresentations;
        }
        String strReplacePrefixesInTypeRepresentations2 = RenderingUtilsKt.replacePrefixesInTypeRepresentations(lowerRendered, a.B(strSubstringBefore$default, "MutableMap.MutableEntry"), upperRendered, a.B(strSubstringBefore$default, "Map.Entry"), a.B(strSubstringBefore$default, "(Mutable)Map.(Mutable)Entry"));
        ...
        StringBuilder sbS = d.s(strSubstringBefore$default2);
        sbS.append(escape("Array<"));
        String string = sbS.toString();
        StringBuilder sbS2 = d.s(strSubstringBefore$default2);
        sbS2.append(escape("Array<out "));
        String string2 = sbS2.toString();
        StringBuilder sbS3 = d.s(strSubstringBefore$default2);
        sbS3.append(escape("Array<(out) "));
        String strReplacePrefixesInTypeRepresentations3 = RenderingUtilsKt.replacePrefixesInTypeRepresentations(lowerRendered, string, upperRendered, string2, sbS3.toString());
    ...
    public String renderName(Name name, boolean z2) {
        ...
        return (getBoldOnlyForNamesInHtml() && getTextFormat() == RenderingFormat.HTML && z2) ? a.j("<b>", strEscape, "</b>") : strEscape;
    }
    ...
    public String renderTypeConstructor(TypeConstructor typeConstructor) {
        ...
        if ((classifierDescriptorMo1437getDeclarationDescriptor instanceof TypeParameterDescriptor) || (classifierDescriptorMo1437getDeclarationDescriptor instanceof ClassDescriptor) || (classifierDescriptorMo1437getDeclarationDescriptor instanceof TypeAliasDescriptor)) {
            return renderClassifierName(classifierDescriptorMo1437getDeclarationDescriptor);
        }
        ...
        throw new IllegalStateException(("Unexpected classifier: " + classifierDescriptorMo1437getDeclarationDescriptor.getClass()).toString());
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final void renderName(DeclarationDescriptor declarationDescriptor, StringBuilder sb2, boolean z2) {
