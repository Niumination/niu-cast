...
public final class ReflectionTypes {
    ...
    public static final class ClassLookup {
        ...
        public ClassLookup(int i8) {
            this.numberOfTypeParameters = i8;
        }
    ...
    public final ClassDescriptor find(String str, int i8) {
        Name nameIdentifier = Name.identifier(str);
        Intrinsics.checkNotNullExpressionValue(nameIdentifier, "identifier(...)");
        ClassifierDescriptor classifierDescriptorMo1439getContributedClassifier = getKotlinReflectScope().mo1439getContributedClassifier(nameIdentifier, NoLookupLocation.FROM_REFLECTION);
        ...
        return classDescriptor == null ? this.notFoundClasses.getClass(new ClassId(StandardNames.KOTLIN_REFLECT_FQ_NAME, nameIdentifier), CollectionsKt.listOf(Integer.valueOf(i8))) : classDescriptor;
    }
