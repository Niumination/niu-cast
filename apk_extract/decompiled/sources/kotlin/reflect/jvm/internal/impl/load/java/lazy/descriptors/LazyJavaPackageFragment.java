...
public final class LazyJavaPackageFragment extends PackageFragmentDescriptorImpl {
    ...
    private final LazyJavaResolverContext f7037c;
    ...
    public LazyJavaPackageFragment(LazyJavaResolverContext outerContext, JavaPackage jPackage) {
        ...
        this.f7037c = lazyJavaResolverContextChildForClassOrPackage$default;
    ...
    public static final Map binaryClasses_delegate$lambda$2(LazyJavaPackageFragment lazyJavaPackageFragment) {
        PackagePartProvider packagePartProvider = lazyJavaPackageFragment.f7037c.getComponents().getPackagePartProvider();
        ...
        for (String str : listFindPackageParts) {
            ...
            KotlinJvmBinaryClass kotlinJvmBinaryClassFindKotlinClass = KotlinClassFinderKt.findKotlinClass(lazyJavaPackageFragment.f7037c.getComponents().getKotlinClassFinder(), companion.topLevel(fqNameForTopLevelClassMaybeWithDollars), lazyJavaPackageFragment.jvmMetadataVersion);
    ...
    public static final HashMap partToFacade_delegate$lambda$4(LazyJavaPackageFragment lazyJavaPackageFragment) {
        ...
        for (Map.Entry<String, KotlinJvmBinaryClass> entry : lazyJavaPackageFragment.getBinaryClasses$descriptors_jvm().entrySet()) {
            ...
            int i8 = WhenMappings.$EnumSwitchMapping$0[classHeader.getKind().ordinal()];
            if (i8 == 1) {
    ...
    public static final List subPackages$lambda$3(LazyJavaPackageFragment lazyJavaPackageFragment) {
        ...
        ArrayList arrayList = new ArrayList(CollectionsKt.i(subPackages));
    ...
    public String toString() {
        return "Lazy Java package fragment: " + getFqName() + " of module " + this.f7037c.getComponents().getModule();
    }
