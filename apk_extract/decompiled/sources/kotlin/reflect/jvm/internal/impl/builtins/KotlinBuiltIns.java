...
public abstract class KotlinBuiltIns {
    ...
    private static /* synthetic */ void $$$reportNull$$$0(int i8) {
        ...
        switch (i8) {
            ...
            case DeviceType.INFRARED_SWEEP_ROBOT /* 114 */:
            ...
            case 122:
            case 123:
            case OSLiquidSearchBar.LIQUID_SEARCHBAR_EXIT_SPRING_FINAL_POSITION /* 124 */:
            case 125:
            case 126:
            case 127:
            case 128:
    ...
    public KotlinBuiltIns(StorageManager storageManager) {
        ...
        this.builtInClassesByName = storageManager.createMemoizedFunction(new Function1<Name, ClassDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.3
            ...
            public ClassDescriptor invoke(Name name) {
                ClassifierDescriptor classifierDescriptorMo1439getContributedClassifier = KotlinBuiltIns.this.getBuiltInsPackageScope().mo1439getContributedClassifier(name, NoLookupLocation.FROM_BUILTINS);
                ...
                throw new AssertionError("Must be a class descriptor " + name + ", but was " + classifierDescriptorMo1439getContributedClassifier);
            }
        });
    }
    ...
    public static PrimitiveType getPrimitiveArrayElementType(KotlinType kotlinType) {
        ...
        return getPrimitiveArrayType(classifierDescriptorMo1437getDeclarationDescriptor);
    }
    ...
    public static boolean isBoolean(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(DeviceType.INFRARED_AIR_PURIFIER);
        }
    ...
    public static boolean isPrimitiveArray(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo1437getDeclarationDescriptor = kotlinType.getConstructor().mo1437getDeclarationDescriptor();
        return (classifierDescriptorMo1437getDeclarationDescriptor == null || getPrimitiveArrayType(classifierDescriptorMo1437getDeclarationDescriptor) == null) ? false : true;
    }
    ...
    public static boolean isPrimitiveTypeOrNullablePrimitiveType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo1437getDeclarationDescriptor = kotlinType.getConstructor().mo1437getDeclarationDescriptor();
        return (classifierDescriptorMo1437getDeclarationDescriptor instanceof ClassDescriptor) && isPrimitiveClass((ClassDescriptor) classifierDescriptorMo1437getDeclarationDescriptor);
    }
    ...
    public static boolean isTypeConstructorForGivenClass(TypeConstructor typeConstructor, FqNameUnsafe fqNameUnsafe) {
        ...
        return (classifierDescriptorMo1437getDeclarationDescriptor instanceof ClassDescriptor) && classFqNameEquals(classifierDescriptorMo1437getDeclarationDescriptor, fqNameUnsafe);
    }
    ...
    public void createBuiltInsModule(boolean z2) {
    ...
    public ClassDescriptor getFunction(int i8) {
        return getBuiltInClassByName(StandardNames.getFunctionName(i8));
    }
    ...
    public ClassDescriptor getSuspendFunction(int i8) {
        ClassDescriptor builtInClassByFqName = getBuiltInClassByFqName(StandardNames.COROUTINES_PACKAGE_FQ_NAME.child(Name.identifier(StandardNames.getSuspendFunctionName(i8))));
        if (builtInClassByFqName == null) {
            $$$reportNull$$$0(18);
        }
        return builtInClassByFqName;
