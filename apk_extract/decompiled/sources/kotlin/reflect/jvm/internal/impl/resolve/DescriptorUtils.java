...
public class DescriptorUtils {
    ...
    private static <D extends CallableDescriptor> void collectAllOverriddenDescriptors(D d7, Set<D> set) {
        if (d7 == null) {
            $$$reportNull$$$0(73);
        }
        if (set == 0) {
        ...
        Iterator<? extends CallableDescriptor> it = d7.getOriginal().getOverriddenDescriptors().iterator();
        while (it.hasNext()) {
    ...
    public static <D extends CallableDescriptor> Set<D> getAllOverriddenDescriptors(D d7) {
        if (d7 == null) {
            $$$reportNull$$$0(71);
        }
        LinkedHashSet linkedHashSet = new LinkedHashSet();
        collectAllOverriddenDescriptors(d7.getOriginal(), linkedHashSet);
    ...
    public static ClassDescriptor getClassDescriptorForTypeConstructor(TypeConstructor typeConstructor) {
        ...
        ClassDescriptor classDescriptor = (ClassDescriptor) typeConstructor.mo1437getDeclarationDescriptor();
    ...
    public static ModuleDescriptor getContainingModuleOrNull(KotlinType kotlinType) {
        ...
        return getContainingModuleOrNull(classifierDescriptorMo1437getDeclarationDescriptor);
    }
    ...
    public static DescriptorVisibility getDefaultConstructorVisibility(ClassDescriptor classDescriptor, boolean z2) {
        if (classDescriptor == null) {
            $$$reportNull$$$0(48);
        }
    ...
    public static ClassDescriptor getSuperClassDescriptor(ClassDescriptor classDescriptor) {
        ...
        Iterator<KotlinType> it = classDescriptor.getTypeConstructor().mo1438getSupertypes().iterator();
        while (it.hasNext()) {
    ...
    private static boolean isSameClass(KotlinType kotlinType, DeclarationDescriptor declarationDescriptor) {
        ...
        DeclarationDescriptor original = classifierDescriptorMo1437getDeclarationDescriptor.getOriginal();
    ...
    public static boolean isSubtypeOfClass(KotlinType kotlinType, DeclarationDescriptor declarationDescriptor) {
        ...
        Iterator<KotlinType> it = kotlinType.getConstructor().mo1438getSupertypes().iterator();
        while (it.hasNext()) {
    ...
    public static <D extends CallableMemberDescriptor> D unwrapFakeOverride(D d7) {
        if (d7 == null) {
            $$$reportNull$$$0(59);
        }
        while (d7.getKind() == CallableMemberDescriptor.Kind.FAKE_OVERRIDE) {
            Collection<? extends CallableMemberDescriptor> overriddenDescriptors = d7.getOverriddenDescriptors();
            if (overriddenDescriptors.isEmpty()) {
                throw new IllegalStateException("Fake override should have at least one overridden descriptor: " + d7);
            }
            d7 = (D) overriddenDescriptors.iterator().next();
        }
        return d7;
    }

    public static <D extends DeclarationDescriptorWithVisibility> D unwrapFakeOverrideToAnyDeclaration(D d7) {
        if (d7 == null) {
            $$$reportNull$$$0(64);
        }
        if (d7 instanceof CallableMemberDescriptor) {
            return unwrapFakeOverride((CallableMemberDescriptor) d7);
        }
        if (d7 == null) {
            $$$reportNull$$$0(65);
        }
