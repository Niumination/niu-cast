...
public final class JvmProtoBufUtil {
    ...
    public static /* synthetic */ JvmMemberSignature.Field getJvmFieldSignature$default(JvmProtoBufUtil jvmProtoBufUtil, ProtoBuf.Property property, NameResolver nameResolver, TypeTable typeTable, boolean z2, int i8, Object obj) {
        if ((i8 & 8) != 0) {
            z2 = true;
        }
    ...
    public final JvmMemberSignature.Method getJvmMethodSignature(ProtoBuf.Function proto, NameResolver nameResolver, TypeTable typeTable) {
        ...
        if (jvmMethodSignature == null || !jvmMethodSignature.hasDesc()) {
            ...
            ArrayList arrayList2 = new ArrayList(CollectionsKt.i(listPlus));
            ...
            strN = a.n(new StringBuilder(), CollectionsKt___CollectionsKt.joinToString$default(arrayList2, "", "(", ")", 0, null, null, 56, null), strMapTypeDefault2);
        } else {
            strN = nameResolver.getString(jvmMethodSignature.getDesc());
        }
        return new JvmMemberSignature.Method(nameResolver.getString(name), strN);
    }
