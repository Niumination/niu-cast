...
public final class JvmProtoBuf {
    ...
    public static final class JvmFieldSignature extends GeneratedMessageLite implements JvmFieldSignatureOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<JvmFieldSignature, Builder> implements JvmFieldSignatureOrBuilder {
            ...
            public JvmFieldSignature buildPartial() {
                ...
                jvmFieldSignature.bitField0_ = i9;
            ...
            public JvmFieldSignature build() {
                ...
                throw AbstractMessageLite.Builder.newUninitializedMessageException(jvmFieldSignatureBuildPartial);
            }
    ...
    public static final class JvmMethodSignature extends GeneratedMessageLite implements JvmMethodSignatureOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<JvmMethodSignature, Builder> implements JvmMethodSignatureOrBuilder {
            ...
            public JvmMethodSignature buildPartial() {
                ...
                jvmMethodSignature.bitField0_ = i9;
            ...
            public JvmMethodSignature build() {
                ...
                throw AbstractMessageLite.Builder.newUninitializedMessageException(jvmMethodSignatureBuildPartial);
            }
    ...
    public static final class JvmPropertySignature extends GeneratedMessageLite implements JvmPropertySignatureOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<JvmPropertySignature, Builder> implements JvmPropertySignatureOrBuilder {
            ...
            public JvmPropertySignature buildPartial() {
                ...
                jvmPropertySignature.bitField0_ = i9;
            ...
            public JvmPropertySignature build() {
                ...
                throw AbstractMessageLite.Builder.newUninitializedMessageException(jvmPropertySignatureBuildPartial);
            }
    ...
    public static final class StringTableTypes extends GeneratedMessageLite implements StringTableTypesOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<StringTableTypes, Builder> implements StringTableTypesOrBuilder {
            ...
            public StringTableTypes build() {
                ...
                throw AbstractMessageLite.Builder.newUninitializedMessageException(stringTableTypesBuildPartial);
            }
        ...
        public static final class Record extends GeneratedMessageLite implements RecordOrBuilder {
            ...
            public static final class Builder extends GeneratedMessageLite.Builder<Record, Builder> implements RecordOrBuilder {
                ...
                public Builder setPredefinedIndex(int i8) {
                    this.bitField0_ |= 2;
                    this.predefinedIndex_ = i8;
                    return this;
                }

                public Builder setRange(int i8) {
                    this.bitField0_ |= 1;
                    this.range_ = i8;
                    return this;
                }
                ...
                public Record build() {
                    ...
                    throw AbstractMessageLite.Builder.newUninitializedMessageException(recordBuildPartial);
                }
            ...
            public int getSerializedSize() {
                ...
                for (int i9 = 0; i9 < this.substringIndex_.size(); i9++) {
                    iComputeInt32SizeNoTag += CodedOutputStream.computeInt32SizeNoTag(this.substringIndex_.get(i9).intValue());
                }
                ...
                for (int i10 = 0; i10 < this.replaceChar_.size(); i10++) {
                    iComputeInt32SizeNoTag3 += CodedOutputStream.computeInt32SizeNoTag(this.replaceChar_.get(i10).intValue());
                }
            ...
            public ByteString getStringBytes() {
                ...
                this.string_ = byteStringCopyFromUtf8;
            ...
            public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
                ...
                for (int i8 = 0; i8 < this.substringIndex_.size(); i8++) {
                    codedOutputStream.writeInt32NoTag(this.substringIndex_.get(i8).intValue());
                }
                ...
                for (int i9 = 0; i9 < this.replaceChar_.size(); i9++) {
                    codedOutputStream.writeInt32NoTag(this.replaceChar_.get(i9).intValue());
                }
                if ((this.bitField0_ & 4) == 4) {
                        ...
                        try {
                            ...
                            if (tag != 0) {
                                if (tag == 8) {
                                    ...
                                    Operation operationValueOf = Operation.valueOf(i9);
                                    ...
                                    if ((i8 & 16) != 16 && codedInputStream.getBytesUntilLimit() > 0) {
                                        this.substringIndex_ = new ArrayList();
                                        i8 |= 16;
                                    }
        ...
        public int getSerializedSize() {
            ...
            for (int i9 = 0; i9 < this.record_.size(); i9++) {
                iComputeMessageSize += CodedOutputStream.computeMessageSize(1, this.record_.get(i9));
            }
            int iComputeInt32SizeNoTag = 0;
            for (int i10 = 0; i10 < this.localName_.size(); i10++) {
                iComputeInt32SizeNoTag += CodedOutputStream.computeInt32SizeNoTag(this.localName_.get(i10).intValue());
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            for (int i8 = 0; i8 < this.record_.size(); i8++) {
                codedOutputStream.writeMessage(1, this.record_.get(i8));
            }
            ...
            for (int i9 = 0; i9 < this.localName_.size(); i9++) {
                codedOutputStream.writeInt32NoTag(this.localName_.get(i9).intValue());
            }
            codedOutputStream.writeRawBytes(this.unknownFields);
        }
                    ...
                    try {
                        ...
                        if (tag != 0) {
                            if (tag == 10) {
                                ...
                                this.record_.add((Record) codedInputStream.readMessage(Record.PARSER, extensionRegistryLite));
                            } else if (tag == 40) {
                                if ((i8 & 2) != 2) {
                                ...
                                int iPushLimit = codedInputStream.pushLimit(codedInputStream.readRawVarint32());
                                if ((i8 & 2) != 2 && codedInputStream.getBytesUntilLimit() > 0) {
                                    this.localName_ = new ArrayList();
                                    i8 |= 2;
                                }
                                while (codedInputStream.getBytesUntilLimit() > 0) {
    ...
    static {
        ...
        anonymousObjectOriginName = GeneratedMessageLite.newSingularGeneratedExtension(ProtoBuf.Class.getDefaultInstance(), 0, null, null, DeviceType.INFRARED_TV_BOX, fieldType2, Integer.class);
