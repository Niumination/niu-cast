...
public final class DescriptorRendererOptionsImpl implements DescriptorRendererOptions {
    ...
    private final <T> ReadWriteProperty<DescriptorRendererOptionsImpl, T> property(final T t3) {
        ...
        while (it.hasNext()) {
            ...
            if ((field.getModifiers() & 8) == 0) {
                ...
                if (observableProperty != null) {
                    ...
                    sb2.append(name3);
                    field.set(descriptorRendererOptionsImpl, descriptorRendererOptionsImpl.property(observableProperty.getValue(this, new PropertyReference1Impl(orCreateKotlinClass, name2, sb2.toString()))));
                }
            }
        }
