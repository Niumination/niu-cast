...
public final class BuiltInFictitiousFunctionClassFactory implements ClassDescriptorFactory {
    ...
    public ClassDescriptor createClass(ClassId classId) {
        ...
        if (!StringsKt__StringsKt.contains$default(strAsString, "Function", false, 2, (Object) null) || (functionalClassKindWithArity = FunctionTypeKindExtractor.Companion.getDefault().getFunctionalClassKindWithArity((packageFqName = classId.getPackageFqName()), strAsString)) == null) {
            return null;
        }
    ...
    public boolean shouldCreateClass(FqName packageFqName, Name name) {
        ...
        Intrinsics.checkNotNullExpressionValue(strAsString, "asString(...)");
        return (StringsKt__StringsJVMKt.startsWith$default(strAsString, "Function", false, 2, null) || StringsKt__StringsJVMKt.startsWith$default(strAsString, "KFunction", false, 2, null) || StringsKt__StringsJVMKt.startsWith$default(strAsString, "SuspendFunction", false, 2, null) || StringsKt__StringsJVMKt.startsWith$default(strAsString, "KSuspendFunction", false, 2, null)) && FunctionTypeKindExtractor.Companion.getDefault().getFunctionalClassKindWithArity(packageFqName, strAsString) != null;
    }
}
