...
public final class ErrorType extends SimpleType {
    ...
    public /* synthetic */ ErrorType(TypeConstructor typeConstructor, MemberScope memberScope, ErrorTypeKind errorTypeKind, List list, boolean z2, String[] strArr, int i8, DefaultConstructorMarker defaultConstructorMarker) {
        this(typeConstructor, memberScope, errorTypeKind, (i8 & 8) != 0 ? CollectionsKt.emptyList() : list, (i8 & 16) != 0 ? false : z2, strArr);
    }
    ...
    public ErrorType(TypeConstructor constructor, MemberScope memberScope, ErrorTypeKind kind, List<? extends TypeProjection> arguments, boolean z2, String... formatParams) {
        ...
        this.debugMessage = d.q(objArrCopyOf, objArrCopyOf.length, debugMessage, "format(...)");
    }
}
