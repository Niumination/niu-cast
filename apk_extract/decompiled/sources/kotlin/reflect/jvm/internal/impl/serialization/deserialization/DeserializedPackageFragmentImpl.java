...
public abstract class DeserializedPackageFragmentImpl extends DeserializedPackageFragment {
    ...
    public void initialize(DeserializationComponents components) {
        ...
        Intrinsics.checkNotNullExpressionValue(r7, "getPackage(...)");
        this._memberScope = new DeserializedPackageMemberScope(this, r7, this.nameResolver, this.metadataVersion, this.containerSource, components, "scope of " + this, new Function0(this) { // from class: kotlin.reflect.jvm.internal.impl.serialization.deserialization.DeserializedPackageFragmentImpl$$Lambda$1
            private final DeserializedPackageFragmentImpl arg$0;
