...
public class LazySubstitutingClassDescriptor extends ModuleAwareClassDescriptor {
    ...
    private static /* synthetic */ void $$$reportNull$$$0(int i8) {
        String str = (i8 == 2 || i8 == 3 || i8 == 5 || i8 == 6 || i8 == 8 || i8 == 10 || i8 == 13 || i8 == 23) ? "Argument for @NotNull parameter '%s' of %s.%s must not be null" : "@NotNull method %s.%s must not return null";
        Object[] objArr = new Object[(i8 == 2 || i8 == 3 || i8 == 5 || i8 == 6 || i8 == 8 || i8 == 10 || i8 == 13 || i8 == 23) ? 3 : 2];
        if (i8 == 2) {
        ...
        if (i8 == 2 || i8 == 3 || i8 == 5 || i8 == 6 || i8 == 8 || i8 == 10) {
        ...
        if (i8 != 2 && i8 != 3 && i8 != 5 && i8 != 6 && i8 != 8 && i8 != 10 && i8 != 13 && i8 != 23) {
    ...
    public ClassDescriptor mo1430getCompanionObjectDescriptor() {
        return this.original.mo1430getCompanionObjectDescriptor();
    }
    ...
    public ClassConstructorDescriptor mo1431getUnsubstitutedPrimaryConstructor() {
        return this.original.mo1431getUnsubstitutedPrimaryConstructor();
    }
