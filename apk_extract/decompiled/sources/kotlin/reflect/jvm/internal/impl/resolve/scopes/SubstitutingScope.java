...
public final class SubstitutingScope implements MemberScope {
    ...
    private final <D extends DeclarationDescriptor> D substitute(D d7) {
        ...
        DeclarationDescriptor declarationDescriptorSubstitute = map.get(d7);
        if (declarationDescriptorSubstitute == null) {
            ...
            declarationDescriptorSubstitute = ((Substitutable) d7).substitute(this.capturingSubstitutor);
            if (declarationDescriptorSubstitute == null) {
                throw new AssertionError("We expect that no conflict should happen while substitution is guaranteed to generate invariant projection, but " + d7 + " substitution fails");
            }
            map.put(d7, declarationDescriptorSubstitute);
        }
        D d10 = (D) declarationDescriptorSubstitute;
    ...
    public ClassifierDescriptor mo1439getContributedClassifier(Name name, LookupLocation location) {
        ...
        if (classifierDescriptorMo1439getContributedClassifier != null) {
            return (ClassifierDescriptor) substitute(classifierDescriptorMo1439getContributedClassifier);
        }
        return null;
    }
    ...
    public void mo1443recordLookup(Name name, LookupLocation lookupLocation) {
