...
public final class NotFoundClasses {
    ...
    public static final class MockClassDescriptor extends ClassDescriptorBase {
        ...
        public MockClassDescriptor(StorageManager storageManager, DeclarationDescriptor container, Name name, boolean z2, int i8) {
            super(storageManager, container, name, SourceElement.NO_SOURCE, false);
            Intrinsics.checkNotNullParameter(storageManager, "storageManager");
            Intrinsics.checkNotNullParameter(container, "container");
            Intrinsics.checkNotNullParameter(name, "name");
            this.isInner = z2;
            IntRange intRangeUntil = RangesKt.until(0, i8);
