...
public final class AbstractBinaryClassAnnotationLoaderKt {
    public static final MemberSignature getPropertySignature(ProtoBuf.Property proto, NameResolver nameResolver, TypeTable typeTable, boolean z2, boolean z3, boolean z5) {
    ...
    public static /* synthetic */ MemberSignature getPropertySignature$default(ProtoBuf.Property property, NameResolver nameResolver, TypeTable typeTable, boolean z2, boolean z3, boolean z5, int i8, Object obj) {
        boolean z10 = (i8 & 8) != 0 ? false : z2;
        boolean z11 = (i8 & 16) != 0 ? false : z3;
        if ((i8 & 32) != 0) {
            z5 = true;
        }
        return getPropertySignature(property, nameResolver, typeTable, z10, z11, z5);
    }
}
