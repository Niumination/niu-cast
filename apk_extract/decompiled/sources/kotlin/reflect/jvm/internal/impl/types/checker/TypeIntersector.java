...
public final class TypeIntersector {
    ...
    public static final class ResultNullability {
        ...
        public static final class ACCEPT_NULL extends ResultNullability {
            public ACCEPT_NULL(String str, int i8) {
                super(str, i8, null);
            }
        ...
        public static final class NOT_NULL extends ResultNullability {
            public NOT_NULL(String str, int i8) {
                super(str, i8, null);
            }
        ...
        public static final class START extends ResultNullability {
            public START(String str, int i8) {
                super(str, i8, null);
            }
        ...
        public static final class UNKNOWN extends ResultNullability {
            public UNKNOWN(String str, int i8) {
                super(str, i8, null);
            }
        ...
        public /* synthetic */ ResultNullability(String str, int i8, DefaultConstructorMarker defaultConstructorMarker) {
            this(str, i8);
        }
        ...
        private ResultNullability(String str, int i8) {
            super(str, i8);
        }
    }
    ...
    public final SimpleType intersectTypes$descriptors(List<? extends SimpleType> types) {
        ...
        for (SimpleType simpleType : types) {
            if (simpleType.getConstructor() instanceof IntersectionTypeConstructor) {
                Collection<KotlinType> collectionMo1438getSupertypes = simpleType.getConstructor().mo1438getSupertypes();
                Intrinsics.checkNotNullExpressionValue(collectionMo1438getSupertypes, "getSupertypes(...)");
                Collection<KotlinType> collection = collectionMo1438getSupertypes;
                ArrayList arrayList2 = new ArrayList(CollectionsKt.i(collection));
