...
public final class NewCapturedType extends SimpleType implements CapturedTypeMarker {
    ...
    public /* synthetic */ NewCapturedType(CaptureStatus captureStatus, NewCapturedTypeConstructor newCapturedTypeConstructor, UnwrappedType unwrappedType, TypeAttributes typeAttributes, boolean z2, boolean z3, int i8, DefaultConstructorMarker defaultConstructorMarker) {
        this(captureStatus, newCapturedTypeConstructor, unwrappedType, (i8 & 8) != 0 ? TypeAttributes.Companion.getEmpty() : typeAttributes, (i8 & 16) != 0 ? false : z2, (i8 & 32) != 0 ? false : z3);
    }
