...
public final class NewKotlinTypeCheckerImpl implements NewKotlinTypeChecker {
    ...
    public boolean equalTypes(KotlinType a6, KotlinType b9) {
        Intrinsics.checkNotNullParameter(a6, "a");
        Intrinsics.checkNotNullParameter(b9, "b");
        return equalTypes(ClassicTypeCheckerStateKt.createClassicTypeCheckerState$default(false, false, null, getKotlinTypePreparator(), getKotlinTypeRefiner(), 6, null), a6.unwrap(), b9.unwrap());
    }
    ...
    public final boolean equalTypes(TypeCheckerState typeCheckerState, UnwrappedType a6, UnwrappedType b9) {
        Intrinsics.checkNotNullParameter(typeCheckerState, "<this>");
        Intrinsics.checkNotNullParameter(a6, "a");
        Intrinsics.checkNotNullParameter(b9, "b");
        return AbstractTypeChecker.INSTANCE.equalTypes(typeCheckerState, a6, b9);
    }
    ...
    public /* synthetic */ NewKotlinTypeCheckerImpl(KotlinTypeRefiner kotlinTypeRefiner, KotlinTypePreparator kotlinTypePreparator, int i8, DefaultConstructorMarker defaultConstructorMarker) {
        this(kotlinTypeRefiner, (i8 & 2) != 0 ? KotlinTypePreparator.Default.INSTANCE : kotlinTypePreparator);
    }
}
