...
public abstract class KotlinTypePreparator extends AbstractTypePreparator {
    ...
    public /* synthetic */ class AnonymousClass1 extends FunctionReference implements Function1<KotlinTypeMarker, UnwrappedType> {
    ...
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> collectionMo1438getSupertypes = capturedTypeConstructorImpl.mo1438getSupertypes();
                ArrayList arrayList = new ArrayList(CollectionsKt.i(collectionMo1438getSupertypes));
        ...
        if (constructor instanceof IntegerValueTypeConstructor) {
            Collection<KotlinType> collectionMo1438getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo1438getSupertypes();
            ArrayList arrayList2 = new ArrayList(CollectionsKt.i(collectionMo1438getSupertypes2));
            Iterator<T> it2 = collectionMo1438getSupertypes2.iterator();
            while (it2.hasNext()) {
        ...
        Collection<KotlinType> collectionMo1438getSupertypes3 = intersectionTypeConstructor.mo1438getSupertypes();
        ArrayList arrayList3 = new ArrayList(CollectionsKt.i(collectionMo1438getSupertypes3));
        Iterator<T> it3 = collectionMo1438getSupertypes3.iterator();
        while (it3.hasNext()) {
