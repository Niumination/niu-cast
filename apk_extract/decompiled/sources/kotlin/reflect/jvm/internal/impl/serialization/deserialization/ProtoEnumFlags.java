...
public final class ProtoEnumFlags {
    ...
    public final Modality modality(ProtoBuf.Modality modality) {
        int i8 = modality == null ? -1 : WhenMappings.$EnumSwitchMapping$0[modality.ordinal()];
        if (i8 == 1) {
        ...
        if (i8 != 3) {
            return i8 != 4 ? Modality.FINAL : Modality.SEALED;
        }
    ...
    public final Variance variance(ProtoBuf.TypeParameter.Variance variance) {
        ...
        int i8 = WhenMappings.$EnumSwitchMapping$5[variance.ordinal()];
        if (i8 == 1) {
    ...
    public final Variance variance(ProtoBuf.Type.Argument.Projection projection) {
        ...
        int i8 = WhenMappings.$EnumSwitchMapping$6[projection.ordinal()];
        if (i8 == 1) {
            return Variance.IN_VARIANCE;
        }
        if (i8 == 2) {
