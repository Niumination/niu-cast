...
public final class JavaNullabilityAnnotationSettingsKt {
    ...
    static {
        ...
        RXJAVA3_ANNOTATIONS = new FqName[]{new FqName(a.B(strAsString, ".Nullable")), new FqName(a.B(strAsString, ".NonNull"))};
    ...
    public static /* synthetic */ Jsr305Settings getDefaultJsr305Settings$default(KotlinVersion kotlinVersion, int i8, Object obj) {
        if ((i8 & 1) != 0) {
    ...
    public static /* synthetic */ ReportLevel getReportLevelForAnnotation$default(FqName fqName, NullabilityAnnotationStates nullabilityAnnotationStates, KotlinVersion kotlinVersion, int i8, Object obj) {
        if ((i8 & 4) != 0) {
