...
public final class KotlinTarget {
    ...
    static {
        ...
        PROPERTY = new KotlinTarget("PROPERTY", 3, "property", z2, i8, defaultConstructorMarker);
        boolean z3 = false;
        int i9 = 2;
        DefaultConstructorMarker defaultConstructorMarker2 = null;
        FIELD = new KotlinTarget("FIELD", 4, "field", z3, i9, defaultConstructorMarker2);
        LOCAL_VARIABLE = new KotlinTarget("LOCAL_VARIABLE", 5, "local variable", z2, i8, defaultConstructorMarker);
        VALUE_PARAMETER = new KotlinTarget("VALUE_PARAMETER", 6, "value parameter", z3, i9, defaultConstructorMarker2);
        CONSTRUCTOR = new KotlinTarget("CONSTRUCTOR", 7, "constructor", z2, i8, defaultConstructorMarker);
        FUNCTION = new KotlinTarget("FUNCTION", 8, "function", z3, i9, defaultConstructorMarker2);
        PROPERTY_GETTER = new KotlinTarget("PROPERTY_GETTER", 9, "getter", z2, i8, defaultConstructorMarker);
        PROPERTY_SETTER = new KotlinTarget("PROPERTY_SETTER", 10, "setter", z3, i9, defaultConstructorMarker2);
        BACKING_FIELD = new KotlinTarget("BACKING_FIELD", 37, "backing field", z2, i8, defaultConstructorMarker);
    ...
    private KotlinTarget(String str, int i8, String str2, boolean z2) {
        super(str, i8);
    ...
    public /* synthetic */ KotlinTarget(String str, int i8, String str2, boolean z2, int i9, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, i8, str2, (i9 & 2) != 0 ? true : z2);
    }
}
