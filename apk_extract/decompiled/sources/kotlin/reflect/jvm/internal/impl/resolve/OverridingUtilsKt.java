...
public final class OverridingUtilsKt {
    ...
    public static final <H> Collection<H> selectMostSpecificInEachOverridableGroup(Collection<? extends H> collection, Function1<? super H, ? extends CallableDescriptor> descriptorByHandle) {
        ...
        while (!linkedList.isEmpty()) {
            ...
            Collection<h> collectionExtractMembersOverridableInBothWays = OverridingUtil.extractMembersOverridableInBothWays(objFirst, linkedList, descriptorByHandle, new Function1(smartSetCreate2) { // from class: kotlin.reflect.jvm.internal.impl.resolve.OverridingUtilsKt$$Lambda$1
            ...
            if (collectionExtractMembersOverridableInBothWays.size() == 1 && smartSetCreate2.isEmpty()) {
                ...
                for (h hVar : collectionExtractMembersOverridableInBothWays) {
                    Intrinsics.checkNotNull(hVar);
                    if (!OverridingUtil.isMoreSpecific(callableDescriptorInvoke, descriptorByHandle.invoke(hVar))) {
                        smartSetCreate2.add(hVar);
                    }
                }
