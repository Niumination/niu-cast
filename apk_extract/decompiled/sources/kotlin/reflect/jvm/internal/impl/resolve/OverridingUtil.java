...
public class OverridingUtil {
    ...
    public static class OverrideCompatibilityInfo {
        ...
        private static /* synthetic */ void $$$reportNull$$$0(int i8) {
            String str = (i8 == 1 || i8 == 2 || i8 == 3 || i8 == 4) ? "Argument for @NotNull parameter '%s' of %s.%s must not be null" : "@NotNull method %s.%s must not return null";
            Object[] objArr = new Object[(i8 == 1 || i8 == 2 || i8 == 3 || i8 == 4) ? 3 : 2];
            if (i8 == 1 || i8 == 2) {
    ...
    private static DescriptorVisibility computeVisibilityToInherit(CallableMemberDescriptor callableMemberDescriptor) {
        if (callableMemberDescriptor == null) {
            $$$reportNull$$$0(DeviceType.INFRARED_PROJECTOR);
        }
    ...
    private TypeCheckerState createTypeCheckerState(List<TypeParameterDescriptor> list, List<TypeParameterDescriptor> list2) {
        ...
        for (int i8 = 0; i8 < list.size(); i8++) {
            map.put(list.get(i8).getTypeConstructor(), list2.get(i8).getTypeConstructor());
        }
    ...
    private static Modality determineModalityForFakeOverride(Collection<CallableMemberDescriptor> collection, ClassDescriptor classDescriptor) {
        ...
        for (CallableMemberDescriptor callableMemberDescriptor : collection) {
            int i8 = AnonymousClass8.$SwitchMap$org$jetbrains$kotlin$descriptors$Modality[callableMemberDescriptor.getModality().ordinal()];
            if (i8 == 1) {
        ...
        if (!z3 && z5) {
            Modality modality3 = z2 ? classDescriptor.getModality() : Modality.ABSTRACT;
            if (modality3 == null) {
                $$$reportNull$$$0(90);
            }
            return modality3;
        ...
        return getMinimalModality(filterOutOverridden(hashSet), z2, classDescriptor.getModality());
    }
    ...
    private Collection<CallableMemberDescriptor> extractAndBindOverridesForMember(CallableMemberDescriptor callableMemberDescriptor, Collection<? extends CallableMemberDescriptor> collection, ClassDescriptor classDescriptor, OverridingStrategy overridingStrategy) {
        ...
        for (CallableMemberDescriptor callableMemberDescriptor2 : collection) {
            ...
            int i8 = AnonymousClass8.$SwitchMap$org$jetbrains$kotlin$resolve$OverridingUtil$OverrideCompatibilityInfo$Result[result.ordinal()];
            if (i8 == 1) {
    ...
    public static <H> Collection<H> extractMembersOverridableInBothWays(H h9, Collection<H> collection, Function1<H, CallableDescriptor> function1, Function1<H, Unit> function2) {
        if (h9 == null) {
            $$$reportNull$$$0(97);
        }
        if (collection == null) {
        ...
        ArrayList arrayList = new ArrayList();
        arrayList.add(h9);
        CallableDescriptor callableDescriptorInvoke = function1.invoke(h9);
    ...
    public static <D> Set<D> filterOverrides(Set<D> set, boolean z2, Function0<?> function0, Function2<? super D, ? super D, Pair<CallableDescriptor, CallableDescriptor>> function2) {
        if (set == null) {
            $$$reportNull$$$0(9);
        }
        if (function2 == null) {
    ...
    public static DescriptorVisibility findMaxVisibility(Collection<? extends CallableMemberDescriptor> collection) {
        ...
        if (collection == null) {
            $$$reportNull$$$0(DeviceType.INFRARED_AMPLIFIER);
        }
    ...
    private static Modality getMinimalModality(Collection<CallableMemberDescriptor> collection, boolean z2, Modality modality) {
        if (collection == null) {
            $$$reportNull$$$0(91);
        }
        if (modality == null) {
        ...
        for (CallableMemberDescriptor callableMemberDescriptor : collection) {
            Modality modality3 = (z2 && callableMemberDescriptor.getModality() == Modality.ABSTRACT) ? modality : callableMemberDescriptor.getModality();
    ...
    public static boolean isVisibleForOverride(MemberDescriptor memberDescriptor, MemberDescriptor memberDescriptor2, boolean z2) {
        ...
        return !DescriptorVisibilities.isPrivate(memberDescriptor2.getVisibility()) && DescriptorVisibilities.isVisibleIgnoringReceiver(memberDescriptor2, memberDescriptor, z2);
    }

    public static <D extends CallableDescriptor> boolean overrides(D d7, D d10, boolean z2, boolean z3) {
        if (d7 == null) {
            $$$reportNull$$$0(13);
        }
        if (d10 == null) {
        ...
        if (!d7.equals(d10) && DescriptorEquivalenceForOverrides.INSTANCE.areEquivalent(d7.getOriginal(), d10.getOriginal(), z2, z3)) {
            return true;
        }
        CallableDescriptor original = d10.getOriginal();
        Iterator it = DescriptorUtils.getAllOverriddenDescriptors(d7).iterator();
        while (it.hasNext()) {
            if (DescriptorEquivalenceForOverrides.INSTANCE.areEquivalent(original, (CallableDescriptor) it.next(), z2, z3)) {
                return true;
            }
        }
        return false;
    ...
    public static void resolveUnknownVisibilityForMember(CallableMemberDescriptor callableMemberDescriptor, Function1<CallableMemberDescriptor, Unit> function1) {
        DescriptorVisibility descriptorVisibility;
        if (callableMemberDescriptor == null) {
            $$$reportNull$$$0(DeviceType.INFRARED_AIR_CONDITION);
        }
    ...
    public static <H> H selectMostSpecificMember(Collection<H> collection, Function1<H, CallableDescriptor> function1) {
        ...
        CallableDescriptor callableDescriptorInvoke = function1.invoke(h11);
        for (H h12 : collection) {
            CallableDescriptor callableDescriptorInvoke2 = function1.invoke(h12);
        ...
        if (arrayList.size() == 1) {
            H h13 = (H) CollectionsKt.first((Iterable) arrayList);
            if (h13 == null) {
                $$$reportNull$$$0(80);
            }
            return h13;
        ...
        do {
            ...
            h9 = (H) it.next();
        } while (FlexibleTypesKt.isFlexible(function1.invoke(h9).getReturnType()));
        if (h9 != null) {
            return h9;
        }
    ...
    public OverrideCompatibilityInfo isOverridableByWithoutExternalConditions(CallableDescriptor callableDescriptor, CallableDescriptor callableDescriptor2, boolean z2) {
        if (callableDescriptor == null) {
            $$$reportNull$$$0(28);
        }
        if (callableDescriptor2 == null) {
        ...
        if (typeParameters.size() != typeParameters2.size()) {
            while (i8 < listCompiledValueParameters.size()) {
                if (!KotlinTypeChecker.DEFAULT.equalTypes(listCompiledValueParameters.get(i8), listCompiledValueParameters2.get(i8))) {
        ...
        for (int i9 = 0; i9 < typeParameters.size(); i9++) {
            if (!areTypeParametersEquivalent(typeParameters.get(i9), typeParameters2.get(i9), typeCheckerStateCreateTypeCheckerState)) {
        ...
        while (i8 < listCompiledValueParameters.size()) {
            if (!areTypesEquivalent(listCompiledValueParameters.get(i8), listCompiledValueParameters2.get(i8), typeCheckerStateCreateTypeCheckerState)) {
    ...
    public OverrideCompatibilityInfo isOverridableBy(CallableDescriptor callableDescriptor, CallableDescriptor callableDescriptor2, ClassDescriptor classDescriptor, boolean z2) {
        if (callableDescriptor == null) {
            $$$reportNull$$$0(22);
        }
        if (callableDescriptor2 == null) {
        ...
        OverrideCompatibilityInfo overrideCompatibilityInfoIsOverridableByWithoutExternalConditions = isOverridableByWithoutExternalConditions(callableDescriptor, callableDescriptor2, z2);
        boolean z3 = overrideCompatibilityInfoIsOverridableByWithoutExternalConditions.getResult() == OverrideCompatibilityInfo.Result.OVERRIDABLE;
        for (ExternalOverridabilityCondition externalOverridabilityCondition : EXTERNAL_CONDITIONS) {
            if (externalOverridabilityCondition.getContract() != ExternalOverridabilityCondition.Contract.CONFLICTS_ONLY && (!z3 || externalOverridabilityCondition.getContract() != ExternalOverridabilityCondition.Contract.SUCCESS_ONLY)) {
                int i8 = AnonymousClass8.$SwitchMap$org$jetbrains$kotlin$resolve$ExternalOverridabilityCondition$Result[externalOverridabilityCondition.isOverridable(callableDescriptor, callableDescriptor2, classDescriptor).ordinal()];
                if (i8 == 1) {
                    z3 = true;
                } else if (i8 == 2) {
        ...
        for (ExternalOverridabilityCondition externalOverridabilityCondition2 : EXTERNAL_CONDITIONS) {
            if (externalOverridabilityCondition2.getContract() == ExternalOverridabilityCondition.Contract.CONFLICTS_ONLY) {
                int i9 = AnonymousClass8.$SwitchMap$org$jetbrains$kotlin$resolve$ExternalOverridabilityCondition$Result[externalOverridabilityCondition2.isOverridable(callableDescriptor, callableDescriptor2, classDescriptor).ordinal()];
                if (i9 == 1) {
    ...
    private static Collection<CallableMemberDescriptor> extractMembersOverridableInBothWays(final CallableMemberDescriptor callableMemberDescriptor, Queue<CallableMemberDescriptor> queue, final OverridingStrategy overridingStrategy) {
        ...
        if (queue == null) {
            $$$reportNull$$$0(DeviceType.INFRARED_TV_BOX);
        }
        if (overridingStrategy == null) {
            $$$reportNull$$$0(104);
        }
