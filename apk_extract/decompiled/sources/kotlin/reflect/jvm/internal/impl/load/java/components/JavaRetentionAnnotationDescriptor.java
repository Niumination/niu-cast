...
public final class JavaRetentionAnnotationDescriptor extends JavaAnnotationDescriptor {
    ...
    public JavaRetentionAnnotationDescriptor(JavaAnnotation annotation, LazyJavaResolverContext c9) {
        ...
        this.allValueArguments$delegate = c9.getStorageManager().createLazyValue(new Function0(this) { // from class: kotlin.reflect.jvm.internal.impl.load.java.components.JavaRetentionAnnotationDescriptor$$Lambda$0
