...
public final class KClassValue extends ConstantValue<Value> {
    ...
    public static final class Companion {
        ...
        public final ConstantValue<?> create(KotlinType argumentType) {
            ...
            if (classifierDescriptorMo1437getDeclarationDescriptor instanceof ClassDescriptor) {
                ClassId classId = DescriptorUtilsKt.getClassId(classifierDescriptorMo1437getDeclarationDescriptor);
                return classId == null ? new KClassValue(new Value.LocalClass(argumentType)) : new KClassValue(classId, i8);
            }
    ...
    public final KotlinType getArgumentType(ModuleDescriptor module) {
        ...
        for (int i8 = 0; i8 < iComponent2; i8++) {
