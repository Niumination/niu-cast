...
public class Flags {
    ...
    public static class BooleanFlagField extends FlagField<Boolean> {
        ...
        public BooleanFlagField(int i8) {
            super(i8, 1);
        }
        ...
        public Boolean get(int i8) {
            return Boolean.valueOf(((1 << this.offset) & i8) != 0);
        }
    ...
    public static class EnumLiteFlagField<E extends Internal.EnumLite> extends FlagField<E> {
        ...
        public EnumLiteFlagField(int i8, E[] eArr) {
            super(i8, bitWidth(eArr));
            this.values = eArr;
        }
    ...
    public static abstract class FlagField<E> {
        ...
        private FlagField(int i8, int i9) {
            this.offset = i8;
            this.bitWidth = i9;
        }
    }
    ...
    public static int getAccessorFlags(boolean z2, ProtoBuf.Visibility visibility, ProtoBuf.Modality modality, boolean z3, boolean z5, boolean z10) {
        if (visibility == null) {
            $$$reportNull$$$0(10);
        }
        if (modality == null) {
        ...
        return HAS_ANNOTATIONS.toFlags(Boolean.valueOf(z2)) | MODALITY.toFlags(modality) | VISIBILITY.toFlags(visibility) | IS_NOT_DEFAULT.toFlags(Boolean.valueOf(z3)) | IS_EXTERNAL_ACCESSOR.toFlags(Boolean.valueOf(z5)) | IS_INLINE_ACCESSOR.toFlags(Boolean.valueOf(z10));
    }
}
