...
public final class CapturedTypeConstructorKt {
    ...
    public static final TypeSubstitution wrapWithCapturingSubstitution(TypeSubstitution typeSubstitution, final boolean z2) {
        ...
        if (!(typeSubstitution instanceof IndexedParametersSubstitution)) {
            return new DelegatedTypeSubstitution(typeSubstitution) { // from class: kotlin.reflect.jvm.internal.impl.resolve.calls.inference.CapturedTypeConstructorKt.wrapWithCapturingSubstitution.2
                ...
                public TypeProjection mo1442get(KotlinType key) {
                    Intrinsics.checkNotNullParameter(key, "key");
                    TypeProjection typeProjectionMo1442get = super.mo1442get(key);
                    if (typeProjectionMo1442get == null) {
                        return null;
                    }
                    ClassifierDescriptor classifierDescriptorMo1437getDeclarationDescriptor = key.getConstructor().mo1437getDeclarationDescriptor();
                    return CapturedTypeConstructorKt.createCapturedIfNeeded(typeProjectionMo1442get, classifierDescriptorMo1437getDeclarationDescriptor instanceof TypeParameterDescriptor ? (TypeParameterDescriptor) classifierDescriptorMo1437getDeclarationDescriptor : null);
                }
            };
        }
        ...
        ArrayList arrayList = new ArrayList(CollectionsKt.i(listZip));
    ...
    public static /* synthetic */ TypeSubstitution wrapWithCapturingSubstitution$default(TypeSubstitution typeSubstitution, boolean z2, int i8, Object obj) {
        if ((i8 & 1) != 0) {
            z2 = true;
        }
