...
public final class InnerClassesScopeWrapper extends MemberScopeImpl {
    ...
    public ClassifierDescriptor mo1439getContributedClassifier(Name name, LookupLocation location) {
        ...
        ClassifierDescriptor classifierDescriptorMo1439getContributedClassifier = this.workerScope.mo1439getContributedClassifier(name, location);
        if (classifierDescriptorMo1439getContributedClassifier == null) {
            return null;
        }
        ClassDescriptor classDescriptor = classifierDescriptorMo1439getContributedClassifier instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo1439getContributedClassifier : null;
        if (classDescriptor != null) {
            return classDescriptor;
        }
        if (classifierDescriptorMo1439getContributedClassifier instanceof TypeAliasDescriptor) {
            return (TypeAliasDescriptor) classifierDescriptorMo1439getContributedClassifier;
        }
        return null;
    }
    ...
    public void mo1443recordLookup(Name name, LookupLocation location) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(location, "location");
        this.workerScope.mo1443recordLookup(name, location);
    }
