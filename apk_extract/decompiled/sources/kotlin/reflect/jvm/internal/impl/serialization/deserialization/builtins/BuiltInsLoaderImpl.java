...
public final class BuiltInsLoaderImpl implements BuiltInsLoader {
    ...
    public final PackageFragmentProvider createBuiltInPackageFragmentProvider(StorageManager storageManager, ModuleDescriptor module, Set<FqName> packageFqNames, Iterable<? extends ClassDescriptorFactory> classDescriptorFactories, PlatformDependentDeclarationFilter platformDependentDeclarationFilter, AdditionalClassPartsProvider additionalClassPartsProvider, boolean z2, Function1<? super String, ? extends InputStream> loadResource) {
        ...
        ArrayList arrayList = new ArrayList(CollectionsKt.i(packageFqNames));
        for (FqName fqName : packageFqNames) {
            ...
            if (inputStreamInvoke == null) {
                throw new IllegalStateException(a.i("Resource not found in classpath: ", builtInsFilePath));
            }
            arrayList.add(BuiltInsPackageFragmentImpl.Companion.create(fqName, storageManager, module, inputStreamInvoke, z2));
        }
