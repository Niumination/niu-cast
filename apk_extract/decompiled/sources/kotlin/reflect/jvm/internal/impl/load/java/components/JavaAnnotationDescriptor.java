...
public class JavaAnnotationDescriptor implements PossiblyExternalAnnotationDescriptor {
    static final /* synthetic */ KProperty<Object>[] $$delegatedProperties = {Reflection.property1(new PropertyReference1Impl(Reflection.getOrCreateKotlinClass(JavaAnnotationDescriptor.class), MessageBank.KEY_TYPE, "getType()Lorg/jetbrains/kotlin/types/SimpleType;"))};
    ...
    public JavaAnnotationDescriptor(final LazyJavaResolverContext c9, JavaAnnotation javaAnnotation, FqName fqName) {
        ...
        this.type$delegate = c9.getStorageManager().createLazyValue(new Function0(c9, this) { // from class: kotlin.reflect.jvm.internal.impl.load.java.components.JavaAnnotationDescriptor$$Lambda$0
