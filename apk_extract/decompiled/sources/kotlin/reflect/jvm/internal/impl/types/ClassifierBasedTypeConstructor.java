...
public abstract class ClassifierBasedTypeConstructor implements TypeConstructor {
    ...
    public boolean equals(Object obj) {
        ...
        ClassifierDescriptor classifierDescriptorMo1437getDeclarationDescriptor = mo1437getDeclarationDescriptor();
        ClassifierDescriptor classifierDescriptorMo1437getDeclarationDescriptor2 = typeConstructor.mo1437getDeclarationDescriptor();
        if (classifierDescriptorMo1437getDeclarationDescriptor2 != null && hasMeaningfulFqName(classifierDescriptorMo1437getDeclarationDescriptor) && hasMeaningfulFqName(classifierDescriptorMo1437getDeclarationDescriptor2)) {
            return isSameClassifier(classifierDescriptorMo1437getDeclarationDescriptor2);
        }
        return false;
    }
    ...
    public abstract ClassifierDescriptor mo1437getDeclarationDescriptor();
    ...
    public int hashCode() {
        ...
        ClassifierDescriptor classifierDescriptorMo1437getDeclarationDescriptor = mo1437getDeclarationDescriptor();
        int iHashCode = hasMeaningfulFqName(classifierDescriptorMo1437getDeclarationDescriptor) ? DescriptorUtils.getFqName(classifierDescriptorMo1437getDeclarationDescriptor).hashCode() : System.identityHashCode(this);
