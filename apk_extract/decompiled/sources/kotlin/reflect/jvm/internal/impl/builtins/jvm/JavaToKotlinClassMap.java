...
public final class JavaToKotlinClassMap {
    ...
    static {
        ...
        for (int i8 = 0; i8 < 23; i8++) {
            ...
            javaToKotlinClassMap3.add(ClassId.Companion.topLevel(new FqName(a.o(i8, "kotlin.jvm.functions.Function"))), StandardNames.getFunctionClassId(i8));
            javaToKotlinClassMap3.addKotlinToJava(new FqName(NUMBERED_K_FUNCTION_PREFIX + i8), K_FUNCTION_CLASS_ID);
        }
        for (int i9 = 0; i9 < 22; i9++) {
            FunctionTypeKind.KSuspendFunction kSuspendFunction2 = FunctionTypeKind.KSuspendFunction.INSTANCE;
            INSTANCE.addKotlinToJava(new FqName((kSuspendFunction2.getPackageFqName() + '.' + kSuspendFunction2.getClassNamePrefix()) + i9), K_FUNCTION_CLASS_ID);
        }
