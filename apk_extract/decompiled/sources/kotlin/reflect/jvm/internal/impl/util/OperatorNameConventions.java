...
public final class OperatorNameConventions {
    ...
    static {
        ...
        Set<Name> of2 = SetsKt.setOf((Object[]) new Name[]{nameIdentifier29, nameIdentifier24, nameIdentifier25, nameIdentifier30, nameIdentifier31, nameIdentifier32, nameIdentifier33, nameIdentifier34});
        ...
        Set<Name> of3 = SetsKt.setOf((Object[]) new Name[]{nameIdentifier15, nameIdentifier16, nameIdentifier17, nameIdentifier18, nameIdentifier19, nameIdentifier20, nameIdentifier21});
        ...
        ALL_BINARY_OPERATION_NAMES = SetsKt.plus(SetsKt.plus((Set) of2, (Iterable) of3), (Iterable) SetsKt.setOf((Object[]) new Name[]{nameIdentifier4, nameIdentifier7, nameIdentifier6}));
        Set<Name> of4 = SetsKt.setOf((Object[]) new Name[]{nameIdentifier35, nameIdentifier36, nameIdentifier37, nameIdentifier38, nameIdentifier39, nameIdentifier40});
        ...
        STATEMENT_LIKE_OPERATORS = SetsKt.plus(SetsKt.setOf(nameIdentifier11), (Iterable) of4);
        ...
        TOKENS_BY_OPERATOR_NAME = MapsKt.mapOf(TuplesKt.to(nameIdentifier22, "++"), TuplesKt.to(nameIdentifier23, "--"), TuplesKt.to(nameIdentifier28, e.ANY_NON_NULL_MARKER), TuplesKt.to(nameIdentifier27, "-"), TuplesKt.to(nameIdentifier26, "!"), TuplesKt.to(nameIdentifier29, e.ANY_MARKER), TuplesKt.to(nameIdentifier24, e.ANY_NON_NULL_MARKER), TuplesKt.to(nameIdentifier25, "-"), TuplesKt.to(nameIdentifier30, "/"), TuplesKt.to(nameIdentifier32, "%"), TuplesKt.to(nameIdentifier33, ".."), TuplesKt.to(nameIdentifier34, "..<"));
    }
