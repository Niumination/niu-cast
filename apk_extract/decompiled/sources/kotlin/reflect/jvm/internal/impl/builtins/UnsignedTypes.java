...
public final class UnsignedTypes {
    ...
    public static final boolean isUnsignedType(KotlinType type) {
        ...
        if (TypeUtils.noExpectedType(type) || (classifierDescriptorMo1437getDeclarationDescriptor = type.getConstructor().mo1437getDeclarationDescriptor()) == null) {
            return false;
        }
        return INSTANCE.isUnsignedClass(classifierDescriptorMo1437getDeclarationDescriptor);
    }
