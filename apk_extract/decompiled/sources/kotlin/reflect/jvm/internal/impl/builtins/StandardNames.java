...
public final class StandardNames {
    ...
    public static final class FqNames {
        ...
        static {
            ...
            mapEntry = a.C("Entry", fqNameCollectionsFqName, "child(...)");
            ...
            mutableMapEntry = a.C("MutableEntry", fqNameCollectionsFqName2, "child(...)");
        ...
        private final FqName annotationName(String str) {
            return a.C(str, StandardNames.ANNOTATION_PACKAGE_FQ_NAME, "child(...)");
        }

        private final FqName collectionsFqName(String str) {
            return a.C(str, StandardNames.COLLECTIONS_PACKAGE_FQ_NAME, "child(...)");
        }

        private final FqName fqName(String str) {
            return a.C(str, StandardNames.BUILT_INS_PACKAGE_FQ_NAME, "child(...)");
        }
        ...
        private final FqName internalName(String str) {
            return a.C(str, StandardNames.KOTLIN_INTERNAL_FQ_NAME, "child(...)");
        }
    ...
    static {
        ...
        CONTINUATION_INTERFACE_FQ_NAME = a.C("Continuation", fqName, "child(...)");
        ...
        FqName fqNameC = a.C("annotation", fqName3, "child(...)");
        ANNOTATION_PACKAGE_FQ_NAME = fqNameC;
        FqName fqNameC2 = a.C("collections", fqName3, "child(...)");
        COLLECTIONS_PACKAGE_FQ_NAME = fqNameC2;
        FqName fqNameC3 = a.C("ranges", fqName3, "child(...)");
        RANGES_PACKAGE_FQ_NAME = fqNameC3;
        TEXT_PACKAGE_FQ_NAME = a.C("text", fqName3, "child(...)");
        FqName fqNameC4 = a.C("internal", fqName3, "child(...)");
        KOTLIN_INTERNAL_FQ_NAME = fqNameC4;
        NON_EXISTENT_CLASS = new FqName("error.NonExistentClass");
        BUILT_INS_PACKAGE_FQ_NAMES = SetsKt.setOf((Object[]) new FqName[]{fqName3, fqNameC2, fqNameC3, fqNameC, fqName2, fqNameC4, fqName});
    }
    ...
    @JvmStatic
    public static final ClassId getFunctionClassId(int i8) {
        FqName fqName = BUILT_INS_PACKAGE_FQ_NAME;
        Name nameIdentifier = Name.identifier(getFunctionName(i8));
        Intrinsics.checkNotNullExpressionValue(nameIdentifier, "identifier(...)");
    ...
    public static final String getSuspendFunctionName(int i8) {
        return FunctionTypeKind.SuspendFunction.INSTANCE.getClassNamePrefix() + i8;
    }
