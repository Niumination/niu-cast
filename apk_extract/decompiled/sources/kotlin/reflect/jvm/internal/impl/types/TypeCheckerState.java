...
public class TypeCheckerState {
    ...
    public static abstract class SupertypesPolicy {
        ...
        public static final class LowerIfFlexible extends SupertypesPolicy {
            ...
            public SimpleTypeMarker mo1441transformType(TypeCheckerState state, KotlinTypeMarker type) {
        ...
        public static final class None extends SupertypesPolicy {
            ...
            public /* bridge */ /* synthetic */ SimpleTypeMarker mo1441transformType(TypeCheckerState typeCheckerState, KotlinTypeMarker kotlinTypeMarker) {
        ...
        /* JADX INFO: renamed from: transformType */
        public abstract SimpleTypeMarker mo1441transformType(TypeCheckerState typeCheckerState, KotlinTypeMarker kotlinTypeMarker);

        private SupertypesPolicy() {
        }
    }

    public TypeCheckerState(boolean z2, boolean z3, boolean z5, TypeSystemContext typeSystemContext, AbstractTypePreparator kotlinTypePreparator, AbstractTypeRefiner kotlinTypeRefiner) {
        Intrinsics.checkNotNullParameter(typeSystemContext, "typeSystemContext");
        Intrinsics.checkNotNullParameter(kotlinTypePreparator, "kotlinTypePreparator");
        Intrinsics.checkNotNullParameter(kotlinTypeRefiner, "kotlinTypeRefiner");
        this.isErrorTypeEqualsToAnything = z2;
        this.isStubTypeEqualsToAnything = z3;
        this.allowedTypeVariable = z5;
        this.typeSystemContext = typeSystemContext;
        this.kotlinTypePreparator = kotlinTypePreparator;
        this.kotlinTypeRefiner = kotlinTypeRefiner;
    }

    public static /* synthetic */ Boolean addSubtypeConstraint$default(TypeCheckerState typeCheckerState, KotlinTypeMarker kotlinTypeMarker, KotlinTypeMarker kotlinTypeMarker2, boolean z2, int i8, Object obj) {
        if (obj != null) {
    ...
    public Boolean addSubtypeConstraint(KotlinTypeMarker subType, KotlinTypeMarker superType, boolean z2) {
    ...
    public boolean runForkingPoint(Function1<? super ForkPointContext, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        ForkPointContext.Default r7 = new ForkPointContext.Default();
        block.invoke(r7);
        return r7.getResult();
    }
}
