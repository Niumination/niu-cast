...
public abstract class ReflectJavaMember extends ReflectJavaElement implements ReflectJavaAnnotationOwner, ReflectJavaModifierListOwner, JavaMember {
    ...
    public final List<JavaValueParameter> getValueParameters(Type[] parameterTypes, Annotation[][] parameterAnnotations, boolean z2) throws IllegalAccessException, InvocationTargetException {
        String str;
        ...
        int i8 = 0;
        while (i8 < length) {
            ReflectJavaType reflectJavaTypeCreate = ReflectJavaType.Factory.create(parameterTypes[i8]);
            if (listLoadParameterNames != null) {
                str = (String) CollectionsKt.getOrNull(listLoadParameterNames, i8 + size);
                if (str == null) {
                    throw new IllegalStateException(("No parameter with index " + i8 + '+' + size + " (name=" + getName() + " type=" + reflectJavaTypeCreate + ") in " + this).toString());
                }
            } else {
                str = null;
            }
            arrayList.add(new ReflectJavaValueParameter(reflectJavaTypeCreate, parameterAnnotations[i8], str, z2 && i8 == ArraysKt.getLastIndex(parameterTypes)));
            i8++;
        }
        return arrayList;
    }
