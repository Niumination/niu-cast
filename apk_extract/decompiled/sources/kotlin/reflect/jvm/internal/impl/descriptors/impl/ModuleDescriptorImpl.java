...
public final class ModuleDescriptorImpl extends DeclarationDescriptorImpl implements ModuleDescriptor {
    ...
    public static final CompositePackageFragmentProvider packageFragmentProviderForWholeModuleWithDependencies_delegate$lambda$10(ModuleDescriptorImpl moduleDescriptorImpl) {
        ...
        if (moduleDependencies == null) {
            throw new AssertionError(a.n(new StringBuilder("Dependencies of module "), moduleDescriptorImpl.getId(), " were not set before querying module content"));
        }
    ...
    public List<ModuleDescriptor> getExpectedByModules() {
        ...
        throw new AssertionError(a.n(new StringBuilder("Dependencies of module "), getId(), " were not set"));
    }
    ...
    public /* synthetic */ ModuleDescriptorImpl(Name name, StorageManager storageManager, KotlinBuiltIns kotlinBuiltIns, TargetPlatform targetPlatform, Map map, Name name2, int i8, DefaultConstructorMarker defaultConstructorMarker) {
        this(name, storageManager, kotlinBuiltIns, (i8 & 8) != 0 ? null : targetPlatform, (i8 & 16) != 0 ? MapsKt.emptyMap() : map, (i8 & 32) != 0 ? null : name2);
    }
