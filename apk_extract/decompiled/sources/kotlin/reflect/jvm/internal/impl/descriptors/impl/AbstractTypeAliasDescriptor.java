...
public abstract class AbstractTypeAliasDescriptor extends DeclarationDescriptorNonRootImpl implements TypeAliasDescriptor {
    ...
    public AbstractTypeAliasDescriptor(StorageManager storageManager, DeclarationDescriptor containingDeclaration, Annotations annotations, Name name, SourceElement sourceElement, DescriptorVisibility visibilityImpl) {
        ...
        this.typeConstructor = new TypeConstructor() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor$typeConstructor$1
            ...
            public KotlinBuiltIns getBuiltIns() {
                return DescriptorUtilsKt.getBuiltIns(mo1437getDeclarationDescriptor());
            }
            ...
            public Collection<KotlinType> mo1438getSupertypes() {
                Collection<KotlinType> collectionMo1438getSupertypes = mo1437getDeclarationDescriptor().getUnderlyingType().getConstructor().mo1438getSupertypes();
            ...
            public String toString() {
                return "[typealias " + mo1437getDeclarationDescriptor().getName().asString() + ']';
            }

            @Override // kotlin.reflect.jvm.internal.impl.types.TypeConstructor
            /* JADX INFO: renamed from: getDeclarationDescriptor */
            public TypeAliasDescriptor mo1437getDeclarationDescriptor() {
                return this.this$0;
            }
        };
    }
    ...
    public static final Boolean isInner$lambda$2(AbstractTypeAliasDescriptor abstractTypeAliasDescriptor, UnwrappedType unwrappedType) {
        ...
        if (KotlinTypeKt.isError(unwrappedType)) {
            ...
            if (!(classifierDescriptorMo1437getDeclarationDescriptor instanceof TypeParameterDescriptor) || Intrinsics.areEqual(((TypeParameterDescriptor) classifierDescriptorMo1437getDeclarationDescriptor).getContainingDeclaration(), abstractTypeAliasDescriptor)) {
                z2 = false;
            } else {
                z2 = true;
            }
