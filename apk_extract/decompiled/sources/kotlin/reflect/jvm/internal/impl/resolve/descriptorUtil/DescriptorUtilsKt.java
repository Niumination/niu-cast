...
public final class DescriptorUtilsKt {
    ...
    public static final Iterable declaresOrInheritsDefaultValue$lambda$5(ValueParameterDescriptor valueParameterDescriptor) {
        ...
        ArrayList arrayList = new ArrayList(CollectionsKt.i(overriddenDescriptors));
    ...
    public static /* synthetic */ CallableMemberDescriptor firstOverridden$default(CallableMemberDescriptor callableMemberDescriptor, boolean z2, Function1 function1, int i8, Object obj) {
        if ((i8 & 1) != 0) {
            z2 = false;
        }
    ...
    public static final ClassDescriptor getAnnotationClass(AnnotationDescriptor annotationDescriptor) {
        ...
        ClassifierDescriptor classifierDescriptorMo1437getDeclarationDescriptor = annotationDescriptor.getType().getConstructor().mo1437getDeclarationDescriptor();
    ...
    public static final ClassDescriptor getSuperClassNotAny(ClassDescriptor classDescriptor) {
        ...
        for (KotlinType kotlinType : classDescriptor.getDefaultType().getConstructor().mo1438getSupertypes()) {
            if (!KotlinBuiltIns.isAnyOrNullableAny(kotlinType)) {
                ...
                if (DescriptorUtils.isClassOrEnumClass(classifierDescriptorMo1437getDeclarationDescriptor)) {
    ...
    public static final ClassDescriptor resolveTopLevelClass(ModuleDescriptor moduleDescriptor, FqName topLevelClassFqName, LookupLocation location) {
        ...
        ClassifierDescriptor classifierDescriptorMo1439getContributedClassifier = memberScope.mo1439getContributedClassifier(nameShortName, location);
