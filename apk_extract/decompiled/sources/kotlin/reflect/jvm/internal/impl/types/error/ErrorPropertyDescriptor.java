...
public final class ErrorPropertyDescriptor implements PropertyDescriptor {
    ...
    public <R, D> R accept(DeclarationDescriptorVisitor<R, D> declarationDescriptorVisitor, D d7) {
        return (R) this.$$delegate_0.accept(declarationDescriptorVisitor, d7);
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.CallableMemberDescriptor
    public CallableMemberDescriptor copy(DeclarationDescriptor declarationDescriptor, Modality modality, DescriptorVisibility descriptorVisibility, CallableMemberDescriptor.Kind kind, boolean z2) {
        PropertyDescriptor propertyDescriptorCopy = this.$$delegate_0.copy(declarationDescriptor, modality, descriptorVisibility, kind, z2);
    ...
    public ConstantValue<?> mo1433getCompileTimeInitializer() {
        return this.$$delegate_0.mo1433getCompileTimeInitializer();
    }
