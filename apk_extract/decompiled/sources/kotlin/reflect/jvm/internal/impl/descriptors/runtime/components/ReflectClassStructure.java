...
final class ReflectClassStructure {
            ...
            if (methodAnnotationVisitorVisitMethod != null) {
                ...
                if (!(parameterAnnotations.length == 0)) {
                    ...
                    for (int i8 = 0; i8 < length2; i8++) {
                        Iterator it3 = ArrayIteratorKt.iterator(parameterAnnotations[i8]);
                        while (it3.hasNext()) {
                            ...
                            KotlinJvmBinaryClass.AnnotationArgumentVisitor annotationArgumentVisitorVisitParameterAnnotation = methodAnnotationVisitorVisitMethod.visitParameterAnnotation(i8 + length, classId, new ReflectAnnotationSource(annotation2));
        ...
        while (it.hasNext()) {
            ...
            if (methodAnnotationVisitorVisitMethod != null) {
                ...
                for (int i8 = 0; i8 < length; i8++) {
                    Iterator it3 = ArrayIteratorKt.iterator(annotationArr[i8]);
                    while (it3.hasNext()) {
                        Annotation annotation2 = (Annotation) it3.next();
                        Class<?> javaClass = JvmClassMappingKt.getJavaClass(JvmClassMappingKt.getAnnotationClass(annotation2));
                        ClassId classId = ReflectClassUtilKt.getClassId(javaClass);
                        Intrinsics.checkNotNull(annotation2);
                        KotlinJvmBinaryClass.AnnotationArgumentVisitor annotationArgumentVisitorVisitParameterAnnotation = methodAnnotationVisitorVisitMethod.visitParameterAnnotation(i8, classId, new ReflectAnnotationSource(annotation2));
                        if (annotationArgumentVisitorVisitParameterAnnotation != null) {
                            INSTANCE.processAnnotationArguments(annotationArgumentVisitorVisitParameterAnnotation, annotation2, javaClass);
                        }
                    }
    ...
    private final void processAnnotationArgumentValue(KotlinJvmBinaryClass.AnnotationArgumentVisitor annotationArgumentVisitor, Name name, Object obj) throws InvocationTargetException {
        ...
        if (componentType.isEnum()) {
            ...
            while (i8 < length4) {
                annotationArrayArgumentVisitorVisitArray.visit(objArr4[i8]);
                i8++;
            }
        }
