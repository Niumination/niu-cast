...
public final class DescriptorUtilKt {
    ...
    public static final ClassDescriptor resolveClassByFqName(ModuleDescriptor moduleDescriptor, FqName fqName, LookupLocation lookupLocation) {
        ...
        ClassifierDescriptor classifierDescriptorMo1439getContributedClassifier2 = memberScope.mo1439getContributedClassifier(nameShortName, lookupLocation);
        ClassDescriptor classDescriptor = classifierDescriptorMo1439getContributedClassifier2 instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo1439getContributedClassifier2 : null;
        if (classDescriptor != null) {
        ...
        if (classDescriptorResolveClassByFqName == null || (unsubstitutedInnerClassesScope = classDescriptorResolveClassByFqName.getUnsubstitutedInnerClassesScope()) == null) {
            classifierDescriptorMo1439getContributedClassifier = null;
        } else {
            Name nameShortName2 = fqName.shortName();
            Intrinsics.checkNotNullExpressionValue(nameShortName2, "shortName(...)");
            classifierDescriptorMo1439getContributedClassifier = unsubstitutedInnerClassesScope.mo1439getContributedClassifier(nameShortName2, lookupLocation);
        }
