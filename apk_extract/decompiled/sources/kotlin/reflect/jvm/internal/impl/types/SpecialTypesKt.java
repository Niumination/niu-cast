...
public final class SpecialTypesKt {
    ...
    public static /* synthetic */ UnwrappedType makeDefinitelyNotNullOrNotNull$default(UnwrappedType unwrappedType, boolean z2, int i8, Object obj) {
        if ((i8 & 1) != 0) {
            z2 = false;
        }
    ...
    public static /* synthetic */ SimpleType makeSimpleTypeDefinitelyNotNullOrNotNull$default(SimpleType simpleType, boolean z2, int i8, Object obj) {
        if ((i8 & 1) != 0) {
            z2 = false;
        }
    ...
    private static final IntersectionTypeConstructor makeDefinitelyNotNullOrNotNull(IntersectionTypeConstructor intersectionTypeConstructor) {
        ...
        Collection<KotlinType> collectionMo1438getSupertypes = intersectionTypeConstructor.mo1438getSupertypes();
