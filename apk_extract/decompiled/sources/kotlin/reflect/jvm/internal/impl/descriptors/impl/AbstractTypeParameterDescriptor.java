...
public abstract class AbstractTypeParameterDescriptor extends DeclarationDescriptorNonRootImpl implements TypeParameterDescriptor {
    ...
    public class TypeParameterTypeConstructor extends AbstractTypeConstructor {
        ...
        public List<KotlinType> processSupertypesWithoutCycles(List<KotlinType> list) {
            ...
            List<KotlinType> listProcessBoundsWithoutCycles = this.this$0.processBoundsWithoutCycles(list);
        ...
        public void reportSupertypeLoopError(KotlinType kotlinType) {
            ...
            this.this$0.mo1440reportSupertypeLoopError(kotlinType);
        }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AbstractTypeParameterDescriptor(final StorageManager storageManager, DeclarationDescriptor declarationDescriptor, Annotations annotations, final Name name, Variance variance, boolean z2, int i8, SourceElement sourceElement, final SupertypeLoopChecker supertypeLoopChecker) {
    ...
    public <R, D> R accept(DeclarationDescriptorVisitor<R, D> declarationDescriptorVisitor, D d7) {
        return declarationDescriptorVisitor.visitTypeParameterDescriptor(this, d7);
    }
    ...
    public List<KotlinType> getUpperBounds() {
        List<KotlinType> listMo1438getSupertypes = ((TypeParameterTypeConstructor) getTypeConstructor()).mo1438getSupertypes();
        if (listMo1438getSupertypes == null) {
            $$$reportNull$$$0(8);
        }
        return listMo1438getSupertypes;
    }
    ...
    public abstract void mo1440reportSupertypeLoopError(KotlinType kotlinType);
