...
public abstract class DescriptorRenderer {
    ...
    public interface ValueParametersHandler {
        ...
        public static final class DEFAULT implements ValueParametersHandler {
            ...
            public void appendAfterValueParameter(ValueParameterDescriptor parameter, int i8, int i9, StringBuilder builder) {
            ...
            @Override // kotlin.reflect.jvm.internal.impl.renderer.DescriptorRenderer.ValueParametersHandler
            public void appendAfterValueParameters(int i8, StringBuilder builder) {
                Intrinsics.checkNotNullParameter(builder, "builder");
                builder.append(")");
            }

            @Override // kotlin.reflect.jvm.internal.impl.renderer.DescriptorRenderer.ValueParametersHandler
            public void appendBeforeValueParameter(ValueParameterDescriptor parameter, int i8, int i9, StringBuilder builder) {
                Intrinsics.checkNotNullParameter(parameter, "parameter");
                Intrinsics.checkNotNullParameter(builder, "builder");
            }

            @Override // kotlin.reflect.jvm.internal.impl.renderer.DescriptorRenderer.ValueParametersHandler
            public void appendBeforeValueParameters(int i8, StringBuilder builder) {
                Intrinsics.checkNotNullParameter(builder, "builder");
                builder.append("(");
            }
        }

        void appendAfterValueParameter(ValueParameterDescriptor valueParameterDescriptor, int i8, int i9, StringBuilder sb2);

        void appendAfterValueParameters(int i8, StringBuilder sb2);

        void appendBeforeValueParameter(ValueParameterDescriptor valueParameterDescriptor, int i8, int i9, StringBuilder sb2);

        void appendBeforeValueParameters(int i8, StringBuilder sb2);
    }
