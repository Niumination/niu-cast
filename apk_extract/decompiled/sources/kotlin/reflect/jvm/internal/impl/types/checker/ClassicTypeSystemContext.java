    ...
    public static final class DefaultImpls {
        public static boolean areEqualTypeConstructors(ClassicTypeSystemContext classicTypeSystemContext, TypeConstructorMarker c9, TypeConstructorMarker c10) {
            ...
            if (!(c9 instanceof TypeConstructor)) {
                throw new IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + c9 + ", " + Reflection.getOrCreateKotlinClass(c9.getClass())).toString());
            }
            if (c10 instanceof TypeConstructor) {
                return Intrinsics.areEqual(c9, c10);
            }
        ...
        public static TypeArgumentListMarker asArgumentList(ClassicTypeSystemContext classicTypeSystemContext, SimpleTypeMarker receiver) {
            ...
            StringBuilder sbZ = a.z("ClassicTypeSystemContext couldn't handle: ", receiver, ", ");
            sbZ.append(Reflection.getOrCreateKotlinClass(receiver.getClass()));
        ...
        public static SimpleTypeMarker captureFromArguments(ClassicTypeSystemContext classicTypeSystemContext, SimpleTypeMarker type, CaptureStatus status) {
            ...
            StringBuilder sbZ = a.z("ClassicTypeSystemContext couldn't handle: ", type, ", ");
            sbZ.append(Reflection.getOrCreateKotlinClass(type.getClass()));
            throw new IllegalArgumentException(sbZ.toString().toString());
        }
        ...
        public static TypeArgumentMarker getArgument(ClassicTypeSystemContext classicTypeSystemContext, KotlinTypeMarker receiver, int i8) {
            Intrinsics.checkNotNullParameter(receiver, "$receiver");
            if (receiver instanceof KotlinType) {
                return ((KotlinType) receiver).getArguments().get(i8);
            }
            throw new IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + Reflection.getOrCreateKotlinClass(receiver.getClass())).toString());
        }
        ...
        public static FqNameUnsafe getClassFqNameUnsafe(ClassicTypeSystemContext classicTypeSystemContext, TypeConstructorMarker receiver) {
            ...
            if (receiver instanceof TypeConstructor) {
                ClassifierDescriptor classifierDescriptorMo1437getDeclarationDescriptor = ((TypeConstructor) receiver).mo1437getDeclarationDescriptor();
                ...
                return DescriptorUtilsKt.getFqNameUnsafe((ClassDescriptor) classifierDescriptorMo1437getDeclarationDescriptor);
            }
            throw new IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + Reflection.getOrCreateKotlinClass(receiver.getClass())).toString());
        }

        public static TypeParameterMarker getParameter(ClassicTypeSystemContext classicTypeSystemContext, TypeConstructorMarker receiver, int i8) {
            Intrinsics.checkNotNullParameter(receiver, "$receiver");
            if (receiver instanceof TypeConstructor) {
        ...
        public static PrimitiveType getPrimitiveArrayType(ClassicTypeSystemContext classicTypeSystemContext, TypeConstructorMarker receiver) {
            ...
            if (receiver instanceof TypeConstructor) {
                ClassifierDescriptor classifierDescriptorMo1437getDeclarationDescriptor = ((TypeConstructor) receiver).mo1437getDeclarationDescriptor();
                Intrinsics.checkNotNull(classifierDescriptorMo1437getDeclarationDescriptor, "null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.ClassDescriptor");
                return KotlinBuiltIns.getPrimitiveArrayType((ClassDescriptor) classifierDescriptorMo1437getDeclarationDescriptor);
            }
            throw new IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + Reflection.getOrCreateKotlinClass(receiver.getClass())).toString());
        }
        ...
        public static PrimitiveType getPrimitiveType(ClassicTypeSystemContext classicTypeSystemContext, TypeConstructorMarker receiver) {
            ...
            if (receiver instanceof TypeConstructor) {
                ClassifierDescriptor classifierDescriptorMo1437getDeclarationDescriptor = ((TypeConstructor) receiver).mo1437getDeclarationDescriptor();
                Intrinsics.checkNotNull(classifierDescriptorMo1437getDeclarationDescriptor, "null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.ClassDescriptor");
                return KotlinBuiltIns.getPrimitiveType((ClassDescriptor) classifierDescriptorMo1437getDeclarationDescriptor);
            }
            throw new IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + Reflection.getOrCreateKotlinClass(receiver.getClass())).toString());
        }
        ...
        public static TypeParameterMarker getTypeParameterClassifier(ClassicTypeSystemContext classicTypeSystemContext, TypeConstructorMarker receiver) {
            ...
            if (receiver instanceof TypeConstructor) {
                ...
                if (classifierDescriptorMo1437getDeclarationDescriptor instanceof TypeParameterDescriptor) {
                    return (TypeParameterDescriptor) classifierDescriptorMo1437getDeclarationDescriptor;
                }
                return null;
            }
            throw new IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + Reflection.getOrCreateKotlinClass(receiver.getClass())).toString());
        ...
        public static boolean identicalArguments(ClassicTypeSystemContext classicTypeSystemContext, SimpleTypeMarker a6, SimpleTypeMarker b9) {
            Intrinsics.checkNotNullParameter(a6, "a");
            Intrinsics.checkNotNullParameter(b9, "b");
            if (!(a6 instanceof SimpleType)) {
                StringBuilder sbZ = a.z("ClassicTypeSystemContext couldn't handle: ", a6, ", ");
                sbZ.append(Reflection.getOrCreateKotlinClass(a6.getClass()));
                throw new IllegalArgumentException(sbZ.toString().toString());
            }
            if (b9 instanceof SimpleType) {
                return ((SimpleType) a6).getArguments() == ((SimpleType) b9).getArguments();
            }
            StringBuilder sbZ2 = a.z("ClassicTypeSystemContext couldn't handle: ", b9, ", ");
            sbZ2.append(Reflection.getOrCreateKotlinClass(b9.getClass()));
        ...
        public static boolean isClassTypeConstructor(ClassicTypeSystemContext classicTypeSystemContext, TypeConstructorMarker receiver) {
            Intrinsics.checkNotNullParameter(receiver, "$receiver");
            if (receiver instanceof TypeConstructor) {
                return ((TypeConstructor) receiver).mo1437getDeclarationDescriptor() instanceof ClassDescriptor;
            }
            throw new IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + Reflection.getOrCreateKotlinClass(receiver.getClass())).toString());
        }
        ...
        public static boolean isUnderKotlinPackage(ClassicTypeSystemContext classicTypeSystemContext, TypeConstructorMarker receiver) {
            ...
            if (receiver instanceof TypeConstructor) {
                ClassifierDescriptor classifierDescriptorMo1437getDeclarationDescriptor = ((TypeConstructor) receiver).mo1437getDeclarationDescriptor();
                return classifierDescriptorMo1437getDeclarationDescriptor != null && KotlinBuiltIns.isUnderKotlinPackage(classifierDescriptorMo1437getDeclarationDescriptor);
            }
            throw new IllegalArgumentException(("ClassicTypeSystemContext couldn't handle: " + receiver + ", " + Reflection.getOrCreateKotlinClass(receiver.getClass())).toString());
        }
        ...
        public static TypeCheckerState.SupertypesPolicy substitutionSupertypePolicy(final ClassicTypeSystemContext classicTypeSystemContext, SimpleTypeMarker type) {
            ...
            if (type instanceof SimpleType) {
                ...
                return new TypeCheckerState.SupertypesPolicy.DoCustomTransform() { // from class: kotlin.reflect.jvm.internal.impl.types.checker.ClassicTypeSystemContext$substitutionSupertypePolicy$2
                    ...
                    public SimpleTypeMarker mo1441transformType(TypeCheckerState state, KotlinTypeMarker type2) {
        ...
        public static Collection<KotlinTypeMarker> supertypes(ClassicTypeSystemContext classicTypeSystemContext, TypeConstructorMarker receiver) {
            Intrinsics.checkNotNullParameter(receiver, "$receiver");
            if (receiver instanceof TypeConstructor) {
                Collection<KotlinType> collectionMo1438getSupertypes = ((TypeConstructor) receiver).mo1438getSupertypes();
