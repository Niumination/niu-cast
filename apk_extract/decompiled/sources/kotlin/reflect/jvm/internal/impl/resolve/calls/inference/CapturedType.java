...
public final class CapturedType extends SimpleType implements CapturedTypeMarker {
    ...
    public /* synthetic */ CapturedType(TypeProjection typeProjection, CapturedTypeConstructor capturedTypeConstructor, boolean z2, TypeAttributes typeAttributes, int i8, DefaultConstructorMarker defaultConstructorMarker) {
        this(typeProjection, (i8 & 2) != 0 ? new CapturedTypeConstructorImpl(typeProjection) : capturedTypeConstructor, (i8 & 4) != 0 ? false : z2, (i8 & 8) != 0 ? TypeAttributes.Companion.getEmpty() : typeAttributes);
    }
