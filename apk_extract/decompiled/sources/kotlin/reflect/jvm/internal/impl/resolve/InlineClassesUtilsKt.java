...
public final class InlineClassesUtilsKt {
    ...
    public static final boolean isInlineClassType(KotlinType kotlinType) {
        ...
        if (classifierDescriptorMo1437getDeclarationDescriptor != null) {
            return isInlineClass(classifierDescriptorMo1437getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean isValueClassType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo1437getDeclarationDescriptor = kotlinType.getConstructor().mo1437getDeclarationDescriptor();
        if (classifierDescriptorMo1437getDeclarationDescriptor != null) {
            return isValueClass(classifierDescriptorMo1437getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean needsMfvcFlattening(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor classifierDescriptorMo1437getDeclarationDescriptor = kotlinType.getConstructor().mo1437getDeclarationDescriptor();
        return (classifierDescriptorMo1437getDeclarationDescriptor == null || !isMultiFieldValueClass(classifierDescriptorMo1437getDeclarationDescriptor) || SimpleClassicTypeSystemContext.INSTANCE.isNullableType(kotlinType)) ? false : true;
    }
