...
public final class UtilKt {
    ...
    */
    ...
    private static final Class<?> loadClass(ClassLoader classLoader, ClassId classId, int i8) {
        ...
        return loadClass(classLoader, strAsString, strAsString2, i8);
    }

    public static /* synthetic */ Class loadClass$default(ClassLoader classLoader, ClassId classId, int i8, int i9, Object obj) {
        if ((i9 & 4) != 0) {
            i8 = 0;
        }
        return loadClass(classLoader, classId, i8);
    }
    ...
    private static final Object toRuntimeValue(ConstantValue<?> constantValue, ClassLoader classLoader) {
        ...
        if (constantValue instanceof EnumValue) {
            ...
            ClassifierDescriptor classifierDescriptorMo1437getDeclarationDescriptor = ((KClassValue.Value.LocalClass) value2).getType().getConstructor().mo1437getDeclarationDescriptor();
    ...
    private static final Class<?> loadClass(ClassLoader classLoader, String str, String str2, int i8) {
        ...
        sb2.append(StringsKt__StringsJVMKt.replace$default(str2, '.', Typography.dollar, false, 4, (Object) null));
        if (i8 > 0) {
            sb2.append(";");
        }
