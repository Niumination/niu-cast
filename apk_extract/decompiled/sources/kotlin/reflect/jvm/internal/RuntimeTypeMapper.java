...
public final class RuntimeTypeMapper {
    ...
    public final ClassId mapJvmClassToKotlinClassId(Class<?> klass) {
        ...
        if (primitiveType2 != null) {
            return new ClassId(StandardNames.BUILT_INS_PACKAGE_FQ_NAME, primitiveType2.getArrayTypeName());
        }
    ...
    public final JvmFunctionSignature mapSignature(FunctionDescriptor possiblySubstitutedFunction) {
        ...
        if (constructorDescriptor.isPrimary()) {
            if (!Intrinsics.areEqual(jvmConstructorSignature.getName(), "constructor-impl") || !StringsKt__StringsJVMKt.endsWith$default(jvmConstructorSignature.getDesc(), ")V", false, 2, null)) {
            ...
            if (StringsKt__StringsJVMKt.endsWith$default(jvmConstructorSignature.getDesc(), ")V", false, 2, null)) {
                jvmConstructorSignature = JvmMemberSignature.Method.copy$default(jvmConstructorSignature, null, StringsKt__StringsKt.removeSuffix(jvmConstructorSignature.getDesc(), (CharSequence) ExifInterface.GPS_MEASUREMENT_INTERRUPTED) + jvmDescriptor, 1, null);
            } else if (!StringsKt__StringsJVMKt.endsWith$default(jvmConstructorSignature.getDesc(), jvmDescriptor, false, 2, null)) {
                throw new IllegalArgumentException(("Invalid signature: " + jvmConstructorSignature).toString());
            }
        }
        return new JvmFunctionSignature.KotlinFunction(jvmConstructorSignature);
