...
public final class KClassImpl<T> extends KDeclarationContainerImpl implements KClass<T>, KClassifierImpl, KTypeParameterOwnerImpl {
    ...
    public final class Data extends KDeclarationContainerImpl.Data {
        ...
        public static final List constructors_delegate$lambda$7(KClassImpl kClassImpl) {
            ...
            ArrayList arrayList = new ArrayList(CollectionsKt.i(constructorDescriptors));
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final Object objectInstance_delegate$lambda$11(Data data, KClassImpl kClassImpl) throws IllegalAccessException {
        ...
        public static final List supertypes_delegate$lambda$18(final Data data, final KClassImpl kClassImpl) {
            Collection<KotlinType> collectionMo1438getSupertypes = data.getDescriptor().getTypeConstructor().mo1438getSupertypes();
            ...
            for (final KotlinType kotlinType : collectionMo1438getSupertypes) {
        ...
        public static final Type supertypes_delegate$lambda$18$lambda$15$lambda$14(KotlinType kotlinType, Data data, KClassImpl kClassImpl) {
            ...
            if (!(classifierDescriptorMo1437getDeclarationDescriptor instanceof ClassDescriptor)) {
                throw new KotlinReflectionInternalError("Supertype not a class: " + classifierDescriptorMo1437getDeclarationDescriptor);
            }
            Class<?> javaClass = UtilKt.toJavaClass((ClassDescriptor) classifierDescriptorMo1437getDeclarationDescriptor);
            if (javaClass == null) {
                throw new KotlinReflectionInternalError("Unsupported superclass of " + data + ": " + classifierDescriptorMo1437getDeclarationDescriptor);
            }
            ...
            throw new KotlinReflectionInternalError("No superclass of " + data + " in Java reflection for " + classifierDescriptorMo1437getDeclarationDescriptor);
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final ClassDescriptor createSyntheticClassOrFail(ClassId classId, RuntimeModuleData moduleData) throws InvocationTargetException {
    ...
    public String toString() {
        ...
        Intrinsics.checkNotNullExpressionValue(strAsString, "asString(...)");
        sb2.append(str + StringsKt__StringsJVMKt.replace$default(strAsString, '.', Typography.dollar, false, 4, (Object) null));
        return sb2.toString();
    }
