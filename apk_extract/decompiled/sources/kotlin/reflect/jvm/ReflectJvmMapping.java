...
public final class ReflectJvmMapping {
    ...
    public static final <T> Constructor<T> getJavaConstructor(KFunction<? extends T> kFunction) {
        ...
        Member memberMo1429getMember = (kCallableImplAsKCallableImpl == null || (caller = kCallableImplAsKCallableImpl.getCaller()) == null) ? null : caller.mo1429getMember();
        if (memberMo1429getMember instanceof Constructor) {
            return (Constructor) memberMo1429getMember;
        }
        return null;
    }
    ...
    public static final Method getJavaMethod(KFunction<?> kFunction) {
        ...
        KCallableImpl<?> kCallableImplAsKCallableImpl = UtilKt.asKCallableImpl(kFunction);
        Member memberMo1429getMember = (kCallableImplAsKCallableImpl == null || (caller = kCallableImplAsKCallableImpl.getCaller()) == null) ? null : caller.mo1429getMember();
        if (memberMo1429getMember instanceof Method) {
            return (Method) memberMo1429getMember;
        }
        return null;
    }
    ...
    public static final KProperty<?> getKotlinProperty(Field field) throws InvocationTargetException {
