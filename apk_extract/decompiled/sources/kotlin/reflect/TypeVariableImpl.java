...
final class TypeVariableImpl implements TypeVariable<GenericDeclaration>, TypeImpl {
    ...
    public Type[] getBounds() {
        ...
        ArrayList arrayList = new ArrayList(CollectionsKt.i(upperBounds));
    ...
    public GenericDeclaration getGenericDeclaration() {
        throw new NotImplementedError(a.i("An operation is not implemented: ", "getGenericDeclaration() is not yet supported for type variables created from KType: " + this.typeParameter));
    }
