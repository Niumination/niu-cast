...
public final class Uuid implements Serializable {
    ...
    private static final Comparator<Uuid> LEXICAL_ORDER = new a(0);
    ...
    public static final class Companion {
        ...
        public final Uuid m1631fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
    ...
    public Uuid(long j8, long j10) {
        this.mostSignificantBits = j8;
        this.leastSignificantBits = j10;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final int LEXICAL_ORDER$lambda$0(Uuid a6, Uuid b9) {
        Intrinsics.checkNotNullParameter(a6, "a");
        Intrinsics.checkNotNullParameter(b9, "b");
        long j8 = a6.mostSignificantBits;
        return j8 != b9.mostSignificantBits ? Long.compareUnsigned(ULong.m333constructorimpl(j8), ULong.m333constructorimpl(b9.mostSignificantBits)) : Long.compareUnsigned(ULong.m333constructorimpl(a6.leastSignificantBits), ULong.m333constructorimpl(b9.leastSignificantBits));
    }
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m327boximpl(ULong.m333constructorimpl(getMostSignificantBits())), ULong.m327boximpl(ULong.m333constructorimpl(getLeastSignificantBits())));
    }
