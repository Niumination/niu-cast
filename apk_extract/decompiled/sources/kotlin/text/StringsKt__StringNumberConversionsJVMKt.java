...
public class StringsKt__StringNumberConversionsJVMKt extends StringsKt__StringBuilderKt {
    ...
    @SinceKotlin(version = "1.1")
    @InlineOnly
    private static final String toString(byte b9, int i8) {
        String string = Integer.toString(b9, CharsKt__CharJVMKt.checkRadix(i8));
    ...
    private static final BigInteger toBigInteger(String str, int i8) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        return new BigInteger(str, CharsKt__CharJVMKt.checkRadix(i8));
    }
    ...
    public static final BigInteger toBigIntegerOrNull(String str, int i8) {
        ...
        if (length != 1) {
            for (int i9 = str.charAt(0) == '-' ? 1 : 0; i9 < length; i9++) {
                if (CharsKt__CharJVMKt.digitOf(str.charAt(i9), i8) < 0) {
                    return null;
                }
            }
        } else if (CharsKt__CharJVMKt.digitOf(str.charAt(0), i8) < 0) {
            return null;
        }
        return new BigInteger(str, CharsKt__CharJVMKt.checkRadix(i8));
    }
    ...
    private static final byte toByte(String str, int i8) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        return Byte.parseByte(str, CharsKt__CharJVMKt.checkRadix(i8));
    }
    ...
    private static final int toInt(String str, int i8) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        return Integer.parseInt(str, CharsKt__CharJVMKt.checkRadix(i8));
    }
    ...
    private static final long toLong(String str, int i8) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        return Long.parseLong(str, CharsKt__CharJVMKt.checkRadix(i8));
    }
    ...
    private static final short toShort(String str, int i8) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        return Short.parseShort(str, CharsKt__CharJVMKt.checkRadix(i8));
    }

    @SinceKotlin(version = "1.1")
    @InlineOnly
    private static final String toString(short s2, int i8) {
        String string = Integer.toString(s2, CharsKt__CharJVMKt.checkRadix(i8));
        Intrinsics.checkNotNullExpressionValue(string, "toString(...)");
        return string;
    }
    ...
    private static final String toString(int i8, int i9) {
        String string = Integer.toString(i8, CharsKt__CharJVMKt.checkRadix(i9));
        Intrinsics.checkNotNullExpressionValue(string, "toString(...)");
        return string;
    }
    ...
    private static final String toString(long j8, int i8) {
        String string = Long.toString(j8, CharsKt__CharJVMKt.checkRadix(i8));
        Intrinsics.checkNotNullExpressionValue(string, "toString(...)");
        return string;
    }
}
