...
public class StringsKt__StringBuilderKt extends StringsKt__StringBuilderJVMKt {
    ...
    @InlineOnly
    private static final String buildString(int i8, Function1<? super StringBuilder, Unit> builderAction) {
        Intrinsics.checkNotNullParameter(builderAction, "builderAction");
    ...
    @InlineOnly
    private static final StringBuilder append(StringBuilder sb2, char[] str, int i8, int i9) {
        Intrinsics.checkNotNullParameter(sb2, "<this>");
    ...
    @SinceKotlin(version = "1.4")
    @InlineOnly
    private static final StringBuilder appendLine(StringBuilder sb2, char c9) {
        Intrinsics.checkNotNullParameter(sb2, "<this>");
        sb2.append(c9);
        sb2.append('\n');
        return sb2;
