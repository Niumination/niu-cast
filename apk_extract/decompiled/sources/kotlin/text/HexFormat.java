...
public final class HexFormat {
    ...
    public static final class BytesHexFormat {
        ...
        public static final class Builder {
            ...
            public final void setBytePrefix(String value) {
                ...
                if (StringsKt__StringsKt.contains$default((CharSequence) value, '\n', false, 2, (Object) null) || StringsKt__StringsKt.contains$default((CharSequence) value, '\r', false, 2, (Object) null)) {
                    throw new IllegalArgumentException(h0.a.i("LF and CR characters are prohibited in bytePrefix, but was ", value));
                }
            ...
            public final void setByteSeparator(String value) {
                Intrinsics.checkNotNullParameter(value, "value");
                if (StringsKt__StringsKt.contains$default((CharSequence) value, '\n', false, 2, (Object) null) || StringsKt__StringsKt.contains$default((CharSequence) value, '\r', false, 2, (Object) null)) {
                    throw new IllegalArgumentException(h0.a.i("LF and CR characters are prohibited in byteSeparator, but was ", value));
                }
            ...
            public final void setByteSuffix(String value) {
                Intrinsics.checkNotNullParameter(value, "value");
                if (StringsKt__StringsKt.contains$default((CharSequence) value, '\n', false, 2, (Object) null) || StringsKt__StringsKt.contains$default((CharSequence) value, '\r', false, 2, (Object) null)) {
                    throw new IllegalArgumentException(h0.a.i("LF and CR characters are prohibited in byteSuffix, but was ", value));
                }
                this.byteSuffix = value;
            }

            public final void setBytesPerGroup(int i8) {
                if (i8 <= 0) {
                    throw new IllegalArgumentException(a1.a.o(i8, "Non-positive values are prohibited for bytesPerGroup, but was "));
                }
                this.bytesPerGroup = i8;
            }

            public final void setBytesPerLine(int i8) {
                if (i8 <= 0) {
                    throw new IllegalArgumentException(a1.a.o(i8, "Non-positive values are prohibited for bytesPerLine, but was "));
                }
        ...
        @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0080\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u0014\u0010\u0004\u001a\u00020\u0005X\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\b"}, d2 = {"Lkotlin/text/HexFormat$BytesHexFormat$Companion;", "", "<init>", "()V", "Default", "Lkotlin/text/HexFormat$BytesHexFormat;", "getDefault$kotlin_stdlib", "()Lkotlin/text/HexFormat$BytesHexFormat;", "kotlin-stdlib"}, k = 1, mv = {2, 1, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
        ...
        public BytesHexFormat(int i8, int i9, String groupSeparator, String byteSeparator, String bytePrefix, String byteSuffix) {
            Intrinsics.checkNotNullParameter(groupSeparator, "groupSeparator");
            Intrinsics.checkNotNullParameter(byteSeparator, "byteSeparator");
            Intrinsics.checkNotNullParameter(bytePrefix, "bytePrefix");
            Intrinsics.checkNotNullParameter(byteSuffix, "byteSuffix");
            this.bytesPerLine = i8;
            this.bytesPerGroup = i9;
            this.groupSeparator = groupSeparator;
            this.byteSeparator = byteSeparator;
            this.bytePrefix = bytePrefix;
            this.byteSuffix = byteSuffix;
            this.noLineAndGroupSeparator = i8 == Integer.MAX_VALUE && i9 == Integer.MAX_VALUE;
        ...
        public String toString() {
            StringBuilder sbS = o.d.s("BytesHexFormat(\n");
            appendOptionsTo$kotlin_stdlib(sbS, "    ").append('\n');
            sbS.append(")");
            return sbS.toString();
        }
    }

    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007R\u0011\u0010\b\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\u0007¨\u0006\n"}, d2 = {"Lkotlin/text/HexFormat$Companion;", "", "<init>", "()V", "Default", "Lkotlin/text/HexFormat;", "getDefault", "()Lkotlin/text/HexFormat;", "UpperCase", "getUpperCase", "kotlin-stdlib"}, k = 1, mv = {2, 1, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    public static final class Companion {
        public /* synthetic */ Companion(DefaultConstructorMarker defaultConstructorMarker) {
            this();
        }
    ...
    public static final class NumberHexFormat {
        ...
        public static final class Builder {
            ...
            public final void setMinLength(int i8) {
                if (i8 <= 0) {
                    throw new IllegalArgumentException(a1.a.o(i8, "Non-positive values are prohibited for minLength, but was ").toString());
                }
                this.minLength = i8;
            }
            ...
            public final void setPrefix(String value) {
                Intrinsics.checkNotNullParameter(value, "value");
                if (StringsKt__StringsKt.contains$default((CharSequence) value, '\n', false, 2, (Object) null) || StringsKt__StringsKt.contains$default((CharSequence) value, '\r', false, 2, (Object) null)) {
                    throw new IllegalArgumentException(h0.a.i("LF and CR characters are prohibited in prefix, but was ", value));
                }
                this.prefix = value;
            }
            ...
            public final void setSuffix(String value) {
                Intrinsics.checkNotNullParameter(value, "value");
                if (StringsKt__StringsKt.contains$default((CharSequence) value, '\n', false, 2, (Object) null) || StringsKt__StringsKt.contains$default((CharSequence) value, '\r', false, 2, (Object) null)) {
                    throw new IllegalArgumentException(h0.a.i("LF and CR characters are prohibited in suffix, but was ", value));
                }
                this.suffix = value;
            }
        }

        @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0080\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u0014\u0010\u0004\u001a\u00020\u0005X\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\b"}, d2 = {"Lkotlin/text/HexFormat$NumberHexFormat$Companion;", "", "<init>", "()V", "Default", "Lkotlin/text/HexFormat$NumberHexFormat;", "getDefault$kotlin_stdlib", "()Lkotlin/text/HexFormat$NumberHexFormat;", "kotlin-stdlib"}, k = 1, mv = {2, 1, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
        public static final class Companion {
            public /* synthetic */ Companion(DefaultConstructorMarker defaultConstructorMarker) {
                this();
            }
        ...
        public NumberHexFormat(String prefix, String suffix, boolean z2, int i8) {
            ...
            this.isDigitsOnlyAndNoPadding = z3 && i8 == 1;
        ...
        public String toString() {
            StringBuilder sbS = o.d.s("NumberHexFormat(\n");
            appendOptionsTo$kotlin_stdlib(sbS, "    ").append('\n');
            sbS.append(")");
            return sbS.toString();
        }
    ...
    public String toString() {
        StringBuilder sbS = o.d.s("HexFormat(\n    upperCase = ");
        sbS.append(this.upperCase);
        sbS.append(",\n    bytes = BytesHexFormat(\n");
        this.bytes.appendOptionsTo$kotlin_stdlib(sbS, "        ").append('\n');
        sbS.append("    ),");
        sbS.append('\n');
        sbS.append("    number = NumberHexFormat(");
        sbS.append('\n');
        this.number.appendOptionsTo$kotlin_stdlib(sbS, "        ").append('\n');
        sbS.append("    )");
        sbS.append('\n');
        sbS.append(")");
        return sbS.toString();
