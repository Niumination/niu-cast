...
public class StringsKt__AppendableKt {
    ...
    @SinceKotlin(version = "1.4")
    public static final <T extends Appendable> T appendRange(T t3, CharSequence value, int i8, int i9) {
        Intrinsics.checkNotNullParameter(t3, "<this>");
        Intrinsics.checkNotNullParameter(value, "value");
        T t8 = (T) t3.append(value, i8, i9);
        Intrinsics.checkNotNull(t8, "null cannot be cast to non-null type T of kotlin.text.StringsKt__AppendableKt.appendRange");
        return t8;
    }
