...
public final class ResultKt {
    ...
    private static final <R, T> R fold(Object obj, Function1<? super T, ? extends R> onSuccess, Function1<? super Throwable, ? extends R> onFailure) {
        ...
        return thM162exceptionOrNullimpl == null ? onSuccess.invoke(obj) : onFailure.invoke(thM162exceptionOrNullimpl);
    }
    ...
    private static final <R, T extends R> R getOrDefault(Object obj, R r7) {
        return Result.m165isFailureimpl(obj) ? r7 : obj;
    }
    ...
    private static final <R, T extends R> R getOrElse(Object obj, Function1<? super Throwable, ? extends R> onFailure) {
        Intrinsics.checkNotNullParameter(onFailure, "onFailure");
        Throwable thM162exceptionOrNullimpl = Result.m162exceptionOrNullimpl(obj);
        return thM162exceptionOrNullimpl == null ? obj : onFailure.invoke(thM162exceptionOrNullimpl);
    }
    ...
    private static final <R, T> Object map(Object obj, Function1<? super T, ? extends R> transform) {
        ...
        return Result.m166isSuccessimpl(obj) ? Result.m159constructorimpl(transform.invoke(obj)) : Result.m159constructorimpl(obj);
    }
    ...
    private static final <R, T> Object mapCatching(Object obj, Function1<? super T, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        if (!Result.m166isSuccessimpl(obj)) {
            return Result.m159constructorimpl(obj);
        }
        try {
            return Result.m159constructorimpl(transform.invoke(obj));
        } catch (Throwable th2) {
            Result.Companion companion = Result.INSTANCE;
            return Result.m159constructorimpl(createFailure(th2));
        }
    }
    ...
    private static final <T> Object onFailure(Object obj, Function1<? super Throwable, Unit> action) {
        ...
        if (thM162exceptionOrNullimpl != null) {
            action.invoke(thM162exceptionOrNullimpl);
        }
        return obj;
    }
    ...
    private static final <R, T extends R> Object recover(Object obj, Function1<? super Throwable, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        Throwable thM162exceptionOrNullimpl = Result.m162exceptionOrNullimpl(obj);
        return thM162exceptionOrNullimpl == null ? obj : Result.m159constructorimpl(transform.invoke(thM162exceptionOrNullimpl));
    }
    ...
    private static final <R, T extends R> Object recoverCatching(Object obj, Function1<? super Throwable, ? extends R> transform) {
        ...
        try {
            return Result.m159constructorimpl(transform.invoke(thM162exceptionOrNullimpl));
        } catch (Throwable th2) {
            Result.Companion companion = Result.INSTANCE;
            return Result.m159constructorimpl(createFailure(th2));
        }
    ...
    private static final <R> Object runCatching(Function0<? extends R> block) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            return Result.m159constructorimpl(block.invoke());
        } catch (Throwable th2) {
    ...
    @SinceKotlin(version = "1.3")
    @InlineOnly
    private static final <T, R> Object runCatching(T t3, Function1<? super T, ? extends R> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        try {
            Result.Companion companion = Result.INSTANCE;
            return Result.m159constructorimpl(block.invoke(t3));
        } catch (Throwable th2) {
            Result.Companion companion2 = Result.INSTANCE;
            return Result.m159constructorimpl(createFailure(th2));
        }
