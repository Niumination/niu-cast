...
public class SetsKt__SetsKt extends SetsKt__SetsJVMKt {
    ...
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    @InlineOnly
    private static final <E> Set<E> buildSet(int i8, @BuilderInference Function1<? super Set<E>, Unit> builderAction) {
        Intrinsics.checkNotNullParameter(builderAction, "builderAction");
        Set setCreateSetBuilder = SetsKt__SetsJVMKt.createSetBuilder(i8);
        builderAction.invoke(setCreateSetBuilder);
        return SetsKt__SetsJVMKt.build(setCreateSetBuilder);
    }
