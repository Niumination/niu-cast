...
public class CollectionsKt__CollectionsKt extends CollectionsKt__CollectionsJVMKt {
    ...
    @InlineOnly
    private static final <T> List<T> List(int i8, Function1<? super Integer, ? extends T> init) {
    ...
    @SinceKotlin(version = "1.1")
    @InlineOnly
    private static final <T> List<T> MutableList(int i8, Function1<? super Integer, ? extends T> init) {
        Intrinsics.checkNotNullParameter(init, "init");
        ArrayList arrayList = new ArrayList(i8);
        for (int i9 = 0; i9 < i8; i9++) {
            arrayList.add(init.invoke(Integer.valueOf(i9)));
    ...
    public static final <T extends Comparable<? super T>> int binarySearch(List<? extends T> list, T t3, int i8, int i9) {
        Intrinsics.checkNotNullParameter(list, "<this>");
        rangeCheck$CollectionsKt__CollectionsKt(list.size(), i8, i9);
        int i10 = i9 - 1;
        while (i8 <= i10) {
            int i11 = (i8 + i10) >>> 1;
            int iCompareValues = ComparisonsKt.compareValues(list.get(i11), t3);
            if (iCompareValues < 0) {
                i8 = i11 + 1;
            } else {
                if (iCompareValues <= 0) {
    ...
    public static final <T, K extends Comparable<? super K>> int binarySearchBy(List<? extends T> list, K k8, int i8, int i9, Function1<? super T, ? extends K> selector) {
        Intrinsics.checkNotNullParameter(list, "<this>");
        Intrinsics.checkNotNullParameter(selector, "selector");
        return binarySearch(list, i8, i9, new AnonymousClass1(selector, k8));
    }
    ...
    public static /* synthetic */ int binarySearchBy$default(List list, Comparable comparable, int i8, int i9, Function1 selector, int i10, Object obj) {
        ...
        Intrinsics.checkNotNullParameter(list, "<this>");
        Intrinsics.checkNotNullParameter(selector, "selector");
        return binarySearch(list, i8, i9, new AnonymousClass1(selector, comparable));
    }
    ...
    private static final void rangeCheck$CollectionsKt__CollectionsKt(int i8, int i9, int i10) {
        if (i9 > i10) {
            throw new IllegalArgumentException(d.g(i9, i10, "fromIndex (", ") is greater than toIndex (", ")."));
        }
        if (i9 < 0) {
            throw new IndexOutOfBoundsException(h0.a.h(i9, "fromIndex (", ") is less than zero."));
        }
        if (i10 > i8) {
            throw new IndexOutOfBoundsException(d.g(i10, i8, "toIndex (", ") is greater than size (", ")."));
        }
    }
    ...
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    @InlineOnly
    private static final <E> List<E> buildList(int i8, @BuilderInference Function1<? super List<E>, Unit> builderAction) {
        Intrinsics.checkNotNullParameter(builderAction, "builderAction");
        List listCreateListBuilder = CollectionsKt__CollectionsJVMKt.createListBuilder(i8);
        builderAction.invoke(listCreateListBuilder);
        return CollectionsKt__CollectionsJVMKt.build(listCreateListBuilder);
    }
    ...
    public static final <T> int binarySearch(List<? extends T> list, T t3, Comparator<? super T> comparator, int i8, int i9) {
        Intrinsics.checkNotNullParameter(list, "<this>");
        ...
        while (i8 <= i10) {
            int i11 = (i8 + i10) >>> 1;
            int iCompare = comparator.compare(list.get(i11), t3);
            if (iCompare < 0) {
                i8 = i11 + 1;
            } else {
                if (iCompare <= 0) {
    ...
    public static final <T> int binarySearch(List<? extends T> list, int i8, int i9, Function1<? super T, Integer> comparison) {
        Intrinsics.checkNotNullParameter(list, "<this>");
        ...
        while (i8 <= i10) {
            int i11 = (i8 + i10) >>> 1;
            int iIntValue = comparison.invoke(list.get(i11)).intValue();
            if (iIntValue < 0) {
                i8 = i11 + 1;
            } else {
                if (iIntValue <= 0) {
