...
final class ReversedList<T> extends AbstractMutableList<T> {
    ...
    public static final class AnonymousClass1 implements ListIterator<T>, KMutableListIterator {
        ...
        public AnonymousClass1(ReversedList<T> reversedList, int i8) {
            this.this$0 = reversedList;
            this.delegateIterator = ((ReversedList) reversedList).delegate.listIterator(CollectionsKt__ReversedViewsKt.reversePositionIndex$CollectionsKt__ReversedViewsKt(reversedList, i8));
        }
