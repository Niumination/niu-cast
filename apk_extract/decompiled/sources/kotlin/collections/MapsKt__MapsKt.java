...
public class MapsKt__MapsKt extends MapsKt__MapsJVMKt {
    ...
    @InlineOnly
    private static final <K, V> V getOrElse(Map<K, ? extends V> map, K k8, Function0<? extends V> defaultValue) {
        Intrinsics.checkNotNullParameter(map, "<this>");
    ...
    public static final <K, V> V getOrElseNullable(Map<K, ? extends V> map, K k8, Function0<? extends V> defaultValue) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(defaultValue, "defaultValue");
        V v3 = map.get(k8);
        return (v3 != null || map.containsKey(k8)) ? v3 : defaultValue.invoke();
    }

    public static final <K, V> V getOrPut(Map<K, V> map, K k8, Function0<? extends V> defaultValue) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(defaultValue, "defaultValue");
        V v3 = map.get(k8);
        if (v3 != null) {
    ...
    public static <K, V> V getValue(Map<K, ? extends V> map, K k8) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        return (V) MapsKt__MapWithDefaultKt.getOrImplicitDefaultNullable(map, k8);
    }
    ...
    private static final <K, V> V remove(Map<? extends K, V> map, K k8) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        return (V) TypeIntrinsics.asMutableMap(map).remove(k8);
    }

    @InlineOnly
    private static final <K, V> void set(Map<K, V> map, K k8, V v3) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        map.put(k8, v3);
    }
    ...
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    @InlineOnly
    private static final <K, V> Map<K, V> buildMap(int i8, @BuilderInference Function1<? super Map<K, V>, Unit> builderAction) {
        Intrinsics.checkNotNullParameter(builderAction, "builderAction");
        Map mapCreateMapBuilder = MapsKt__MapsJVMKt.createMapBuilder(i8);
        builderAction.invoke(mapCreateMapBuilder);
        return MapsKt__MapsJVMKt.build(mapCreateMapBuilder);
    }
