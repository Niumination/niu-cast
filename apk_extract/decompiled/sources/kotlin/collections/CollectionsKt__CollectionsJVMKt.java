...
public class CollectionsKt__CollectionsJVMKt {
    ...
    @PublishedApi
    @InlineOnly
    private static final <E> List<E> buildListInternal(int i8, Function1<? super List<E>, Unit> builderAction) {
        Intrinsics.checkNotNullParameter(builderAction, "builderAction");
        List listCreateListBuilder = createListBuilder(i8);
        builderAction.invoke(listCreateListBuilder);
        return build(listCreateListBuilder);
    }
