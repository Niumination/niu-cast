...
public class SetsKt__SetsJVMKt {
    ...
    @PublishedApi
    @InlineOnly
    private static final <E> Set<E> buildSetInternal(int i8, Function1<? super Set<E>, Unit> builderAction) {
        Intrinsics.checkNotNullParameter(builderAction, "builderAction");
        Set setCreateSetBuilder = createSetBuilder(i8);
        builderAction.invoke(setCreateSetBuilder);
        return build(setCreateSetBuilder);
    }
