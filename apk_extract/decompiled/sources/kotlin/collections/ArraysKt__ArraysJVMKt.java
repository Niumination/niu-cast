...
class ArraysKt__ArraysJVMKt {
    ...
    public static final void copyOfRangeToIndexCheck(int i8, int i9) {
        if (i8 > i9) {
            throw new IndexOutOfBoundsException(d.g(i8, i9, "toIndex (", ") is greater than size (", ")."));
        }
    }
