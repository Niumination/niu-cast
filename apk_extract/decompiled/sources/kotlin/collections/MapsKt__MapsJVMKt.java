...
public class MapsKt__MapsJVMKt extends MapsKt__MapWithDefaultKt {
    ...
    public static final <K, V> V getOrPut(ConcurrentMap<K, V> concurrentMap, K k8, Function0<? extends V> defaultValue) {
        Intrinsics.checkNotNullParameter(concurrentMap, "<this>");
        Intrinsics.checkNotNullParameter(defaultValue, "defaultValue");
        V v3 = concurrentMap.get(k8);
        if (v3 != null) {
            return v3;
        }
        V vInvoke = defaultValue.invoke();
        V vPutIfAbsent = concurrentMap.putIfAbsent(k8, vInvoke);
    ...
    @PublishedApi
    @InlineOnly
    private static final <K, V> Map<K, V> buildMapInternal(int i8, Function1<? super Map<K, V>, Unit> builderAction) {
        Intrinsics.checkNotNullParameter(builderAction, "builderAction");
        Map mapCreateMapBuilder = createMapBuilder(i8);
        builderAction.invoke(mapCreateMapBuilder);
        return build(mapCreateMapBuilder);
    }
