...
public final /* data */ class TimedValue<T> {
    ...
    public final TimedValue<T> m1628copyRFiDyg4(T value, long duration) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.value, timedValue.value) && Duration.m1503equalsimpl0(this.duration, timedValue.duration);
    }

    /* JADX INFO: renamed from: getDuration-UwyO8pc, reason: not valid java name */
    public final long m1629getDurationUwyO8pc() {
        return this.duration;
    }
    ...
    public int hashCode() {
        T t3 = this.value;
        return Duration.m1519hashCodeimpl(this.duration) + ((t3 == null ? 0 : t3.hashCode()) * 31);
    }

    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + ((Object) Duration.m1538toStringimpl(this.duration)) + ')';
    }

    private TimedValue(T t3, long j8) {
        this.value = t3;
        this.duration = j8;
    }
}
