...
public final class DurationConversionsJDK8Kt {
    ...
    private static final Duration m1630toJavaDurationLRDsOJo(long j8) {
        Duration durationOfSeconds = Duration.ofSeconds(kotlin.time.Duration.m1512getInWholeSecondsimpl(j8), kotlin.time.Duration.m1514getNanosecondsComponentimpl(j8));
    ...
    private static final long toKotlinDuration(Duration duration) {
        ...
        return kotlin.time.Duration.m1527plusLRDsOJo(DurationKt.toDuration(duration.getSeconds(), DurationUnit.SECONDS), DurationKt.toDuration(duration.getNano(), DurationUnit.NANOSECONDS));
    }
}
