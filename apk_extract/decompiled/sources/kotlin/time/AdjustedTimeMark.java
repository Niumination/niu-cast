...
final class AdjustedTimeMark implements TimeMark {
    ...
    public /* synthetic */ AdjustedTimeMark(TimeMark timeMark, long j8, DefaultConstructorMarker defaultConstructorMarker) {
        this(timeMark, j8);
    }
    ...
    public long mo1488elapsedNowUwyO8pc() {
        return Duration.m1526minusLRDsOJo(this.mark.mo1488elapsedNowUwyO8pc(), this.adjustment);
    }
    ...
    public TimeMark mo1489minusLRDsOJo(long j8) {
        return TimeMark.DefaultImpls.m1605minusLRDsOJo(this, j8);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo1491plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1527plusLRDsOJo(this.adjustment, duration), null);
    }

    private AdjustedTimeMark(TimeMark mark, long j8) {
