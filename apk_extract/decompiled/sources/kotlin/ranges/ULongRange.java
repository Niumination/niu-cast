...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong>, OpenEndRange<ULong> {
    ...
    public /* synthetic */ ULongRange(long j8, long j10, DefaultConstructorMarker defaultConstructorMarker) {
        this(j8, j10);
    }
    ...
    public static /* synthetic */ void m1394getEndExclusivesVKNKU$annotations() {
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m1395containsVKZWuLQ(((ULong) comparable).getData());
    }

    /* JADX INFO: renamed from: contains-VKZWuLQ, reason: not valid java name */
    public boolean m1395containsVKZWuLQ(long value) {
    ...
    public /* bridge */ /* synthetic */ Comparable getEndExclusive() {
        return ULong.m327boximpl(m1396getEndExclusivesVKNKU());
    }

    /* JADX INFO: renamed from: getEndExclusive-s-VKNKU, reason: not valid java name */
    public long m1396getEndExclusivesVKNKU() {
        if (getLast() == -1) {
            throw new IllegalStateException("Cannot return the exclusive upper bound of a range that includes MAX_VALUE.");
        }
        return ULong.m333constructorimpl(ULong.m333constructorimpl(((long) 1) & 4294967295L) + getLast());
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ Comparable getEndInclusive() {
        return ULong.m327boximpl(m1397getEndInclusivesVKNKU());
    }

    /* JADX INFO: renamed from: getEndInclusive-s-VKNKU, reason: not valid java name */
    public long m1397getEndInclusivesVKNKU() {
        return getLast();
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ Comparable getStart() {
        return ULong.m327boximpl(m1398getStartsVKNKU());
    }

    /* JADX INFO: renamed from: getStart-s-VKNKU, reason: not valid java name */
    public long m1398getStartsVKNKU() {
        return getFirst();
    }
    ...
    public int hashCode() {
        ...
        return ((int) ULong.m333constructorimpl(getLast() ^ ULong.m333constructorimpl(getLast() >>> 32))) + (((int) ULong.m333constructorimpl(getFirst() ^ ULong.m333constructorimpl(getFirst() >>> 32))) * 31);
    }
    ...
    public String toString() {
        return ((Object) ULong.m379toStringimpl(getFirst())) + ".." + ((Object) ULong.m379toStringimpl(getLast()));
    }

    private ULongRange(long j8, long j10) {
        super(j8, j10, 1L, null);
    }
}
