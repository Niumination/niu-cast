...
public abstract class BaseContinuationImpl implements Continuation<Object>, CoroutineStackFrame, Serializable {
    ...
    public final void resumeWith(Object result) {
        ?? r7 = this;
        while (true) {
            DebugProbesKt.probeCoroutineResumed(r7);
            BaseContinuationImpl baseContinuationImpl = (BaseContinuationImpl) r7;
            ...
            try {
                ...
                if (objInvokeSuspend == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    ...
                    result = Result.m159constructorimpl(objInvokeSuspend);
                }
            } catch (Throwable th2) {
                Result.Companion companion = Result.INSTANCE;
                result = Result.m159constructorimpl(ResultKt.createFailure(th2));
            }
