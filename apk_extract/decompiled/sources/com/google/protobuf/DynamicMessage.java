...
public final class DynamicMessage extends AbstractMessage {
    ...
    public static final class Builder extends AbstractMessage.Builder<Builder> {
        ...
        private void verifySingularValueType(Descriptors.FieldDescriptor fieldDescriptor, Object obj) {
            int i8 = AnonymousClass2.$SwitchMap$com$google$protobuf$Descriptors$FieldDescriptor$Type[fieldDescriptor.getType().ordinal()];
            if (i8 != 1) {
                if (i8 == 2 && (obj instanceof Message.Builder)) {
        ...
        public Object getRepeatedField(Descriptors.FieldDescriptor fieldDescriptor, int i8) {
            verifyContainingType(fieldDescriptor);
            return this.fields.getRepeatedField(fieldDescriptor, i8);
        }
        ...
        public Message.Builder getRepeatedFieldBuilder(Descriptors.FieldDescriptor fieldDescriptor, int i8) {
            ...
            Message.Builder messageBuilder = toMessageBuilder(this.fields.getRepeatedFieldAllowBuilders(fieldDescriptor, i8));
            this.fields.setRepeatedField(fieldDescriptor, i8, messageBuilder);
        ...
        public Builder setRepeatedField(Descriptors.FieldDescriptor fieldDescriptor, int i8, Object obj) {
            verifyContainingType(fieldDescriptor);
            verifySingularValueType(fieldDescriptor, obj);
            this.fields.setRepeatedField(fieldDescriptor, i8, obj);
            return this;
        }
                ...
                if (dynamicMessage.type == this.type) {
                    ...
                    while (true) {
                        ...
                        if (fieldDescriptorArr[i8] == null) {
                            ...
                            this.fields.clearField(this.oneofCases[i8]);
    ...
    public Object getField(Descriptors.FieldDescriptor fieldDescriptor) {
        ...
        return fieldDescriptor.getJavaType() == Descriptors.FieldDescriptor.JavaType.MESSAGE ? getDefaultInstance(fieldDescriptor.getMessageType()) : fieldDescriptor.getDefaultValue();
    }
    ...
    public int getSerializedSize() {
        ...
        int i9 = serializedSize2 + serializedSize;
