...
public abstract class AbstractParser<MessageType extends MessageLite> implements Parser<MessageType> {
    ...
    public MessageType parsePartialDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        try {
            ...
            return (MessageType) parsePartialFrom((InputStream) new AbstractMessageLite.Builder.LimitedInputStream(inputStream, CodedInputStream.readRawVarint32(i8, inputStream)), extensionRegistryLite);
        } catch (IOException e) {
    ...
    @Override // com.google.protobuf.Parser
    public MessageType parsePartialFrom(byte[] bArr, int i8, int i9, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
    ...
    public MessageType parsePartialFrom(byte[] bArr, int i8, int i9) throws InvalidProtocolBufferException {
        return (MessageType) parsePartialFrom(bArr, i8, i9, EMPTY_REGISTRY);
    }
    ...
    @Override // com.google.protobuf.Parser
    public MessageType parseFrom(byte[] bArr, int i8, int i9, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        return (MessageType) checkMessageInitialized(parsePartialFrom(bArr, i8, i9, extensionRegistryLite));
    }
    ...
    public MessageType parseFrom(byte[] bArr, int i8, int i9) throws InvalidProtocolBufferException {
        return (MessageType) parseFrom(bArr, i8, i9, EMPTY_REGISTRY);
    }
