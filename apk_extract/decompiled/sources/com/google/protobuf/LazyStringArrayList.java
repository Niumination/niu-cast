...
public class LazyStringArrayList extends AbstractProtobufList<String> implements LazyStringList, RandomAccess {
    ...
    public static class ByteArrayListView extends AbstractList<byte[]> implements RandomAccess {
        ...
        public byte[] remove(int i8) {
            String strRemove = this.list.remove(i8);
            ((AbstractList) this).modCount++;
    ...
    public byte[] getByteArray(int i8) {
        ...
        if (bArrAsByteArray != obj) {
            this.list.set(i8, bArrAsByteArray);
        }
    ...
    public ByteString getByteString(int i8) {
        ...
        if (byteStringAsByteString != obj) {
            this.list.set(i8, byteStringAsByteString);
        }
    ...
    public boolean addAll(int i8, Collection<? extends String> collection) {
        ...
        boolean zAddAll = this.list.addAll(i8, collection);
        ((AbstractList) this).modCount++;
        return zAddAll;
    }
    ...
    public String remove(int i8) {
        ensureIsMutable();
        Object objRemove = this.list.remove(i8);
        ((AbstractList) this).modCount++;
