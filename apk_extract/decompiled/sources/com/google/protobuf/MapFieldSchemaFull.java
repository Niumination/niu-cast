...
class MapFieldSchemaFull implements MapFieldSchema {
    private static <K, V> int getSerializedSizeFull(int i8, Object obj, Object obj2) {
        ...
        for (Map.Entry<K, V> entry : map.entrySet()) {
            iComputeLengthDelimitedFieldSize += CodedOutputStream.computeLengthDelimitedFieldSize(MapEntryLite.computeSerializedSize(mapEntry.getMetadata(), entry.getKey(), entry.getValue())) + CodedOutputStream.computeTagSize(i8);
        }
    ...
    public int getSerializedSize(int i8, Object obj, Object obj2) {
        return getSerializedSizeFull(i8, obj, obj2);
    }
