...
final class ExtensionSchemaFull extends ExtensionSchema<Descriptors.FieldDescriptor> {
    ...
    public Object findExtensionByNumber(ExtensionRegistryLite extensionRegistryLite, MessageLite messageLite, int i8) {
        return ((ExtensionRegistry) extensionRegistryLite).findImmutableExtensionByNumber(((Message) messageLite).getDescriptorForType(), i8);
    }
    ...
    public FieldSet<Descriptors.FieldDescriptor> getMutableExtensions(Object obj) {
        ...
        FieldSet fieldSetM89clone = extensions.m89clone();
        setExtensions(obj, fieldSetM89clone);
        return fieldSetM89clone;
    }
    ...
    public <UT, UB> UB parseExtension(Object obj, Reader reader, Object obj2, ExtensionRegistryLite extensionRegistryLite, FieldSet<Descriptors.FieldDescriptor> fieldSet, UB ub2, UnknownFieldSchema<UT, UB> unknownFieldSchema) throws IOException {
        ...
        if (extensionInfo.descriptor.isRepeated() && extensionInfo.descriptor.isPacked()) {
                ...
                case 14:
                    ...
                    while (it.hasNext()) {
                        ...
                        if (enumValueDescriptorFindValueByNumber != null) {
                            ...
                            ub2 = (UB) SchemaUtil.storeUnknownEnum(obj, number, iIntValue, ub2, unknownFieldSchema);
                        }
                    }
                    fieldSet.setField(extensionInfo.descriptor, arrayList2);
                    break;
            ...
            if (extensionInfo.descriptor.isRepeated()) {
                ...
                int i8 = AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$FieldType[extensionInfo.descriptor.getLiteType().ordinal()];
                if ((i8 == 17 || i8 == 18) && (field = fieldSet.getField(extensionInfo.descriptor)) != null) {
