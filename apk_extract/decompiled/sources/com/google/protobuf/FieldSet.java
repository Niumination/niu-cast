...
final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    public static final class Builder<T extends FieldDescriptorLite<T>> {
        ...
        private FieldSet<T> buildImpl(boolean z2) {
            ...
            if (this.hasNestedBuilders) {
                ...
                replaceBuilders(smallSortedMapCloneAllFieldsMap, z2);
            }
        ...
        private static <T extends FieldDescriptorLite<T>> void replaceBuilders(SmallSortedMap<T, Object> smallSortedMap, boolean z2) {
            for (int i8 = 0; i8 < smallSortedMap.getNumArrayEntries(); i8++) {
                replaceBuilders(smallSortedMap.getArrayEntryAt(i8), z2);
            }
        ...
        public Object getRepeatedField(T t3, int i8) {
            if (this.hasNestedBuilders) {
                ensureIsMutable();
            }
            return replaceBuilder(getRepeatedFieldAllowBuilders(t3, i8), true);
        }

        public Object getRepeatedFieldAllowBuilders(T t3, int i8) {
            if (!t3.isRepeated()) {
        ...
        public void setField(T t3, Object obj) {
            ...
            this.hasNestedBuilders = this.hasNestedBuilders || (obj instanceof MessageLite.Builder);
            this.fields.put(t3, obj);
        }

        public void setRepeatedField(T t3, int i8, Object obj) {
            ensureIsMutable();
            if (!t3.isRepeated()) {
                throw new IllegalArgumentException("getRepeatedField() can only be called on repeated fields.");
            }
                ...
                if (obj instanceof List) {
                    ...
                    for (int i8 = 0; i8 < arrayList.size(); i8++) {
                        ...
                        if (objReplaceBuilder != obj2) {
                            ...
                            arrayList.set(i8, objReplaceBuilder);
                        }
                    }
                    return arrayList;
                }
    ...
    public static <T extends FieldDescriptorLite<T>> SmallSortedMap<T, Object> cloneAllFieldsMap(SmallSortedMap<T, Object> smallSortedMap, boolean z2) {
        ...
        for (int i8 = 0; i8 < smallSortedMap.getNumArrayEntries(); i8++) {
            cloneFieldEntry(smallSortedMapNewFieldMap, smallSortedMap.getArrayEntryAt(i8), z2);
        }
        Iterator it = smallSortedMap.getOverflowEntries().iterator();
        while (it.hasNext()) {
    ...
    public static int computeElementSize(WireFormat.FieldType fieldType, int i8, Object obj) {
        int iComputeTagSize = CodedOutputStream.computeTagSize(i8);
    ...
    public int getMessageSetSerializedSize() {
        ...
        for (int i8 = 0; i8 < this.fields.getNumArrayEntries(); i8++) {
            messageSetSerializedSize += getMessageSetSerializedSize(this.fields.getArrayEntryAt(i8));
        }
        Iterator it = this.fields.getOverflowEntries().iterator();
        while (it.hasNext()) {
    ...
    public int getSerializedSize() {
        ...
        for (int i8 = 0; i8 < this.fields.getNumArrayEntries(); i8++) {
            Map.Entry<K, Object> arrayEntryAt = this.fields.getArrayEntryAt(i8);
