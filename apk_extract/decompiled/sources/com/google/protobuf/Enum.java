...
public final class Enum extends GeneratedMessageV3 implements EnumOrBuilder {
    ...
    public static /* synthetic */ int access$976(Enum r7, int i8) {
        int i9 = i8 | r7.bitField0_;
        r7.bitField0_ = i9;
        return i9;
    }
    ...
    public boolean equals(Object obj) {
        ...
        Enum r7 = (Enum) obj;
        if (getName().equals(r7.getName()) && getEnumvalueList().equals(r7.getEnumvalueList()) && getOptionsList().equals(r7.getOptionsList()) && hasSourceContext() == r7.hasSourceContext()) {
            return (!hasSourceContext() || getSourceContext().equals(r7.getSourceContext())) && this.syntax_ == r7.syntax_ && getEdition().equals(r7.getEdition()) && getUnknownFields().equals(r7.getUnknownFields());
        }
        return false;
    }
    ...
    public int getSerializedSize() {
        ...
        for (int i9 = 0; i9 < this.enumvalue_.size(); i9++) {
            iComputeStringSize += CodedOutputStream.computeMessageSize(2, this.enumvalue_.get(i9));
        }
        ...
        if (!GeneratedMessageV3.isStringEmpty(this.edition_)) {
            iComputeStringSize += GeneratedMessageV3.computeStringSize(6, this.edition_);
        }
    ...
    public int hashCode() {
        ...
        if (getEnumvalueCount() > 0) {
            iHashCode = getEnumvalueList().hashCode() + d.a(iHashCode, 37, 2, 53);
        }
        if (getOptionsCount() > 0) {
            iHashCode = getOptionsList().hashCode() + d.a(iHashCode, 37, 3, 53);
        }
        if (hasSourceContext()) {
            iHashCode = getSourceContext().hashCode() + d.a(iHashCode, 37, 4, 53);
        }
        int iHashCode2 = getUnknownFields().hashCode() + ((getEdition().hashCode() + ((((d.a(iHashCode, 37, 5, 53) + this.syntax_) * 37) + 6) * 53)) * 29);
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        ...
        for (int i8 = 0; i8 < this.enumvalue_.size(); i8++) {
            codedOutputStream.writeMessage(2, this.enumvalue_.get(i8));
        }
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements EnumOrBuilder {
        ...
        private void buildPartial0(Enum r7) {
            int i8;
            ...
            if ((i9 & 8) != 0) {
                ...
                r7.sourceContext_ = singleFieldBuilderV3 == null ? this.sourceContext_ : (SourceContext) singleFieldBuilderV3.build();
                i8 = 1;
            } else {
                i8 = 0;
            }
            if ((i9 & 16) != 0) {
                r7.syntax_ = this.syntax_;
            }
            if ((i9 & 32) != 0) {
                r7.edition_ = this.edition_;
            }
            Enum.access$976(r7, i8);
        }

        private void buildPartialRepeatedFields(Enum r7) {
            ...
            if (repeatedFieldBuilderV3 == null) {
                ...
                r7.enumvalue_ = this.enumvalue_;
            } else {
                r7.enumvalue_ = repeatedFieldBuilderV3.build();
            }
            ...
            if (repeatedFieldBuilderV4 != null) {
                r7.options_ = repeatedFieldBuilderV4.build();
                return;
            }
        ...
        public EnumValue getEnumvalue(int i8) {
            RepeatedFieldBuilderV3<EnumValue, EnumValue.Builder, EnumValueOrBuilder> repeatedFieldBuilderV3 = this.enumvalueBuilder_;
            return repeatedFieldBuilderV3 == null ? this.enumvalue_.get(i8) : (EnumValue) repeatedFieldBuilderV3.getMessage(i8);
        }

        public EnumValue.Builder getEnumvalueBuilder(int i8) {
            return (EnumValue.Builder) getEnumvalueFieldBuilder().getBuilder(i8);
        }
        ...
        public EnumValueOrBuilder getEnumvalueOrBuilder(int i8) {
            RepeatedFieldBuilderV3<EnumValue, EnumValue.Builder, EnumValueOrBuilder> repeatedFieldBuilderV3 = this.enumvalueBuilder_;
            return repeatedFieldBuilderV3 == null ? this.enumvalue_.get(i8) : (EnumValueOrBuilder) repeatedFieldBuilderV3.getMessageOrBuilder(i8);
        }
        ...
        public Builder setEnumvalue(int i8, EnumValue enumValue) {
            ...
            if (repeatedFieldBuilderV3 == null) {
                ...
                repeatedFieldBuilderV3.setMessage(i8, enumValue);
            }
            return this;
        }
        ...
        public Enum buildPartial() {
            Enum r7 = new Enum(this);
            buildPartialRepeatedFields(r7);
        ...
        public EnumValue.Builder addEnumvalueBuilder(int i8) {
            return (EnumValue.Builder) getEnumvalueFieldBuilder().addBuilder(i8, EnumValue.getDefaultInstance());
        }
        ...
        public Builder addEnumvalue(int i8, EnumValue enumValue) {
            ...
            if (repeatedFieldBuilderV3 == null) {
                ...
                repeatedFieldBuilderV3.addMessage(i8, enumValue);
            }
            return this;
        }
        ...
        public Builder setEnumvalue(int i8, EnumValue.Builder builder) {
            ...
            if (repeatedFieldBuilderV3 == null) {
                ensureEnumvalueIsMutable();
                this.enumvalue_.set(i8, builder.build());
                onChanged();
            } else {
        ...
        public Builder mergeFrom(Enum r7) {
            if (r7 == Enum.getDefaultInstance()) {
                return this;
            }
            if (!r7.getName().isEmpty()) {
                this.name_ = r7.name_;
                this.bitField0_ |= 1;
                onChanged();
            }
            if (this.enumvalueBuilder_ == null) {
                if (!r7.enumvalue_.isEmpty()) {
                    if (this.enumvalue_.isEmpty()) {
                        this.enumvalue_ = r7.enumvalue_;
                        this.bitField0_ &= -3;
                    } else {
                        ensureEnumvalueIsMutable();
                        this.enumvalue_.addAll(r7.enumvalue_);
                    }
                    onChanged();
                }
            } else if (!r7.enumvalue_.isEmpty()) {
                if (this.enumvalueBuilder_.isEmpty()) {
                    ...
                    this.enumvalueBuilder_.addAllMessages(r7.enumvalue_);
                }
            }
            if (this.optionsBuilder_ == null) {
                if (!r7.options_.isEmpty()) {
                    if (this.options_.isEmpty()) {
                        this.options_ = r7.options_;
                        this.bitField0_ &= -5;
                    } else {
                        ensureOptionsIsMutable();
                        this.options_.addAll(r7.options_);
                    }
                    onChanged();
                }
            } else if (!r7.options_.isEmpty()) {
                if (this.optionsBuilder_.isEmpty()) {
                    ...
                    this.optionsBuilder_.addAllMessages(r7.options_);
                }
            }
            if (r7.hasSourceContext()) {
                mergeSourceContext(r7.getSourceContext());
            }
            if (r7.syntax_ != 0) {
                setSyntaxValue(r7.getSyntaxValue());
            }
            if (!r7.getEdition().isEmpty()) {
                this.edition_ = r7.edition_;
                this.bitField0_ |= 32;
                onChanged();
            }
            mergeUnknownFields(r7.getUnknownFields());
            onChanged();
            return this;
        }
        ...
        public Builder addEnumvalue(int i8, EnumValue.Builder builder) {
            ...
            if (repeatedFieldBuilderV3 == null) {
                ensureEnumvalueIsMutable();
                this.enumvalue_.add(i8, builder.build());
                onChanged();
            } else {
    ...
    public static Builder newBuilder(Enum r7) {
        return DEFAULT_INSTANCE.toBuilder().mergeFrom(r7);
    }
