...
public final class Internal {
    ...
    public interface BooleanList extends ProtobufList<Boolean> {
        ...
        ProtobufList<Boolean> mutableCopyWithCapacity2(int i8);
    ...
    public interface DoubleList extends ProtobufList<Double> {
        ...
        ProtobufList<Double> mutableCopyWithCapacity2(int i8);
    ...
    public interface FloatList extends ProtobufList<Float> {
        ...
        @Override // com.google.protobuf.Internal.ProtobufList, com.google.protobuf.Internal.BooleanList
        /* JADX INFO: renamed from: mutableCopyWithCapacity */
        ProtobufList<Float> mutableCopyWithCapacity2(int i8);

        @CanIgnoreReturnValue
        float setFloat(int i8, float f);
    }
    ...
    public interface IntList extends ProtobufList<Integer> {
        ...
        @Override // com.google.protobuf.Internal.ProtobufList, com.google.protobuf.Internal.BooleanList
        /* JADX INFO: renamed from: mutableCopyWithCapacity */
        ProtobufList<Integer> mutableCopyWithCapacity2(int i8);
    ...
    public interface LongList extends ProtobufList<Long> {
        ...
        @Override // com.google.protobuf.Internal.ProtobufList, com.google.protobuf.Internal.BooleanList
        /* JADX INFO: renamed from: mutableCopyWithCapacity */
        ProtobufList<Long> mutableCopyWithCapacity2(int i8);
    ...
    public static class MapAdapter<K, V, RealValue> extends AbstractMap<K, V> {
        ...
        public class EntryAdapter implements Map.Entry<K, V> {
            ...
            public V setValue(V v3) {
                RealValue value = this.realEntry.setValue((RealValue) MapAdapter.this.valueConverter.doBackward(v3));
                if (value == null) {
                    return null;
                }
        ...
        public static <T extends EnumLite> Converter<Integer, T> newEnumConverter(final EnumLiteMap<T> enumLiteMap, final T t3) {
            return (Converter<Integer, T>) new Converter<Integer, T>() { // from class: com.google.protobuf.Internal.MapAdapter.1
                ...
                public EnumLite doForward(Integer num) {
                    ...
                    return enumLiteFindValueByNumber == null ? t3 : enumLiteFindValueByNumber;
                }
            };
        }
        ...
        public V put(K k8, V v3) {
            RealValue realvaluePut = this.realMap.put(k8, this.valueConverter.doBackward(v3));
    ...
    public interface ProtobufList<E> extends List<E>, RandomAccess {
        ...
        /* JADX INFO: renamed from: mutableCopyWithCapacity */
        ProtobufList<E> mutableCopyWithCapacity2(int i8);
    }
    ...
    public static int hashCode(byte[] bArr, int i8, int i9) {
        int iPartialHash = partialHash(i9, bArr, i8, i9);
        if (iPartialHash == 0) {
            return 1;
        }
        return iPartialHash;
