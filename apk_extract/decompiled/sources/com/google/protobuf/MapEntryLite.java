...
public class MapEntryLite<K, V> {
    ...
    public static class Metadata<K, V> {
        ...
        public Metadata(WireFormat.FieldType fieldType, K k8, WireFormat.FieldType fieldType2, V v3) {
    ...
    private MapEntryLite(WireFormat.FieldType fieldType, K k8, WireFormat.FieldType fieldType2, V v3) {
        this.metadata = new Metadata<>(fieldType, k8, fieldType2, v3);
        this.key = k8;
        this.value = v3;
    }

    public static <K, V> int computeSerializedSize(Metadata<K, V> metadata, K k8, V v3) {
        return FieldSet.computeElementSize(metadata.keyType, 1, k8) + FieldSet.computeElementSize(metadata.valueType, 2, v3);
    }

    public static <K, V> MapEntryLite<K, V> newDefaultInstance(WireFormat.FieldType fieldType, K k8, WireFormat.FieldType fieldType2, V v3) {
        return new MapEntryLite<>(fieldType, k8, fieldType2, v3);
    }
    ...
    public static <K, V> void writeTo(CodedOutputStream codedOutputStream, Metadata<K, V> metadata, K k8, V v3) throws IOException {
    ...
    public int computeMessageSize(int i8, K k8, V v3) {
        return CodedOutputStream.computeLengthDelimitedFieldSize(computeSerializedSize(this.metadata, k8, v3)) + CodedOutputStream.computeTagSize(i8);
    }
    ...
    public void serializeTo(CodedOutputStream codedOutputStream, int i8, K k8, V v3) throws IOException {
        codedOutputStream.writeTag(i8, 2);
        codedOutputStream.writeUInt32NoTag(computeSerializedSize(this.metadata, k8, v3));
        writeTo(codedOutputStream, this.metadata, k8, v3);
    }
    ...
    private MapEntryLite(Metadata<K, V> metadata, K k8, V v3) {
