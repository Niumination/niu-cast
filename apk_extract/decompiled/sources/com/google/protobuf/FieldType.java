...
public final class FieldType {
    ...
    static {
        ...
        for (FieldType fieldType52 : fieldTypeArrValues) {
            VALUES[fieldType52.f2287id] = fieldType52;
        }
    }
    ...
    private FieldType(String str, int i8, int i9, Collection collection, JavaType javaType) {
        ...
        int i11 = AnonymousClass1.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        if (i11 == 1 || i11 == 2) {
            this.elementType = javaType.getBoxedType();
        } else {
            this.elementType = null;
        }
        this.primitiveScalar = (collection != Collection.SCALAR || (i10 = AnonymousClass1.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i10 == 2 || i10 == 3) ? false : true;
    }

    public static FieldType forId(int i8) {
        if (i8 < 0) {
            return null;
        }
