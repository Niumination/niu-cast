...
class IterableByteBufferInputStream extends InputStream {
    ...
    public int read() throws IOException {
        ...
        if (this.hasArray) {
            int i8 = this.currentArray[this.currentByteBufferPos + this.currentArrayOffset] & UByte.MAX_VALUE;
            updateCurrentByteBufferPos(1);
            return i8;
        }
        int i9 = UnsafeUtil.getByte(((long) this.currentByteBufferPos) + this.currentAddress) & UByte.MAX_VALUE;
        updateCurrentByteBufferPos(1);
        return i9;
    }
