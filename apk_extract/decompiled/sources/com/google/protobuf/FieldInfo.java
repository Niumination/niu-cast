...
final class FieldInfo implements Comparable<FieldInfo> {
    ...
    private FieldInfo(java.lang.reflect.Field field, int i8, FieldType fieldType, Class<?> cls, java.lang.reflect.Field field2, int i9, boolean z2, boolean z3, OneofInfo oneofInfo, Class<?> cls2, Object obj, Internal.EnumVerifier enumVerifier, java.lang.reflect.Field field3) {
        this.field = field;
        this.type = fieldType;
    ...
    private static void checkFieldNumber(int i8) {
        if (i8 <= 0) {
            throw new IllegalArgumentException(a.o(i8, "fieldNumber must be positive: "));
        }
    }

    public static FieldInfo forExplicitPresenceField(java.lang.reflect.Field field, int i8, FieldType fieldType, java.lang.reflect.Field field2, int i9, boolean z2, Internal.EnumVerifier enumVerifier) {
        checkFieldNumber(i8);
        Internal.checkNotNull(field, "field");
        Internal.checkNotNull(fieldType, "fieldType");
        Internal.checkNotNull(field2, "presenceField");
        if (field2 == null || isExactlyOneBitSet(i9)) {
            return new FieldInfo(field, i8, fieldType, null, field2, i9, false, z2, null, null, null, enumVerifier, null);
        }
        throw new IllegalArgumentException(a.o(i9, "presenceMask must have exactly one bit set: "));
    }

    public static FieldInfo forField(java.lang.reflect.Field field, int i8, FieldType fieldType, boolean z2) {
        checkFieldNumber(i8);
        Internal.checkNotNull(field, "field");
        Internal.checkNotNull(fieldType, "fieldType");
        ...
        return new FieldInfo(field, i8, fieldType, null, null, 0, false, z2, null, null, null, null, null);
    }
    ...
    public static FieldInfo forLegacyRequiredField(java.lang.reflect.Field field, int i8, FieldType fieldType, java.lang.reflect.Field field2, int i9, boolean z2, Internal.EnumVerifier enumVerifier) {
        checkFieldNumber(i8);
        Internal.checkNotNull(field, "field");
        Internal.checkNotNull(fieldType, "fieldType");
        Internal.checkNotNull(field2, "presenceField");
        if (field2 == null || isExactlyOneBitSet(i9)) {
            return new FieldInfo(field, i8, fieldType, null, field2, i9, true, z2, null, null, null, enumVerifier, null);
        }
        throw new IllegalArgumentException(a.o(i9, "presenceMask must have exactly one bit set: "));
    }
    ...
    public static FieldInfo forOneofMemberField(int i8, FieldType fieldType, OneofInfo oneofInfo, Class<?> cls, boolean z2, Internal.EnumVerifier enumVerifier) {
        checkFieldNumber(i8);
        Internal.checkNotNull(fieldType, "fieldType");
        Internal.checkNotNull(oneofInfo, "oneof");
        Internal.checkNotNull(cls, "oneofStoredType");
        if (fieldType.isScalar()) {
            return new FieldInfo(null, i8, fieldType, null, null, 0, false, z2, oneofInfo, cls, null, enumVerifier, null);
        }
    ...
    public Class<?> getMessageFieldClass() {
        int i8 = AnonymousClass1.$SwitchMap$com$google$protobuf$FieldType[this.type.ordinal()];
        if (i8 == 1 || i8 == 2) {
