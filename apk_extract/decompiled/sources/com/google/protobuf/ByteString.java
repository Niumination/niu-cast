...
public abstract class ByteString implements Iterable<Byte>, Serializable {
    ...
    public static class LiteralByteString extends LeafByteString {
        ...
        public final boolean equalsRange(ByteString byteString, int i8, int i9) {
            ...
            if (i10 > byteString.size()) {
                StringBuilder sbR = d.r(i8, i9, "Ran off end of other: ", ", ", ", ");
                sbR.append(byteString.size());
        ...
        public final ByteString substring(int i8, int i9) {
            int iCheckRange = ByteString.checkRange(i8, i9, size());
            return iCheckRange == 0 ? ByteString.EMPTY : new BoundedByteString(this.bytes, getOffsetIntoBytes() + i8, iCheckRange);
        }
    ...
    private static ByteString balancedConcat(Iterator<ByteString> it, int i8) {
        if (i8 < 1) {
            throw new IllegalArgumentException(a.h(i8, "length (", ") must be >= 1"));
        }
        if (i8 == 1) {
            return it.next();
        }
    ...
    public static void checkIndex(int i8, int i9) {
        if (((i9 - (i8 + 1)) | i8) < 0) {
            if (i8 >= 0) {
                throw new ArrayIndexOutOfBoundsException(d.f(i8, i9, "Index > length: ", ", "));
            }
    ...
    public static int checkRange(int i8, int i9, int i10) {
        ...
        if (i8 < 0) {
            throw new IndexOutOfBoundsException(a.h(i8, "Beginning index: ", " < 0"));
        }
        if (i9 < i8) {
            throw new IndexOutOfBoundsException(d.f(i8, i9, "Beginning index larger than ending index: ", ", "));
        }
        throw new IndexOutOfBoundsException(d.f(i9, i10, "End index: ", " >= "));
    }
    ...
    private String truncateAndEscapeForDisplay() {
        return size() <= 50 ? TextFormatEscaper.escapeBytes(this) : a.n(new StringBuilder(), TextFormatEscaper.escapeBytes(substring(0, 47)), "...");
    }
    ...
    public final ByteString concat(ByteString byteString) {
        ...
        throw new IllegalArgumentException("ByteString would be too long: " + size() + e.ANY_NON_NULL_MARKER + byteString.size());
    }
    ...
    public static ByteString readFrom(InputStream inputStream, int i8, int i9) throws IOException {
        ...
        while (true) {
            ByteString chunk = readChunk(inputStream, i8);
            if (chunk == null) {
    ...
    public final String toString() {
        ...
        sb2.append(size);
        sb2.append(" contents=\"");
        return a.n(sb2, strTruncateAndEscapeForDisplay, "\">");
    }
