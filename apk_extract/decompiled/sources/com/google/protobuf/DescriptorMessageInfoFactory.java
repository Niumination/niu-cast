...
final class DescriptorMessageInfoFactory implements MessageInfoFactory {
    ...
    public static class IsInitializedCheckAnalyzer {
        ...
        private void analyze(StronglyConnectedComponent stronglyConnectedComponent) {
            ...
            stronglyConnectedComponent.needsIsInitializedCheck = z2;
    ...
    public static final class OneofState {
        ...
        private static OneofInfo newInfo(Class<?> cls, Descriptors.OneofDescriptor oneofDescriptor) {
            ...
            String strB = a.B(strSnakeCaseToLowerCamelCase, "_");
            return new OneofInfo(oneofDescriptor.getIndex(), DescriptorMessageInfoFactory.field(cls, a.B(strSnakeCaseToLowerCamelCase, "Case_")), DescriptorMessageInfoFactory.field(cls, strB));
        }
    ...
    private static java.lang.reflect.Field bitField(Class<?> cls, int i8) {
        return field(cls, a.h(i8, "bitField", "_"));
    }
    ...
    private static FieldInfo buildOneofMember(Class<?> cls, Descriptors.FieldDescriptor fieldDescriptor, OneofState oneofState, boolean z2, Internal.EnumVerifier enumVerifier) {
        ...
        return FieldInfo.forOneofMemberField(fieldDescriptor.getNumber(), fieldType, oneof, getOneofStoredType(cls, fieldDescriptor, fieldType), z2, enumVerifier);
    }
    ...
    private static MessageInfo convert(Class<?> cls, Descriptors.Descriptor descriptor) {
        ...
        builderNewBuilder.withSyntax(convertSyntax(descriptor.getFile().getSyntax()));
        ...
        int i9 = 0;
        int i10 = 0;
        while (i9 < fields.size()) {
            final Descriptors.FieldDescriptor fieldDescriptor = fields.get(i9);
            ...
            Internal.EnumVerifier enumVerifier = (javaType == javaType2 && fieldDescriptor.legacyEnumFieldTreatedAsClosed()) ? new Internal.EnumVerifier() { // from class: com.google.protobuf.DescriptorMessageInfoFactory.1
                ...
                public boolean isInRange(int i11) {
                    return fieldDescriptor.getEnumType().findValueByNumber(i11) != null;
                }
            } : anonymousClass1;
            if (fieldDescriptor.getRealContainingOneof() != null) {
                ...
                if (fieldDescriptor.hasPresence()) {
                    if (fieldBitField == null) {
                        fieldBitField = bitField(cls, i10);
                    }
                    builderNewBuilder.withField(fieldDescriptor.isRequired() ? FieldInfo.forLegacyRequiredField(field, number, fieldType, fieldBitField, i8, zNeedsUtf8Check, enumVerifier) : FieldInfo.forExplicitPresenceField(field, number, fieldType, fieldBitField, i8, zNeedsUtf8Check, enumVerifier));
                    i8 <<= 1;
                    if (i8 == 0) {
                        i10++;
                        i8 = 1;
                    ...
                    if (fieldDescriptor.isMapField()) {
                        ...
                        if (fieldDescriptorFindFieldByNumber.getJavaType() == javaType2 && fieldDescriptorFindFieldByNumber.legacyEnumFieldTreatedAsClosed()) {
                            enumVerifier = new Internal.EnumVerifier() { // from class: com.google.protobuf.DescriptorMessageInfoFactory.2
                                @Override // com.google.protobuf.Internal.EnumVerifier
                                public boolean isInRange(int i11) {
                                    return fieldDescriptorFindFieldByNumber.getEnumType().findValueByNumber(i11) != null;
                                }
                            };
                        }
        ...
        for (int i11 = 0; i11 < fields.size(); i11++) {
            Descriptors.FieldDescriptor fieldDescriptor2 = fields.get(i11);
    ...
    private static ProtoSyntax convertSyntax(Descriptors.FileDescriptor.Syntax syntax) {
        int i8 = AnonymousClass3.$SwitchMap$com$google$protobuf$Descriptors$FileDescriptor$Syntax[syntax.ordinal()];
        if (i8 == 1) {
    ...
    private static String getCachedSizeFieldName(Descriptors.FieldDescriptor fieldDescriptor) {
        return a.n(new StringBuilder(), snakeCaseToLowerCamelCase(fieldDescriptor.getName()), "MemoizedSerializedSize");
    }
    ...
    public static String getFieldName(Descriptors.FieldDescriptor fieldDescriptor) {
        ...
        return a.n(new StringBuilder(), snakeCaseToLowerCamelCase(name), specialFieldNames.contains(snakeCaseToUpperCamelCase(name)) ? "__" : "_");
    }
    ...
    public static java.lang.reflect.Field field(Class<?> cls, String str) {
        try {
            ...
            StringBuilder sbY = a1.a.y("Unable to find field ", str, " in message class ");
