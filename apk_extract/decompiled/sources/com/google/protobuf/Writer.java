...
interface Writer {
    ...
    void writeBool(int i8, boolean z2) throws IOException;

    void writeBoolList(int i8, List<Boolean> list, boolean z2) throws IOException;
    ...
    void writeDouble(int i8, double d7) throws IOException;

    void writeDoubleList(int i8, List<Double> list, boolean z2) throws IOException;
    ...
    void writeEnumList(int i8, List<Integer> list, boolean z2) throws IOException;

    void writeFixed32(int i8, int i9) throws IOException;

    void writeFixed32List(int i8, List<Integer> list, boolean z2) throws IOException;

    void writeFixed64(int i8, long j8) throws IOException;

    void writeFixed64List(int i8, List<Long> list, boolean z2) throws IOException;

    void writeFloat(int i8, float f) throws IOException;

    void writeFloatList(int i8, List<Float> list, boolean z2) throws IOException;
    ...
    void writeInt32List(int i8, List<Integer> list, boolean z2) throws IOException;

    void writeInt64(int i8, long j8) throws IOException;

    void writeInt64List(int i8, List<Long> list, boolean z2) throws IOException;
    ...
    void writeSFixed32List(int i8, List<Integer> list, boolean z2) throws IOException;

    void writeSFixed64(int i8, long j8) throws IOException;

    void writeSFixed64List(int i8, List<Long> list, boolean z2) throws IOException;

    void writeSInt32(int i8, int i9) throws IOException;

    void writeSInt32List(int i8, List<Integer> list, boolean z2) throws IOException;

    void writeSInt64(int i8, long j8) throws IOException;

    void writeSInt64List(int i8, List<Long> list, boolean z2) throws IOException;
    ...
    void writeUInt32List(int i8, List<Integer> list, boolean z2) throws IOException;

    void writeUInt64(int i8, long j8) throws IOException;

    void writeUInt64List(int i8, List<Long> list, boolean z2) throws IOException;
}
