...
public final class Option extends GeneratedMessageV3 implements OptionOrBuilder {
    ...
    public static /* synthetic */ int access$576(Option option, int i8) {
        int i9 = i8 | option.bitField0_;
        option.bitField0_ = i9;
        return i9;
    }
    ...
    public int hashCode() {
        ...
        if (hasValue()) {
            iHashCode = getValue().hashCode() + d.a(iHashCode, 37, 2, 53);
        }
