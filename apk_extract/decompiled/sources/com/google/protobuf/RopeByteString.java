...
final class RopeByteString extends ByteString {
    ...
    private boolean equalsFragments(ByteString byteString) {
        ...
        int i10 = 0;
        while (true) {
            int size = next2.size() - i8;
            int size2 = next3.size() - i9;
            int iMin = Math.min(size, size2);
            if (!(i8 == 0 ? next2.equalsRange(next3, i9, iMin) : next3.equalsRange(next2, i8, iMin))) {
                return false;
            }
            i10 += iMin;
    ...
    public static int minLength(int i8) {
    ...
    public byte internalByteAt(int i8) {
        ...
        return i8 < i9 ? this.left.internalByteAt(i8) : this.right.internalByteAt(i8 - i9);
    }
    ...
    public ByteString substring(int i8, int i9) {
        int iCheckRange = ByteString.checkRange(i8, i9, this.totalLength);
        if (iCheckRange == 0) {
        ...
        return i8 >= i10 ? this.right.substring(i8 - i10, i9 - i10) : new RopeByteString(this.left.substring(i8), this.right.substring(0, i9 - this.leftLength));
    }
    ...
    public class RopeInputStream extends InputStream {
        ...
        public int read(byte[] bArr, int i8, int i9) {
            ...
            int skipInternal = readSkipInternal(bArr, i8, i9);
            if (skipInternal != 0 || (i9 <= 0 && availableInternal() != 0)) {
                return skipInternal;
            }
            return -1;
        }
        ...
        public int read() throws IOException {
            ...
            return leafByteString.byteAt(i8) & UByte.MAX_VALUE;
        }
    }
}
