...
public final class Type extends GeneratedMessageV3 implements TypeOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements TypeOrBuilder {
        ...
        public Field getFields(int i8) {
            RepeatedFieldBuilderV3<Field, Field.Builder, FieldOrBuilder> repeatedFieldBuilderV3 = this.fieldsBuilder_;
            return repeatedFieldBuilderV3 == null ? this.fields_.get(i8) : (Field) repeatedFieldBuilderV3.getMessage(i8);
        }

        public Field.Builder getFieldsBuilder(int i8) {
            return (Field.Builder) getFieldsFieldBuilder().getBuilder(i8);
        }
        ...
        public FieldOrBuilder getFieldsOrBuilder(int i8) {
            RepeatedFieldBuilderV3<Field, Field.Builder, FieldOrBuilder> repeatedFieldBuilderV3 = this.fieldsBuilder_;
            return repeatedFieldBuilderV3 == null ? this.fields_.get(i8) : (FieldOrBuilder) repeatedFieldBuilderV3.getMessageOrBuilder(i8);
        }
        ...
        public ByteString getOneofsBytes(int i8) {
            return this.oneofs_.getByteString(i8);
        }
        ...
        public Field.Builder addFieldsBuilder(int i8) {
            return (Field.Builder) getFieldsFieldBuilder().addBuilder(i8, Field.getDefaultInstance());
        }
        ...
        public Builder setFields(int i8, Field.Builder builder) {
            ...
            if (repeatedFieldBuilderV3 == null) {
                ensureFieldsIsMutable();
                this.fields_.set(i8, builder.build());
                onChanged();
            } else {
        ...
        public Builder addFields(int i8, Field.Builder builder) {
            ...
            if (repeatedFieldBuilderV3 == null) {
                ensureFieldsIsMutable();
                this.fields_.add(i8, builder.build());
                onChanged();
            } else {
    ...
    public static /* synthetic */ int access$1076(Type type, int i8) {
        int i9 = i8 | type.bitField0_;
        type.bitField0_ = i9;
        return i9;
    }
    ...
    public int getSerializedSize() {
        ...
        for (int i9 = 0; i9 < this.fields_.size(); i9++) {
            iComputeStringSize += CodedOutputStream.computeMessageSize(2, this.fields_.get(i9));
        }
        int iComputeStringSizeNoTag = 0;
        for (int i10 = 0; i10 < this.oneofs_.size(); i10++) {
            iComputeStringSizeNoTag += GeneratedMessageV3.computeStringSizeNoTag(this.oneofs_.getRaw(i10));
        }
        int size = getOneofsList().size() + iComputeStringSize + iComputeStringSizeNoTag;
        for (int i11 = 0; i11 < this.options_.size(); i11++) {
            size += CodedOutputStream.computeMessageSize(4, this.options_.get(i11));
        }
    ...
    public int hashCode() {
        ...
        if (getFieldsCount() > 0) {
            iHashCode = getFieldsList().hashCode() + d.a(iHashCode, 37, 2, 53);
        }
        if (getOneofsCount() > 0) {
            iHashCode = getOneofsList().hashCode() + d.a(iHashCode, 37, 3, 53);
        }
        if (getOptionsCount() > 0) {
            iHashCode = getOptionsList().hashCode() + d.a(iHashCode, 37, 4, 53);
        }
        if (hasSourceContext()) {
            iHashCode = getSourceContext().hashCode() + d.a(iHashCode, 37, 5, 53);
        }
        int iHashCode2 = getUnknownFields().hashCode() + ((getEdition().hashCode() + ((((d.a(iHashCode, 37, 6, 53) + this.syntax_) * 37) + 7) * 53)) * 29);
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        ...
        for (int i8 = 0; i8 < this.fields_.size(); i8++) {
            codedOutputStream.writeMessage(2, this.fields_.get(i8));
        }
        for (int i9 = 0; i9 < this.oneofs_.size(); i9++) {
            GeneratedMessageV3.writeString(codedOutputStream, 3, this.oneofs_.getRaw(i9));
        }
        for (int i10 = 0; i10 < this.options_.size(); i10++) {
            codedOutputStream.writeMessage(4, this.options_.get(i10));
        }
        if ((this.bitField0_ & 1) != 0) {
