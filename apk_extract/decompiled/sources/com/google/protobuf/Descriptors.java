...
public final class Descriptors {
    ...
    public static final class Descriptor extends GenericDescriptor {
        ...
        public /* synthetic */ Descriptor(DescriptorProtos.DescriptorProto descriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int i8, AnonymousClass1 anonymousClass1) throws DescriptorValidationException {
            this(descriptorProto, fileDescriptor, descriptor, i8);
        }
        ...
        public void setProto(DescriptorProtos.DescriptorProto descriptorProto) {
            ...
            while (true) {
                ...
                descriptorArr[i9].setProto(descriptorProto.getNestedType(i9));
                i9++;
            }
            int i10 = 0;
            while (true) {
                ...
                oneofDescriptorArr[i10].setProto(descriptorProto.getOneofDecl(i10));
                i10++;
            }
            int i11 = 0;
            while (true) {
            ...
            while (true) {
                ...
                fieldDescriptorArr2[i8].setProto(descriptorProto.getExtension(i8));
                i8++;
            }
        }
        ...
        public FieldDescriptor findFieldByNumber(int i8) {
            FieldDescriptor[] fieldDescriptorArr = this.fieldsSortedByNumber;
            return (FieldDescriptor) Descriptors.binarySearch(fieldDescriptorArr, fieldDescriptorArr.length, FieldDescriptor.NUMBER_GETTER, i8);
        }
        ...
        public boolean isExtensionNumber(int i8) {
            int iBinarySearch = Arrays.binarySearch(this.extensionRangeLowerBounds, i8);
            if (iBinarySearch < 0) {
                iBinarySearch = (~iBinarySearch) - 1;
            }
            return iBinarySearch >= 0 && i8 < this.extensionRangeUpperBounds[iBinarySearch];
        }
        ...
        private Descriptor(DescriptorProtos.DescriptorProto descriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int i8) throws DescriptorValidationException {
            ...
            for (int i16 = 0; i16 < descriptorProto.getFieldCount(); i16++) {
                ...
                if (containingOneof != null) {
                    containingOneof.fields[OneofDescriptor.access$2608(containingOneof)] = this.fields[i16];
                }
            }
            int i17 = 0;
            ...
            this.realOneofCount = this.oneofs.length - i17;
            ...
            if (descriptorProto.getExtensionRangeCount() > 0) {
                ...
                for (DescriptorProtos.DescriptorProto.ExtensionRange extensionRange : descriptorProto.getExtensionRangeList()) {
                    this.extensionRangeLowerBounds[i9] = extensionRange.getStart();
                    this.extensionRangeUpperBounds[i9] = extensionRange.getEnd();
                    i9++;
                }
    ...
    public static final class DescriptorPool {
        ...
        public static void validateSymbolName(GenericDescriptor genericDescriptor) throws DescriptorValidationException {
            ...
            for (int i8 = 0; i8 < name.length(); i8++) {
                ...
                if (('a' > cCharAt || cCharAt > 'z') && (('A' > cCharAt || cCharAt > 'Z') && cCharAt != '_' && ('0' > cCharAt || cCharAt > '9' || i8 <= 0))) {
                    throw new DescriptorValidationException(genericDescriptor, a.j("\"", name, "\" is not a valid identifier."), anonymousClass1);
                }
            }
        }
        ...
        public void addPackage(String str, FileDescriptor fileDescriptor) throws DescriptorValidationException {
            ...
            if (genericDescriptorPut != null) {
                ...
                StringBuilder sbY = a1.a.y("\"", strSubstring, "\" is already defined (as something other than a package) in file \"");
                sbY.append(genericDescriptorPut.getFile().getName());
                sbY.append("\".");
                throw new DescriptorValidationException(fileDescriptor, sbY.toString(), (AnonymousClass1) null);
            }
        }
        ...
        public void addSymbol(GenericDescriptor genericDescriptor) throws DescriptorValidationException {
            ...
            if (genericDescriptorPut != null) {
                ...
                if (genericDescriptor.getFile() != genericDescriptorPut.getFile()) {
                    StringBuilder sbY = a1.a.y("\"", fullName, "\" is already defined in file \"");
                    sbY.append(genericDescriptorPut.getFile().getName());
                    sbY.append("\".");
                    throw new DescriptorValidationException(genericDescriptor, sbY.toString(), anonymousClass1);
                }
                int iLastIndexOf = fullName.lastIndexOf(46);
                if (iLastIndexOf == -1) {
                    throw new DescriptorValidationException(genericDescriptor, a.j("\"", fullName, "\" is already defined."), anonymousClass1);
                }
        ...
        public GenericDescriptor lookupSymbol(String str, GenericDescriptor genericDescriptor, SearchFilter searchFilter) throws DescriptorValidationException {
            ...
            if (!this.allowUnknownDependencies || searchFilter != SearchFilter.TYPES_ONLY) {
                throw new DescriptorValidationException(genericDescriptor, a.j("\"", str, "\" is not defined."), (AnonymousClass1) null);
            }
    ...
    public static final class EnumDescriptor extends GenericDescriptor implements Internal.EnumLiteMap<EnumValueDescriptor> {
        ...
        public static class UnknownEnumValueReference extends WeakReference<EnumValueDescriptor> {
            ...
            public /* synthetic */ UnknownEnumValueReference(int i8, EnumValueDescriptor enumValueDescriptor, AnonymousClass1 anonymousClass1) {
                this(i8, enumValueDescriptor);
            }

            private UnknownEnumValueReference(int i8, EnumValueDescriptor enumValueDescriptor) {
                super(enumValueDescriptor);
                this.number = i8;
            }
        }

        public /* synthetic */ EnumDescriptor(DescriptorProtos.EnumDescriptorProto enumDescriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int i8, AnonymousClass1 anonymousClass1) throws DescriptorValidationException {
            this(enumDescriptorProto, fileDescriptor, descriptor, i8);
        }
        ...
        public void setProto(DescriptorProtos.EnumDescriptorProto enumDescriptorProto) {
            ...
            while (true) {
                ...
                enumValueDescriptorArr[i8].setProto(enumDescriptorProto.getValue(i8));
                i8++;
            }
        }
        ...
        public EnumValueDescriptor findValueByNumberCreatingIfUnknown(int i8) {
            ...
            EnumValueDescriptor enumValueDescriptorFindValueByNumber = findValueByNumber(i8);
            ...
            synchronized (this) {
                try {
                    ...
                    WeakReference<EnumValueDescriptor> weakReference = this.unknownValues.get(Integer.valueOf(i8));
                    AnonymousClass1 anonymousClass1 = null;
                    enumValueDescriptor = weakReference == null ? null : weakReference.get();
                    if (enumValueDescriptor == null) {
                        enumValueDescriptor = new EnumValueDescriptor(this, Integer.valueOf(i8), anonymousClass1);
                        this.unknownValues.put(Integer.valueOf(i8), new UnknownEnumValueReference(i8, enumValueDescriptor, anonymousClass1));
                    }
                } catch (Throwable th2) {
                    throw th2;
                }
        ...
        public boolean isReservedNumber(int i8) {
            for (DescriptorProtos.EnumDescriptorProto.EnumReservedRange enumReservedRange : this.proto.getReservedRangeList()) {
                if (enumReservedRange.getStart() <= i8 && i8 <= enumReservedRange.getEnd()) {
                    return true;
                }
            }
            return false;
        ...
        /* JADX WARN: Illegal instructions before constructor call */
        private EnumDescriptor(DescriptorProtos.EnumDescriptorProto enumDescriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int i8) throws DescriptorValidationException {
            AnonymousClass1 anonymousClass1 = null;
            super(anonymousClass1);
            ...
            for (int i11 = 1; i11 < enumDescriptorProto.getValueCount(); i11++) {
                ...
                EnumValueDescriptor enumValueDescriptor = enumValueDescriptorArr2[i9];
                EnumValueDescriptor enumValueDescriptor2 = enumValueDescriptorArr2[i11];
                if (enumValueDescriptor.getNumber() != enumValueDescriptor2.getNumber()) {
                    i9++;
                    this.valuesSortedByNumber[i9] = enumValueDescriptor2;
                }
            }
            int i12 = i9 + 1;
            this.distinctNumbers = i12;
            Arrays.fill(this.valuesSortedByNumber, i12, enumDescriptorProto.getValueCount(), (Object) null);
            fileDescriptor.pool.addSymbol(this);
        }

        @Override // com.google.protobuf.Internal.EnumLiteMap
        public EnumValueDescriptor findValueByNumber(int i8) {
            return (EnumValueDescriptor) Descriptors.binarySearch(this.valuesSortedByNumber, this.distinctNumbers, EnumValueDescriptor.NUMBER_GETTER, i8);
        }
    ...
    public static final class EnumValueDescriptor extends GenericDescriptor implements Internal.EnumLite {
        ...
        public /* synthetic */ EnumValueDescriptor(DescriptorProtos.EnumValueDescriptorProto enumValueDescriptorProto, FileDescriptor fileDescriptor, EnumDescriptor enumDescriptor, int i8, AnonymousClass1 anonymousClass1) throws DescriptorValidationException {
            this(enumValueDescriptorProto, fileDescriptor, enumDescriptor, i8);
        }
        ...
        private EnumValueDescriptor(DescriptorProtos.EnumValueDescriptorProto enumValueDescriptorProto, FileDescriptor fileDescriptor, EnumDescriptor enumDescriptor, int i8) throws DescriptorValidationException {
            super(null);
            this.index = i8;
            this.proto = enumValueDescriptorProto;
    ...
    public static final class FieldDescriptor extends GenericDescriptor implements Comparable<FieldDescriptor>, FieldSet.FieldDescriptorLite<FieldDescriptor> {
        ...
        public /* synthetic */ FieldDescriptor(DescriptorProtos.FieldDescriptorProto fieldDescriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int i8, boolean z2, AnonymousClass1 anonymousClass1) throws DescriptorValidationException {
            this(fieldDescriptorProto, fileDescriptor, descriptor, i8, z2);
        }
        ...
        public void crossLink() throws DescriptorValidationException {
            ...
            if (this.proto.hasDefaultValue()) {
                ...
                try {
                    ...
                    throw new DescriptorValidationException(this, "Could not parse default value: \"" + this.proto.getDefaultValue() + Typography.quote, e4, anonymousClass1);
                }
            } else if (isRepeated()) {
                this.defaultValue = Collections.emptyList();
            } else {
                int i8 = AnonymousClass1.$SwitchMap$com$google$protobuf$Descriptors$FieldDescriptor$JavaType[getJavaType().ordinal()];
                if (i8 == 1) {
        ...
        /* JADX WARN: Illegal instructions before constructor call */
        private FieldDescriptor(DescriptorProtos.FieldDescriptorProto fieldDescriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int i8, boolean z2) throws DescriptorValidationException {
            AnonymousClass1 anonymousClass1 = null;
            super(anonymousClass1);
            this.index = i8;
            this.proto = fieldDescriptorProto;
    ...
    public static final class FileDescriptor extends GenericDescriptor {
        ...
        private FileDescriptor(DescriptorProtos.FileDescriptorProto fileDescriptorProto, FileDescriptor[] fileDescriptorArr, DescriptorPool descriptorPool, boolean z2) throws DescriptorValidationException {
            ...
            for (int i8 = 0; i8 < fileDescriptorProto.getPublicDependencyCount(); i8++) {
                ...
                if (fileDescriptor2 != null) {
                    ...
                    throw new DescriptorValidationException(this, a.i("Invalid public dependency: ", dependency), anonymousClass1);
                }
            }
            ...
            for (int i9 = 0; i9 < fileDescriptorProto.getMessageTypeCount(); i9++) {
                this.messageTypes[i9] = new Descriptor(fileDescriptorProto.getMessageType(i9), this, null, i9, null);
            }
            ...
            for (int i10 = 0; i10 < fileDescriptorProto.getEnumTypeCount(); i10++) {
                this.enumTypes[i10] = new EnumDescriptor(fileDescriptorProto.getEnumType(i10), this, null, i10, null);
            }
            ...
            for (int i11 = 0; i11 < fileDescriptorProto.getServiceCount(); i11++) {
                this.services[i11] = new ServiceDescriptor(fileDescriptorProto.getService(i11), this, i11, anonymousClass1);
            }
        ...
        private static FileDescriptor[] findDescriptors(Class<?> cls, String[] strArr, String[] strArr2) {
            ...
            for (int i8 = 0; i8 < strArr.length; i8++) {
                try {
                    ...
                    Descriptors.logger.warning("Descriptors for \"" + strArr2[i8] + "\" can not be found.");
                }
            }
        ...
        public static void internalBuildGeneratedFileFrom(String[] strArr, FileDescriptor[] fileDescriptorArr, InternalDescriptorAssigner internalDescriptorAssigner) {
            ...
            try {
                ...
                try {
                    ...
                    throw new IllegalArgumentException("Invalid embedded descriptor for \"" + from.getName() + "\".", e4);
                }
        ...
        private void setProto(DescriptorProtos.FileDescriptorProto fileDescriptorProto) {
            ...
            while (true) {
                ...
                descriptorArr[i9].setProto(fileDescriptorProto.getMessageType(i9));
                i9++;
            }
            int i10 = 0;
            while (true) {
                ...
                enumDescriptorArr[i10].setProto(fileDescriptorProto.getEnumType(i10));
                i10++;
            }
            int i11 = 0;
            while (true) {
                ...
                serviceDescriptorArr[i11].setProto(fileDescriptorProto.getService(i11));
                i11++;
            }
            while (true) {
                ...
                fieldDescriptorArr[i8].setProto(fileDescriptorProto.getExtension(i8));
                i8++;
            }
        }
    ...
    public static final class MethodDescriptor extends GenericDescriptor {
        ...
        public /* synthetic */ MethodDescriptor(DescriptorProtos.MethodDescriptorProto methodDescriptorProto, FileDescriptor fileDescriptor, ServiceDescriptor serviceDescriptor, int i8, AnonymousClass1 anonymousClass1) throws DescriptorValidationException {
            this(methodDescriptorProto, fileDescriptor, serviceDescriptor, i8);
        }
        ...
        private MethodDescriptor(DescriptorProtos.MethodDescriptorProto methodDescriptorProto, FileDescriptor fileDescriptor, ServiceDescriptor serviceDescriptor, int i8) throws DescriptorValidationException {
            super(null);
            this.index = i8;
            this.proto = methodDescriptorProto;
            this.file = fileDescriptor;
    ...
    public static final class OneofDescriptor extends GenericDescriptor {
        ...
        public /* synthetic */ OneofDescriptor(DescriptorProtos.OneofDescriptorProto oneofDescriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int i8, AnonymousClass1 anonymousClass1) {
            this(oneofDescriptorProto, fileDescriptor, descriptor, i8);
        }

        public static /* synthetic */ int access$2608(OneofDescriptor oneofDescriptor) {
            int i8 = oneofDescriptor.fieldCount;
            oneofDescriptor.fieldCount = i8 + 1;
            return i8;
        }
        ...
        private OneofDescriptor(DescriptorProtos.OneofDescriptorProto oneofDescriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int i8) {
            super(null);
            this.proto = oneofDescriptorProto;
    ...
    public static final class ServiceDescriptor extends GenericDescriptor {
        ...
        public /* synthetic */ ServiceDescriptor(DescriptorProtos.ServiceDescriptorProto serviceDescriptorProto, FileDescriptor fileDescriptor, int i8, AnonymousClass1 anonymousClass1) throws DescriptorValidationException {
        ...
        public void setProto(DescriptorProtos.ServiceDescriptorProto serviceDescriptorProto) {
            ...
            while (true) {
                ...
                if (i8 >= methodDescriptorArr.length) {
                    return;
                }
                methodDescriptorArr[i8].setProto(serviceDescriptorProto.getMethod(i8));
                i8++;
            }
        }
        ...
        private ServiceDescriptor(DescriptorProtos.ServiceDescriptorProto serviceDescriptorProto, FileDescriptor fileDescriptor, int i8) throws DescriptorValidationException {
            super(null);
            this.index = i8;
            this.proto = serviceDescriptorProto;
            ...
            for (int i9 = 0; i9 < serviceDescriptorProto.getMethodCount(); i9++) {
                this.methods[i9] = new MethodDescriptor(serviceDescriptorProto.getMethod(i9), fileDescriptor, this, i9, null);
            }
            fileDescriptor.pool.addSymbol(this);
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static <T> T binarySearch(T[] tArr, int i8, NumberGetter<T> numberGetter, int i9) {
        int i10 = i8 - 1;
        int i11 = 0;
        while (i11 <= i10) {
            int i12 = (i11 + i10) / 2;
            T t3 = tArr[i12];
            int number = numberGetter.getNumber(t3);
            if (i9 < number) {
                i10 = i12 - 1;
            } else {
                if (i9 <= number) {
