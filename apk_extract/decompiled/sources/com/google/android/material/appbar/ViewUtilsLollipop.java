...
class ViewUtilsLollipop {
    ...
    public static void setDefaultAppBarLayoutStateListAnimator(@NonNull View view, float f) {
        ...
        stateListAnimator.addState(new int[]{R.attr.state_enabled}, ObjectAnimator.ofFloat(view, "elevation", f).setDuration(j8));
    ...
    public static void setStateListAnimatorFromAttrs(@NonNull View view, AttributeSet attributeSet, int i8, int i9) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, STATE_LIST_ANIM_ATTRS, i8, i9, new int[0]);
        try {
