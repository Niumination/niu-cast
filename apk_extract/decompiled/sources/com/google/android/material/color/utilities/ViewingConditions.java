...
public final class ViewingConditions {
    ...
    private final double f2228n;
    private final double nbb;

    /* JADX INFO: renamed from: nc, reason: collision with root package name */
    private final double f2229nc;
    private final double ncb;
    private final double[] rgbD;

    /* JADX INFO: renamed from: z, reason: collision with root package name */
    private final double f2230z;

    private ViewingConditions(double d7, double d10, double d11, double d12, double d13, double d14, double[] dArr, double d15, double d16, double d17) {
        this.f2228n = d7;
        this.aw = d10;
        this.nbb = d11;
        this.ncb = d12;
    ...
    public static ViewingConditions make(double[] dArr, double d7, double d10, double d11, boolean z2) {
        ...
        double dClampDouble = MathUtils.clampDouble(0.0d, 1.0d, z2 ? 1.0d : (1.0d - (Math.exp(((-d7) - 42.0d) / 92.0d) * 0.2777777777777778d)) * d20);
        ...
        double d24 = 1.0d - d23;
        double dCbrt = (Math.cbrt(d21) * 0.1d * d24 * d24) + (d23 * d7);
