...
public class ColorUtils {
    ...
    public static int argbFromLab(double d7, double d10, double d11) {
    ...
    public static int argbFromLstar(double d7) {
        int iDelinearized = delinearized(yFromLstar(d7));
    ...
    public static int argbFromXyz(double d7, double d10, double d11) {
        ...
        double[] dArr4 = dArr[2];
        return argbFromRgb(delinearized(d12), delinearized(d13), delinearized((dArr4[2] * d11) + (dArr4[1] * d10) + (dArr4[0] * d7)));
    }
    ...
    public static double[] labFromArgb(int i8) {
        double dLinearized = linearized(redFromArgb(i8));
        double dLinearized2 = linearized(greenFromArgb(i8));
        double dLinearized3 = linearized(blueFromArgb(i8));
        double[][] dArr = SRGB_TO_XYZ;
        double[] dArr2 = dArr[0];
        double d7 = (dArr2[2] * dLinearized3) + (dArr2[1] * dLinearized2) + (dArr2[0] * dLinearized);
        double[] dArr3 = dArr[1];
    ...
    public static double labInvf(double d7) {
        double d10 = d7 * d7 * d7;
        return d10 > 0.008856451679035631d ? d10 : ((d7 * 116.0d) - 16.0d) / 903.2962962962963d;
    }
