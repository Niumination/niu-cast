...
public final class DynamicColor {
    ...
    public static double foregroundTone(double d7, double d10) {
        double dLighterUnsafe = Contrast.lighterUnsafe(d7, d10);
        double dDarkerUnsafe = Contrast.darkerUnsafe(d7, d10);
        double dRatioOfTones = Contrast.ratioOfTones(dLighterUnsafe, d7);
        double dRatioOfTones2 = Contrast.ratioOfTones(dDarkerUnsafe, d7);
    ...
    public static DynamicColor fromArgb(@NonNull String str, int i8) {
        return fromPalette(str, new b(TonalPalette.fromInt(i8), 1), new b(Hct.fromInt(i8), 2));
    }
    ...
    public int getArgb(@NonNull DynamicScheme dynamicScheme) {
        ...
        return (MathUtils.clampInt(0, 255, (int) Math.round(function.apply(dynamicScheme).doubleValue() * 255.0d)) << 24) | (16777215 & i8);
    }
    ...
    public double getTone(@NonNull DynamicScheme dynamicScheme) {
        ...
        if (function == null) {
            ...
            if (!this.isBackground || 50.0d > dDoubleValue || dDoubleValue >= 60.0d) {
                ...
                d7 = Contrast.ratioOfTones(49.0d, tone) >= contrast ? 49.0d : 60.0d;
            }
            ...
            if (Contrast.ratioOfTones(dMax2, d7) >= contrast && Contrast.ratioOfTones(dMin2, d7) >= contrast) {
                return d7;
            }
