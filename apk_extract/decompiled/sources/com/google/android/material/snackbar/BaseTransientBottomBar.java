...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    private int calculateBottomMarginForAnchorView() {
        ...
        return (this.targetParent.getHeight() + iArr2[1]) - i8;
    }

    /* JADX INFO: Access modifiers changed from: private */
    @NonNull
    public static GradientDrawable createGradientDrawableBackground(@ColorInt int i8, @NonNull Resources resources) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    @NonNull
    public static MaterialShapeDrawable createMaterialShapeDrawableBackground(@ColorInt int i8, @NonNull ShapeAppearanceModel shapeAppearanceModel) {
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(shapeAppearanceModel);
        materialShapeDrawable.setFillColor(ColorStateList.valueOf(i8));
    ...
    private void startFadeOutAnimation(final int i8) {
        ...
        alphaAnimator.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.10
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
                BaseTransientBottomBar.this.onViewHidden(i8);
            }
        });
        alphaAnimator.start();
    }
    ...
    private void startSlideOutAnimation(final int i8) {
        ValueAnimator valueAnimator = new ValueAnimator();
    ...
    public void updateMargins() {
        ...
        int i8 = this.view.originalMargins.bottom + (getAnchorView() != null ? this.extraBottomMarginAnchorView : this.extraBottomMarginWindowInset);
        int i9 = this.view.originalMargins.left + this.extraLeftMarginWindowInset;
        int i10 = this.view.originalMargins.right + this.extraRightMarginWindowInset;
        int i11 = this.view.originalMargins.top;
        boolean z2 = (marginLayoutParams.bottomMargin == i8 && marginLayoutParams.leftMargin == i9 && marginLayoutParams.rightMargin == i10 && marginLayoutParams.topMargin == i11) ? false : true;
        if (z2) {
    ...
    public void dispatchDismiss(int i8) {
        SnackbarManager.getInstance().dismiss(this.managerCallback, i8);
    }
    ...
    public final void hideView(int i8) {
    ...
    public void onViewHidden(int i8) {
        SnackbarManager.getInstance().onDismissed(this.managerCallback);
        List<BaseCallback<B>> list = this.callbacks;
        if (list != null) {
            for (int size = list.size() - 1; size >= 0; size--) {
                this.callbacks.get(size).onDismissed(this, i8);
            }
        }
    ...
    public BaseTransientBottomBar(@NonNull Context context, @NonNull ViewGroup viewGroup, @NonNull View view, @NonNull com.google.android.material.snackbar.ContentViewCallback contentViewCallback) {
        ...
        this.managerCallback = new SnackbarManager.Callback() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.5
            ...
            public void dismiss(int i8) {
                ...
                handler2.sendMessage(handler2.obtainMessage(1, i8, 0, BaseTransientBottomBar.this));
            }
    ...
    public B setAnchorView(@IdRes int i8) {
        View viewFindViewById = this.targetParent.findViewById(i8);
        if (viewFindViewById != null) {
            return (B) setAnchorView(viewFindViewById);
        }
        throw new IllegalArgumentException(a.o(i8, "Unable to find anchor view with id: "));
    }
}
