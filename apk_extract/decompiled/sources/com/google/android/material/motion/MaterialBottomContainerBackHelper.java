...
public class MaterialBottomContainerBackHelper extends MaterialBackAnimationHelper<View> {
    ...
    public void updateBackProgress(float f) {
        ...
        float f4 = this.maxScaleXDistance / width;
        float f10 = this.maxScaleYDistance / height;
        float fLerp = 1.0f - AnimationUtils.lerp(0.0f, f4, fInterpolateProgress);
        float fLerp2 = 1.0f - AnimationUtils.lerp(0.0f, f10, fInterpolateProgress);
