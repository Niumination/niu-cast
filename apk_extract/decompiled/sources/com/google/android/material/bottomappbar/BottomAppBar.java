...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    private void createFabTranslationXAnimation(int i8, @NonNull List<Animator> list) {
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(findDependentFab(), "translationX", getFabTranslationX(i8));
        objectAnimatorOfFloat.setDuration(getFabAlignmentAnimationDuration());
        list.add(objectAnimatorOfFloat);
    }

    private void createMenuViewTranslationAnimation(final int i8, final boolean z2, @NonNull List<Animator> list) {
        ...
        if (Math.abs(actionMenuView.getTranslationX() - getActionMenuViewTranslationX(actionMenuView, i8, z2)) <= 1.0f) {
            ...
            objectAnimatorOfFloat.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.bottomappbar.BottomAppBar.7
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    BottomAppBar.this.translateActionMenuView(actionMenuView, i8, z2, z3);
                }
            });
    ...
    public float getFabTranslationX(int i8) {
        ...
        View viewFindDependentView = findDependentView();
        int i9 = zIsLayoutRtl ? this.leftInset : this.rightInset;
        return ((getMeasuredWidth() / 2) - ((this.fabAlignmentModeEndMargin == -1 || viewFindDependentView == null) ? this.fabOffsetEndMode + i9 : ((viewFindDependentView.getMeasuredWidth() / 2) + this.fabAlignmentModeEndMargin) + i9)) * (zIsLayoutRtl ? -1 : 1);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void maybeAnimateMenuView(int i8, boolean z2) {
        ...
        createMenuViewTranslationAnimation(i8, z2, arrayList);
        AnimatorSet animatorSet = new AnimatorSet();
    ...
    private void translateActionMenuView(@NonNull ActionMenuView actionMenuView, int i8, boolean z2) {
        translateActionMenuView(actionMenuView, i8, z2, false);
    }
    ...
    public void createFabDefaultXAnimation(final int i8, List<Animator> list) {
        FloatingActionButton floatingActionButtonFindDependentFab = findDependentFab();
    ...
    public int getActionMenuViewTranslationX(@NonNull ActionMenuView actionMenuView, int i8, boolean z2) {
        int i9 = 0;
        if (this.menuAlignmentMode != 1 && (i8 != 1 || !z2)) {
            return 0;
        }
        boolean zIsLayoutRtl = ViewUtils.isLayoutRtl(this);
        ...
        int i11 = zIsLayoutRtl ? this.rightInset : -this.leftInset;
    ...
    public void onLayout(boolean z2, int i8, int i9, int i10, int i11) {
        ...
        if (z2) {
            ...
            View viewFindDependentView = findDependentView();
            if (viewFindDependentView != null && ViewCompat.isLaidOut(viewFindDependentView)) {
                viewFindDependentView.post(new c(viewFindDependentView, 7));
            }
        }
    ...
    public boolean setFabDiameter(@Px int i8) {
        float f = i8;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void translateActionMenuView(@NonNull final ActionMenuView actionMenuView, final int i8, final boolean z2, boolean z3) {
        Runnable runnable = new Runnable() { // from class: com.google.android.material.bottomappbar.BottomAppBar.8
            @Override // java.lang.Runnable
            public void run() {
                ActionMenuView actionMenuView2 = actionMenuView;
                actionMenuView2.setTranslationX(BottomAppBar.this.getActionMenuViewTranslationX(actionMenuView2, i8, z2));
            }
        };
        if (z3) {
    ...
    public BottomAppBar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i8) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.BottomAppBar, i8, i9, new int[0]);
        ...
        ViewUtils.doOnApplyWindowInsets(this, attributeSet, i8, i9, new ViewUtils.OnApplyWindowInsetsListener() { // from class: com.google.android.material.bottomappbar.BottomAppBar.3
            ...
            public WindowInsetsCompat onApplyWindowInsets(View view, @NonNull WindowInsetsCompat windowInsetsCompat, @NonNull ViewUtils.RelativePadding relativePadding) {
                ...
                if (BottomAppBar.this.paddingLeftSystemWindowInsets) {
                    z3 = BottomAppBar.this.leftInset != windowInsetsCompat.getSystemWindowInsetLeft();
                ...
                if (BottomAppBar.this.paddingRightSystemWindowInsets) {
                    boolean z10 = BottomAppBar.this.rightInset != windowInsetsCompat.getSystemWindowInsetRight();
