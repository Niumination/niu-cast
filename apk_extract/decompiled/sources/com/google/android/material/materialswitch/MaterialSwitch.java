...
public class MaterialSwitch extends SwitchCompat {
    ...
    public void setThumbIconSize(@Px int i8) {
        if (this.thumbIconSize != i8) {
            this.thumbIconSize = i8;
            refreshThumbDrawable();
        }
    }
    ...
    public MaterialSwitch(@NonNull Context context, @Nullable AttributeSet attributeSet, int i8) {
        ...
        TintTypedArray tintTypedArrayObtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attributeSet, R.styleable.MaterialSwitch, i8, i9, new int[0]);
        ...
        int i10 = tintTypedArrayObtainTintedStyledAttributes.getInt(R.styleable.MaterialSwitch_thumbIconTintMode, -1);
        PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
        this.thumbIconTintMode = ViewUtils.parseTintMode(i10, mode);
