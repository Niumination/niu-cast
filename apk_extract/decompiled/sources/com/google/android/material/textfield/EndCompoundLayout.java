...
class EndCompoundLayout extends LinearLayout {
    ...
    public static class EndIconDelegates {
        ...
        private EndIconDelegate create(int i8) {
            ...
            throw new IllegalArgumentException(a1.a.o(i8, "Invalid end icon mode: "));
        }

        public EndIconDelegate get(int i8) {
            EndIconDelegate endIconDelegate = this.delegates.get(i8);
            if (endIconDelegate != null) {
                return endIconDelegate;
            }
            EndIconDelegate endIconDelegateCreate = create(i8);
            this.delegates.append(i8, endIconDelegateCreate);
