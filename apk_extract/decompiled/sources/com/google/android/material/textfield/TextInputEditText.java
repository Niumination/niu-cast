...
public class TextInputEditText extends AppCompatEditText {
    ...
    private String getAccessibilityNodeInfoText(@NonNull TextInputLayout textInputLayout) {
        ...
        sb2.append(TextUtils.isEmpty(string) ? "" : h0.a.i(", ", string));
        return sb2.toString();
    }
    ...
    public TextInputEditText(@NonNull Context context, @Nullable AttributeSet attributeSet, int i8) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, R.styleable.TextInputEditText, i8, R.style.Widget_Design_TextInputEditText, new int[0]);
