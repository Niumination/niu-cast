...
class CutoutDrawable extends MaterialShapeDrawable {
    ...
    public void setCutout(float f, float f4, float f10, float f11) {
        if (f == this.drawableState.cutoutBounds.left && f4 == this.drawableState.cutoutBounds.top && f10 == this.drawableState.cutoutBounds.right && f11 == this.drawableState.cutoutBounds.bottom) {
            return;
        }
        this.drawableState.cutoutBounds.set(f, f4, f10, f11);
        invalidateSelf();
    }
