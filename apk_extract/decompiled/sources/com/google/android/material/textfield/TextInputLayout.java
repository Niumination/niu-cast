...
public class TextInputLayout extends LinearLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private void assignBoxBackgroundByMode() {
        ...
        if (i8 == 0) {
            ...
            if (i8 != 2) {
                throw new IllegalArgumentException(h0.a.m(new StringBuilder(), " is illegal; only @BoxBackgroundMode constants are supported.", this.boxBackgroundMode));
            }
    ...
    private int getLabelLeftBoundAlignedWithPrefixAndSuffix(int i8, boolean z2) {
        ...
        if (!z2 && getPrefixText() != null) {
            ...
            if (!z2 || getSuffixText() == null) {
                return this.editText.getCompoundPaddingLeft() + i8;
            }
    ...
    private int getLabelRightBoundAlignedWithPrefixAndSuffix(int i8, boolean z2) {
        int compoundPaddingRight;
        if (z2 || getSuffixText() == null) {
            compoundPaddingRight = (!z2 || getPrefixText() == null) ? this.editText.getCompoundPaddingRight() : this.startLayout.getPrefixTextStartOffset();
        } else {
    ...
    private static Drawable getOutlinedBoxBackgroundWithRipple(Context context, MaterialShapeDrawable materialShapeDrawable, int i8, int[][] iArr) {
        ...
        int iLayer = MaterialColors.layer(i8, color, 0.1f);
    ...
    private static void updateCounterContentDescription(@NonNull Context context, @NonNull TextView textView, int i8, int i9, boolean z2) {
        textView.setContentDescription(context.getString(z2 ? R.string.character_counter_overflowed_content_description : R.string.character_counter_content_description, Integer.valueOf(i8), Integer.valueOf(i9)));
    }
    ...
    public void onGlobalLayout() {
        ...
        if (zUpdateEditTextHeightBasedOnIcon || zUpdateDummyDrawables) {
            this.editText.post(new a4.c(this, 13));
        }
    }
    ...
    public void setBoxCornerRadii(float f, float f4, float f10, float f11) {
        boolean zIsLayoutRtl = ViewUtils.isLayoutRtl(this);
        this.areCornerRadiiRtl = zIsLayoutRtl;
        float f12 = zIsLayoutRtl ? f4 : f;
        if (!zIsLayoutRtl) {
            f = f4;
        }
        float f13 = zIsLayoutRtl ? f11 : f10;
        if (!zIsLayoutRtl) {
            f10 = f11;
        }
        MaterialShapeDrawable materialShapeDrawable = this.boxBackground;
        if (materialShapeDrawable != null && materialShapeDrawable.getTopLeftCornerResolvedSize() == f12 && this.boxBackground.getTopRightCornerResolvedSize() == f && this.boxBackground.getBottomLeftCornerResolvedSize() == f13 && this.boxBackground.getBottomRightCornerResolvedSize() == f10) {
            return;
        }
        this.shapeAppearanceModel = this.shapeAppearanceModel.toBuilder().setTopLeftCornerSize(f12).setTopRightCornerSize(f).setBottomLeftCornerSize(f13).setBottomRightCornerSize(f10).build();
        applyBoxAttributes();
    }
    ...
    private void updateLabelState(boolean z2, boolean z3) {
        ...
        if (z10 || !this.expandedHintEnabled || (isEnabled() && z5)) {
    ...
    public TextInputLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i8) {
        ...
        TintTypedArray tintTypedArrayObtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attributeSet, R.styleable.TextInputLayout, i8, i9, R.styleable.TextInputLayout_counterTextAppearance, R.styleable.TextInputLayout_counterOverflowTextAppearance, R.styleable.TextInputLayout_errorTextAppearance, R.styleable.TextInputLayout_helperTextTextAppearance, R.styleable.TextInputLayout_hintTextAppearance);
        ...
        boolean z10 = tintTypedArrayObtainTintedStyledAttributes.getBoolean(R.styleable.TextInputLayout_android_enabled, true);
    ...
    public void updateCounter(@Nullable Editable editable) {
        ...
        if (i8 == -1) {
            ...
            this.counterOverflowed = iCountLength > i8;
