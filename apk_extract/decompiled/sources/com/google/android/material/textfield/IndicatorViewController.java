...
final class IndicatorViewController {
    ...
    public IndicatorViewController(@NonNull TextInputLayout textInputLayout) {
        ...
        this.captionFadeInAnimationInterpolator = MotionUtils.resolveThemeInterpolator(context, i8, timeInterpolator);
    ...
    private void createCaptionAnimators(@NonNull List<Animator> list, boolean z2, @Nullable TextView textView, int i8, int i9, int i10) {
        if (textView == null || !z2) {
            return;
        }
        if (i8 == i10 || i8 == i9) {
            ObjectAnimator objectAnimatorCreateCaptionOpacityAnimator = createCaptionOpacityAnimator(textView, i10 == i8);
            if (i8 == i10 && i9 != 0) {
    ...
    private int getIndicatorPadding(boolean z2, @DimenRes int i8, int i9) {
        return z2 ? this.context.getResources().getDimensionPixelSize(i8) : i9;
    }

    private boolean isCaptionStateError(int i8) {
        return (i8 != 1 || this.errorView == null || TextUtils.isEmpty(this.errorText)) ? false : true;
    }

    private boolean isCaptionStateHelperText(int i8) {
        return (i8 != 2 || this.helperTextView == null || TextUtils.isEmpty(this.helperText)) ? false : true;
    }
    ...
    private void updateCaptionViewsVisibility(final int i8, final int i9, boolean z2) {
        if (i8 == i9) {
            return;
        }
        if (z2) {
    ...
    public boolean isCaptionView(int i8) {
        return i8 == 0 || i8 == 1;
    }
