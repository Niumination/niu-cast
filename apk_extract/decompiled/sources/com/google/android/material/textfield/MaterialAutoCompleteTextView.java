...
public class MaterialAutoCompleteTextView extends AppCompatAutoCompleteTextView {
    ...
    public class MaterialArrayAdapter<T> extends ArrayAdapter<String> {
        ...
        public MaterialArrayAdapter(Context context, @NonNull int i8, String[] strArr) {
    ...
    public MaterialAutoCompleteTextView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i8) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, com.google.android.material.R.styleable.MaterialAutoCompleteTextView, i8, com.google.android.material.R.style.Widget_AppCompat_AutoCompleteTextView, new int[0]);
        ...
        listPopupWindow.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: com.google.android.material.textfield.MaterialAutoCompleteTextView.1
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i9, long j8) {
                ...
                MaterialAutoCompleteTextView.this.updateText(i9 < 0 ? materialAutoCompleteTextView.modalListPopup.getSelectedItem() : materialAutoCompleteTextView.getAdapter().getItem(i9));
                AdapterView.OnItemClickListener onItemClickListener = MaterialAutoCompleteTextView.this.getOnItemClickListener();
                if (onItemClickListener != null) {
                    if (view == null || i9 < 0) {
                        view = MaterialAutoCompleteTextView.this.modalListPopup.getSelectedView();
                        i9 = MaterialAutoCompleteTextView.this.modalListPopup.getSelectedItemPosition();
                        j8 = MaterialAutoCompleteTextView.this.modalListPopup.getSelectedItemId();
                    }
                    onItemClickListener.onItemClick(MaterialAutoCompleteTextView.this.modalListPopup.getListView(), view, i9, j8);
                }
