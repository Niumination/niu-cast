...
public class TextAppearance {
    ...
    public TextAppearance(@NonNull Context context, @StyleRes int i8) {
        ...
        TypedArray typedArrayObtainStyledAttributes2 = context.obtainStyledAttributes(i8, R.styleable.MaterialTextAppearance);
    ...
    public void updateDrawState(@NonNull Context context, @NonNull TextPaint textPaint, @NonNull TextAppearanceFontCallback textAppearanceFontCallback) {
        ...
        textPaint.setShadowLayer(f, f4, f10, colorStateList2 != null ? colorStateList2.getColorForState(textPaint.drawableState, colorStateList2.getDefaultColor()) : 0);
    }
