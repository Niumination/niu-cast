...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        private String getCheckedStateString() {
            ...
            if (i8 != 1) {
                return i8 != 2 ? "unchecked" : "indeterminate";
            }
            return "checked";
        }
        ...
        public String toString() {
            ...
            return a.n(sb2, getCheckedStateString(), "}");
        }
    ...
    private String getButtonStateDescription() {
        ...
        return i8 == 0 ? getResources().getString(R.string.mtrl_checkbox_state_description_unchecked) : getResources().getString(R.string.mtrl_checkbox_state_description_indeterminate);
    }
    ...
    public MaterialCheckBox(Context context, @Nullable AttributeSet attributeSet, int i8) {
        ...
        TintTypedArray tintTypedArrayObtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attributeSet, R.styleable.MaterialCheckBox, i8, i9, new int[0]);
