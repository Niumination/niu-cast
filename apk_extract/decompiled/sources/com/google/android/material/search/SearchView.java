...
public class SearchView extends FrameLayout implements CoordinatorLayout.AttachedBehavior, MaterialBackHandler {
    ...
    private void setUpBackButton(boolean z2, boolean z3) {
        ...
        this.toolbar.setNavigationOnClickListener(new b4.b(this, 2));
        if (z2) {
    ...
    private void setUpClearButton() {
        this.clearButton.setOnClickListener(new b4.b(this, 0));
    ...
    private void setUpContentOnTouchListener() {
        this.contentContainer.setOnTouchListener(new b4.f(this, 0));
    }
    ...
    private void setUpDividerInsetListener() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this.divider, new OnApplyWindowInsetsListener() { // from class: b4.a
            @Override // androidx.core.view.OnApplyWindowInsetsListener
            public final WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                return SearchView.lambda$setUpDividerInsetListener$6(marginLayoutParams, i8, i9, view, windowInsetsCompat);
            }
        });
    }
    ...
    private void setUpRootView() {
        this.rootView.setOnTouchListener(new b4.e(0));
    }
    ...
    private void setUpStatusBarSpacerInsetListener() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this.statusBarSpacer, new b4.d(this));
    }

    private void setUpToolbarInsetListener() {
        ViewUtils.doOnApplyWindowInsets(this.toolbar, new b4.d(this));
    }
    ...
    private void updateNavigationIconProgressIfNeeded() {
        ...
        if (drawableUnwrap instanceof DrawerArrowDrawable) {
            ((DrawerArrowDrawable) drawableUnwrap).setProgress(i8);
        }
        if (drawableUnwrap instanceof FadeThroughDrawable) {
            ((FadeThroughDrawable) drawableUnwrap).setProgress(i8);
        }
    }
    ...
    public void clearFocusAndHideKeyboard() {
        this.editText.post(new b4.c(this, 2));
    }
    ...
    public void requestFocusAndShowKeyboard() {
        this.editText.postDelayed(new b4.c(this, 0), TALKBACK_FOCUS_CHANGE_DELAY_MS);
    }
    ...
    public void setupWithSearchBar(@Nullable SearchBar searchBar) {
        ...
        if (searchBar != null) {
            searchBar.setOnClickListener(new b4.b(this, 1));
            if (Build.VERSION.SDK_INT >= 34) {
                try {
                    searchBar.setHandwritingDelegatorCallback(new b4.c(this, 1));
    ...
    public SearchView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i8) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.SearchView, i8, i9, new int[0]);
