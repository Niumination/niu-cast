...
public class SearchBar extends Toolbar {
    ...
    private ColorStateList getCompatBackgroundColorStateList(@ColorInt int i8, @ColorInt int i9) {
        ...
        int iLayer = MaterialColors.layer(i8, i9);
        return new ColorStateList(iArr, new int[]{iLayer, iLayer, i8});
    }

    private void initBackground(ShapeAppearanceModel shapeAppearanceModel, @ColorInt int i8, float f, float f4, @ColorInt int i9) {
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(shapeAppearanceModel);
        this.backgroundShape = materialShapeDrawable;
        materialShapeDrawable.initializeElevationOverlay(getContext());
        this.backgroundShape.setElevation(f);
        if (f4 >= 0.0f) {
            this.backgroundShape.setStroke(f4, i9);
        }
    ...
    private void setHandwritingBoundsInsets() {
        ...
        if (navigationIconButton == null || !navigationIconButton.isClickable()) {
            ...
            width = z2 ? getWidth() - navigationIconButton.getLeft() : navigationIconButton.getRight();
        }
        ActionMenuView actionMenuView = ToolbarUtils.getActionMenuView(this);
        if (actionMenuView != null) {
            right = z2 ? actionMenuView.getRight() : getWidth() - actionMenuView.getLeft();
        }
    ...
    public SearchBar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i8) {
        int i9 = DEF_STYLE_RES;
        super(MaterialThemeOverlay.wrap(context, attributeSet, i8, i9), attributeSet, i8);
        this.menuResId = -1;
        this.touchExplorationStateChangeListener = new a4.b(this, 2);
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.SearchBar, i8, i9, new int[0]);
        ShapeAppearanceModel shapeAppearanceModelBuild = ShapeAppearanceModel.builder(context2, attributeSet, i8, i9).build();
