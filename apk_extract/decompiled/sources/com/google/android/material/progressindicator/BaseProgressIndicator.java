...
public abstract class BaseProgressIndicator<S extends BaseProgressIndicatorSpec> extends ProgressBar {
    ...
    public BaseProgressIndicator(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i8, @StyleRes int i9) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.BaseProgressIndicator, i8, i9, new int[0]);
    ...
    public void hide() {
        ...
        if (jUptimeMillis >= i8) {
            ...
            postDelayed(this.delayedHide, ((long) i8) - jUptimeMillis);
        }
    }
    ...
    public synchronized void onMeasure(int i8, int i9) {
        try {
            ...
            setMeasuredDimension(currentDrawingDelegate.getPreferredWidth() < 0 ? ProgressBar.getDefaultSize(getSuggestedMinimumWidth(), i8) : currentDrawingDelegate.getPreferredWidth() + getPaddingLeft() + getPaddingRight(), currentDrawingDelegate.getPreferredHeight() < 0 ? ProgressBar.getDefaultSize(getSuggestedMinimumHeight(), i9) : currentDrawingDelegate.getPreferredHeight() + getPaddingTop() + getPaddingBottom());
        } catch (Throwable th2) {
            throw th2;
        }
    }
    ...
    public void setIndicatorTrackGapSize(@Px int i8) {
        S s2 = this.spec;
        if (s2.indicatorTrackGapSize != i8) {
            s2.indicatorTrackGapSize = i8;
            s2.validateSpec();
            invalidate();
        }
    }
    ...
    public void setTrackCornerRadius(@Px int i8) {
        S s2 = this.spec;
        if (s2.trackCornerRadius != i8) {
            s2.trackCornerRadius = Math.min(i8, s2.trackThickness / 2);
            invalidate();
        }
    }
    ...
    public void setTrackThickness(@Px int i8) {
        S s2 = this.spec;
        if (s2.trackThickness != i8) {
            s2.trackThickness = i8;
            requestLayout();
        }
    }
