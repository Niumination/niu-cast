...
public final class CircularProgressIndicatorSpec extends BaseProgressIndicatorSpec {
    ...
    public int getIndicatorTrackGapSizeDegree() {
        int i8 = this.indicatorTrackGapSize;
        if (i8 == 0) {
            return 0;
        }
        return (int) Math.round(360.0d / ((((double) ((this.indicatorSize - (this.indicatorInset * 2)) - this.trackThickness)) * 3.141592653589793d) / ((double) (i8 + this.trackCornerRadius))));
    }
    ...
    public CircularProgressIndicatorSpec(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i8, @StyleRes int i9) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, R.styleable.CircularProgressIndicator, i8, i9, new int[0]);
