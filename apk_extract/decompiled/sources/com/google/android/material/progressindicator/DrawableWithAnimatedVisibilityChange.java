...
abstract class DrawableWithAnimatedVisibilityChange extends Drawable implements Animatable2Compat {
    ...
    @VisibleForTesting
    public void setMockHideAnimationRunning(boolean z2, @FloatRange(from = 0.0d, to = Contrast.RATIO_MIN) float f) {
        this.mockHideAnimationRunning = z2;
        this.mockGrowFraction = f;
    }

    @VisibleForTesting
    public void setMockShowAnimationRunning(boolean z2, @FloatRange(from = 0.0d, to = Contrast.RATIO_MIN) float f) {
    ...
    public boolean setVisibleInternal(boolean z2, boolean z3, boolean z5) {
    ...
    public boolean setVisible(boolean z2, boolean z3, boolean z5) {
        return setVisibleInternal(z2, z3, z5 && this.animatorDurationScaleProvider.getSystemAnimatorDurationScale(this.context.getContentResolver()) > 0.0f);
    }
}
