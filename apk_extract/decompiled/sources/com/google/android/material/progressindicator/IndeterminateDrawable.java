...
public final class IndeterminateDrawable<S extends BaseProgressIndicatorSpec> extends DrawableWithAnimatedVisibilityChange {
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        if (!getBounds().isEmpty() && isVisible() && canvas.getClipBounds(rect)) {
            ...
            if (i8 == 0) {
                ...
                DrawingDelegate.ActiveIndicator activeIndicator2 = (DrawingDelegate.ActiveIndicator) a.j(1, this.animatorDelegate.activeIndicators);
    ...
    @Override // com.google.android.material.progressindicator.DrawableWithAnimatedVisibilityChange, android.graphics.drawable.Drawable
    public /* bridge */ /* synthetic */ void setAlpha(@IntRange(from = 0, to = ScatterMapKt.Sentinel) int i8) {
        super.setAlpha(i8);
    }
    ...
    public boolean setVisibleInternal(boolean z2, boolean z3, boolean z5) {
        Drawable drawable;
        boolean visibleInternal = super.setVisibleInternal(z2, z3, z5);
        if (isSystemAnimatorDisabled() && (drawable = this.staticDummyDrawable) != null) {
    ...
    @Override // com.google.android.material.progressindicator.DrawableWithAnimatedVisibilityChange
    public /* bridge */ /* synthetic */ boolean setVisible(boolean z2, boolean z3, boolean z5) {
        return super.setVisible(z2, z3, z5);
    }
}
