...
public class SingleDateSelector implements DateSelector<Long> {
    ...
    public String getSelectionContentDescription(@NonNull Context context) {
        ...
        Long l4 = this.selectedItem;
        return resources.getString(R.string.mtrl_picker_announce_current_selection, l4 == null ? resources.getString(R.string.mtrl_picker_announce_current_selection_none) : DateStrings.getYearMonthDay(l4.longValue()));
    }
    ...
    public String getSelectionDisplayString(@NonNull Context context) {
        ...
        return resources.getString(R.string.mtrl_picker_date_header_selected, DateStrings.getYearMonthDay(l4.longValue()));
    }
    ...
    public void setSelection(@Nullable Long l4) {
        this.selectedItem = l4 == null ? null : Long.valueOf(UtcDates.canonicalYearMonthDay(l4.longValue()));
    }
}
