...
final class CalendarItemStyle {
    ...
    @NonNull
    public static CalendarItemStyle create(@NonNull Context context, @StyleRes int i8) {
        Preconditions.checkArgument(i8 != 0, "Cannot create a CalendarItemStyle with a styleResId of 0");
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(i8, R.styleable.MaterialCalendarItem);
