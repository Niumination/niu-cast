...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    private void enableEdgeToEdgeIfNeeded(Window window) {
        ...
        final int i8 = viewFindViewById.getLayoutParams().height;
        ViewCompat.setOnApplyWindowInsetsListener(viewFindViewById, new OnApplyWindowInsetsListener() { // from class: com.google.android.material.datepicker.MaterialDatePicker.3
            ...
            public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                ...
                if (i8 >= 0) {
                    viewFindViewById.getLayoutParams().height = i8 + i9;
                    View view2 = viewFindViewById;
                    view2.setLayoutParams(view2.getLayoutParams());
                }
                View view3 = viewFindViewById;
                view3.setPadding(view3.getPaddingLeft(), paddingTop + i9, viewFindViewById.getPaddingRight(), viewFindViewById.getPaddingBottom());
    ...
    private static int getPaddedPickerWidth(@NonNull Context context) {
        ...
        return ((i8 - 1) * resources.getDimensionPixelOffset(com.google.android.material.R.dimen.mtrl_calendar_month_horizontal_padding)) + (resources.getDimensionPixelSize(com.google.android.material.R.dimen.mtrl_calendar_day_width) * i8) + (dimensionPixelOffset * 2);
    }
    ...
    private void initHeaderToggle(Context context) {
        ...
        this.headerToggleButton.setOnClickListener(new ce.a(this, 11));
    }
    ...
    public static boolean readMaterialCalendarStyleBoolean(@NonNull Context context, int i8) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, com.google.android.material.R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{i8});
    ...
    public final Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(null, com.google.android.material.R.styleable.MaterialCalendar, com.google.android.material.R.attr.materialCalendarStyle, com.google.android.material.R.style.Widget_MaterialComponents_MaterialCalendar);
    ...
    public static final class Builder<S> {
        ...
        @NonNull
        public Builder<S> setInputMode(int i8) {
            this.inputMode = i8;
            return this;
        }

        @NonNull
        public Builder<S> setNegativeButtonContentDescription(@StringRes int i8) {
            this.negativeButtonContentDescriptionResId = i8;
            this.negativeButtonContentDescription = null;
            return this;
        }

        @NonNull
        public Builder<S> setNegativeButtonText(@StringRes int i8) {
        ...
        @NonNull
        public Builder<S> setPositiveButtonContentDescription(@StringRes int i8) {
            this.positiveButtonContentDescriptionResId = i8;
            this.positiveButtonContentDescription = null;
            return this;
        }

        @NonNull
        public Builder<S> setPositiveButtonText(@StringRes int i8) {
        ...
        @NonNull
        public Builder<S> setTheme(@StyleRes int i8) {
            this.overrideThemeResId = i8;
            return this;
        }

        @NonNull
        public Builder<S> setTitleText(@StringRes int i8) {
