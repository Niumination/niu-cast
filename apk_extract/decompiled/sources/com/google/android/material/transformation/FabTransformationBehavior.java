...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private void calculateChildVisibleBoundsAtEndOfExpansion(@NonNull View view, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull MotionTiming motionTiming, @NonNull MotionTiming motionTiming2, float f, float f4, float f10, float f11, @NonNull RectF rectF) {
        float fCalculateValueOfAnimationAtEndOfExpansion = calculateValueOfAnimationAtEndOfExpansion(fabTransformationSpec, motionTiming, f, f10);
        float fCalculateValueOfAnimationAtEndOfExpansion2 = calculateValueOfAnimationAtEndOfExpansion(fabTransformationSpec, motionTiming2, f4, f11);
    ...
    @NonNull
    private Pair<MotionTiming, MotionTiming> calculateMotionTiming(float f, float f4, boolean z2, @NonNull FabTransformationSpec fabTransformationSpec) {
        MotionTiming timing;
    ...
    private float calculateTranslationY(@NonNull View view, @NonNull View view2, @NonNull Positioning positioning) {
        ...
        calculateDependencyWindowBounds(view, rectF);
        calculateWindowBounds(view2, rectF2);
        int i8 = positioning.gravity & DeviceType.INFRARED_HEATER;
        if (i8 == 16) {
    ...
    private float calculateValueOfAnimationAtEndOfExpansion(@NonNull FabTransformationSpec fabTransformationSpec, @NonNull MotionTiming motionTiming, float f, float f4) {
        long delay = motionTiming.getDelay();
        long duration = motionTiming.getDuration();
        MotionTiming timing = fabTransformationSpec.timings.getTiming("expansion");
        return AnimationUtils.lerp(f, f4, motionTiming.getInterpolator().getInterpolation((((timing.getDuration() + timing.getDelay()) + 17) - delay) / duration));
    }
    ...
    private void createColorAnimation(@NonNull View view, View view2, boolean z2, boolean z3, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof CircularRevealWidget) {
            ...
            if (z2) {
                ...
                objectAnimatorOfInt = ObjectAnimator.ofInt(circularRevealWidget, CircularRevealWidget.CircularRevealScrimColorProperty.CIRCULAR_REVEAL_SCRIM_COLOR, i8);
            } else {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    private void createExpansionAnimation(@NonNull View view, View view2, boolean z2, boolean z3, @NonNull FabTransformationSpec fabTransformationSpec, float f, float f4, @NonNull List<Animator> list, @NonNull List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof CircularRevealWidget) {
            ...
            if (z2) {
                ...
                animatorCreateCircularReveal = CircularRevealCompat.createCircularReveal(circularRevealWidget, fCalculateRevealCenterX, fCalculateRevealCenterY, MathUtils.distanceToFurthestCorner(fCalculateRevealCenterX, fCalculateRevealCenterY, 0.0f, 0.0f, f, f4));
                ...
                int i8 = (int) fCalculateRevealCenterX;
                int i9 = (int) fCalculateRevealCenterY;
                createPreFillRadialExpansion(view2, timing.getDelay(), i8, i9, f10, list);
                createPostFillRadialExpansion(view2, timing.getDelay(), timing.getDuration(), fabTransformationSpec.timings.getTotalDuration(), i8, i9, fWidth, list);
    ...
    private void createPostFillRadialExpansion(View view, long j8, long j10, long j11, int i8, int i9, float f, @NonNull List<Animator> list) {
        long j12 = j8 + j10;
        if (j12 < j11) {
            Animator animatorCreateCircularReveal = ViewAnimationUtils.createCircularReveal(view, i8, i9, f, f);
    ...
    private void createPreFillRadialExpansion(View view, long j8, int i8, int i9, float f, @NonNull List<Animator> list) {
        if (j8 > 0) {
            Animator animatorCreateCircularReveal = ViewAnimationUtils.createCircularReveal(view, i8, i9, f, f);
