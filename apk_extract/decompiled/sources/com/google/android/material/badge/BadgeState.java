...
public final class BadgeState {
    ...
    public BadgeState(Context context, @XmlRes int i8, @AttrRes int i9, @StyleRes int i10, @Nullable State state) {
        ...
        TypedArray typedArrayGenerateTypedArray = generateTypedArray(context, state.badgeResId, i9, i10);
    ...
    private TypedArray generateTypedArray(Context context, @XmlRes int i8, @AttrRes int i9, @StyleRes int i10) {
        ...
        int styleAttribute;
        if (i8 != 0) {
            drawableXml = DrawableUtils.parseDrawableXml(context, i8, BADGE_RESOURCE_TAG);
            styleAttribute = drawableXml.getStyleAttribute();
        } else {
            drawableXml = null;
            styleAttribute = 0;
        }
        return ThemeEnforcement.obtainStyledAttributes(context, drawableXml, R.styleable.Badge, i9, styleAttribute == 0 ? i10 : styleAttribute, new int[0]);
    }
