...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private void autoAdjustWithinGrandparentBounds(@NonNull View view) {
        ...
        if (customBadgeParent == null) {
            ...
            y3 = customBadgeParent.getY();
            x2 = customBadgeParent.getX();
            customBadgeParent = (View) customBadgeParent.getParent();
        }
        float topCutOff = getTopCutOff(customBadgeParent, y3);
        float leftCutOff = getLeftCutOff(customBadgeParent, x2);
        float bottomCutOff = getBottomCutOff(customBadgeParent, y3);
    ...
    public CharSequence getContentDescription() {
        ...
        return hasNumber() ? getNumberContentDescription() : getEmptyContentDescription();
    }
