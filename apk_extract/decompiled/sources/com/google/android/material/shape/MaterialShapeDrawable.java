...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
    ...
    private void drawCompatShadow(@NonNull Canvas canvas) {
        ...
        for (int i8 = 0; i8 < 4; i8++) {
            this.cornerShadowOperation[i8].draw(this.shadowRenderer, this.drawableState.shadowCompatRadius, canvas);
            this.edgeShadowOperation[i8].draw(this.shadowRenderer, this.drawableState.shadowCompatRadius, canvas);
        }
    ...
    private boolean hasCompatShadow() {
        ...
        return i8 != 1 && materialShapeDrawableState.shadowCompatRadius > 0 && (i8 == 2 || requiresCompatShadow());
    }
    ...
    private static int modulateAlpha(int i8, int i9) {
        return ((i9 + (i9 >>> 7)) * i8) >>> 8;
    }
    ...
    public boolean isShadowEnabled() {
        int i8 = this.drawableState.shadowCompatMode;
        return i8 == 0 || i8 == 2;
    }
    ...
    @Override // android.graphics.drawable.Drawable
    public void setAlpha(@IntRange(from = 0, to = ScatterMapKt.Sentinel) int i8) {
        MaterialShapeDrawableState materialShapeDrawableState = this.drawableState;
        if (materialShapeDrawableState.alpha != i8) {
            materialShapeDrawableState.alpha = i8;
            invalidateSelfIgnoreShape();
        }
    }
    ...
    public void setPadding(int i8, int i9, int i10, int i11) {
        ...
        this.drawableState.padding.set(i8, i9, i10, i11);
        invalidateSelf();
    }
    ...
    public void setShadowColor(int i8) {
        this.shadowRenderer.setShadowColor(i8);
    ...
    public void setShadowCompatRotation(int i8) {
        MaterialShapeDrawableState materialShapeDrawableState = this.drawableState;
        if (materialShapeDrawableState.shadowCompatRotation != i8) {
            materialShapeDrawableState.shadowCompatRotation = i8;
            invalidateSelfIgnoreShape();
        }
    }
    ...
    public void setShadowCompatibilityMode(int i8) {
        MaterialShapeDrawableState materialShapeDrawableState = this.drawableState;
        if (materialShapeDrawableState.shadowCompatMode != i8) {
            materialShapeDrawableState.shadowCompatMode = i8;
            invalidateSelfIgnoreShape();
        }
    }
    ...
    public void setShadowRadius(int i8) {
        this.drawableState.shadowCompatRadius = i8;
    }

    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public void setShadowVerticalOffset(int i8) {
        MaterialShapeDrawableState materialShapeDrawableState = this.drawableState;
        if (materialShapeDrawableState.shadowCompatOffset != i8) {
            materialShapeDrawableState.shadowCompatOffset = i8;
            invalidateSelfIgnoreShape();
        }
    }
    ...
    public void setStroke(float f, @ColorInt int i8) {
        setStrokeWidth(f);
    ...
    public MaterialShapeDrawable(@NonNull MaterialShapeDrawableState materialShapeDrawableState) {
        ...
        this.pathShadowListener = new ShapeAppearancePathProvider.PathListener() { // from class: com.google.android.material.shape.MaterialShapeDrawable.1
            ...
            public void onCornerPathCreated(@NonNull ShapePath shapePath, Matrix matrix, int i8) {
                MaterialShapeDrawable.this.containsIncompatibleShadowOp.set(i8, shapePath.containsIncompatibleShadowOp());
                MaterialShapeDrawable.this.cornerShadowOperation[i8] = shapePath.createShadowCompatOperation(matrix);
            }

            @Override // com.google.android.material.shape.ShapeAppearancePathProvider.PathListener
            public void onEdgePathCreated(@NonNull ShapePath shapePath, Matrix matrix, int i8) {
                MaterialShapeDrawable.this.containsIncompatibleShadowOp.set(i8 + 4, shapePath.containsIncompatibleShadowOp());
                MaterialShapeDrawable.this.edgeShadowOperation[i8] = shapePath.createShadowCompatOperation(matrix);
            }
        };
    }
