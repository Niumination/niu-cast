...
public class SideSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> implements Sheet<SideSheetCallback> {
    ...
    public SideSheetBehavior() {
        ...
        this.dragCallback = new ViewDragHelper.Callback() { // from class: com.google.android.material.sidesheet.SideSheetBehavior.1
            ...
            public void onViewReleased(@NonNull View view, float f, float f4) {
                int iCalculateTargetStateOnViewReleased = SideSheetBehavior.this.calculateTargetStateOnViewReleased(view, f, f4);
    ...
    private int calculateCurrentOffset(int i8, V v3) {
        int i9 = this.state;
        if (i9 == 1 || i9 == 2) {
            return i8 - this.sheetDelegate.getOuterEdge(v3);
        }
        if (i9 == 3) {
            return 0;
        }
    ...
    private float calculateDragDistance(float f, float f4) {
        return Math.abs(f - f4);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public int calculateTargetStateOnViewReleased(@NonNull View view, float f, float f4) {
        if (isExpandingOutwards(f)) {
            return 3;
        }
        if (shouldHide(view, f)) {
            if (!this.sheetDelegate.isSwipeSignificant(f, f4) && !this.sheetDelegate.isReleasedCloseToInnerEdge(view)) {
                return 3;
            }
        } else if (f == 0.0f || !SheetUtils.isSwipeMostlyHorizontal(f, f4)) {
    ...
    private AccessibilityViewCommand createAccessibilityViewCommandForState(int i8) {
        return new c4.a(this, i8);
    }
    ...
    public void dispatchOnSlide(@NonNull View view, int i8) {
        ...
        float fCalculateSlideOffset = this.sheetDelegate.calculateSlideOffset(i8);
    ...
    private ValueAnimator.AnimatorUpdateListener getCoplanarFinishAnimatorUpdateListener() {
        ...
        return new ValueAnimator.AnimatorUpdateListener() { // from class: c4.b
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                View view = coplanarSiblingView;
                this.f1429a.lambda$getCoplanarFinishAnimatorUpdateListener$1(marginLayoutParams, coplanarSiblingAdjacentMargin, view, valueAnimator);
            }
        };
    }
    ...
    private CoordinatorLayout.LayoutParams getViewLayoutParams() {
        ...
        return (CoordinatorLayout.LayoutParams) v3.getLayoutParams();
    }
    ...
    private boolean isLayingOut(@NonNull V v3) {
        ViewParent parent = v3.getParent();
        return parent != null && parent.isLayoutRequested() && ViewCompat.isAttachedToWindow(v3);
    }

    private boolean isSettling(View view, int i8, boolean z2) {
    ...
    private void maybeAssignCoplanarSiblingViewBasedId(@NonNull CoordinatorLayout coordinatorLayout) {
        ...
        if (this.coplanarSiblingViewRef != null || (i8 = this.coplanarSiblingViewId) == -1 || (viewFindViewById = coordinatorLayout.findViewById(i8)) == null) {
            return;
        }
        this.coplanarSiblingViewRef = new WeakReference<>(viewFindViewById);
    }

    private void replaceAccessibilityActionForState(V v3, AccessibilityNodeInfoCompat.AccessibilityActionCompat accessibilityActionCompat, int i8) {
        ViewCompat.replaceAccessibilityAction(v3, accessibilityActionCompat, null, createAccessibilityViewCommandForState(i8));
    }
    ...
    private void runAfterLayout(@NonNull V v3, Runnable runnable) {
        if (isLayingOut(v3)) {
            v3.post(runnable);
        } else {
            runnable.run();
    ...
    private void setSheetEdge(@NonNull V v3, int i8) {
        setSheetEdge(GravityCompat.getAbsoluteGravity(((CoordinatorLayout.LayoutParams) v3.getLayoutParams()).gravity, i8) == 3 ? 1 : 0);
    }
    ...
    private boolean shouldInterceptTouchEvent(@NonNull V v3) {
        return (v3.isShown() || ViewCompat.getAccessibilityPaneTitle(v3) != null) && this.draggable;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void startSettling(View view, int i8, boolean z2) {
        if (!isSettling(view, i8, z2)) {
            setStateInternal(i8);
        } else {
            setStateInternal(2);
    ...
    public int getOuterEdgeOffsetForState(int i8) {
        ...
        throw new IllegalArgumentException(a1.a.o(i8, "Invalid state to get outer edge offset: "));
    }
    ...
    public boolean onLayoutChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v3, int i8) {
        ...
        ViewCompat.offsetLeftAndRight(v3, calculateCurrentOffset(outerEdge, v3));
    ...
    public boolean onMeasureChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v3, int i8, int i9, int i10, int i11) {
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) v3.getLayoutParams();
        v3.measure(getChildMeasureSpec(i8, coordinatorLayout.getPaddingRight() + coordinatorLayout.getPaddingLeft() + marginLayoutParams.leftMargin + marginLayoutParams.rightMargin + i9, -1, marginLayoutParams.width), getChildMeasureSpec(i10, coordinatorLayout.getPaddingBottom() + coordinatorLayout.getPaddingTop() + marginLayoutParams.topMargin + marginLayoutParams.bottomMargin + i11, -1, marginLayoutParams.height));
        return true;
    }
    ...
    public void setCoplanarSiblingViewId(@IdRes int i8) {
        ...
        if (weakReference != null) {
            V v3 = weakReference.get();
            if (i8 == -1 || !ViewCompat.isLaidOut(v3)) {
                return;
            }
            v3.requestLayout();
        }
    ...
    public void setState(int i8) {
        ...
        if (weakReference == null || weakReference.get() == null) {
            ...
            runAfterLayout(this.viewRef.get(), new b0.b(i8, 1, this));
        }
    }
    ...
    private void setSheetEdge(int i8) {
        ...
        if (sheetDelegate == null || sheetDelegate.getSheetEdge() != i8) {
            ...
            throw new IllegalArgumentException(h0.a.h(i8, "Invalid sheet edge position value: ", ". Must be 0 or 1."));
        }
    }
