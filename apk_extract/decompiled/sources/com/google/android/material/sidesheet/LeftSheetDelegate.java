...
final class LeftSheetDelegate extends SheetDelegate {
    ...
    @Override // com.google.android.material.sidesheet.SheetDelegate
    public <V extends View> int getOuterEdge(@NonNull V v3) {
    ...
    @Override // com.google.android.material.sidesheet.SheetDelegate
    public boolean isSwipeSignificant(float f, float f4) {
        return SheetUtils.isSwipeMostlyHorizontal(f, f4) && Math.abs(f) > ((float) this.sheetBehavior.getSignificantVelocityThreshold());
    }
