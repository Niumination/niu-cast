...
public class BottomNavigationMenuView extends NavigationBarMenuView {
    ...
    public void onMeasure(int i8, int i9) {
        ...
        if (isShifting(getLabelVisibilityMode(), size2) && isItemHorizontalTranslationEnabled()) {
            ...
            int i13 = size - iMin;
            int iMin2 = Math.min(i13 / (i12 != 0 ? i12 : 1), this.inactiveItemMaxWidth);
            int i14 = i13 - (i12 * iMin2);
            int i15 = 0;
            while (i15 < childCount) {
                if (getChildAt(i15).getVisibility() != 8) {
                    i11 = i15 == getSelectedItemPosition() ? iMin : iMin2;
                    if (i14 > 0) {
                        i11++;
                        i14--;
                    }
        ...
        for (int i18 = 0; i18 < childCount; i18++) {
            ...
            if (childAt2.getVisibility() != 8) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec(this.tempChildWidths.get(i18).intValue(), BasicMeasure.EXACTLY), iMakeMeasureSpec);
