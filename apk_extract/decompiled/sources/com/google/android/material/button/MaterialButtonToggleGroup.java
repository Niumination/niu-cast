...
public class MaterialButtonToggleGroup extends LinearLayout {
    ...
    public interface OnButtonCheckedListener {
        void onButtonChecked(MaterialButtonToggleGroup materialButtonToggleGroup, @IdRes int i8, boolean z2);
    }
    ...
    private void adjustChildMarginsAndUpdateLayout() {
        ...
        for (int i8 = firstVisibleChildIndex + 1; i8 < getChildCount(); i8++) {
            ...
            int iMin = Math.min(childButton.getStrokeWidth(), getChildButton(i8 - 1).getStrokeWidth());
    ...
    private void checkInternal(@IdRes int i8, boolean z2) {
        if (i8 == -1) {
    ...
    private void dispatchOnButtonChecked(@IdRes int i8, boolean z2) {
        Iterator<OnButtonCheckedListener> it = this.onButtonCheckedListeners.iterator();
        while (it.hasNext()) {
            it.next().onButtonChecked(this, i8, z2);
        }
    }
    ...
    private void setCheckedStateForView(@IdRes int i8, boolean z2) {
    ...
    private void updateCheckedIds(Set<Integer> set) {
        ...
        for (int i8 = 0; i8 < getChildCount(); i8++) {
            int id2 = getChildButton(i8).getId();
    ...
    private void updateChildrenA11yClassName() {
        for (int i8 = 0; i8 < getChildCount(); i8++) {
            getChildButton(i8).setA11yClassName((this.singleSelection ? RadioButton.class : ToggleButton.class).getName());
        }
    }
    ...
    public void setEnabled(boolean z2) {
        super.setEnabled(z2);
        for (int i8 = 0; i8 < getChildCount(); i8++) {
            getChildButton(i8).setEnabled(z2);
        }
    }
    ...
    public MaterialButtonToggleGroup(@NonNull Context context, @Nullable AttributeSet attributeSet, int i8) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, R.styleable.MaterialButtonToggleGroup, i8, i9, new int[0]);
