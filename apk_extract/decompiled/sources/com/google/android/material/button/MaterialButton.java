...
public class MaterialButton extends AppCompatButton implements Checkable, Shapeable {
    ...
    private int getTextLayoutWidth() {
        ...
        for (int i8 = 0; i8 < lineCount; i8++) {
            fMax = Math.max(fMax, getLayout().getLineWidth(i8));
        }
    ...
    private void updateIconPosition(int i8, int i9) {
        ...
        if (!isIconStart() && !isIconEnd()) {
            if (isIconTop()) {
                ...
                int iMax = Math.max(0, (((((i9 - getTextHeight()) - getPaddingTop()) - intrinsicHeight) - this.iconPadding) - getPaddingBottom()) / 2);
        ...
        int textLayoutWidth = ((((i8 - getTextLayoutWidth()) - ViewCompat.getPaddingEnd(this)) - intrinsicWidth) - this.iconPadding) - ViewCompat.getPaddingStart(this);
    ...
    public MaterialButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i8) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, com.google.android.material.R.styleable.MaterialButton, i8, i9, new int[0]);
        ...
        MaterialButtonHelper materialButtonHelper = new MaterialButtonHelper(this, ShapeAppearanceModel.builder(context2, attributeSet, i8, i9).build());
