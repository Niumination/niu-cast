...
class MaterialButtonHelper {
    ...
    private void setVerticalInsets(@Dimension int i8, @Dimension int i9) {
        ...
        ViewCompat.setPaddingRelative(this.materialButton, paddingStart, (paddingTop + i8) - i10, paddingEnd, (paddingBottom + i9) - i11);
    }
    ...
    public void updateMaskBounds(int i8, int i9) {
