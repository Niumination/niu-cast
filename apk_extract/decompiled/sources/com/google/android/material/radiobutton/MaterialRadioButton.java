...
public class MaterialRadioButton extends AppCompatRadioButton {
    ...
    public MaterialRadioButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i8) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.MaterialRadioButton, i8, i9, new int[0]);
