...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    public void performMotion(int i8, @Nullable final OnChangedCallback onChangedCallback) {
        ...
        if (i8 == 0) {
            ...
            if (i8 != 3) {
                throw new IllegalStateException(a.o(i8, "Unknown strategy type: "));
            }
    ...
    public ExtendedFloatingActionButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i8) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.ExtendedFloatingActionButton, i8, i9, new int[0]);
        ...
        int i10 = typedArrayObtainStyledAttributes.getInt(R.styleable.ExtendedFloatingActionButton_extendStrategy, 1);
