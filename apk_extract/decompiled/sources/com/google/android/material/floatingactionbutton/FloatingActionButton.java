...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable, CoordinatorLayout.AttachedBehavior {
    ...
    public static class BaseBehavior<T extends FloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        private void offsetIfNeeded(@NonNull CoordinatorLayout coordinatorLayout, @NonNull FloatingActionButton floatingActionButton) {
            ...
            if (floatingActionButton.getRight() >= coordinatorLayout.getWidth() - ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin) {
                ...
                i8 = floatingActionButton.getLeft() <= ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin ? -rect.left : 0;
            }
    ...
    public class ShadowDelegateImpl implements ShadowViewDelegate {
        ...
        public void setShadowPadding(int i8, int i9, int i10, int i11) {
            ...
            floatingActionButton.setPadding(floatingActionButton.imagePadding + i8, FloatingActionButton.this.imagePadding + i9, FloatingActionButton.this.imagePadding + i10, FloatingActionButton.this.imagePadding + i11);
        }
    }
    ...
    public void onMeasure(int i8, int i9) {
        ...
        int iMin = Math.min(View.resolveSize(sizeDimension, i8), View.resolveSize(sizeDimension, i9));
    ...
    public FloatingActionButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i8) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.FloatingActionButton, i8, i9, new int[0]);
        ...
        ShapeAppearanceModel shapeAppearanceModelBuild = ShapeAppearanceModel.builder(context2, attributeSet, i8, i9, ShapeAppearanceModel.PILL).build();
