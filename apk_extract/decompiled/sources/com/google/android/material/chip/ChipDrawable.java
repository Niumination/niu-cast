...
public class ChipDrawable extends MaterialShapeDrawable implements TintAwareDrawable, Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    public static ChipDrawable createFromResource(@NonNull Context context, @XmlRes int i8) {
        AttributeSet drawableXml = DrawableUtils.parseDrawableXml(context, i8, "chip");
    ...
    private void drawChipStroke(@NonNull Canvas canvas, @NonNull Rect rect) {
        ...
        rectF.set((f4 / 2.0f) + f, (f4 / 2.0f) + rect.top, rect.right - (f4 / 2.0f), rect.bottom - (f4 / 2.0f));
    ...
    private void loadFromAttributes(@Nullable AttributeSet attributeSet, @AttrRes int i8, @StyleRes int i9) {
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(this.context, attributeSet, com.google.android.material.R.styleable.Chip, i8, i9, new int[0]);
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        int i8 = this.alpha;
        int iSaveLayerAlpha = i8 < 255 ? CanvasCompat.saveLayerAlpha(canvas, bounds.left, bounds.top, bounds.right, bounds.bottom, i8) : 0;
    ...
    public boolean onLayoutDirectionChanged(int i8) {
        ...
        if (showsChipIcon()) {
            zOnLayoutDirectionChanged |= DrawableCompat.setLayoutDirection(this.chipIcon, i8);
        }
        if (showsCheckedIcon()) {
            zOnLayoutDirectionChanged |= DrawableCompat.setLayoutDirection(this.checkedIcon, i8);
        }
        if (showsCloseIcon()) {
            zOnLayoutDirectionChanged |= DrawableCompat.setLayoutDirection(this.closeIcon, i8);
        }
    ...
    public boolean onLevelChange(int i8) {
        ...
        if (showsChipIcon()) {
            zOnLevelChange |= this.chipIcon.setLevel(i8);
        }
        if (showsCheckedIcon()) {
            zOnLevelChange |= this.checkedIcon.setLevel(i8);
        }
        if (showsCloseIcon()) {
            zOnLevelChange |= this.closeIcon.setLevel(i8);
        }
        if (zOnLevelChange) {
            invalidateSelf();
        }
