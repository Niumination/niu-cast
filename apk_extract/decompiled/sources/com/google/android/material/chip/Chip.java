...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable, MaterialCheckable<Chip> {
    ...
    public class ChipTouchHelper extends ExploreByTouchHelper {
        ...
        public int getVirtualViewAt(float f, float f4) {
            return (Chip.this.hasCloseIcon() && Chip.this.getCloseIconTouchBounds().contains(f, f4)) ? 1 : 0;
        }
    ...
    private void initMinTouchTarget(Context context, @Nullable AttributeSet attributeSet, int i8) {
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, R.styleable.Chip, i8, DEF_STYLE_RES, new int[0]);
    ...
    public boolean ensureAccessibleTouchTarget(@Dimension int i8) {
        ...
        int iMax = Math.max(0, i8 - this.chipDrawable.getIntrinsicHeight());
        int iMax2 = Math.max(0, i8 - this.chipDrawable.getIntrinsicWidth());
        if (iMax2 <= 0 && iMax <= 0) {
            if (this.insetBackgroundDrawable != null) {
                removeBackgroundInset();
            } else {
    ...
    public void onFocusChanged(boolean z2, int i8, Rect rect) {
        ...
        if (this.touchHelperEnabled) {
            this.touchHelper.onFocusChanged(z2, i8, rect);
        }
    }
    ...
    public PointerIcon onResolvePointerIcon(@NonNull MotionEvent motionEvent, int i8) {
        return (getCloseIconTouchBounds().contains(motionEvent.getX(), motionEvent.getY()) && isEnabled()) ? PointerIcon.getSystemIcon(getContext(), PointerIconCompat.TYPE_HAND) : super.onResolvePointerIcon(motionEvent, i8);
    }
    ...
    public void setTextSize(int i8, float f) {
        ...
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setTextSize(TypedValue.applyDimension(i8, f, getResources().getDisplayMetrics()));
        }
        updateTextPaintDrawState();
    }
    ...
    public Chip(Context context, AttributeSet attributeSet, int i8) {
        ...
        ChipDrawable chipDrawableCreateFromAttributes = ChipDrawable.createFromAttributes(context2, attributeSet, i8, i9);
        initMinTouchTarget(context2, attributeSet, i8);
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.Chip, i8, i9, new int[0]);
        ...
        super.setOnCheckedChangeListener(new a(this, 1));
    }
