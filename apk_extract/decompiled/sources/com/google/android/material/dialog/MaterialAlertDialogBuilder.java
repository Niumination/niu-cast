...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    ...
    private static int getOverridingThemeResId(@NonNull Context context, int i8) {
        return i8 == 0 ? getMaterialAlertDialogThemeOverlay(context) : i8;
    }
    ...
    public MaterialAlertDialogBuilder(@NonNull Context context, int i8) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context2.obtainStyledAttributes(null, R.styleable.MaterialAlertDialog, i9, i10);
