...
public final class MaterialSharedAxis extends MaterialVisibility<VisibilityAnimatorProvider> {
    ...
    public MaterialSharedAxis(int i8, boolean z2) {
        super(createPrimaryAnimatorProvider(i8, z2), createSecondaryAnimatorProvider());
        this.axis = i8;
        this.forward = z2;
    }

    private static VisibilityAnimatorProvider createPrimaryAnimatorProvider(int i8, boolean z2) {
        if (i8 == 0) {
        ...
        throw new IllegalArgumentException(a1.a.o(i8, "Invalid axis: "));
    }
