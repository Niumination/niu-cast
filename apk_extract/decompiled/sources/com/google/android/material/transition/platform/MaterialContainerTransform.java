...
public final class MaterialContainerTransform extends Transition {
    ...
    public static class ProgressThresholds {
        ...
        public ProgressThresholds(@FloatRange(from = 0.0d, to = Contrast.RATIO_MIN) float f, @FloatRange(from = 0.0d, to = Contrast.RATIO_MIN) float f4) {
            this.start = f;
            this.end = f4;
        }
    ...
    public static final class TransitionDrawable extends Drawable {
        ...
        private void drawDebugCumulativePath(Canvas canvas, RectF rectF, Path path, @ColorInt int i8) {
            ...
            if (this.progress == 0.0f) {
                ...
                this.debugPaint.setColor(i8);
                canvas.drawPath(path, this.debugPaint);
            }
        }

        private void drawDebugRect(Canvas canvas, RectF rectF, @ColorInt int i8) {
            this.debugPaint.setColor(i8);
        ...
        private void updateProgress(float f) {
            ...
            if (f > 1.0f || f < 0.0f) {
                if (f > 1.0f) {
                    f10 = (f - 1.0f) / 0.00999999f;
                    f4 = 0.99f;
                } else {
                    f4 = 0.01f;
                    f10 = (f / 0.01f) * MaterialContainerTransform.ELEVATION_NOT_SET;
                }
                this.motionPathMeasure.getPosTan(this.motionPathLength * f4, fArr, null);
                float[] fArr2 = this.motionPathPosition;
                float f11 = fArr2[0];
                float f12 = fArr2[1];
                fB = a1.a.b(fB, f11, f10, fB);
                fB2 = a1.a.b(fB2, f12, f10, fB2);
            }
            float f13 = fB;
            float f14 = fB2;
            ...
            RectF rectF = this.currentStartBounds;
            float f15 = fitModeResultEvaluate.currentStartWidth;
            rectF.set(f13 - (f15 / 2.0f), f14, (f15 / 2.0f) + f13, fitModeResultEvaluate.currentStartHeight + f14);
            RectF rectF2 = this.currentEndBounds;
            FitModeResult fitModeResult = this.fitModeResult;
            float f16 = fitModeResult.currentEndWidth;
            rectF2.set(f13 - (f16 / 2.0f), f14, (f16 / 2.0f) + f13, fitModeResult.currentEndHeight + f14);
            ...
            float f18 = (int) (fCalculateElevationDyMultiplier * f17);
            this.currentElevationDy = f18;
            this.shadowPaint.setShadowLayer(f17, (int) (fCalculateElevationDxMultiplier * f17), f18, SHADOW_COLOR);
        ...
        private TransitionDrawable(PathMotion pathMotion, View view, RectF rectF, ShapeAppearanceModel shapeAppearanceModel, float f, View view2, RectF rectF2, ShapeAppearanceModel shapeAppearanceModel2, float f4, @ColorInt int i8, @ColorInt int i9, @ColorInt int i10, int i11, boolean z2, boolean z3, FadeModeEvaluator fadeModeEvaluator, FitModeEvaluator fitModeEvaluator, ProgressThresholdsGroup progressThresholdsGroup, boolean z5) {
            ...
            paint4.setShader(TransitionUtils.createColorShader(i11));
    ...
    private static RectF calculateDrawableBounds(View view, @Nullable View view2, float f, float f4) {
        if (view2 == null) {
            return new RectF(0.0f, 0.0f, view.getWidth(), view.getHeight());
        }
        RectF locationOnScreen = TransitionUtils.getLocationOnScreen(view2);
        locationOnScreen.offset(f, f4);
    ...
    private static void captureValues(@NonNull TransitionValues transitionValues, @Nullable View view, @IdRes int i8, @Nullable ShapeAppearanceModel shapeAppearanceModel) {
        if (i8 != -1) {
            transitionValues.view = TransitionUtils.findDescendantOrAncestorById(transitionValues.view, i8);
        } else if (view != null) {
    ...
    public Animator createAnimator(@NonNull ViewGroup viewGroup, @Nullable TransitionValues transitionValues, @Nullable TransitionValues transitionValues2) {
        ...
        if (transitionValues != null && transitionValues2 != null) {
            ...
            if (rectF != null && shapeAppearanceModel != null) {
                ...
                float f4 = -locationOnScreen.top;
                RectF rectFCalculateDrawableBounds = calculateDrawableBounds(viewFindAncestorById, view, f, f4);
                rectF.offset(f, f4);
                rectF2.offset(f, f4);
