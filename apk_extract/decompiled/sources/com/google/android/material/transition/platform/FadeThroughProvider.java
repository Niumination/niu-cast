...
public final class FadeThroughProvider implements VisibilityAnimatorProvider {
    ...
    private static Animator createFadeThroughAnimator(final View view, final float f, final float f4, @FloatRange(from = 0.0d, to = Contrast.RATIO_MIN) final float f10, @FloatRange(from = 0.0d, to = Contrast.RATIO_MIN) final float f11, final float f12) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.transition.platform.FadeThroughProvider.1
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                view.setAlpha(TransitionUtils.lerp(f, f4, f10, f11, ((Float) valueAnimator.getAnimatedValue()).floatValue()));
            }
        });
