...
public class RangeSlider extends BaseSlider<RangeSlider, OnChangeListener, OnSliderTouchListener> {
    ...
    public interface OnChangeListener extends BaseOnChangeListener<RangeSlider> {
        ...
        void onValueChange(@NonNull RangeSlider rangeSlider, float f, boolean z2);
    }
    ...
    public RangeSlider(@NonNull Context context, @Nullable AttributeSet attributeSet, int i8) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, R.styleable.RangeSlider, i8, BaseSlider.DEF_STYLE_RES, new int[0]);
