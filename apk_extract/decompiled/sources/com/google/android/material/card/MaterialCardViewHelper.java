...
class MaterialCardViewHelper {
    ...
    public MaterialCardViewHelper(@NonNull MaterialCardView materialCardView, AttributeSet attributeSet, int i8, @StyleRes int i9) {
        ...
        TypedArray typedArrayObtainStyledAttributes = materialCardView.getContext().obtainStyledAttributes(attributeSet, R.styleable.CardView, i8, R.style.CardView);
    ...
    public void animateCheckedIcon(boolean z2) {
        ...
        float f4 = z2 ? 1.0f - this.checkedAnimationProgress : this.checkedAnimationProgress;
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.card.a
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                this.f2215a.lambda$animateCheckedIcon$0(valueAnimator2);
            }
        });
        this.iconAnimator.setInterpolator(this.iconFadeAnimInterpolator);
        this.iconAnimator.setDuration((long) ((z2 ? this.iconFadeInAnimDuration : this.iconFadeOutAnimDuration) * f4));
    ...
    public void recalculateCheckedIconPosition(int i8, int i9) {
        ...
        if (this.clickableForegroundDrawable != null) {
            ...
            int i12 = isCheckedIconEnd() ? ((i8 - this.checkedIconMargin) - this.checkedIconSize) - iCeil2 : this.checkedIconMargin;
            int i13 = isCheckedIconBottom() ? this.checkedIconMargin : ((i9 - this.checkedIconMargin) - this.checkedIconSize) - iCeil;
            int i14 = isCheckedIconEnd() ? this.checkedIconMargin : ((i8 - this.checkedIconMargin) - this.checkedIconSize) - iCeil2;
            int i15 = isCheckedIconBottom() ? ((i9 - this.checkedIconMargin) - this.checkedIconSize) - iCeil : this.checkedIconMargin;
            ...
            this.clickableForegroundDrawable.setLayerInset(2, i11, i15, i10, i13);
        }
    }
