...
public class MaterialDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private void drawForHorizontalOrientation(@NonNull Canvas canvas, @NonNull RecyclerView recyclerView) {
        ...
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if (shouldDrawDivider(recyclerView, childAt)) {
                ...
                if (zIsLayoutRtl) {
                    i9 = this.tempRect.left + iRound;
                    i8 = this.thickness + i9;
                } else {
                    i8 = iRound + this.tempRect.right;
                    i9 = i8 - this.thickness;
                }
                this.dividerDrawable.setBounds(i9, i10, i8, i11);
    ...
    private void drawForVerticalOrientation(@NonNull Canvas canvas, @NonNull RecyclerView recyclerView) {
        ...
        boolean zIsLayoutRtl = ViewUtils.isLayoutRtl(recyclerView);
        int i8 = paddingLeft + (zIsLayoutRtl ? this.insetEnd : this.insetStart);
        int i9 = width - (zIsLayoutRtl ? this.insetStart : this.insetEnd);
        int childCount = recyclerView.getChildCount();
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (shouldDrawDivider(recyclerView, childAt)) {
                ...
                this.dividerDrawable.setBounds(i8, iRound - this.thickness, i9, iRound);
                this.dividerDrawable.setAlpha(Math.round(childAt.getAlpha() * 255.0f));
                this.dividerDrawable.draw(canvas);
            }
        }
    ...
    public void setDividerColor(@ColorInt int i8) {
        ...
        DrawableCompat.setTint(drawableWrap, i8);
    }
    ...
    public void setOrientation(int i8) {
        if (i8 != 0 && i8 != 1) {
            throw new IllegalArgumentException(a.h(i8, "Invalid orientation: ", ". It should be either HORIZONTAL or VERTICAL"));
        }
        this.orientation = i8;
    }

    public boolean shouldDrawDivider(int i8, @Nullable RecyclerView.Adapter<?> adapter) {
        return true;
    }
    ...
    public MaterialDividerItemDecoration(@NonNull Context context, @Nullable AttributeSet attributeSet, int i8, int i9) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, R.styleable.MaterialDivider, i8, DEF_STYLE_RES, new int[0]);
