...
public class ShadowRenderer {
    ...
    public void drawCornerShadow(@NonNull Canvas canvas, @Nullable Matrix matrix, @NonNull RectF rectF, int i8, float f, float f4) {
        boolean z2 = f4 < 0.0f;
        ...
        canvas.drawArc(rectF, f, f4, true, this.cornerShadowPaint);
        canvas.restore();
    }
    ...
    public void drawInnerCornerShadow(@NonNull Canvas canvas, @Nullable Matrix matrix, @NonNull RectF rectF, int i8, float f, float f4, @NonNull float[] fArr) {
        if (f4 > 0.0f) {
            f += f4;
            f4 = -f4;
        }
        drawCornerShadow(canvas, matrix, rectF, i8, f, f4);
        Path path = this.scratch;
        path.rewind();
    ...
    public void setShadowColor(int i8) {
        this.shadowStartColor = ColorUtils.setAlphaComponent(i8, COLOR_ALPHA_START);
