...
public class ShadowDrawableWrapper extends DrawableWrapperCompat {
    ...
    public ShadowDrawableWrapper(Context context, Drawable drawable, float f, float f4, float f10) {
        super(drawable);
        this.dirty = true;
    ...
    private void buildComponents(@NonNull Rect rect) {
        ...
        this.contentBounds.set(rect.left + f, rect.top + f4, rect.right - f, rect.bottom - f4);
    ...
    private void drawShadow(@NonNull Canvas canvas) {
        ...
        float f = this.cornerRadius;
        float f4 = (-f) - this.shadowSize;
        float f10 = f * 2.0f;
        boolean z2 = this.contentBounds.width() - f10 > 0.0f;
        boolean z3 = this.contentBounds.height() - f10 > 0.0f;
        float f11 = this.rawShadowSize;
        float f12 = f / ((f11 - (0.5f * f11)) + f);
        float f13 = f / ((f11 - (SHADOW_TOP_SCALE * f11)) + f);
        float f14 = f / ((f11 - (f11 * 1.0f)) + f);
        ...
        if (z2) {
            ...
            canvas.drawRect(0.0f, f4, this.contentBounds.width() - f10, -this.cornerRadius, this.edgeShadowPaint);
        }
        ...
        if (z2) {
            canvas.scale(1.0f / f12, 1.0f);
            canvas.drawRect(0.0f, f4, this.contentBounds.width() - f10, (-this.cornerRadius) + this.shadowSize, this.edgeShadowPaint);
        }
        ...
        if (z3) {
            ...
            canvas.drawRect(0.0f, f4, this.contentBounds.height() - f10, -this.cornerRadius, this.edgeShadowPaint);
        }
