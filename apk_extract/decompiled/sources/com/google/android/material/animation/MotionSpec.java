...
public class MotionSpec {
    ...
    public static MotionSpec createFromResource(@NonNull Context context, @AnimatorRes int i8) {
        try {
            ...
            Log.w(TAG, "Can't load animation resource ID #0x" + Integer.toHexString(i8), e);
            return null;
        }
    }
    ...
    public <T> ObjectAnimator getAnimator(@NonNull String str, @NonNull T t3, @NonNull Property<T, ?> property) {
        ObjectAnimator objectAnimatorOfPropertyValuesHolder = ObjectAnimator.ofPropertyValuesHolder(t3, getPropertyValues(str));
    ...
    public long getTotalDuration() {
        ...
        long jMax = 0;
        for (int i8 = 0; i8 < size; i8++) {
            MotionTiming motionTimingValueAt = this.timings.valueAt(i8);
