...
class ViewOverlayApi14 implements ViewOverlayImpl {
    ...
    public static ViewOverlayApi14 createFrom(View view) {
        ...
        for (int i8 = 0; i8 < childCount; i8++) {
            View childAt = contentView.getChildAt(i8);
    ...
    public static class OverlayViewGroup extends ViewGroup {
        ...
        public void dispatchDraw(Canvas canvas) {
            ...
            for (int i8 = 0; i8 < size; i8++) {
                this.drawables.get(i8).draw(canvas);
            }
        }
        ...
        public ViewParent invalidateChildInParentFast(int i8, int i9, Rect rect) {
            if (this.hostView == null || invalidateChildInParentFastMethod == null) {
                return null;
            }
            try {
                getOffset(new int[2]);
                invalidateChildInParentFastMethod.invoke(this.hostView, Integer.valueOf(i8), Integer.valueOf(i9), rect);
                return null;
