...
public final class CollapsingTextHelper {
    ...
    @ColorInt
    private static int blendARGB(@ColorInt int i8, @ColorInt int i9, @FloatRange(from = 0.0d, to = Contrast.RATIO_MIN) float f) {
        float f4 = 1.0f - f;
        return Color.argb(Math.round((Color.alpha(i9) * f) + (Color.alpha(i8) * f4)), Math.round((Color.red(i9) * f) + (Color.red(i8) * f4)), Math.round((Color.green(i9) * f) + (Color.green(i8) * f4)), Math.round((Color.blue(i9) * f) + (Color.blue(i8) * f4)));
    }
    ...
    private void calculateBaseOffsets(boolean z2) {
        ...
        int i8 = absoluteGravity & DeviceType.INFRARED_HEATER;
        if (i8 == 48) {
        ...
        int i10 = absoluteGravity2 & DeviceType.INFRARED_HEATER;
        if (i10 == 48) {
    ...
    private float calculateFadeModeTextAlpha(@FloatRange(from = 0.0d, to = Contrast.RATIO_MIN) float f) {
        ...
        return f <= f4 ? AnimationUtils.lerp(1.0f, 0.0f, this.fadeModeStartFraction, f4, f) : AnimationUtils.lerp(0.0f, 1.0f, f4, 1.0f, f);
    }

    private float calculateFadeModeThresholdFraction() {
        float f = this.fadeModeStartFraction;
        return a1.a.b(1.0f, f, 0.5f, f);
    }
    ...
    private void calculateOffsets(float f) {
        ...
        if (f10 != f11) {
            this.textPaint.setLetterSpacing(lerp(f11, f10, f, timeInterpolator));
        } else {
    ...
    private void drawMultilineTransition(@NonNull Canvas canvas, float f, float f4) {
    ...
    private float getCollapsedTextRightBound(@NonNull RectF rectF, int i8, int i9) {
        if (i9 == 17 || (i9 & 7) == 1) {
            return (this.collapsedTextWidth / 2.0f) + (i8 / 2.0f);
        }
        if ((i9 & GravityCompat.END) == 8388613 || (i9 & 5) == 5) {
    ...
    private static boolean isClose(float f, float f4) {
        return Math.abs(f - f4) < 1.0E-5f;
    }
    ...
    private static float lerp(float f, float f4, float f10, @Nullable TimeInterpolator timeInterpolator) {
        if (timeInterpolator != null) {
            f10 = timeInterpolator.getInterpolation(f10);
        }
        return AnimationUtils.lerp(f, f4, f10);
    }
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        if (z2) {
            canvas.drawBitmap(this.expandedTitleTexture, f, f4, this.texturePaint);
    ...
    private void calculateUsingTextSize(float f, boolean z2) {
        float f4;
        float f10;
        Typeface typeface;
        if (this.text == null) {
        ...
        if (isClose(f, 1.0f)) {
            ...
            fWidth = (z2 || this.fadeModeEnabled || fWidth2 * f13 <= fWidth) ? fWidth2 : Math.min(fWidth / f13, fWidth2);
            f4 = f11;
            f10 = f12;
            typeface = typeface2;
        }
        boolean z3 = false;
        if (fWidth > 0.0f) {
            boolean z5 = this.currentTextSize != f4;
            boolean z10 = this.currentLetterSpacing != f10;
            boolean z11 = this.currentTypeface != typeface;
            StaticLayout staticLayout = this.textLayout;
            boolean z12 = z5 || z10 || (staticLayout != null && (fWidth > ((float) staticLayout.getWidth()) ? 1 : (fWidth == ((float) staticLayout.getWidth()) ? 0 : -1)) != 0) || z11 || this.boundsChanged;
