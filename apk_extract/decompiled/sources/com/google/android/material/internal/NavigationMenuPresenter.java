...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    public class NavigationMenuAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        private void prepareMenuItems() {
            ...
            int size2 = 0;
            while (i9 < size) {
                MenuItemImpl menuItemImpl = NavigationMenuPresenter.this.menu.getVisibleItems().get(i9);
        ...
        private void setAccessibilityDelegate(View view, final int i8, final boolean z2) {
            ViewCompat.setAccessibilityDelegate(view, new AccessibilityDelegateCompat() { // from class: com.google.android.material.internal.NavigationMenuPresenter.NavigationMenuAdapter.1
                ...
                public void onInitializeAccessibilityNodeInfo(@NonNull View view2, @NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                    ...
                    accessibilityNodeInfoCompat.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(NavigationMenuAdapter.this.adjustItemPositionForA11yDelegate(i8), 1, 1, 1, z2, view2.isSelected()));
                }
            });
        }
    ...
    private void updateTopPadding() {
        int i8 = (hasHeader() || !this.isBehindStatusBar) ? 0 : this.paddingTopDefault;
    ...
    public View inflateHeaderView(@LayoutRes int i8) {
        View viewInflate = this.layoutInflater.inflate(i8, (ViewGroup) this.headerLayout, false);
