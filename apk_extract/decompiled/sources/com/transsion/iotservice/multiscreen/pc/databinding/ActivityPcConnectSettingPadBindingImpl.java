...
public class ActivityPcConnectSettingPadBindingImpl extends ActivityPcConnectSettingPadBinding implements a {

    /* JADX INFO: renamed from: v, reason: collision with root package name */
    public static final SparseIntArray f2480v;
    public final k p;
    public final k q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    public final k f2481r;

    /* JADX INFO: renamed from: s, reason: collision with root package name */
    public final k f2482s;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    public final k f2483t;
    public long u;

    static {
        SparseIntArray sparseIntArray = new SparseIntArray();
        f2480v = sparseIntArray;
    ...
    public ActivityPcConnectSettingPadBindingImpl(View view, DataBindingComponent dataBindingComponent) {
        Object[] objArrMapBindings = ViewDataBinding.mapBindings(dataBindingComponent, view, 14, (ViewDataBinding.IncludedLayouts) null, f2480v);
        ...
        setRootTag(view);
        this.p = new k(3, 2, this);
        this.q = new k(4, 2, this);
        this.f2481r = new k(1, 2, this);
        this.f2482s = new k(5, 2, this);
        this.f2483t = new k(2, 2, this);
        invalidateAll();
    }
    ...
    public final void executeBindings() {
        ...
        if ((j8 & 16384) != 0) {
            this.f2468a.setOnClickListener(this.f2483t);
            this.f2469b.setOnClickListener(this.f2481r);
            this.f2471d.setOnClickListener(this.p);
            this.f2472h.setOnClickListener(this.q);
            this.f2473i.setOnClickListener(this.f2482s);
        }
        if ((j8 & 20480) != 0) {
            d.c(this.f2468a, str);
            d.l(this.f2468a, i8);
