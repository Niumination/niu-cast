...
public class OSMaskConstraintLayout extends ConstraintLayout {
    ...
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u001b\n\u0000\b\u0087\u0002\u0018\u00002\u00020\u0001B\u0000¨\u0006\u0002"}, d2 = {"Lcom/transsion/widgetsliquid/effect/OSMaskConstraintLayout$OSMASKLAYERPOSITION;", "", "widgetsliquid_release"}, k = 1, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    @Retention(RetentionPolicy.SOURCE)
    @kotlin.annotation.Retention(AnnotationRetention.SOURCE)
    public @interface OSMASKLAYERPOSITION {
    }

    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u001b\n\u0000\b\u0087\u0002\u0018\u00002\u00020\u0001B\u0000¨\u0006\u0002"}, d2 = {"Lcom/transsion/widgetsliquid/effect/OSMaskConstraintLayout$OSMASKPOSITION;", "", "widgetsliquid_release"}, k = 1, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    @Retention(RetentionPolicy.SOURCE)
    @kotlin.annotation.Retention(AnnotationRetention.SOURCE)
    ...
    @JvmOverloads
    public OSMaskConstraintLayout(Context context) {
    ...
    public static /* synthetic */ void setFadeEffect$default(OSMaskConstraintLayout oSMaskConstraintLayout, int i8, float f, int i9, Object obj) {
        if (obj != null) {
        ...
        oSMaskConstraintLayout.setFadeEffect(i8, f);
    }
    ...
    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    @JvmOverloads
    public OSMaskConstraintLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0, 4, null);
        Intrinsics.checkNotNullParameter(context, "context");
    }

    public /* synthetic */ OSMaskConstraintLayout(Context context, AttributeSet attributeSet, int i8, int i9, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, (i9 & 2) != 0 ? null : attributeSet, (i9 & 4) != 0 ? 0 : i8);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    @JvmOverloads
    public OSMaskConstraintLayout(Context context, AttributeSet attributeSet, int i8) {
        ...
        int i10 = typedArrayObtainStyledAttributes.getInt(R.styleable.OSMaskFrameLayout_os_mask_scene, 0);
        oSMaskDrawable.setMaskColor(color);
        oSMaskDrawable.setMaskPosition(i9);
        oSMaskDrawable.setMaskHeight(dimensionPixelSize);
        oSMaskDrawable.setMaskScene(i10);
