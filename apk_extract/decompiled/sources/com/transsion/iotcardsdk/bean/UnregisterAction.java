...
public final class UnregisterAction extends ControlAction {
    ...
    public UnregisterAction(String str) {
        this(3, str);
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public UnregisterAction(Bundle bundle) {
