...
public final class R$styleable {
    ...
    public static int OSLiquidButton_os_liquid_button_icon_mirror = 0;
    public static int OSLiquidButton_os_liquid_button_text = 1;
    public static int OSLiquidButton_os_liquid_button_text_color = 2;
    public static int OSLiquidButton_os_liquid_button_text_size = 3;
    ...
    public static int OSLiquidFloatingOvalButton_liquid_background_color = 0;
    public static int OSLiquidFloatingOvalButton_liquid_text_color = 1;
    public static int OSLiquidFloatingOvalButton_liquid_text_icon = 2;
    public static int OSLiquidFloatingOvalButton_liquid_text_size = 3;
    public static int OSLiquidFloatingOvalButton_liquid_use_default_inset = 4;
    public static int OSLiquidFootOperationBar_os_liquid_fob_horizontal_default_select_position = 0;
    public static int OSLiquidFootOperationBar_os_liquid_fob_horizontal_space = 1;
    public static int OSLiquidFootOperationBar_os_liquid_fob_indicator_color = 2;
    public static int OSLiquidFootOperationBar_os_liquid_fob_item_space = 3;
    public static int OSLiquidFootOperationBar_os_liquid_fob_select_color = 4;
    public static int OSLiquidFootOperationBar_os_liquid_fob_un_select_color = 5;
    public static int OSLiquidSearchBar_os_enable_union_effect = 0;
    public static int OSLiquidSearchBar_os_search_button_mode_icon = 1;
    public static int OSLiquidSearchBar_os_search_edittext_layout = 2;
    public static int OSLiquidSearchBar_os_search_hint = 3;
    public static int OSLiquidSearchBar_os_search_init_state = 4;
    public static int OSLiquidSearchBar_os_search_inner_left_icon = 5;
    public static int OSLiquidSearchBar_os_search_inner_right_icon = 6;
    public static int OSLiquidSearchBar_os_search_left_icon = 7;
    public static int OSLiquidSearchBar_os_search_right_icon = 8;
    public static int OSLiquidSearchBar_os_search_right_icon_2 = 9;
    public static int OSLiquidSearchBar_os_search_show_right_icon = 10;
    public static int OSLiquidToolBar_os_liquid_toolbar_left_icon = 0;
    public static int OSLiquidToolBar_os_liquid_toolbar_subtitle = 1;
    public static int OSLiquidToolBar_os_liquid_toolbar_title = 2;
    ...
    public static int OSMaskFrameLayout_os_mask_color = 0;
    public static int OSMaskFrameLayout_os_mask_layer_position = 1;
    public static int OSMaskFrameLayout_os_mask_length = 2;
    public static int OSMaskFrameLayout_os_mask_position = 3;
    public static int OSMaskFrameLayout_os_mask_scene = 4;
    ...
    public static int OSMixColorTextView_os_grident = 0;
    public static int OSMixColorTextView_os_mix_blendShader1 = 1;
    public static int OSMixColorTextView_os_mix_blendShader2 = 2;
    public static int OSMixColorTextView_os_mix_color1 = 3;
    public static int OSMixColorTextView_os_mix_color2 = 4;
    public static int OSMixColorTextView_os_mix_custom = 5;
    public static int OSMixColorTextView_os_mix_level = 6;
    ...
    public static int[] OSLiquidButton = {R.attr.os_liquid_button_icon_mirror, R.attr.os_liquid_button_text, R.attr.os_liquid_button_text_color, R.attr.os_liquid_button_text_size};
    ...
    public static int[] OSLiquidFloatingOvalButton = {R.attr.liquid_background_color, R.attr.liquid_text_color, R.attr.liquid_text_icon, R.attr.liquid_text_size, R.attr.liquid_use_default_inset};
    public static int[] OSLiquidFootOperationBar = {R.attr.os_liquid_fob_horizontal_default_select_position, R.attr.os_liquid_fob_horizontal_space, R.attr.os_liquid_fob_indicator_color, R.attr.os_liquid_fob_item_space, R.attr.os_liquid_fob_select_color, R.attr.os_liquid_fob_un_select_color};
    public static int[] OSLiquidSearchBar = {R.attr.os_enable_union_effect, R.attr.os_search_button_mode_icon, R.attr.os_search_edittext_layout, R.attr.os_search_hint, R.attr.os_search_init_state, R.attr.os_search_inner_left_icon, R.attr.os_search_inner_right_icon, R.attr.os_search_left_icon, R.attr.os_search_right_icon, R.attr.os_search_right_icon_2, R.attr.os_search_show_right_icon};
    public static int[] OSLiquidToolBar = {R.attr.os_liquid_toolbar_left_icon, R.attr.os_liquid_toolbar_subtitle, R.attr.os_liquid_toolbar_title};
    ...
    public static int[] OSMaskFrameLayout = {R.attr.os_mask_color, R.attr.os_mask_layer_position, R.attr.os_mask_length, R.attr.os_mask_position, R.attr.os_mask_scene};
    ...
    public static int[] OSMixColorTextView = {R.attr.os_grident, R.attr.os_mix_blendShader1, R.attr.os_mix_blendShader2, R.attr.os_mix_color1, R.attr.os_mix_color2, R.attr.os_mix_custom, R.attr.os_mix_level};
