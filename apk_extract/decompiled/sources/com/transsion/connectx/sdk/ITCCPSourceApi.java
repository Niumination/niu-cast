...
public interface ITCCPSourceApi extends IInterface {
    ...
    public static class Default implements ITCCPSourceApi {
        ...
        public void cancelBackup(long j8) throws RemoteException {
        }
        ...
        @Override // com.transsion.connectx.sdk.ITCCPSourceApi
        public boolean castActivity(String str, int i8) throws RemoteException {
            return false;
        }
        ...
        @Override // com.transsion.connectx.sdk.ITCCPSourceApi
        public void confirmReceiveFile(List<String> list, String str, boolean z2, String str2, String str3) throws RemoteException {
        }

        @Override // com.transsion.connectx.sdk.ITCCPSourceApi
        public void connectTccpServer(String str, int i8) throws RemoteException {
        }
        ...
        @Override // com.transsion.connectx.sdk.ITCCPSourceApi
        public void enableFeature(String str, boolean z2) throws RemoteException {
        }

        @Override // com.transsion.connectx.sdk.ITCCPSourceApi
        public void enableFeatures(List<String> list, boolean z2) throws RemoteException {
        }
        ...
        @Override // com.transsion.connectx.sdk.ITCCPSourceApi
        public boolean isMotionControlByPc(long j8) throws RemoteException {
            return false;
        }
        ...
        @Override // com.transsion.connectx.sdk.ITCCPSourceApi
        public void responseAuth(boolean z2, boolean z3) throws RemoteException {
        }

        @Override // com.transsion.connectx.sdk.ITCCPSourceApi
        public void sendFile(List<String> list, int i8, String str, String str2) throws RemoteException {
        }
        ...
        @Override // com.transsion.connectx.sdk.ITCCPSourceApi
        public int startTCCPServer(int i8) throws RemoteException {
            return 0;
        }
        ...
        @Override // com.transsion.connectx.sdk.ITCCPSourceApi
        public void updateMirrorWindowPoint(int i8, int i9) throws RemoteException {
        }
    }
    ...
    void cancelBackup(long j8) throws RemoteException;

    void cancelFileTransfer() throws RemoteException;

    boolean castActivity(String str, int i8) throws RemoteException;
    ...
    void confirmReceiveFile(List<String> list, String str, boolean z2, String str2, String str3) throws RemoteException;

    void connectTccpServer(String str, int i8) throws RemoteException;

    void disconnectTccpServer() throws RemoteException;

    void enableFeature(String str, boolean z2) throws RemoteException;

    void enableFeatures(List<String> list, boolean z2) throws RemoteException;

    void executeAction(String str, String str2) throws RemoteException;

    int getTCCPStatus() throws RemoteException;

    boolean isMotionControlByPc(long j8) throws RemoteException;
    ...
    void responseAuth(boolean z2, boolean z3) throws RemoteException;

    void sendFile(List<String> list, int i8, String str, String str2) throws RemoteException;

    void setConnectDeviceInfo(DeviceInfo deviceInfo) throws RemoteException;

    void startExtendScreen() throws RemoteException;

    int startTCCPServer(int i8) throws RemoteException;
    ...
    void updateMirrorWindowPoint(int i8, int i9) throws RemoteException;
}
