...
public class TCCPSourceApi implements ITCCPSourceApi {
    ...
    private final ServiceConnection mServiceConnection = new ServiceConnection() { // from class: com.transsion.connectx.sdk.TCCPSourceApi.2
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            try {
                ...
                Log.e(TCCPSourceApi.TAG, e.getMessage(), e);
            }
    ...
    public void cancelBackup(long j8) {
        if (!isServiceAvailable()) {
            Log.e(TAG, "cancelBackup: failed,service not available");
            return;
        }
        try {
            this.mRemoteInterface.cancelBackup(j8);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }
    ...
    @Override // com.transsion.connectx.sdk.ITCCPSourceApi
    public boolean castActivity(String str, int i8) {
        if (!isServiceAvailable()) {
            Log.e(TAG, "castActivity: failed,service not available");
            return false;
        }
        try {
            return this.mRemoteInterface.castActivity(str, i8);
        } catch (RemoteException e) {
            Log.e(TAG, e.getMessage(), e);
            return false;
        }
    ...
    @Override // com.transsion.connectx.sdk.ITCCPSourceApi
    public void confirmReceiveFile(List<String> list, String str, boolean z2, String str2, String str3) {
        if (!isServiceAvailable()) {
            Log.e(TAG, "downloadFile: failed,service not available");
            return;
        }
        try {
            this.mRemoteInterface.confirmReceiveFile(list, str, z2, str2, str3);
        } catch (RemoteException e) {
            Log.e(TAG, e.getMessage(), e);
        }
    }
    ...
    @Override // com.transsion.connectx.sdk.ITCCPSourceApi
    public void connectTccpServer(String str, int i8) {
        if (!isServiceAvailable()) {
            Log.e(TAG, "connectTccpServer: fail");
            return;
        }
        try {
            this.mRemoteInterface.connectTccpServer(str, i8);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }
    ...
    public void disconnectService(Context context) {
        ...
        try {
            ...
            Log.e(TAG, "disconnectService exception", e);
        }
    ...
    @Override // com.transsion.connectx.sdk.ITCCPSourceApi
    public void enableFeature(String str, boolean z2) {
        if (!isServiceAvailable()) {
            Log.e(TAG, "enableUIBC: failed,service not available");
            return;
        }
        try {
            this.mRemoteInterface.enableFeature(str, z2);
        } catch (RemoteException e) {
            Log.e(TAG, e.getMessage(), e);
        }
    }
    ...
    @Override // com.transsion.connectx.sdk.ITCCPSourceApi
    public void enableFeatures(List<String> list, boolean z2) {
        if (!isServiceAvailable()) {
            Log.e(TAG, "enableUIBC: failed,service not available");
            return;
        }
        try {
            this.mRemoteInterface.enableFeatures(list, z2);
        } catch (RemoteException e) {
            Log.e(TAG, e.getMessage(), e);
        }
    }
    ...
    @Override // com.transsion.connectx.sdk.ITCCPSourceApi
    public boolean isMotionControlByPc(long j8) {
        if (!isServiceAvailable()) {
            Log.e(TAG, "isControlByPc: failed,service not available");
            return false;
        }
        try {
            return this.mRemoteInterface.isMotionControlByPc(j8);
        } catch (RemoteException e) {
            Log.e(TAG, e.getMessage(), e);
            return false;
        }
    ...
    @Override // com.transsion.connectx.sdk.ITCCPSourceApi
    public void responseAuth(boolean z2, boolean z3) {
        if (!isServiceAvailable()) {
            Log.e(TAG, "responseAuth: failed,service not available");
            return;
        }
        try {
            this.mRemoteInterface.responseAuth(z2, z3);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }
    ...
    @Override // com.transsion.connectx.sdk.ITCCPSourceApi
    public void sendFile(List<String> list, int i8, String str, String str2) {
        if (!isServiceAvailable()) {
            Log.e(TAG, "sendFile: failed,service not available");
            return;
        }
        try {
            this.mRemoteInterface.sendFile(list, i8, str, str2);
        } catch (RemoteException e) {
            Log.e(TAG, e.getMessage(), e);
        }
    }
    ...
    @Override // com.transsion.connectx.sdk.ITCCPSourceApi
    public int startTCCPServer(int i8) {
        if (!isServiceAvailable()) {
            Log.e(TAG, "startCastServer: failed,service not available");
            return -1;
        }
        try {
            return this.mRemoteInterface.startTCCPServer(i8);
        } catch (RemoteException e) {
            Log.e(TAG, e.getMessage(), e);
            return -1;
        }
    ...
    @Override // com.transsion.connectx.sdk.ITCCPSourceApi
    public void updateMirrorWindowPoint(int i8, int i9) {
        if (!isServiceAvailable()) {
            Log.e(TAG, "updateMirrorWindowPoint: fail");
            return;
        }
        try {
            this.mRemoteInterface.updateMirrorWindowPoint(i8, i9);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }
