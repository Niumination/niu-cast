...
public interface BackupFileListener extends IInterface {
    ...
    public static class Default implements BackupFileListener {
        ...
        public void onCancel(long j8, boolean z2) throws RemoteException {
        }

        @Override // com.transsion.connectx.sdk.BackupFileListener
        public void onFail(long j8, int i8) throws RemoteException {
        }

        @Override // com.transsion.connectx.sdk.BackupFileListener
        public void onFinish(long j8) throws RemoteException {
        }

        @Override // com.transsion.connectx.sdk.BackupFileListener
        public void onProgress(long j8, double d7, int i8, int i9) throws RemoteException {
        }

        @Override // com.transsion.connectx.sdk.BackupFileListener
        public void onStart(long j8, int i8) throws RemoteException {
        }
    }
    ...
    void onCancel(long j8, boolean z2) throws RemoteException;

    void onFail(long j8, int i8) throws RemoteException;

    void onFinish(long j8) throws RemoteException;

    void onProgress(long j8, double d7, int i8, int i9) throws RemoteException;

    void onStart(long j8, int i8) throws RemoteException;
}
