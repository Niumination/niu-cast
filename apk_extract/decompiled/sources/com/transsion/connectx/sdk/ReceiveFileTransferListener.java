...
public interface ReceiveFileTransferListener extends IInterface {
    ...
    public static class Default implements ReceiveFileTransferListener {
        ...
        @Override // com.transsion.connectx.sdk.ReceiveFileTransferListener
        public void onConfirmReceiveFile(List<String> list, long j8, String str, String str2, int i8) throws RemoteException {
        }
    ...
    void onConfirmReceiveFile(List<String> list, long j8, String str, String str2, int i8) throws RemoteException;
