...
public class LongSparseArray<E> implements Cloneable {
    ...
    public void append(long j10, E e10) {
        ...
        if (i11 >= this.mKeys.length) {
            int iIdealLongArraySize = ContainerHelpers.idealLongArraySize(i11 + 1);
    ...
    public void put(long j10, E e10) {
        int iBinarySearch = ContainerHelpers.binarySearch(this.mKeys, this.mSize, j10);
        if (iBinarySearch >= 0) {
        ...
        if (i12 >= this.mKeys.length) {
            int iIdealLongArraySize = ContainerHelpers.idealLongArraySize(i12 + 1);
            long[] jArr = new long[iIdealLongArraySize];
    ...
    public LongSparseArray(int i10) {
        ...
        if (i10 == 0) {
            ...
            int iIdealLongArraySize = ContainerHelpers.idealLongArraySize(i10);
