...
public class SimpleArrayMap<K, V> {
    ...
    public V getOrDefault(Object obj, V v10) {
        ...
        return iIndexOfKey >= 0 ? (V) this.mArray[(iIndexOfKey << 1) + 1] : v10;
    }
    ...
    public int indexOf(Object obj, int i10) {
        ...
        for (int i13 = iBinarySearchHashes - 1; i13 >= 0 && this.mHashes[i13] == i10; i13--) {
    ...
    public int indexOfNull() {
        ...
        int iBinarySearchHashes = binarySearchHashes(this.mHashes, i10, 0);
        if (iBinarySearchHashes < 0 || this.mArray[iBinarySearchHashes << 1] == null) {
            return iBinarySearchHashes;
        }
        int i11 = iBinarySearchHashes + 1;
        ...
        for (int i12 = iBinarySearchHashes - 1; i12 >= 0 && this.mHashes[i12] == 0; i12--) {
    ...
    public V removeAt(int i10) {
        ...
        int i13 = 0;
        if (i12 <= 1) {
            freeArrays(this.mHashes, objArr, i12);
            this.mHashes = ContainerHelpers.EMPTY_INTS;
            this.mArray = ContainerHelpers.EMPTY_OBJECTS;
        } else {
            int i14 = i12 - 1;
