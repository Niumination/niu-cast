...
class FragmentStateManager {
    ...
    public void attach() {
        ...
        if (fragment2 != null) {
            ...
            if (str != null && (fragmentStateManager = this.mFragmentStore.getFragmentStateManager(str)) == null) {
                ...
                throw new IllegalStateException(c.a(sb2, this.mFragment.mTargetWho, " that does not belong to this FragmentManager!"));
            }
        }
    ...
    public int computeExpectedState() {
        ...
        int i10 = AnonymousClass2.$SwitchMap$androidx$lifecycle$Lifecycle$State[fragment2.mMaxState.ordinal()];
        if (i10 != 1) {
            if (i10 == 2) {
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            StringBuilder sbA = b.a("computeExpectedState() of ", iMin, " for ");
            sbA.append(this.mFragment);
