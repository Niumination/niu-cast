...
public class FragmentController {
    ...
    public void dispatchMultiWindowModeChanged(boolean z10) {
        this.mHost.mFragmentManager.dispatchMultiWindowModeChanged(z10);
    }
    ...
    public void dispatchPictureInPictureModeChanged(boolean z10) {
        this.mHost.mFragmentManager.dispatchPictureInPictureModeChanged(z10);
    }
    ...
    @NonNull
    public List<Fragment> getActiveFragments(@a({"UnknownNullness"}) List<Fragment> list) {
    ...
    @Deprecated
    public void restoreLoaderNonConfig(@a({"UnknownNullness"}) SimpleArrayMap<String, LoaderManager> simpleArrayMap) {
    }
