...
class FragmentLifecycleCallbacksDispatcher {
    ...
    public void dispatchOnFragmentActivityCreated(@NonNull Fragment fragment, @Nullable Bundle bundle, boolean z10) {
        ...
        for (FragmentLifecycleCallbacksHolder fragmentLifecycleCallbacksHolder : this.mLifecycleCallbacks) {
            if (!z10 || fragmentLifecycleCallbacksHolder.mRecursive) {
                fragmentLifecycleCallbacksHolder.mCallback.onFragmentActivityCreated(this.mFragmentManager, fragment, bundle);
            }
        }
    }

    public void dispatchOnFragmentAttached(@NonNull Fragment fragment, boolean z10) {
    ...
    public void dispatchOnFragmentCreated(@NonNull Fragment fragment, @Nullable Bundle bundle, boolean z10) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    public void dispatchOnFragmentDestroyed(@NonNull Fragment fragment, boolean z10) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    public void dispatchOnFragmentDetached(@NonNull Fragment fragment, boolean z10) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    public void dispatchOnFragmentPaused(@NonNull Fragment fragment, boolean z10) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    public void dispatchOnFragmentPreAttached(@NonNull Fragment fragment, boolean z10) {
        Context context = this.mFragmentManager.getHost().getContext();
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    public void dispatchOnFragmentPreCreated(@NonNull Fragment fragment, @Nullable Bundle bundle, boolean z10) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    public void dispatchOnFragmentResumed(@NonNull Fragment fragment, boolean z10) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    public void dispatchOnFragmentSaveInstanceState(@NonNull Fragment fragment, @NonNull Bundle bundle, boolean z10) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    public void dispatchOnFragmentStarted(@NonNull Fragment fragment, boolean z10) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    public void dispatchOnFragmentStopped(@NonNull Fragment fragment, boolean z10) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    public void dispatchOnFragmentViewCreated(@NonNull Fragment fragment, @NonNull View view, @Nullable Bundle bundle, boolean z10) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    public void dispatchOnFragmentViewDestroyed(@NonNull Fragment fragment, boolean z10) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    public void registerFragmentLifecycleCallbacks(@NonNull FragmentManager.FragmentLifecycleCallbacks fragmentLifecycleCallbacks, boolean z10) {
        this.mLifecycleCallbacks.add(new FragmentLifecycleCallbacksHolder(fragmentLifecycleCallbacks, z10));
    }
