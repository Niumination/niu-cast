...
class FastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
    ...
    public FastScroller(RecyclerView recyclerView, StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2, int i10, int i11, int i12) {
        ...
        this.mHideRunnable = new Runnable() { // from class: androidx.recyclerview.widget.FastScroller.1
            ...
            public void run() {
                FastScroller.this.hide(OSSwipeMenuLayout.D0);
            }
        };
    ...
    private void horizontalScrollTo(float f10) {
        ...
        float fMax = Math.max(horizontalRange[0], Math.min(horizontalRange[1], f10));
    ...
    private void verticalScrollTo(float f10) {
        ...
        float fMax = Math.max(verticalRange[0], Math.min(verticalRange[1], f10));
    ...
    public boolean isPointInsideVerticalThumb(float f10, float f11) {
        if (!isLayoutRTL() ? f10 >= this.mRecyclerViewWidth - this.mVerticalThumbWidth : f10 <= this.mVerticalThumbWidth / 2) {
    ...
    public void updateScrollPosition(int i10, int i11) {
        ...
        boolean z10 = iComputeHorizontalScrollRange - i13 > 0 && i13 >= this.mScrollbarMinimumRange;
        ...
        if (z11) {
            float f10 = i12;
            this.mVerticalThumbCenterY = (int) ((((f10 / 2.0f) + i11) * f10) / iComputeVerticalScrollRange);
            this.mVerticalThumbHeight = Math.min(i12, (i12 * i12) / iComputeVerticalScrollRange);
        }
        if (this.mNeedHorizontalScrollbar) {
            float f11 = i13;
            this.mHorizontalThumbCenterX = (int) ((((f11 / 2.0f) + i10) * f11) / iComputeHorizontalScrollRange);
