...
public final class OnBackPressedDispatcher {
    ...
    public OnBackPressedDispatcher(@Nullable Runnable runnable) {
        ...
        if (BuildCompat.isAtLeastT()) {
            this.mEnabledConsumer = new Consumer() { // from class: d.f
                @Override // androidx.core.util.Consumer
                public final void accept(Object obj) {
                    this.f3500a.lambda$new$0((Boolean) obj);
                }
            };
            this.mOnBackInvokedCallback = Api33Impl.createOnBackInvokedCallback(new Runnable() { // from class: d.g
                @Override // java.lang.Runnable
                public final void run() {
                    this.f3501a.onBackPressed();
                }
            });
        }
    }
