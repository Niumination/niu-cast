...
public class ComponentActivity extends androidx.core.app.ComponentActivity implements ContextAware, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, OnBackPressedDispatcherOwner, ActivityResultRegistryOwner, ActivityResultCaller, OnConfigurationChangedProvider, OnTrimMemoryProvider, OnNewIntentProvider, OnMultiWindowModeChangedProvider, OnPictureInPictureModeChangedProvider, MenuHost {
    ...
    public ComponentActivity() {
        ...
        this.mMenuHostHelper = new MenuHostHelper(new Runnable() { // from class: d.a
            @Override // java.lang.Runnable
            public final void run() {
                this.f3496a.invalidateMenu();
            }
        });
        ...
        this.mActivityResultRegistry = new ActivityResultRegistry() { // from class: androidx.activity.ComponentActivity.2
            ...
            public <I, O> void onLaunch(final int i10, @NonNull ActivityResultContract<I, O> activityResultContract, I i11, @Nullable ActivityOptionsCompat activityOptionsCompat) {
                ...
                if (!ActivityResultContracts.StartIntentSenderForResult.ACTION_INTENT_SENDER_REQUEST.equals(intentCreateIntent.getAction())) {
                    ActivityCompat.startActivityForResult(componentActivity, intentCreateIntent, i10, bundle);
                    return;
                }
        ...
        getSavedStateRegistry().registerSavedStateProvider(ACTIVITY_RESULT_TAG, new SavedStateRegistry.SavedStateProvider() { // from class: d.b
            @Override // androidx.savedstate.SavedStateRegistry.SavedStateProvider
            public final Bundle saveState() {
                return this.f3497a.lambda$new$0();
            }
        });
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: d.c
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void onContextAvailable(Context context) {
                this.f3498a.lambda$new$1(context);
            }
        });
    }
    ...
    public void addContentView(@a({"UnknownNullness", "MissingNullability"}) View view, @a({"UnknownNullness", "MissingNullability"}) ViewGroup.LayoutParams layoutParams) {
        initViewTreeOwners();
    ...
    @Override // android.app.Activity
    @CallSuper
    public void onNewIntent(@a({"UnknownNullness", "MissingNullability"}) Intent intent) {
    ...
    @Override // android.app.Activity
    public void setContentView(@a({"UnknownNullness", "MissingNullability"}) View view) {
        initViewTreeOwners();
    ...
    @Override // android.app.Activity
    public void setContentView(@a({"UnknownNullness", "MissingNullability"}) View view, @a({"UnknownNullness", "MissingNullability"}) ViewGroup.LayoutParams layoutParams) {
        initViewTreeOwners();
