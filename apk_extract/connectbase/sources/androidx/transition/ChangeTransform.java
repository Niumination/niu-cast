...
public class ChangeTransform extends Transition {
    ...
    private void createGhostView(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        ?? r10 = this;
        while (true) {
            TransitionSet transitionSet = r10.mParent;
        ...
        r10.addListener(new GhostListener(view, ghostViewAddGhost));
    ...
    private ObjectAnimator createTransformAnimator(TransitionValues transitionValues, TransitionValues transitionValues2, final boolean z10) {
    ...
    public Animator createAnimator(@NonNull ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        ObjectAnimator objectAnimatorCreateTransformAnimator = createTransformAnimator(transitionValues, transitionValues2, z10);
        if (z10 && objectAnimatorCreateTransformAnimator != null && this.mUseOverlay) {
