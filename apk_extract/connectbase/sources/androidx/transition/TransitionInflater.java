...
public class TransitionInflater {
    ...
    private Object createCustom(AttributeSet attributeSet, Class<?> cls, String str) {
        ...
        if (attributeValue == null) {
            throw new InflateException(a.a(str, " tag must have a 'class' attribute"));
        }
        try {
                            ...
                            if (namedString2 != null) {
                                ...
                                if (namedString3 != null) {
                                    try {
                                        ...
                                        throw new RuntimeException(m.a.a("Could not create ", namedString3), e10);
                                    }
                                } else {
    ...
    private void loadTransition(AttributeSet attributeSet, XmlPullParser xmlPullParser, ViewGroup viewGroup, TransitionManager transitionManager) throws Resources.NotFoundException {
        ...
        if (namedResourceId >= 0 && (transitionInflateTransition = inflateTransition(namedResourceId)) != null) {
            if (sceneForLayout2 == null) {
                throw new RuntimeException(h.a.a("No toScene for transition ID ", namedResourceId));
            }
    ...
    public Transition inflateTransition(int i10) {
    ...
    public TransitionManager inflateTransitionManager(int i10, ViewGroup viewGroup) {
        XmlResourceParser xml = this.mContext.getResources().getXml(i10);
        try {
            try {
