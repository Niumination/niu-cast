...
public abstract class Transition implements Cloneable {
    ...
    private ArrayList<Integer> excludeId(ArrayList<Integer> arrayList, int i10, boolean z10) {
        if (i10 > 0) {
            return z10 ? ArrayListManager.add(arrayList, Integer.valueOf(i10)) : ArrayListManager.remove(arrayList, Integer.valueOf(i10));
        }
        return arrayList;
    }
    ...
    private static <T> ArrayList<T> excludeObject(ArrayList<T> arrayList, T t10, boolean z10) {
        if (t10 != null) {
            return z10 ? ArrayListManager.add(arrayList, t10) : ArrayListManager.remove(arrayList, t10);
        }
        return arrayList;
    }
    ...
    private ArrayList<Class<?>> excludeType(ArrayList<Class<?>> arrayList, Class<?> cls, boolean z10) {
        if (cls != null) {
            return z10 ? ArrayListManager.add(arrayList, cls) : ArrayListManager.remove(arrayList, cls);
        }
        return arrayList;
    }
    ...
    private ArrayList<View> excludeView(ArrayList<View> arrayList, View view, boolean z10) {
        if (view != null) {
            return z10 ? ArrayListManager.add(arrayList, view) : ArrayListManager.remove(arrayList, view);
        }
        return arrayList;
    }
    ...
    private static int[] parseMatchOrder(String str) {
        StringTokenizer stringTokenizer = new StringTokenizer(str, g.f9491d);
    ...
    public void createAnimators(ViewGroup viewGroup, TransitionValuesMaps transitionValuesMaps, TransitionValuesMaps transitionValuesMaps2, ArrayList<TransitionValues> arrayList, ArrayList<TransitionValues> arrayList2) {
        ...
        if (sparseIntArray.size() != 0) {
            for (int i14 = 0; i14 < sparseIntArray.size(); i14++) {
                ...
                animator3.setStartDelay(animator3.getStartDelay() + (((long) sparseIntArray.valueAt(i14)) - jMin));
            }
        }
    }
    ...
    public void end() {
        ...
        if (i10 == 0) {
            ...
            for (int i12 = 0; i12 < this.mStartValues.mItemIdValues.size(); i12++) {
                View viewValueAt = this.mStartValues.mItemIdValues.valueAt(i12);
                if (viewValueAt != null) {
                    ViewCompat.setHasTransientState(viewValueAt, false);
                }
            }
            for (int i13 = 0; i13 < this.mEndValues.mItemIdValues.size(); i13++) {
                View viewValueAt2 = this.mEndValues.mItemIdValues.valueAt(i13);
    ...
    public void pause(View view) {
        ...
        for (int i10 = size - 1; i10 >= 0; i10--) {
            AnimationInfo animationInfoValueAt = runningAnimators.valueAt(i10);
    ...
    public String toString(String str) {
        ...
        if (this.mDuration != -1) {
            string = d.a(c.a(string, "dur("), this.mDuration, ") ");
        }
        if (this.mStartDelay != -1) {
            string = d.a(c.a(string, "dly("), this.mStartDelay, ") ");
        }
        if (this.mInterpolator != null) {
            StringBuilder sbA2 = c.a(string, "interp(");
    ...
    public Transition(Context context, AttributeSet attributeSet) {
        ...
        int namedResourceId = TypedArrayUtils.getNamedResourceId(typedArrayObtainStyledAttributes, xmlResourceParser, dc.d.f3689t, 0, 0);
