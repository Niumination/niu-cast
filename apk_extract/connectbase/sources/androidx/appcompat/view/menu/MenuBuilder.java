...
public class MenuBuilder implements SupportMenu {
    ...
    private void setShortcutsVisibleInner(boolean z10) {
        boolean z11;
        if (z10) {
            z11 = this.mResources.getConfiguration().keyboard != 1 && ViewConfigurationCompat.shouldShowMenuShortcutsWhenKeyboardPresent(ViewConfiguration.get(this.mContext), this.mContext);
        }
        this.mShortcutsVisible = z11;
    }
    ...
    public MenuItem addInternal(int i10, int i11, int i12, CharSequence charSequence) {
        ...
        MenuItemImpl menuItemImplCreateNewMenuItem = createNewMenuItem(i10, i11, i12, ordering, charSequence, this.mDefaultShowAsAction);
        ...
        if (keyEvent.getKeyData(keyData) || i10 == 67) {
            ...
            for (int i11 = 0; i11 < size; i11++) {
                ...
                if ((modifiers & SupportMenu.SUPPORTED_MODIFIERS_MASK) == ((zIsQwertyMode ? menuItemImpl.getAlphabeticModifiers() : menuItemImpl.getNumericModifiers()) & SupportMenu.SUPPORTED_MODIFIERS_MASK) && alphabeticShortcut != 0) {
                    char[] cArr = keyData.meta;
                    if ((alphabeticShortcut == cArr[0] || alphabeticShortcut == cArr[2] || (zIsQwertyMode && alphabeticShortcut == '\b' && i10 == 67)) && menuItemImpl.isEnabled()) {
    ...
    public boolean performShortcut(int i10, KeyEvent keyEvent, int i11) {
        MenuItemImpl menuItemImplFindItemWithShortcutForKey = findItemWithShortcutForKey(i10, keyEvent);
        boolean zPerformItemAction = menuItemImplFindItemWithShortcutForKey != null ? performItemAction(menuItemImplFindItemWithShortcutForKey, i11) : false;
        if ((i11 & 2) != 0) {
            close(true);
        }
    ...
    public void removeGroup(int i10) {
        ...
        if (iFindGroupIndex >= 0) {
            ...
            while (true) {
                int i12 = i11 + 1;
                if (i11 >= size || this.mItems.get(iFindGroupIndex).getGroupId() != i10) {
                    break;
                }
