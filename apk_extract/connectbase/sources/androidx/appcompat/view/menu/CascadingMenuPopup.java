...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private View findParentViewForSubmenu(@NonNull CascadingMenuInfo cascadingMenuInfo, @NonNull MenuBuilder menuBuilder) {
        ...
        while (true) {
            ...
            if (menuItemFindMenuItemForSubmenu == menuAdapter.getItem(i10)) {
                break;
            }
            i10++;
        }
        if (i10 != -1 && (firstVisiblePosition = (i10 + headersCount) - listView.getFirstVisiblePosition()) >= 0 && firstVisiblePosition < listView.getChildCount()) {
    ...
    private void showMenu(@NonNull MenuBuilder menuBuilder) {
        ...
        if (viewFindParentViewForSubmenu != null) {
            ...
            if ((this.mDropDownGravity & 5) != 5) {
                iMeasureIndividualMenuWidth = z10 ? viewFindParentViewForSubmenu.getWidth() : 0 - iMeasureIndividualMenuWidth;
            } else if (!z10) {
    ...
    public void onCloseMenu(MenuBuilder menuBuilder, boolean z10) {
        ...
        int i10 = iFindIndexOfAddedMenu + 1;
