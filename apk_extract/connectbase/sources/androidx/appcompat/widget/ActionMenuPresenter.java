...
class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public boolean flagActionItems() {
        ...
        if (actionMenuPresenter.mStrictWidthLimit) {
            ...
            iMeasureChildForCells = i12 / i17;
            i10 = ((i12 % i17) / iMeasureChildForCells) + i17;
        } else {
        ...
        while (i18 < size) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                View itemView = r12.getItemView(menuItemImpl2, view, viewGroup);
                if (r12.mStrictWidthLimit) {
                    iMeasureChildForCells -= ActionMenuView.measureChildForCells(itemView, i10, iMeasureChildForCells, iMakeMeasureSpec, r11);
                } else {
                ...
                boolean z12 = (i16 > 0 || z11) && i12 > 0 && (!r12.mStrictWidthLimit || iMeasureChildForCells > 0);
                boolean z13 = z12;
                if (z12) {
                    View itemView2 = r12.getItemView(menuItemImpl2, null, viewGroup);
                    if (r12.mStrictWidthLimit) {
                    ...
                    z12 = z14 & (!r12.mStrictWidthLimit ? i12 + i19 <= 0 : i12 < 0);
                }
                if (z12 && groupId2 != 0) {
                ...
                r10 = r11;
                menuItemImpl2.setIsActionButton(r10);
            }
            i18++;
            r11 = r10;
            size = size;
