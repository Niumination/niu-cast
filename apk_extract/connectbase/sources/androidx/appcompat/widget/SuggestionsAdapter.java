...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private Drawable getActivityIcon(ComponentName componentName) {
        ...
        try {
            ...
            StringBuilder sbA = h.b.a("Invalid icon resource ", iconResource, " for ");
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    Log.e(LOG_TAG, "Error closing icon stream for " + uri, e11);
                }
                throw th2;
            }
        } catch (FileNotFoundException e12) {
            Log.w(LOG_TAG, "Icon not found: " + uri + ", " + e12.getMessage());
            return null;
        }
        Log.w(LOG_TAG, "Icon not found: " + uri + ", " + e12.getMessage());
        return null;
    ...
    private Drawable getDrawableFromResourceValue(String str) {
        if (str == null || str.isEmpty() || hi.b.f7118g.equals(str)) {
            return null;
        }
        try {
    ...
    public Cursor getSearchManagerSuggestions(SearchableInfo searchableInfo, String str, int i10) {
        ...
        Uri.Builder builderFragment = new Uri.Builder().scheme(t2.a.f15437d).authority(suggestAuthority).query("").fragment("");
