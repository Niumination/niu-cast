...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class PreQAutoCompleteTextViewReflector {
        ...
        @b.a({"DiscouragedPrivateApi", "SoonBlockedPrivateApi"})
    ...
    public static class UpdatableTouchDelegate extends TouchDelegate {
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (action != 0) {
                ...
                z12 = z11;
                z10 = true;
            } else if (this.mTargetBounds.contains(x10, y10)) {
    ...
    public SearchView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i10) {
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, R.styleable.SearchView, i10, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, R.styleable.SearchView, attributeSet, tintTypedArrayObtainStyledAttributes.getWrappedTypeArray(), i10, 0);
        ...
        int i11 = tintTypedArrayObtainStyledAttributes.getInt(R.styleable.SearchView_android_imeOptions, -1);
        if (i11 != -1) {
            setImeOptions(i11);
        }
        int i12 = tintTypedArrayObtainStyledAttributes.getInt(R.styleable.SearchView_android_inputType, -1);
        if (i12 != -1) {
            setInputType(i12);
        }
