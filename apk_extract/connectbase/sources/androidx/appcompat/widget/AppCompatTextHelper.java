...
class AppCompatTextHelper {
    ...
    private void updateTypefaceAndStyle(Context context, TintTypedArray tintTypedArray) {
        ...
        final int i13 = this.mFontWeight;
        final int i14 = this.mStyle;
        if (!context.isRestricted()) {
            ...
            try {
                Typeface font = tintTypedArray.getFont(i12, this.mStyle, new ResourcesCompat.FontCallback() { // from class: androidx.appcompat.widget.AppCompatTextHelper.1
                    ...
                    public void lambda$callbackFailAsync$1(int i15) {
                    }
                    ...
                    public void lambda$callbackSuccessAsync$0(@NonNull Typeface typeface) {
                        int i15 = i13;
                        if (i15 != -1) {
                            typeface = Api28Impl.create(typeface, i15, (i14 & 2) != 0);
                        }
    ...
    public void loadFromAttributes(@Nullable AttributeSet attributeSet, int i10) {
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, R.styleable.AppCompatTextHelper, i10, 0);
        TextView textView = this.mView;
        ViewCompat.saveAttributeDataForStyleable(textView, textView.getContext(), R.styleable.AppCompatTextHelper, attributeSet, tintTypedArrayObtainStyledAttributes.getWrappedTypeArray(), i10, 0);
        ...
        if (resourceId != -1) {
            ...
            if (z12 || !tintTypedArrayObtainStyledAttributes2.hasValue(R.styleable.TextAppearance_textAllCaps)) {
                ...
                z10 = tintTypedArrayObtainStyledAttributes2.getBoolean(R.styleable.TextAppearance_textAllCaps, false);
                z11 = true;
            }
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes3 = TintTypedArray.obtainStyledAttributes(context, attributeSet, R.styleable.TextAppearance, i10, 0);
        if (z12 || !tintTypedArrayObtainStyledAttributes3.hasValue(R.styleable.TextAppearance_textAllCaps)) {
            z13 = z11;
        } else {
            z10 = tintTypedArrayObtainStyledAttributes3.getBoolean(R.styleable.TextAppearance_textAllCaps, false);
        }
    ...
    public void onSetTextAppearance(Context context, int i10) {
        String string;
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, i10, R.styleable.TextAppearance);
