...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public static final class Api17Impl {
        ...
        @DoNotInline
        public static void setTextAlignment(@NonNull View view, int i10) {
            view.setTextAlignment(i10);
        }

        @DoNotInline
        public static void setTextDirection(@NonNull View view, int i10) {
    ...
    public class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
        ...
        public void computeContentWidth() {
            ...
            setHorizontalOffset(ViewUtils.isLayoutRtl(AppCompatSpinner.this) ? (((width - paddingRight) - getWidth()) - getHorizontalOriginalOffset()) + i10 : paddingLeft + getHorizontalOriginalOffset() + i10);
        }
    ...
    public AppCompatSpinner(@NonNull Context context, @Nullable AttributeSet attributeSet, int i10, int i11, Resources.Theme theme) throws Throwable {
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, androidx.appcompat.R.styleable.Spinner, i10, 0);
        ...
        try {
                ...
                try {
                    ...
                    try {
                        ...
                        if (i11 != 0) {
                            ...
                            TintTypedArray tintTypedArrayObtainStyledAttributes2 = TintTypedArray.obtainStyledAttributes(this.mPopupContext, attributeSet, androidx.appcompat.R.styleable.Spinner, i10, 0);
            ...
            if (i11 != 0) {
                ...
                TintTypedArray tintTypedArrayObtainStyledAttributes3 = TintTypedArray.obtainStyledAttributes(this.mPopupContext, attributeSet, androidx.appcompat.R.styleable.Spinner, i10, 0);
