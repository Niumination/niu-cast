...
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int gravity = getGravity() & y5.a.f20716e0;
        if (gravity == 16) {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (i10 == 1) {
                ...
                float fConstrain = constrain(this.mThumbPosition + f10, 0.0f, 1.0f);
    ...
    public void setSwitchTextAppearance(Context context, int i10) {
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, i10, androidx.appcompat.R.styleable.TextAppearance);
    ...
    public SwitchCompat(@NonNull Context context, @Nullable AttributeSet attributeSet, int i10) {
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, androidx.appcompat.R.styleable.SwitchCompat, i10, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, androidx.appcompat.R.styleable.SwitchCompat, attributeSet, tintTypedArrayObtainStyledAttributes.getWrappedTypeArray(), i10, 0);
