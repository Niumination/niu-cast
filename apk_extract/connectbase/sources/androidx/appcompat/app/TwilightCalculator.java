...
class TwilightCalculator {
    ...
    public void calculateTwilight(long j10, double d10, double d11) {
        float f10 = (j10 - UTC_2000) / 8.64E7f;
        ...
        double dSin2 = (Math.sin(2.0d * dSin) * (-0.0069d)) + (Math.sin(d12) * 0.0053d) + ((double) (Math.round(((double) (f10 - J0)) - d13) + J0)) + d13;
