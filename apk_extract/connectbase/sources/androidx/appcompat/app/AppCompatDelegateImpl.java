...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public class AnonymousClass1 implements Thread.UncaughtExceptionHandler {
        ...
        private boolean shouldWrapException(Throwable th2) {
            ...
            return message.contains(d.f3677h) || message.contains("Drawable");
        }
    ...
    public static class Api33Impl {
        ...
        public static OnBackInvokedCallback registerOnBackPressedCallback(Object obj, final AppCompatDelegateImpl appCompatDelegateImpl) {
            ...
            f.d.a(obj).registerOnBackInvokedCallback(g.f10254a, onBackInvokedCallback);
            return onBackInvokedCallback;
        }

        @DoNotInline
        public static void unregisterOnBackInvokedCallback(Object obj, Object obj2) {
            f.d.a(obj).unregisterOnBackInvokedCallback(c.a(obj2));
        }
    }
    ...
    public class AppCompatWindowCallback extends WindowCallbackWrapper {
        ...
        public boolean onPreparePanel(int i10, View view, Menu menu) {
            ...
            ActionBarMenuCallback actionBarMenuCallback = this.mActionBarCallback;
            boolean zOnPreparePanel = actionBarMenuCallback != null && actionBarMenuCallback.onPreparePanel(i10);
            if (!zOnPreparePanel) {
        ...
        public android.view.ActionMode onWindowStartingActionMode(android.view.ActionMode.Callback callback, int i10) {
            return (AppCompatDelegateImpl.this.isHandleNativeActionModesEnabled() && i10 == 0) ? startAsSupportActionMode(callback) : super.onWindowStartingActionMode(callback, i10);
        }
    }
    ...
    public final class PanelMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public void onCloseMenu(@NonNull MenuBuilder menuBuilder, boolean z10) {
            ...
            if (panelFeatureStateFindMenuPanel != null) {
                if (!z11) {
                    AppCompatDelegateImpl.this.closePanel(panelFeatureStateFindMenuPanel, z10);
                } else {
    ...
    private boolean onKeyUpPanel(int i10, KeyEvent keyEvent) {
        ...
        if (i10 != 0 || (decorContentParent = this.mDecorContentParent) == null || !decorContentParent.canShowOverflowMenu() || ViewConfiguration.get(this.mContext).hasPermanentMenuKey()) {
            boolean z10 = panelState.isOpen;
            if (z10 || panelState.isHandled) {
                closePanel(panelState, true);
                zHideOverflowMenu = z10;
    ...
    private void openPanel(PanelFeatureState panelFeatureState, KeyEvent keyEvent) {
        ...
        if (windowManager != null && preparePanel(panelFeatureState, keyEvent)) {
            ...
            if (viewGroup != null && !panelFeatureState.refreshDecorView) {
                ...
                WindowManager.LayoutParams layoutParams2 = new WindowManager.LayoutParams(i10, -2, panelFeatureState.f422x, panelFeatureState.f423y, PointerIconCompat.TYPE_HAND, 8519680, -3);
            ...
            i10 = -2;
            panelFeatureState.isHandled = false;
            WindowManager.LayoutParams layoutParams4 = new WindowManager.LayoutParams(i10, -2, panelFeatureState.f422x, panelFeatureState.f423y, PointerIconCompat.TYPE_HAND, 8519680, -3);
    ...
    private boolean updateAppConfiguration(int i10, @Nullable LocaleListCompat localeListCompat, boolean z10) {
        boolean z11;
        Configuration configurationCreateOverrideAppConfiguration = createOverrideAppConfiguration(this.mContext, i10, localeListCompat, null, false);
        ...
        int i12 = configurationCreateOverrideAppConfiguration.uiMode & 48;
    ...
    public boolean hasWindowFeature(int i10) {
        boolean z10;
        int iSanitizeWindowFeatureId = sanitizeWindowFeatureId(i10);
        if (iSanitizeWindowFeatureId == 1) {
            ...
            z10 = iSanitizeWindowFeatureId != 109 ? false : this.mOverlayActionBar;
        } else {
            z10 = this.mHasActionBar;
        }
        return z10 || this.mWindow.hasFeature(i10);
    }
    ...
    private boolean applyApplicationSpecificConfig(boolean z10, boolean z11) {
        ...
        if (!z11 && localeListCompatCalculateApplicationLocales != null) {
            localeListCompatCalculateApplicationLocales = getConfigurationLocales(this.mContext.getResources().getConfiguration());
        }
        boolean zUpdateAppConfiguration = updateAppConfiguration(iMapNightMode, localeListCompatCalculateApplicationLocales, z10);
