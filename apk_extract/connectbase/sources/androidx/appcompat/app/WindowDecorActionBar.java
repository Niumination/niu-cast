...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private DecorToolbar getDecorToolbar(View view) {
        ...
        throw new IllegalStateException("Can't make a decor toolbar out of ".concat(view != 0 ? view.getClass().getSimpleName() : d6.a.E));
    }
    ...
    public void doHide(boolean z10) {
        ...
        ViewPropertyAnimatorCompat viewPropertyAnimatorCompatTranslationY = ViewCompat.animate(this.mContainerView).translationY(f10);
    ...
    public void removeTabAt(int i10) {
        ...
        TabImpl tabImplRemove = this.mTabs.remove(i10);
