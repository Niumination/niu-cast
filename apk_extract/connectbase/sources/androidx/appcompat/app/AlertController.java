...
class AlertController {
    ...
    private void setupView() {
        ...
        boolean z11 = (viewGroupResolvePanel == null || viewGroupResolvePanel.getVisibility() == 8) ? 0 : 1;
        boolean z12 = (viewGroupResolvePanel3 == null || viewGroupResolvePanel3.getVisibility() == 8) ? false : true;
        if (!z12 && viewGroupResolvePanel2 != null && (viewFindViewById2 = viewGroupResolvePanel2.findViewById(androidx.appcompat.R.id.textSpacerNoButtons)) != null) {
        ...
        if (!z10) {
            ...
            if (view != null) {
                setScrollIndicators(viewGroupResolvePanel2, view, z11 | (z12 ? 2 : 0), 3);
            }
        }
