...
public class DrawableContainerCompat extends Drawable implements Drawable.Callback {
    ...
    public static abstract class DrawableContainerState extends Drawable.ConstantState {
        ...
        public final Drawable getChild(int i10) {
            ...
            this.mDrawables[i10] = drawablePrepareDrawable;
        ...
        if (drawable2 != null) {
            ...
            if (j11 != 0) {
                if (j11 <= jUptimeMillis) {
                    ...
                    drawable2.setAlpha(((255 - (((int) ((j11 - jUptimeMillis) * 255)) / this.mDrawableContainerState.mEnterFadeDuration)) * this.mAlpha) / 255);
                    z11 = true;
                }
            }
            drawable = this.mLastDrawable;
            if (drawable != null) {
                j10 = this.mExitAnimationEnd;
                if (j10 == 0) {
                    if (j10 <= jUptimeMillis) {
                        ...
                        drawable.setAlpha(((((int) ((j10 - jUptimeMillis) * 255)) / this.mDrawableContainerState.mExitFadeDuration) * this.mAlpha) / 255);
                    }
                }
                if (z10 || !z12) {
                }
        ...
        if (i10 >= 0) {
            ...
            if (i10 < drawableContainerState.mNumChildren) {
                ...
                if (child != null) {
                    ...
                    if (i11 > 0) {
                        this.mEnterAnimationEnd = jUptimeMillis + ((long) i11);
                    }
