...
public abstract class ConstraintHelper extends View {
    ...
    private int findId(String referenceId) {
        ...
        return iFindId == 0 ? this.myContext.getResources().getIdentifier(referenceId, d.f3692w, this.myContext.getPackageName()) : iFindId;
    }
    ...
    public void setIds(String idList) {
        ...
        while (true) {
            ...
            if (iIndexOf == -1) {
                ...
                addID(idList.substring(i10, iIndexOf));
                i10 = iIndexOf + 1;
            }
        }
    }
    ...
    public void setReferenceTags(String tagList) {
        ...
        while (true) {
            ...
            if (iIndexOf == -1) {
                ...
                addTag(tagList.substring(i10, iIndexOf));
                i10 = iIndexOf + 1;
            }
        }
    }
    ...
    public void updatePreLayout(ConstraintLayout container) {
        ...
        for (int i10 = 0; i10 < this.mCount; i10++) {
            ...
            if (viewById == null && (iFindId = findId(container, (str = this.mMap.get(Integer.valueOf(i11))))) != 0) {
