...
public class ConstraintSet {
    ...
    public class WriteXmlEngine {
        ...
        private void writeEnum(String dimString, int val, String[] types, int def) throws IOException {
            if (val != def) {
                ...
                StringBuilder sbA = e.a.a(SPACE, dimString, "=\"");
        ...
        public String getName(int id2) {
            if (this.idMap.containsKey(Integer.valueOf(id2))) {
                return c.a(new StringBuilder("@+id/"), this.idMap.get(Integer.valueOf(id2)), "");
            }
            if (id2 == 0) {
                return ConstraintSet.KEY_PERCENT_PARENT;
            }
            String strLookup = lookup(id2);
            this.idMap.put(Integer.valueOf(id2), strLookup);
            return "@+id/" + strLookup + "";
        }
        ...
        public void writeLayout() throws IOException {
            ...
            for (Integer num : ConstraintSet.this.mConstraints.keySet()) {
                ...
                writeEnum("app:barrierDirection", layout.mBarrierDirection, new String[]{"left", "right", "top", "bottom", FloatingWindow.f2048b0, FloatingWindow.f2049c0}, -1);
        ...
        public void writeVariable(String name, String value) throws IOException {
            ...
            this.writer.write(":");
            this.writer.write(", ".concat(value));
            this.writer.write("\n");
        }
    }
    ...
    private int[] convertReferenceString(View view, String referenceIdString) {
        ...
        String[] strArrSplit = referenceIdString.split(g.f9491d);
        ...
        while (i10 < strArrSplit.length) {
            ...
            if (iIntValue == 0) {
                iIntValue = context.getResources().getIdentifier(strTrim, d.f3692w, context.getPackageName());
            }
    ...
    public static void parseDimensionConstraints(Object data, TypedArray a10, int attr, int orientation) {
        ...
        int i11 = 0;
        if (i10 != 5) {
            dimensionPixelSize = a10.getInt(attr, 0);
            ...
            if (data instanceof Constraint.Delta) {
                ...
                if (orientation == 0) {
                    ...
                    delta.add(21, i11);
                    delta.add(CONSTRAINED_HEIGHT, z10);
                }
            }
        }
    ...
    public static void parseDimensionRatioString(ConstraintLayout.LayoutParams params, String value) {
        ...
        if (value != null) {
            ...
            int iIndexOf2 = value.indexOf(WIDTH_MIN);
            try {
        ...
        for (int i10 = 0; i10 < indexCount; i10++) {
            ...
            switch (overrideMapToConstant.get(index)) {
                ...
                case 56:
                    ...
                    break;
                case HEIGHT_MAX /* 57 */:
                    delta.add(HEIGHT_MAX, a10.getDimensionPixelSize(index, c10.layout.heightMax));
                    break;
                case WIDTH_MIN /* 58 */:
                    delta.add(WIDTH_MIN, a10.getDimensionPixelSize(index, c10.layout.widthMin));
                    break;
                case HEIGHT_MIN /* 59 */:
                    delta.add(HEIGHT_MIN, a10.getDimensionPixelSize(index, c10.layout.heightMin));
                    break;
                case 60:
                    delta.add(60, a10.getFloat(index, c10.transform.rotation));
                    break;
                case CIRCLE_RADIUS /* 62 */:
                    delta.add(CIRCLE_RADIUS, a10.getDimensionPixelSize(index, c10.layout.circleRadius));
                    break;
                case 63:
                ...
                case 67:
                    ...
                    break;
                case PROGRESS /* 68 */:
                    delta.add(PROGRESS, a10.getFloat(index, c10.propertySet.mProgress));
                    break;
                case WIDTH_PERCENT /* 69 */:
                    delta.add(WIDTH_PERCENT, a10.getFloat(index, 1.0f));
                    break;
                case HEIGHT_PERCENT /* 70 */:
                    delta.add(HEIGHT_PERCENT, a10.getFloat(index, 1.0f));
                    break;
                case CHAIN_USE_RTL /* 71 */:
                    Log.e(TAG, "CURRENTLY UNSUPPORTED");
                    break;
                case 72:
                    ...
                    break;
                case BARRIER_MARGIN /* 73 */:
                    delta.add(BARRIER_MARGIN, a10.getDimensionPixelSize(index, c10.layout.mBarrierMargin));
                    break;
                case CONSTRAINT_REFERENCED_IDS /* 74 */:
                    delta.add(CONSTRAINT_REFERENCED_IDS, a10.getString(index));
                    break;
                case BARRIER_ALLOWS_GONE_WIDGETS /* 75 */:
                    delta.add(BARRIER_ALLOWS_GONE_WIDGETS, a10.getBoolean(index, c10.layout.mBarrierAllowsGoneWidgets));
                    break;
                case 76:
                    delta.add(76, a10.getInt(index, c10.motion.mPathMotionArc));
                    break;
                case CONSTRAINT_TAG /* 77 */:
                    delta.add(CONSTRAINT_TAG, a10.getString(index));
                    break;
                case VISIBILITY_MODE /* 78 */:
                    delta.add(VISIBILITY_MODE, a10.getInt(index, c10.propertySet.mVisibilityMode));
                    break;
                case MOTION_STAGGER /* 79 */:
                    delta.add(MOTION_STAGGER, a10.getFloat(index, c10.motion.mMotionStagger));
                    break;
                case 80:
                    delta.add(80, a10.getBoolean(index, c10.layout.constrainedWidth));
                    break;
                case CONSTRAINED_HEIGHT /* 81 */:
                    delta.add(CONSTRAINED_HEIGHT, a10.getBoolean(index, c10.layout.constrainedHeight));
                    break;
                case ANIMATE_CIRCLE_ANGLE_TO /* 82 */:
                    delta.add(ANIMATE_CIRCLE_ANGLE_TO, a10.getInteger(index, c10.motion.mAnimateCircleAngleTo));
                    break;
                case TRANSFORM_PIVOT_TARGET /* 83 */:
                    delta.add(TRANSFORM_PIVOT_TARGET, lookupID(a10, index, c10.transform.transformPivotTarget));
                    break;
                case QUANTIZE_MOTION_STEPS /* 84 */:
                    delta.add(QUANTIZE_MOTION_STEPS, a10.getInteger(index, c10.motion.mQuantizeMotionSteps));
                    break;
                case QUANTIZE_MOTION_PHASE /* 85 */:
                    delta.add(QUANTIZE_MOTION_PHASE, a10.getFloat(index, c10.motion.mQuantizeMotionPhase));
                    break;
                case QUANTIZE_MOTION_INTERPOLATOR /* 86 */:
                    int i11 = a10.peekValue(index).type;
                    if (i11 == 1) {
                        c10.motion.mQuantizeInterpolatorID = a10.getResourceId(index, -1);
                        delta.add(QUANTIZE_MOTION_INTERPOLATOR_ID, c10.motion.mQuantizeInterpolatorID);
                        Motion motion = c10.motion;
                        ...
                        c10.motion.mQuantizeInterpolatorString = a10.getString(index);
                        delta.add(QUANTIZE_MOTION_INTERPOLATOR_STR, c10.motion.mQuantizeInterpolatorString);
                        if (c10.motion.mQuantizeInterpolatorString.indexOf("/") > 0) {
                            c10.motion.mQuantizeInterpolatorID = a10.getResourceId(index, -1);
                            delta.add(QUANTIZE_MOTION_INTERPOLATOR_ID, c10.motion.mQuantizeInterpolatorID);
                            c10.motion.mQuantizeInterpolatorType = -2;
                ...
                case 93:
                    ...
                    break;
                case GONE_BASELINE_MARGIN /* 94 */:
                    delta.add(GONE_BASELINE_MARGIN, a10.getDimensionPixelSize(index, c10.layout.goneBaselineMargin));
                    break;
                case 95:
                ...
                case LAYOUT_CONSTRAINT_HEIGHT /* 96 */:
                    ...
                    break;
                case LAYOUT_WRAP_BEHAVIOR /* 97 */:
                    delta.add(LAYOUT_WRAP_BEHAVIOR, a10.getInt(index, c10.layout.mWrapBehavior));
                    break;
                ...
                case GUIDELINE_USE_RTL /* 99 */:
                    delta.add(GUIDELINE_USE_RTL, a10.getBoolean(index, c10.layout.guidelineUseRtl));
                    break;
            }
        }
    }
    ...
    private String sideToString(int side) {
        switch (side) {
            ...
            case 5:
                return "baseline";
            case 6:
                return FloatingWindow.f2048b0;
            case 7:
                return FloatingWindow.f2049c0;
            default:
                return "undefined";
        }
    }
    ...
    public void applyDeltaFrom(ConstraintSet cs2) {
        for (Constraint constraint : cs2.mConstraints.values()) {
        ...
        switch (startSide) {
            case 1:
                if (endSide == 1) {
                    ...
                    if (endSide != 2) {
                        throw new IllegalArgumentException(c.a(new StringBuilder("Left to "), sideToString(endSide), " undefined"));
                    }
            ...
            case 2:
                if (endSide == 1) {
                    ...
                    if (endSide != 2) {
                        throw new IllegalArgumentException(c.a(new StringBuilder("right to "), sideToString(endSide), " undefined"));
                    }
            ...
            default:
                StringBuilder sb2 = new StringBuilder();
                sb2.append(sideToString(startSide));
                sb2.append(" to ");
                throw new IllegalArgumentException(c.a(sb2, sideToString(endSide), " unknown"));
        }
    }
    ...
    public void parseColorAttributes(Constraint set, String attributes) {
        String[] strArrSplit = attributes.split(g.f9491d);
    ...
    public class WriteJsonEngine {
        ...
        public String getName(int id2) {
            if (this.idMap.containsKey(Integer.valueOf(id2))) {
                return c.a(new StringBuilder("'"), this.idMap.get(Integer.valueOf(id2)), "'");
            }
            if (id2 == 0) {
                return "'parent'";
            }
            ...
            while (eventType != 1) {
                if (eventType == 0) {
                    ...
                    switch (parser.getName()) {
                        case "Constraint":
                            constraintFillFromAttributeList = fillFromAttributeList(context, Xml.asAttributeSet(parser), false);
                            break;
                        case "ConstraintOverride":
                            constraintFillFromAttributeList = fillFromAttributeList(context, Xml.asAttributeSet(parser), true);
                            break;
                        case "Guideline":
                            constraintFillFromAttributeList = fillFromAttributeList(context, Xml.asAttributeSet(parser), false);
                        ...
                        case "PropertySet":
                            if (constraintFillFromAttributeList != null) {
                                constraintFillFromAttributeList.propertySet.fillFromAttributeList(context, Xml.asAttributeSet(parser));
                                break;
                            } else {
                        ...
                        case "Transform":
                            if (constraintFillFromAttributeList != null) {
                                constraintFillFromAttributeList.transform.fillFromAttributeList(context, Xml.asAttributeSet(parser));
                                break;
                            } else {
                                throw new RuntimeException(ERROR_MESSAGE + parser.getLineNumber());
                            }
                        ...
                        case "Layout":
                            if (constraintFillFromAttributeList != null) {
                                constraintFillFromAttributeList.layout.fillFromAttributeList(context, Xml.asAttributeSet(parser));
                                break;
                            } else {
                                throw new RuntimeException(ERROR_MESSAGE + parser.getLineNumber());
                            }
                        ...
                        case "Motion":
                            if (constraintFillFromAttributeList != null) {
                                constraintFillFromAttributeList.motion.fillFromAttributeList(context, Xml.asAttributeSet(parser));
                                break;
                            } else {
                                throw new RuntimeException(ERROR_MESSAGE + parser.getLineNumber());
                            }
                        ...
                        case "CustomMethod":
                            if (constraintFillFromAttributeList != null) {
                                ConstraintAttribute.parse(context, parser, constraintFillFromAttributeList.mCustomConstraints);
                                break;
                            } else {
                                throw new RuntimeException(ERROR_MESSAGE + parser.getLineNumber());
                            }
