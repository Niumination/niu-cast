...
public class ConstraintLayout extends ViewGroup {
    ...
    public class Measurer implements BasicMeasure.Measurer {
        ...
        public final void measure(ConstraintWidget widget, BasicMeasure.Measure measure) {
            ...
            if (i15 == 1) {
                ...
                iMakeMeasureSpec = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, i14, -2);
            } else if (i15 == 3) {
                iMakeMeasureSpec = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, widget.getHorizontalMargin() + i14, -1);
            } else if (i15 != 4) {
                iMakeMeasureSpec = 0;
            } else {
                iMakeMeasureSpec = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, i14, -2);
            ...
            if (i17 == 1) {
                ...
                iMakeMeasureSpec2 = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, i13, -2);
            } else if (i17 == 3) {
                iMakeMeasureSpec2 = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, widget.getVerticalMargin() + i13, -1);
            } else if (i17 != 4) {
                iMakeMeasureSpec2 = 0;
            } else {
                iMakeMeasureSpec2 = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, i13, -2);
            ...
            if (i19 != BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS && i19 != BasicMeasure.Measure.USE_GIVEN_DIMENSIONS && z14 && widget.mMatchConstraintDefaultWidth == 0 && z15 && widget.mMatchConstraintDefaultHeight == 0) {
                i10 = -1;
                iMax2 = 0;
                baseline = 0;
                iMax = 0;
                ...
                int i20 = widget.mMatchConstraintMinWidth;
                iMax = i20 > 0 ? Math.max(i20, measuredWidth) : measuredWidth;
                int i21 = widget.mMatchConstraintMaxWidth;
                if (i21 > 0) {
                    iMax = Math.min(i21, iMax);
                }
                int i22 = widget.mMatchConstraintMinHeight;
                iMax2 = i22 > 0 ? Math.max(i22, measuredHeight) : measuredHeight;
                int i23 = widget.mMatchConstraintMaxHeight;
                if (i23 > 0) {
        ...
        if (isInEditMode()) {
            ...
            for (int i11 = 0; i11 < childCount; i11++) {
                ...
                if (childAt.getVisibility() != 8 && (tag = childAt.getTag()) != null && (tag instanceof String)) {
                    String[] strArrSplit = ((String) tag).split(g.f9491d);
    ...
    public void resolveSystem(ConstraintWidgetContainer layout, int optimizationLevel, int widthMeasureSpec, int heightMeasureSpec) {
        ...
        this.mMeasurer.captureLayoutInfo(widthMeasureSpec, heightMeasureSpec, iMax, iMax2, paddingWidth, i10);
        ...
        layout.measure(optimizationLevel, mode, i11, mode2, i12, this.mLastMeasureWidth, this.mLastMeasureHeight, iMax4, iMax);
    }
    ...
    public void setSelfDimensionBehaviour(ConstraintWidgetContainer layout, int widthMode, int widthSize, int heightMode, int heightSize) {
        ...
        if (widthMode == Integer.MIN_VALUE) {
            ...
            dimensionBehaviour = ConstraintWidget.DimensionBehaviour.WRAP_CONTENT;
            widthSize = childCount == 0 ? Math.max(0, this.mMinWidth) : 0;
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public void resolveLayoutDirection(int layoutDirection) {
            ...
            int i16 = this.guideBegin;
            this.resolvedGuideBegin = i16;
            int i17 = this.guideEnd;
            this.resolvedGuideEnd = i17;
            float f11 = this.guidePercent;
            this.resolvedGuidePercent = f11;
            if (z11) {
