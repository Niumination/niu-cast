...
public class ConstraintAttribute {
    ...
    public static void setAttributes(View view, HashMap<String, ConstraintAttribute> map) {
        ...
        for (String str : map.keySet()) {
            ...
            String strA = !constraintAttribute.mMethod ? a.a("set", str) : str;
            try {
                ...
                StringBuilder sbA = e.a.a(" Custom Attribute \"", str, "\" not found on ");
                ...
                Log.e(TAG, cls.getName() + " must have a method " + strA);
            } catch (InvocationTargetException e12) {
                StringBuilder sbA2 = e.a.a(" Custom Attribute \"", str, "\" not found on ");
    ...
    public void applyCustom(View view) {
        ...
        String strA = !this.mMethod ? a.a("set", str) : str;
        try {
            switch (AnonymousClass1.$SwitchMap$androidx$constraintlayout$widget$ConstraintAttribute$AttributeType[this.mType.ordinal()]) {
                case 1:
                case 6:
                    cls.getMethod(strA, Integer.TYPE).invoke(view, Integer.valueOf(this.mIntegerValue));
                    break;
                case 2:
                    cls.getMethod(strA, Boolean.TYPE).invoke(view, Boolean.valueOf(this.mBooleanValue));
                    break;
                case 3:
                    cls.getMethod(strA, CharSequence.class).invoke(view, this.mStringValue);
                    break;
                case 4:
                    cls.getMethod(strA, Integer.TYPE).invoke(view, Integer.valueOf(this.mColorValue));
                    break;
                case 5:
                    Method method = cls.getMethod(strA, Drawable.class);
                    ColorDrawable colorDrawable = new ColorDrawable();
                    ...
                    break;
                case 7:
                    cls.getMethod(strA, Float.TYPE).invoke(view, Float.valueOf(this.mFloatValue));
                    break;
                case 8:
                    cls.getMethod(strA, Float.TYPE).invoke(view, Float.valueOf(this.mFloatValue));
                    break;
