    ...
    public void apply() {
        ...
        while (it2.hasNext()) {
            ...
            if (constraintReference2 == null) {
                ...
                if (obj != null) {
                    constraintReferenceConstraints.startToStart(obj).margin(this.mMarginStart);
                } else {
                    Object obj2 = this.mStartToEnd;
                    if (obj2 != null) {
                        constraintReferenceConstraints.startToEnd(obj2).margin(this.mMarginStart);
                    } else {
                        Object obj3 = this.mLeftToLeft;
                        if (obj3 != null) {
                            constraintReferenceConstraints.startToStart(obj3).margin(this.mMarginLeft);
                        } else {
                            Object obj4 = this.mLeftToRight;
                            if (obj4 != null) {
                                constraintReferenceConstraints.startToEnd(obj4).margin(this.mMarginLeft);
                            } else {
        ...
        if (constraintReference != null) {
            ...
            if (obj5 != null) {
                ...
                if (obj6 != null) {
                    ...
                    if (obj7 != null) {
                        constraintReference.endToStart(obj7).margin(this.mMarginRight);
                    } else {
                        Object obj8 = this.mRightToRight;
                        if (obj8 != null) {
                            constraintReference.endToEnd(obj8).margin(this.mMarginRight);
                        } else {
