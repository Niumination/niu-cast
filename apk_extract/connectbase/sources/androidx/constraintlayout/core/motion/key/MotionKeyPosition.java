...
public class MotionKeyPosition extends MotionKey {
    ...
    private void calcCartesianPosition(float f10, float f11, float f12, float f13) {
        ...
        this.mCalculatedPositionX = (int) (((Float.isNaN(this.mAltPercentX) ? 0.0f : this.mAltPercentX) * f15) + (f16 * f14) + f10);
        this.mCalculatedPositionY = (int) ((f15 * f18) + (f14 * f17) + f11);
    }
    ...
    private void calcPathPosition(float f10, float f11, float f12, float f13) {
        ...
        this.mCalculatedPositionX = ((-f15) * f18) + f17;
        this.mCalculatedPositionY = (f14 * f18) + (f15 * f16) + f11;
    }
