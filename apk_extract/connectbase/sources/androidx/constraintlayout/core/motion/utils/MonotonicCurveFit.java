    ...
    public double getSlope(double d10, int i10) {
        ...
        while (i11 < length - 1) {
            ...
            if (d11 <= d12) {
                ...
                return diff(d14, d15, d16, d17, dArr4[i11][i10], dArr4[i12][i10]) / d14;
            }
            i11 = i12;
        }
        return 0.0d;
    ...
    public double getPos(double d10, int i10) {
        ...
        while (i11 < length - 1) {
            ...
            if (d10 < d14) {
                ...
                double[][] dArr3 = this.mY;
                double d17 = dArr3[i11][i10];
                double d18 = dArr3[i14][i10];
                double[][] dArr4 = this.mTangent;
                return interpolate(d15, d16, d17, d18, dArr4[i11][i10], dArr4[i14][i10]);
            }
            i11 = i14;
        }
        return 0.0d;
