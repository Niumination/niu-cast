    ...
    private void defineChainProperties() {
        ...
        while (!z10) {
            ...
            if (constraintWidget.getVisibility() != 8) {
                ...
                int margin = constraintWidget.mListAnchors[i10].getMargin() + this.mTotalSize;
                this.mTotalSize = margin;
                int i12 = i10 + 1;
                this.mTotalSize = constraintWidget.mListAnchors[i12].getMargin() + margin;
                int margin2 = constraintWidget.mListAnchors[i10].getMargin() + this.mTotalMargins;
                this.mTotalMargins = margin2;
                this.mTotalMargins = constraintWidget.mListAnchors[i12].getMargin() + margin2;
