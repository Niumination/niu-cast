...
public class Grouping {
    ...
    public static WidgetGroup findDependents(ConstraintWidget constraintWidget, int i10, ArrayList<WidgetGroup> arrayList, WidgetGroup widgetGroup) {
        ...
        if (i11 != -1 && (widgetGroup == null || i11 != widgetGroup.f442id)) {
    ...
    public static boolean simpleSolvingPass(ConstraintWidgetContainer constraintWidgetContainer, BasicMeasure.Measurer measurer) {
        ...
        while (i12 < size) {
            ...
            if (!validInGroup(constraintWidgetContainer.getHorizontalDimensionBehaviour(), constraintWidgetContainer.getVerticalDimensionBehaviour(), constraintWidget2.getHorizontalDimensionBehaviour(), constraintWidget2.getVerticalDimensionBehaviour())) {
                ConstraintWidgetContainer.measure(i10, constraintWidget2, measurer, constraintWidgetContainer.mMeasure, BasicMeasure.Measure.SELF_DIMENSIONS);
            }
            boolean z12 = constraintWidget2 instanceof Guideline;
            if (z12) {
            ...
            if (constraintWidget2.mLeft.mTarget == null && constraintWidget2.mRight.mTarget == null && !z12 && !(constraintWidget2 instanceof Barrier)) {
                if (arrayList5 == null) {
                    arrayList5 = new ArrayList();
                }
                arrayList5.add(constraintWidget2);
            }
            if (constraintWidget2.mTop.mTarget == null && constraintWidget2.mBottom.mTarget == null && constraintWidget2.mBaseline.mTarget == null && !z12 && !(constraintWidget2 instanceof Barrier)) {
                if (arrayList6 == null) {
        ...
        if (arrayList2 != null) {
            for (HelperWidget helperWidget2 : arrayList2) {
                WidgetGroup widgetGroupFindDependents = findDependents(helperWidget2, i13, arrayList7, widgetGroup3);
                helperWidget2.addDependents(arrayList7, i13, widgetGroupFindDependents);
        ...
        if (arrayList4 != null) {
            for (HelperWidget helperWidget3 : arrayList4) {
                WidgetGroup widgetGroupFindDependents2 = findDependents(helperWidget3, i14, arrayList7, widgetGroup4);
                helperWidget3.addDependents(arrayList7, i14, widgetGroupFindDependents2);
        ...
        for (int i15 = 0; i15 < size; i15++) {
            ConstraintWidget constraintWidget3 = children.get(i15);
        ...
        if (constraintWidgetContainer.getHorizontalDimensionBehaviour() == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) {
            ...
            if (widgetGroup != null) {
                ...
                constraintWidgetContainer.setWidth(i16);
        ...
        if (constraintWidgetContainer.getVerticalDimensionBehaviour() == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) {
            ...
            if (widgetGroup6 != null) {
                ...
                constraintWidgetContainer.setHeight(i17);
                widgetGroup6.setAuthoritative(true);
                widgetGroup2 = widgetGroup6;
            }
            return (widgetGroup == null || widgetGroup2 != null) ? z11 : z10;
        }
        z10 = false;
        z11 = true;
        widgetGroup2 = null;
