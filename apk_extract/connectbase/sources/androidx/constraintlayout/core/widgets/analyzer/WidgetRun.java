...
public abstract class WidgetRun implements Dependency {
    ...
    private void resolveDimension(int i10, int i11) {
        ...
        if (i12 == 2) {
            ...
            if (parent != null) {
                DimensionDependency dimensionDependency = (i10 == 0 ? parent.horizontalRun : parent.verticalRun).dimension;
                if (dimensionDependency.resolved) {
                    ConstraintWidget constraintWidget = this.widget;
                    this.dimension.resolve(getLimitedDimension((int) ((dimensionDependency.value * (i10 == 0 ? constraintWidget.mMatchConstraintPercentWidth : constraintWidget.mMatchConstraintPercentHeight)) + 0.5f), i10));
                    return;
                }
                return;
            }
    ...
    public long wrapSize(int i10) {
        ...
        if (isCenterConnection()) {
            j10 = this.start.margin - this.end.margin;
        } else {
            if (i10 != 0) {
                return j11 - ((long) this.end.margin);
            }
            j10 = this.start.margin;
        }
        return j11 + j10;
    }
