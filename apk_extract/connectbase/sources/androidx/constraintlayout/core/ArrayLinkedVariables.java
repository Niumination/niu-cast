...
public class ArrayLinkedVariables implements ArrayRow.ArrayRowVariables {
    ...
    public void add(SolverVariable solverVariable, float f10, boolean z10) {
        ...
        if (f10 <= (-f11) || f10 >= f11) {
            ...
            if (i10 == -1) {
                ...
                this.mArrayIndices[0] = solverVariable.f429id;
            ...
            this.mArrayIndices[length] = solverVariable.f429id;
    ...
    public boolean contains(SolverVariable solverVariable) {
        ...
        for (int i11 = 0; i10 != -1 && i11 < this.currentSize; i11++) {
            if (this.mArrayIndices[i10] == solverVariable.f429id) {
                return true;
            }
            i10 = this.mArrayNextIndices[i10];
        }
    ...
    public String toString() {
        ...
        String string = "";
        for (int i11 = 0; i10 != -1 && i11 < this.currentSize; i11++) {
            StringBuilder sbA = a.a(j.a.a(string, " -> "));
            sbA.append(this.mArrayValues[i10]);
            sbA.append(" : ");
            StringBuilder sbA2 = a.a(sbA.toString());
            sbA2.append(this.mCache.mIndexedVariables[this.mArrayIndices[i10]]);
