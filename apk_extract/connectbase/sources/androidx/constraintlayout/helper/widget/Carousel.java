...
public class Carousel extends MotionHelper {
    ...
    public Carousel(Context context) {
        ...
        this.mUpdateRunnable = new Runnable() { // from class: androidx.constraintlayout.helper.widget.Carousel.1
            ...
            public void run() {
                ...
                final float f10 = Carousel.this.dampening * velocity;
    ...
    public void updateItems() {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            int iCount = (this.mIndex + i10) - this.startIndex;
        ...
        if (i13 != -1 && i13 != this.mIndex) {
            this.mMotionLayout.post(new Runnable() { // from class: p.a
                @Override // java.lang.Runnable
                public final void run() {
                    this.f12551a.lambda$updateItems$0();
                }
            });
    ...
    private boolean updateViewVisibility(View view, int visibility) {
        ...
        for (int i10 : motionLayout.getConstraintSetIds()) {
            zUpdateViewVisibility |= updateViewVisibility(i10, view, visibility);
        }
