...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public class DecelerateInterpolator extends MotionInterpolator {
        ...
        public float getInterpolation(float time) {
            ...
            if (f10 > 0.0f) {
                ...
                MotionLayout.this.mLastVelocity = f10 - (f11 * time);
                return ((f10 * time) - (((f11 * time) * time) / 2.0f)) + this.currentP;
            }
            float f12 = this.maxA;
            if ((-f10) / f12 < time) {
                time = (-f10) / f12;
            }
            MotionLayout.this.mLastVelocity = (f12 * time) + f10;
            return (((f12 * time) * time) / 2.0f) + (f10 * time) + this.currentP;
        }
    ...
    public class DevModeDraw {
        ...
        private void drawPathCartesianTicks(Canvas canvas, float x10, float y10) {
            ...
            canvas.drawText(str, ((fMin2 / 2.0f) - (this.mBounds.width() / 2)) + fMin, y10 - 20.0f, this.mTextPaint);
            ...
            canvas.drawText(str2, x10 + 5.0f, fMax - ((fMax2 / 2.0f) - (this.mBounds.height() / 2)), this.mTextPaint);
                ...
                if (mode != 4 || this.mPathMode[i10 - 1] != 0) {
                    ...
                    if (mode == 4) {
                        ...
                        if (i13 == 1) {
                            ...
                            if (i13 == 2) {
                                drawPathScreenTicks(canvas, f10 - 0.0f, f11 - 0.0f, width, height);
                            }
        ...
        private void drawTranslation(Canvas canvas, float x10, float y10, float x11, float y11) {
            canvas.drawRect(x10, y10, x11, y11, this.mPaintGraph);
            canvas.drawLine(x10, y10, x11, y11, this.mPaintGraph);
        }
    ...
    public class Model {
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c10) {
            View view = (View) c10.getCompanionWidget();
            StringBuilder sbA = c.a(title, " ");
            sbA.append(Debug.getName(view));
            String string = sbA.toString();
            Log.v(MotionLayout.TAG, string + "  ========= " + c10);
            int size = c10.getChildren().size();
            for (int i10 = 0; i10 < size; i10++) {
                String str = string + "[" + i10 + "] ";
                ConstraintWidget constraintWidget = c10.getChildren().get(i10);
                StringBuilder sbA2 = k.a.a(constraintWidget.mTop.mTarget != null ? "T" : "_");
                sbA2.append(constraintWidget.mBottom.mTarget != null ? "B" : "_");
                StringBuilder sbA3 = k.a.a(sbA2.toString());
                sbA3.append(constraintWidget.mLeft.mTarget != null ? "L" : "_");
                StringBuilder sbA4 = k.a.a(sbA3.toString());
                sbA4.append(constraintWidget.mRight.mTarget != null ? "R" : "_");
                String string2 = sbA4.toString();
                View view2 = (View) constraintWidget.getCompanionWidget();
                String name = Debug.getName(view2);
                if (view2 instanceof TextView) {
                    StringBuilder sbA5 = c.a(name, "(");
                    sbA5.append((Object) ((TextView) view2).getText());
                    sbA5.append(")");
                    name = sbA5.toString();
                }
                Log.v(MotionLayout.TAG, str + "  " + name + " " + constraintWidget + " " + string2);
            }
        ...
        private void debugLayoutParam(String str, ConstraintLayout.LayoutParams params) {
            StringBuilder sbA = k.a.a(" ".concat(params.startToStart != -1 ? "SS" : "__"));
            sbA.append(params.startToEnd != -1 ? "|SE" : "|__");
            StringBuilder sbA2 = k.a.a(sbA.toString());
            sbA2.append(params.endToStart != -1 ? "|ES" : "|__");
            StringBuilder sbA3 = k.a.a(sbA2.toString());
            sbA3.append(params.endToEnd != -1 ? "|EE" : "|__");
            StringBuilder sbA4 = k.a.a(sbA3.toString());
            sbA4.append(params.leftToLeft != -1 ? "|LL" : "|__");
            StringBuilder sbA5 = k.a.a(sbA4.toString());
            sbA5.append(params.leftToRight != -1 ? "|LR" : "|__");
            StringBuilder sbA6 = k.a.a(sbA5.toString());
            sbA6.append(params.rightToLeft != -1 ? "|RL" : "|__");
            StringBuilder sbA7 = k.a.a(sbA6.toString());
            sbA7.append(params.rightToRight != -1 ? "|RR" : "|__");
            StringBuilder sbA8 = k.a.a(sbA7.toString());
            sbA8.append(params.topToTop != -1 ? "|TT" : "|__");
            StringBuilder sbA9 = k.a.a(sbA8.toString());
            sbA9.append(params.topToBottom != -1 ? "|TB" : "|__");
            StringBuilder sbA10 = k.a.a(sbA9.toString());
            sbA10.append(params.bottomToTop != -1 ? "|BT" : "|__");
            StringBuilder sbA11 = k.a.a(sbA10.toString());
            sbA11.append(params.bottomToBottom != -1 ? "|BB" : "|__");
            Log.v(MotionLayout.TAG, str + sbA11.toString());
        }
        ...
        private void debugWidget(String str, ConstraintWidget child) {
            ...
            StringBuilder sbA = k.a.a(sb2.toString());
            ...
            Log.v(MotionLayout.TAG, str + sbA3.toString() + " ---  " + child);
        }
    ...
    private boolean handlesTouchEvent(float x10, float y10, View view, MotionEvent event) {
        ...
        while (true) {
            ...
            if (handlesTouchEvent((childAt.getLeft() + x10) - view.getScrollX(), (childAt.getTop() + y10) - view.getScrollY(), childAt, event)) {
                z10 = true;
                break;
            }
            childCount--;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if ((this.mDebugPath & 1) == 1 && !isInEditMode()) {
            ...
            if (j10 != -1) {
                ...
                if (j11 > 200000000) {
                    this.mLastFps = ((int) ((this.mFrames / (j11 * 1.0E-9f)) * 100.0f)) / 100.0f;
                    this.mFrames = 0;
            ...
            StringBuilder sbA = k.a.a(this.mLastFps + " fps " + Debug.getState(this, this.mBeginState) + " -> ");
            sbA.append(Debug.getState(this, this.mEndState));
            sbA.append(" (progress: ");
            sbA.append(progress);
            sbA.append(" ) state=");
            int i10 = this.mCurrentState;
            sbA.append(i10 == -1 ? "undefined" : Debug.getState(this, i10));
            String string = sbA.toString();
    ...
    public void evaluate(boolean force) {
        ...
        boolean z12 = false;
        if (this.mKeepAnimating || (this.mInTransition && (force || this.mTransitionGoalPosition != f10))) {
            float fSignum = Math.signum(this.mTransitionGoalPosition - f10);
            long nanoTime2 = getNanoTime();
            Interpolator interpolator3 = this.mInterpolator;
            float f11 = !(interpolator3 instanceof MotionInterpolator) ? (((nanoTime2 - this.mTransitionLastTime) * fSignum) * 1.0E-9f) / this.mTransitionDuration : 0.0f;
            float f12 = this.mTransitionLastPosition + f11;
            if (this.mTransitionInstantly) {
                f12 = this.mTransitionGoalPosition;
            }
            if ((fSignum <= 0.0f || f12 < this.mTransitionGoalPosition) && (fSignum > 0.0f || f12 > this.mTransitionGoalPosition)) {
                z10 = false;
            } else {
                f12 = this.mTransitionGoalPosition;
                this.mInTransition = false;
            ...
            if (interpolator3 == null || z10) {
                ...
                if (this.mTemporalInterpolator) {
                    ...
                    c10 = interpolator4 == stopLogic ? stopLogic.isStopped() ? (char) 2 : (char) 1 : (char) 0;
                    ...
                    if (interpolator5 instanceof MotionInterpolator) {
                        ...
                        if (Math.abs(velocity) * this.mTransitionDuration <= EPSILON && c10 == 2) {
                            this.mInTransition = false;
                        }
                    ...
                    if (interpolator6 instanceof MotionInterpolator) {
                        ...
                        this.mLastVelocity = ((interpolator6.getInterpolation(f12 + f11) - interpolation3) * fSignum) / f11;
                    }
                    f12 = interpolation3;
                }
                ...
                if (interpolator2 != null) {
                    float interpolation4 = interpolator2.getInterpolation((fSignum / this.mTransitionDuration) + f12);
                    this.mLastVelocity = interpolation4;
                    this.mLastVelocity = interpolation4 - this.mProgressInterpolator.getInterpolation(f12);
                }
                ...
                boolean z13 = (fSignum <= 0.0f && f12 >= this.mTransitionGoalPosition) || (fSignum <= 0.0f && f12 <= this.mTransitionGoalPosition);
                if (!this.mKeepAnimating && !this.mInTransition && z13) {
                    setState(TransitionState.FINISHED);
                }
                if (this.mMeasureDuringTransition) {
                    requestLayout();
                }
                this.mKeepAnimating = (!z13) | this.mKeepAnimating;
                if (f12 <= 0.0f && (i13 = this.mBeginState) != -1 && this.mCurrentState != i13) {
                ...
                if (f12 >= 1.0d) {
                    ...
                    if (i11 != i12) {
                        ...
                        this.mScene.getConstraintSet(i12).applyCustomAttributes(this);
                        setState(TransitionState.FINISHED);
                        z12 = true;
                    }
                }
                ...
                if (!this.mKeepAnimating && !this.mInTransition && ((fSignum > 0.0f && f12 == 1.0f) || (fSignum < 0.0f && f12 == 0.0f))) {
            ...
            interpolator2 = this.mProgressInterpolator;
            if (interpolator2 != null) {
                float interpolation5 = interpolator2.getInterpolation((fSignum / this.mTransitionDuration) + f12);
                this.mLastVelocity = interpolation5;
                this.mLastVelocity = interpolation5 - this.mProgressInterpolator.getInterpolation(f12);
            }
            while (i10 < childCount) {
                childAt = getChildAt(i10);
                motionController = this.mFrameArrayList.get(childAt);
        ...
        if (f13 < 1.0f) {
            ...
            this.mNeedsFireTransitionCompleted |= z12;
            if (z12 && !this.mInLayout) {
                requestLayout();
            }
    ...
    public void getAnchorDpDt(int mTouchAnchorId, float pos, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        Log.w(TAG, "WARNING could not find view id " + (viewById == null ? h.a.a("", mTouchAnchorId) : viewById.getContext().getResources().getResourceName(mTouchAnchorId)));
    }
    ...
    public static class MyTracker implements MotionTracker {
        ...
        private static MyTracker f445me = new MyTracker();
        ...
        public static MyTracker obtain() {
            f445me.tracker = VelocityTracker.obtain();
            return f445me;
        }
    ...
    public void transitionToState(int id2, int screenWidth, int screenHeight, int duration) {
        ...
        MotionScene motionScene = this.mScene;
        if (motionScene != null && (stateSet = motionScene.mStateSet) != null && (iConvertToConstraintSet = stateSet.convertToConstraintSet(this.mCurrentState, id2, screenWidth, screenHeight)) != -1) {
            id2 = iConvertToConstraintSet;
        }
        int i10 = this.mCurrentState;
        if (i10 == id2) {
            return;
    ...
    private void checkStructure(int csetId, ConstraintSet set) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            int id2 = childAt.getId();
            if (id2 == -1) {
                StringBuilder sbA = e.a.a("CHECK: ", name, " ALL VIEWS SHOULD HAVE ID's ");
                sbA.append(childAt.getClass().getName());
                sbA.append(" does not!");
                Log.w(TAG, sbA.toString());
            }
            if (set.getConstraint(id2) == null) {
                StringBuilder sbA2 = e.a.a("CHECK: ", name, " NO CONSTRAINTS for ");
