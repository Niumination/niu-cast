...
public class DesignTool implements ProxyInterface {
    ...
    private static void Connect(int dpi, ConstraintSet set, View view, HashMap<String, String> attributes, int from, int to2) {
        String str = allAttributes.get(Pair.create(Integer.valueOf(from), Integer.valueOf(to2)));
        String str2 = attributes.get(str);
        if (str2 != null) {
            String str3 = allMargins.get(str);
            set.connect(view.getId(), from, Integer.parseInt(str2), to2, str3 != null ? GetPxFromDp(dpi, attributes.get(str3)) : 0);
        }
    }
    ...
    public void setState(String id2) {
        ...
        int iLookUpConstraintId = motionLayout.lookUpConstraintId(id2);
