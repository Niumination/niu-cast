...
public class ViewTransition {
    ...
    public static class Animate {
        ...
        public void mutateForward() {
            ...
            this.mLastRender = jNanoTime;
            float f10 = (((float) (j10 * 1.0E-6d)) * this.mDpositionDt) + this.mPosition;
            this.mPosition = f10;
            if (f10 >= 1.0f) {
                this.mPosition = 1.0f;
            }
    ...
    public void applyTransition(ViewTransitionController controller, MotionLayout layout, int fromId, ConstraintSet current, final View... views) {
        ...
        layout.transitionToEnd(new Runnable() { // from class: q.a
            @Override // java.lang.Runnable
            public final void run() {
                this.f13348a.lambda$applyTransition$0(views);
            }
        });
    }
