...
public class KeyPosition extends KeyPositionBase {
    ...
    private void calcCartesianPosition(float start_x, float start_y, float end_x, float end_y) {
        ...
        this.mCalculatedPositionX = (int) (((Float.isNaN(this.mAltPercentX) ? 0.0f : this.mAltPercentX) * f11) + (f12 * f10) + start_x);
        this.mCalculatedPositionY = (int) ((f11 * f14) + (f10 * f13) + start_y);
    }
    ...
    private void calcPathPosition(float start_x, float start_y, float end_x, float end_y) {
        ...
        this.mCalculatedPositionY = (f10 * f14) + (f11 * f12) + start_y;
    }
