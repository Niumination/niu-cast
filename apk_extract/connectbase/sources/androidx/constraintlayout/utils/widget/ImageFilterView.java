...
public class ImageFilterView extends AppCompatImageView {
    ...
    public static class ImageMatrix {
        ...
        private void warmth(float warmth) {
            ...
            if (f10 < 66.0f) {
                fLog2 = f10 > 19.0f ? (((float) Math.log(f10 - 10.0f)) * 138.51773f) - 305.0448f : 0.0f;
            } else {
                fLog2 = 255.0f;
            }
        ...
        public void updateMatrix(ImageView view) {
            ...
            if (f10 != 1.0f) {
                saturation(f10);
                this.mColorMatrix.set(this.f448m);
                z10 = true;
            } else {
                z10 = false;
            }
            ...
            if (f12 != 1.0f) {
                warmth(f12);
                this.mTmpColorMatrix.set(this.f448m);
                this.mColorMatrix.postConcat(this.mTmpColorMatrix);
                z10 = true;
            }
