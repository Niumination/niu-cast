...
public class ContextCompat {
    ...
    public static String obtainAndCheckReceiverPermission(Context context) {
        ...
        throw new RuntimeException(n.a.a("Permission ", str, " is required by your application to receive broadcasts, please add it to your manifest"));
    }
    ...
    public static Intent registerReceiver(@NonNull Context context, @Nullable BroadcastReceiver broadcastReceiver, @NonNull IntentFilter intentFilter, @Nullable String str, @Nullable Handler handler, int i10) {
        ...
        if (i13 == 0 || (i12 & 4) == 0) {
            return BuildCompat.isAtLeastT() ? Api33Impl.registerReceiver(context, broadcastReceiver, intentFilter, str, handler, i12) : Api26Impl.registerReceiver(context, broadcastReceiver, intentFilter, str, handler, i12);
        }
