...
public class FileProvider extends ContentProvider {
    ...
    public static class SimplePathStrategy implements PathStrategy {
        ...
        public Uri getUriForFile(File file) {
            try {
                ...
                if (entry == null) {
                    throw new IllegalArgumentException(m.a.a("Failed to find configured root that contains ", canonicalPath));
                }
                String path2 = entry.getValue().getPath();
                return new Uri.Builder().scheme(t2.a.f15437d).authority(this.mAuthority).encodedPath(Uri.encode(entry.getKey()) + b0.f4502a + Uri.encode(path2.endsWith("/") ? canonicalPath.substring(path2.length()) : canonicalPath.substring(path2.length() + 1), "/")).build();
            } catch (IOException unused) {
    ...
    public static XmlResourceParser getFileProviderPathsMetaData(Context context, String str, @Nullable ProviderInfo providerInfo, int i10) {
        if (providerInfo == null) {
            throw new IllegalArgumentException(m.a.a("Couldn't find meta-data for provider with authority ", str));
        }
    ...
    private static int modeToMode(String str) {
        ...
        if (w.f13020a.equals(str) || "wt".equals(str)) {
            return 738197504;
        }
        if ("wa".equals(str)) {
            return 704643072;
        ...
        throw new IllegalArgumentException(m.a.a("Invalid mode: ", str));
    }

    private static PathStrategy parsePathStrategy(Context context, String str, int i10) throws XmlPullParserException, IOException {
