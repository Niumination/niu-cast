...
public class IntentSanitizer {
    ...
    public static class Api16Impl {
        ...
        /* JADX WARN: Code duplicated, block: B:34:0x0094 A[DONT_INVERT] */
        /* JADX WARN: Code duplicated, block: B:35:0x0096  */
        /* JADX WARN: Code duplicated, block: B:36:0x00a5  */
        @DoNotInline
        public static void sanitizeClipData(@NonNull Intent intent, Intent intent2, Predicate<ClipData> predicate, boolean z10, Predicate<Uri> predicate2, Consumer<String> consumer) {
            CharSequence text;
            Uri uri;
            ...
            for (int i10 = 0; i10 < clipData.getItemCount(); i10++) {
                ...
                if (z10) {
                    ...
                    if (itemAt.getText() != null) {
                        StringBuilder sbA = b.a("Item text cannot contain value. Item position: ", i10, ". Text: ");
                        sbA.append((Object) itemAt.getText());
                        consumer.accept(sbA.toString());
                    }
                    text = null;
                }
                if (predicate2 != null) {
                    if (itemAt.getUri() == null || predicate2.test(itemAt.getUri())) {
                        ...
                        StringBuilder sbA2 = b.a("Item URI is not allowed. Item position: ", i10, ". URI: ");
                        sbA2.append(itemAt.getUri());
                        consumer.accept(sbA2.toString());
                    }
                    ...
                    StringBuilder sbA3 = b.a("Item URI is not allowed. Item position: ", i10, ". URI: ");
                    sbA3.append(itemAt.getUri());
                    consumer.accept(sbA3.toString());
                }
                uri = null;
                if (text == null) {
                    if (clipData2 == null) {
    ...
    public static final class Builder {
        ...
        private boolean mAllowSourceBounds;
        private int mAllowedFlags;
        private Predicate<String> mAllowedActions = new m();
        private Predicate<Uri> mAllowedData = new n();
        private Predicate<String> mAllowedTypes = new o();
        private Predicate<String> mAllowedCategories = new p();
        private Predicate<String> mAllowedPackages = new q();
        private Predicate<ComponentName> mAllowedComponents = new r();
        private Map<String, Predicate<Object>> mAllowedExtras = new HashMap();
        private boolean mAllowClipDataText = false;
        private Predicate<Uri> mAllowedClipDataUri = new s();
        private Predicate<ClipData> mAllowedClipData = new t();
        ...
        public Builder allowClipDataUriWithAuthority(@NonNull final String str) {
            Preconditions.checkNotNull(str);
            return allowClipDataUri(new Predicate() { // from class: s.j
        ...
        public Builder allowComponent(@NonNull final ComponentName componentName) {
            ...
            return allowComponent(new Predicate() { // from class: s.h
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
        ...
        public Builder allowComponentWithPackage(@NonNull final String str) {
            Preconditions.checkNotNull(str);
            return allowComponent(new Predicate() { // from class: s.e
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
        ...
        public Builder allowDataWithAuthority(@NonNull final String str) {
            Preconditions.checkNotNull(str);
            allowData(new Predicate() { // from class: s.f
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
        ...
        public Builder allowExtraOutput(@NonNull final String str) {
            allowExtra("output", Uri.class, new Predicate() { // from class: s.c
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
        ...
        public Builder allowExtraStreamUriWithAuthority(@NonNull final String str) {
            Preconditions.checkNotNull(str);
            allowExtra("android.intent.extra.STREAM", Uri.class, new Predicate() { // from class: s.l
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
        ...
        public <T> Builder allowExtra(@NonNull String str, @NonNull final Class<T> cls, @NonNull final Predicate<T> predicate) {
            ...
            Preconditions.checkNotNull(predicate);
            return allowExtra(str, new Predicate() { // from class: s.g
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
        ...
        public Builder allowExtra(@NonNull String str, @NonNull Predicate<Object> predicate) {
            Preconditions.checkNotNull(str);
            Preconditions.checkNotNull(predicate);
            Predicate<Object> kVar = this.mAllowedExtras.get(str);
            if (kVar == null) {
                kVar = new k();
            }
            this.mAllowedExtras.put(str, kVar.or(predicate));
            return this;
        }
    }
    ...
    public Intent sanitizeByFiltering(@NonNull Intent intent) {
        return sanitize(intent, new s.b());
    }

    @NonNull
    public Intent sanitizeByThrowing(@NonNull Intent intent) {
        return sanitize(intent, new s.a());
    }
