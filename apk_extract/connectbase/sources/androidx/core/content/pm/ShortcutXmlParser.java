...
public class ShortcutXmlParser {
    ...
    private static Set<String> parseShortcutIds(@NonNull Context context) {
        ...
        if (listQueryIntentActivities != null && listQueryIntentActivities.size() != 0) {
            try {
                ...
                Log.e(TAG, "Failed to parse the Xml resource: ", e10);
            }
        }
        return hashSet;
    }
    ...
    @NonNull
    @VisibleForTesting
    public static List<String> parseShortcutIds(@NonNull XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
