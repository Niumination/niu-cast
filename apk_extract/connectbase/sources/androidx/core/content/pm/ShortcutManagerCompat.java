...
public class ShortcutManagerCompat {
    ...
    public static boolean convertUriIconToBitmapIcon(@NonNull Context context, @NonNull ShortcutInfoCompat shortcutInfoCompat) {
        ...
        shortcutInfoCompat.mIcon = i10 == 6 ? IconCompat.createWithAdaptiveBitmap(bitmapDecodeStream) : IconCompat.createWithBitmap(bitmapDecodeStream);
        return true;
    }
    ...
    public static List<ShortcutInfoCompat> getShortcuts(@NonNull Context context, int i10) {
        return ShortcutInfoCompat.fromShortcuts(context, ((ShortcutManager) context.getSystemService(ShortcutManager.class)).getShortcuts(i10));
    }
