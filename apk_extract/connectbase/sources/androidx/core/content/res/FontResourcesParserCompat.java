...
public class FontResourcesParserCompat {
    ...
    public static final class FontFileResourceEntry {
        ...
        public FontFileResourceEntry(@NonNull String str, int i10, boolean z10, @Nullable String str2, int i11, int i12) {
            this.mFileName = str;
            this.mWeight = i10;
            this.mItalic = z10;
    ...
    @NonNull
    public static List<List<byte[]>> readCerts(@NonNull Resources resources, @ArrayRes int i10) {
        if (i10 == 0) {
    ...
    private static FamilyResourceEntry readFamily(XmlPullParser xmlPullParser, Resources resources) throws XmlPullParserException, IOException {
        ...
        while (xmlPullParser.next() != 3) {
            if (xmlPullParser.getEventType() == 2) {
                if (xmlPullParser.getName().equals(i.f11251q)) {
    ...
    private static FontFileResourceEntry readFont(XmlPullParser xmlPullParser, Resources resources) throws XmlPullParserException, IOException {
        ...
        int i10 = typedArrayObtainAttributes.getInt(typedArrayObtainAttributes.hasValue(R.styleable.FontFamilyFont_fontWeight) ? R.styleable.FontFamilyFont_fontWeight : R.styleable.FontFamilyFont_android_fontWeight, NORMAL_WEIGHT);
        ...
        return new FontFileResourceEntry(string2, i10, z10, string, i12, resourceId);
    }
