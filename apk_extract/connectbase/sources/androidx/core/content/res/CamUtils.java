...
final class CamUtils {
    ...
    public static float[] xyzFromInt(int i10) {
        float fLinearized = linearized(Color.red(i10));
        float fLinearized2 = linearized(Color.green(i10));
        float fLinearized3 = linearized(Color.blue(i10));
        float[][] fArr = SRGB_TO_XYZ;
        float[] fArr2 = fArr[0];
        float f10 = (fArr2[2] * fLinearized3) + (fArr2[1] * fLinearized2) + (fArr2[0] * fLinearized);
        float[] fArr3 = fArr[1];
        float f11 = (fArr3[2] * fLinearized3) + (fArr3[1] * fLinearized2) + (fArr3[0] * fLinearized);
        float[] fArr4 = fArr[2];
        return new float[]{f10, f11, (fLinearized3 * fArr4[2]) + (fLinearized2 * fArr4[1]) + (fLinearized * fArr4[0])};
    }
