...
class FindAddress {
    ...
    public static class ZipRange {
        ...
        public boolean matches(String str) {
            ...
            return (this.mLow <= i10 && i10 <= this.mHigh) || i10 == this.mException1 || i10 == this.mException2;
        }
    }
            ...
            if (!matcher.find(iEnd)) {
                ...
                if (matchHouseNumber(str, iEnd) == null) {
                    if (!isValidLocationName(matcher.group(0))) {
                        ...
                        if (z11 && i12 > 4 && (matchResultMatchState = matchState(str, iEnd)) != null) {
    ...
    public static MatchResult matchHouseNumber(String str, int i10) {
        ...
        Matcher matcherRegion = sHouseNumberRe.matcher(str).region(i10, str.length());
    ...
    public static MatchResult matchState(String str, int i10) {
        ...
        Matcher matcherRegion = sStateRe.matcher(str).region(i10, str.length());
        if (matcherRegion.lookingAt()) {
