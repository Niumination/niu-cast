...
public class NotificationCompat {
    ...
    public static class CallStyle extends Style {
        ...
        private static Notification.Action getActionFromActionCompat(Action action) {
            ...
            Notification.Action.Builder builderCreateActionBuilder = Api23Impl.createActionBuilder(iconCompat == null ? null : iconCompat.toIcon(), action.getTitle(), action.getActionIntent());
            Bundle bundle = action.getExtras() != null ? new Bundle(action.getExtras()) : new Bundle();
            bundle.putBoolean("android.support.allowGeneratedReplies", action.getAllowGeneratedReplies());
            Api24Impl.setAllowGeneratedReplies(builderCreateActionBuilder, action.getAllowGeneratedReplies());
            Api31Impl.setAuthenticationRequired(builderCreateActionBuilder, action.isAuthenticationRequired());
            Api20Impl.addExtras(builderCreateActionBuilder, bundle);
            RemoteInput[] remoteInputs = action.getRemoteInputs();
            if (remoteInputs != null) {
                for (android.app.RemoteInput remoteInput : RemoteInput.fromCompat(remoteInputs)) {
                    Api20Impl.addRemoteInput(builderCreateActionBuilder, remoteInput);
                }
            }
            return Api20Impl.build(builderCreateActionBuilder);
        }
        ...
        private Action makeAction(int i10, int i11, Integer num, int i12, PendingIntent pendingIntent) {
            ...
            Action actionBuild = new Action.Builder(IconCompat.createWithResource(this.mBuilder.mContext, i10), spannableStringBuilder, pendingIntent).build();
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (callStyleForIncomingCall != null) {
                ...
                Api16Impl.setBuilder(callStyleForIncomingCall, notificationBuilderWithBuilderAccessor.getBuilder());
                Integer num = this.mAnswerButtonColor;
                if (num != null) {
        ...
        public ArrayList<Action> getActionsListWithSystemActions() {
            ...
            if (arrayList2 != null) {
                for (Action action : arrayList2) {
                    ...
                    if (actionMakeAnswerAction != null && i10 == 1) {
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z10) {
            ...
            if (!z10 || nonContextualActions == null || (iMin = Math.min(nonContextualActions.size(), 3)) <= 0) {
                i10 = 8;
            } else {
                for (int i11 = 0; i11 < iMin; i11++) {
                    remoteViewsApplyStandardTemplate.addView(R.id.actions, generateActionButton(nonContextualActions.get(i11)));
                }
            }
            remoteViewsApplyStandardTemplate.setViewVisibility(R.id.actions, i10);
            remoteViewsApplyStandardTemplate.setViewVisibility(R.id.action_divider, i10);
    ...
    public static abstract class Style {
        ...
        private Bitmap createIconWithBackground(int i10, int i11, int i12, int i13) {
            ...
            Bitmap bitmapCreateColoredBitmap = createColoredBitmap(i14, i13, i11);
            ...
            if (charSequence5 == null) {
                ...
                if (charSequence != null) {
                    ...
                    if (charSequence2 != null) {
                        ...
                        if (z11) {
                            Api16Impl.setTextViewTextSize(remoteViews, R.id.text, 0, resources.getDimensionPixelSize(R.dimen.notification_subtext_size));
                        }
                ...
                if (this.mBuilder.getWhenIfShowing() != 0) {
                    ...
                    z14 = this.mBuilder.mChronometerCountDown;
                    if (z14) {
                        Api24Impl.setChronometerCountDown(remoteViews, R.id.chronometer, z14);
                    }
                } else {
                    remoteViews.setViewVisibility(R.id.time, 0);
                    remoteViews.setLong(R.id.time, "setTime", this.mBuilder.getWhenIfShowing());
                }
                int i12 = R.id.right_side;
                if (z15) {
                    i11 = 0;
                } else {
                    i11 = 8;
    ...
    public static Action getActionCompatFromAction(@NonNull Notification.Action action) {
        ...
        if (remoteInputs == null) {
            ...
            for (int i11 = 0; i11 < remoteInputs.length; i11++) {
                ...
                remoteInputArr2[i11] = new RemoteInput(Api20Impl.getResultKey(remoteInput), Api20Impl.getLabel(remoteInput), Api20Impl.getChoices(remoteInput), Api20Impl.getAllowFreeFormInput(remoteInput), Api29Impl.getEditChoicesBeforeSending(remoteInput), Api20Impl.getExtras(remoteInput), null);
            }
        ...
        if (Api23Impl.getIcon(action) != null || (i10 = action.icon) == 0) {
            return new Action(Api23Impl.getIcon(action) != null ? IconCompat.createFromIconOrNullIfZeroResId(Api23Impl.getIcon(action)) : null, action.title, action.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z10, semanticAction, z11, zIsContextual, zIsAuthenticationRequired);
        }
        return new Action(i10, action.title, action.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z10, semanticAction, z11, zIsContextual, zIsAuthenticationRequired);
    }
    ...
    public static final class CarExtender implements Extender {
        ...
        public static class Api20Impl {
            ...
            @DoNotInline
            public static android.app.RemoteInput.Builder setAllowFreeFormInput(android.app.RemoteInput.Builder builder, boolean z10) {
        ...
        private static Bundle getBundleForUnreadConversation(@NonNull UnreadConversation unreadConversation) {
            ...
            if (remoteInput != null) {
                ...
                bundle.putParcelable(KEY_REMOTE_INPUT, Api20Impl.build(builderCreateBuilder));
            }
