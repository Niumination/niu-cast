...
public final class RemoteInput {
    ...
    public static class Api26Impl {
        ...
        @DoNotInline
        public static android.app.RemoteInput.Builder setAllowDataType(android.app.RemoteInput.Builder builder, String str, boolean z10) {
    ...
    public static class Api29Impl {
        ...
        @DoNotInline
        public static android.app.RemoteInput.Builder setEditChoicesBeforeSending(android.app.RemoteInput.Builder builder, int i10) {
    ...
    private static String getExtraResultsKeyForData(String str) {
        return m.a.a(EXTRA_DATA_TYPE_RESULTS_DATA, str);
    }
