...
public final class NotificationManagerCompat {
    ...
    public static class NotifyTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) throws RemoteException {
            iNotificationSideChannel.notify(this.packageName, this.f452id, this.tag, this.notif);
        }
        ...
        public String toString() {
            ...
            sb2.append(", id:");
            sb2.append(this.f452id);
            sb2.append(", tag:");
            return c.a(sb2, this.tag, "]");
        }
    }
    ...
    public static class CancelTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) throws RemoteException {
            if (this.all) {
                ...
                iNotificationSideChannel.cancel(this.packageName, this.f451id, this.tag);
            }
        }

        @NonNull
        public String toString() {
            return "CancelTask[packageName:" + this.packageName + ", id:" + this.f451id + ", tag:" + this.tag + ", all:" + this.all + "]";
        }
