...
public final class TimeUtils {
    ...
    private static int formatDurationLocked(long j10, int i10) {
        ...
        if (i10 != 0) {
            ...
            i15 = 0;
            for (int iAccumField5 = accumField(i17, 2, true, iAccumField4 > 0 ? 3 : 0) + 1 + iAccumField4; iAccumField5 < i10; iAccumField5++) {
                cArr[i15] = ' ';
                i15++;
            }
        } else {
        ...
        int i19 = i15 + 1;
        boolean z10 = i10 != 0;
        int iPrintField = printField(cArr, i11, f.f9273f, i19, false, 0);
        int iPrintField2 = printField(cArr, i12, f.f9272e, iPrintField, iPrintField != i19, z10 ? 2 : 0);
        int iPrintField3 = printField(cArr, i14, f.f9271d, iPrintField2, iPrintField2 != i19, z10 ? 2 : 0);
        int iPrintField4 = printField(cArr, i13, f.f9270c, iPrintField3, iPrintField3 != i19, z10 ? 2 : 0);
        int iPrintField5 = printField(cArr, i17, f.f9271d, iPrintField4, true, (!z10 || iPrintField4 == i19) ? 0 : 3);
        cArr[iPrintField5] = f.f9270c;
