...
public final class LocationRequestCompat {
    ...
    public String toString() {
        StringBuilder sbA = k.a.a("Request[");
        if (this.mIntervalMillis != Long.MAX_VALUE) {
            sbA.append("@");
            TimeUtils.formatDuration(this.mIntervalMillis, sbA);
