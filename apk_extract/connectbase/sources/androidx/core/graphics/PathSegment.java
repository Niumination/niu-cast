...
public final class PathSegment {
    ...
    public int hashCode() {
        ...
        int iHashCode2 = (this.mEnd.hashCode() + ((iHashCode + (f10 != 0.0f ? Float.floatToIntBits(f10) : 0)) * 31)) * 31;
        float f11 = this.mEndFraction;
        return iHashCode2 + (f11 != 0.0f ? Float.floatToIntBits(f11) : 0);
    }

    public String toString() {
        return "PathSegment{start=" + this.mStart + ", startFraction=" + this.mStartFraction + ", end=" + this.mEnd + ", endFraction=" + this.mEndFraction + f.f14860b;
    }
}
