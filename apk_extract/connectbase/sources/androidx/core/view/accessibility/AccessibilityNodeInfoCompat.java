...
public class AccessibilityNodeInfoCompat {
            ...
            if (cls != null) {
                try {
                    ...
                    try {
                        ...
                        Log.e(TAG, "Failed to execute command with argument class ViewCommandArgument: ".concat(cls2 == null ? d6.a.E : cls2.getName()), e);
                    }
                } catch (Exception e11) {
                    e = e11;
                }
    ...
    public CharSequence getText() {
        ...
        for (int i10 = 0; i10 < listExtrasIntList.size(); i10++) {
            spannableString.setSpan(new AccessibilityClickableSpanCompat(listExtrasIntList4.get(i10).intValue(), this, getExtras().getInt(SPANS_ACTION_ID_KEY)), listExtrasIntList.get(i10).intValue(), listExtrasIntList2.get(i10).intValue(), listExtrasIntList3.get(i10).intValue());
        }
