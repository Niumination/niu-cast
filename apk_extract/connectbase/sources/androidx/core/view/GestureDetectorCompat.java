    ...
    public static class GestureDetectorCompatImplBase implements GestureDetectorCompatImpl {
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (i10 == 1) {
                ...
                float f13 = this.mLastFocusX - f11;
                float f14 = this.mLastFocusY - f12;
                if (this.mIsDoubleTapping) {
                ...
                if (!this.mAlwaysInTapRegion) {
                    ...
                    boolean zOnScroll = this.mListener.onScroll(this.mCurrentDownEvent, motionEvent, f13, f14);
                    this.mLastFocusX = f11;
                    this.mLastFocusY = f12;
                    return zOnScroll;
                }
                int i13 = (int) (f11 - this.mDownFocusX);
                int i14 = (int) (f12 - this.mDownFocusY);
                int i15 = (i14 * i14) + (i13 * i13);
                if (i15 > this.mTouchSlopSquare) {
                    zOnFling = this.mListener.onScroll(this.mCurrentDownEvent, motionEvent, f13, f14);
                    this.mLastFocusX = f11;
                    this.mLastFocusY = f12;
                    this.mAlwaysInTapRegion = false;
                    this.mHandler.removeMessages(3);
