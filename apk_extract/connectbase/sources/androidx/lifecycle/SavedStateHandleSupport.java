...
public final class SavedStateHandleSupport {
    ...
    @MainThread
    public static final <T extends SavedStateRegistryOwner & ViewModelStoreOwner> void enableSavedStateHandles(@l T t10) {
        l0.p(t10, "<this>");
    ...
    public static final SavedStateHandlesVM getSavedStateHandlesVM(@l ViewModelStoreOwner viewModelStoreOwner) {
        ...
        initializerViewModelFactoryBuilder.addInitializer(l1.d(SavedStateHandlesVM.class), SavedStateHandleSupport$savedStateHandlesVM$1$1.INSTANCE);
