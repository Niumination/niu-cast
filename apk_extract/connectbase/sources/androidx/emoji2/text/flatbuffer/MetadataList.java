...
public final class MetadataList extends Table {
    ...
    public static final class Vector extends BaseVector {
        ...
        public MetadataList get(MetadataList metadataList, int i10) {
            return metadataList.__assign(Table.__indirect(__element(i10), this.f505bb), this.f505bb);
        }
    }
    ...
    public MetadataItem list(MetadataItem metadataItem, int i10) {
        ...
        return metadataItem.__assign(__indirect((i10 * 4) + __vector(i__offset)), this.f511bb);
    }

    public MetadataItem.Vector listVector(MetadataItem.Vector vector) {
        int i__offset = __offset(6);
        if (i__offset != 0) {
            return vector.__assign(__vector(i__offset), 4, this.f511bb);
        }
        return null;
    }
}
