...
class MetadataListReader {
    ...
    public static class InputStreamOpenTypeReader implements OpenTypeReader {
        ...
        private void read(@IntRange(from = 0, to = 4) int i10) throws IOException {
    ...
    public static MetadataList read(InputStream inputStream) throws IOException {
        ...
        if (i10 == offsetInfoFindOffsetInfo.getLength()) {
            return MetadataList.getRootAsMetadataList(byteBufferAllocate);
        }
        throw new IOException("Needed " + offsetInfoFindOffsetInfo.getLength() + " bytes, got " + i10);
    }
