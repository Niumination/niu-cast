                    ...
                    if (this.mMainHandlerLoadCallback == null) {
                        this.mMainHandlerLoadCallback = new Runnable() { // from class: androidx.emoji2.text.d
                            ...
                            public final void run() {
                                this.f504a.loadInternal();
                            }
                        };
                    }
                    handlerMainHandlerAsync.postDelayed(this.mMainHandlerLoadCallback, j10);
                } catch (Throwable th2) {
                    throw th2;
                }
            }
                        ...
                        synchronized (this.mLock) {
                            try {
                                ...
                                if (metadataRepoLoaderCallback2 != null) {
                                    metadataRepoLoaderCallback2.onFailed(th5);
                                }
                                cleanUp();
                            } catch (Throwable th6) {
                                throw th6;
