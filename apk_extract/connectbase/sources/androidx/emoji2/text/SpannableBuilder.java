...
public final class SpannableBuilder extends SpannableStringBuilder {
    ...
    @NonNull
    public SpannableStringBuilder append(@b.a({"UnknownNullness"}) CharSequence charSequence) {
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY})
    public SpannableBuilder(@NonNull Class<?> cls, @NonNull CharSequence charSequence, int i10, int i11) {
    ...
    @Override // android.text.SpannableStringBuilder, android.text.Editable, java.lang.Appendable
    @NonNull
    public SpannableStringBuilder append(@b.a({"UnknownNullness"}) CharSequence charSequence, int i10, int i11) {
