...
public class ProfileInstallerInitializer implements Initializer<Result> {
    ...
    public static void writeInBackground(@NonNull final Context context) {
        new ThreadPoolExecutor(0, 1, 0L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue()).execute(new Runnable() { // from class: h0.h
    ...
    public void delayAfterFirstFrame(@NonNull final Context context) {
        Choreographer16Impl.postFrameCallback(new Runnable() { // from class: h0.g
            @Override // java.lang.Runnable
            public final void run() {
                this.f6925a.lambda$delayAfterFirstFrame$0(context);
            }
        });
    }
    ...
    public void lambda$delayAfterFirstFrame$0(@NonNull final Context context) {
        Handler28Impl.createAsync(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: h0.f
            @Override // java.lang.Runnable
            public final void run() {
