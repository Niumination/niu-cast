...
public final class ProfileVerifier {
    ...
    @NonNull
    public static s1<CompilationStatus> getCompilationStatusAsync() {
        return sFuture;
    }
    ...
    public static CompilationStatus writeProfileVerification(@NonNull Context context, boolean z10) {
        ...
        synchronized (SYNC_OBJ) {
            ...
            try {
                ...
                if (fromFile != null && fromFile.mPackageLastUpdateTime == packageLastUpdateTime && (i10 = fromFile.mResultCode) != 2) {
                    i11 = i10;
                } else if (z11) {
                    i11 = 1;
                } else if (z12) {
                ...
                if (fromFile != null && fromFile.mResultCode == 2 && i11 == 1 && length < fromFile.mInstalledCurrentProfileSize) {
                    i11 = 3;
                }
                Cache cache = new Cache(1, i11, packageLastUpdateTime, length2);
                ...
                return setCompilationStatus(i11, z11, z12);
