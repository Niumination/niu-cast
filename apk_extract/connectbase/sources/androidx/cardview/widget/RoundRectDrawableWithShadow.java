...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    private void drawShadow(Canvas canvas) {
        ...
        float f12 = (this.mRawShadowSize / 2.0f) + f10 + this.mInsetShadow;
        float f13 = f12 * 2.0f;
    ...
    public float getMinHeight() {
        float f10 = this.mRawMaxShadowSize;
        return (((this.mRawMaxShadowSize * SHADOW_MULTIPLIER) + this.mInsetShadow) * 2.0f) + (Math.max(f10, ((f10 * SHADOW_MULTIPLIER) / 2.0f) + this.mCornerRadius + this.mInsetShadow) * 2.0f);
    }

    public float getMinWidth() {
        float f10 = this.mRawMaxShadowSize;
        return ((this.mRawMaxShadowSize + this.mInsetShadow) * 2.0f) + (Math.max(f10, (f10 / 2.0f) + this.mCornerRadius + this.mInsetShadow) * 2.0f);
    }
