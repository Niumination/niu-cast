...
public class l0 {
    ...
    public static <T extends Throwable> T A(T t10) {
        return (T) B(t10, l0.class.getName());
    }
    ...
    public static void L() {
        throw ((lm.z) A(new lm.z()));
    }

    public static void M(String str) {
        throw ((lm.z) A(new lm.z(str)));
    }
    ...
    public static void h(Object obj, String str) {
        if (obj == null) {
            throw ((IllegalStateException) A(new IllegalStateException(j.a.a(str, " must not be null"))));
        }
    }
    ...
    public static void k(String str) throws ClassNotFoundException {
        String strReplace = str.replace(el.b0.f4502a, n1.e.f11183c);
        try {
            Class.forName(strReplace);
        } catch (ClassNotFoundException e10) {
            throw ((ClassNotFoundException) A(new ClassNotFoundException(n.a.a("Class ", strReplace, " is not found. Please update the Kotlin runtime to the latest version"), e10)));
        }
    }
    ...
    public static void o(Object obj, String str) {
        if (obj == null) {
            throw ((NullPointerException) A(new NullPointerException(j.a.a(str, " must not be null"))));
        }
    }
