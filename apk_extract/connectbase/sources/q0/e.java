...
public class e extends f<Integer> {
    public e(List<a1.a<Integer>> list) {
        super(list);
    }
    ...
    public int q(a1.a<Integer> aVar, float f10) {
        ...
        return (jVar == 0 || (num = (Integer) jVar.b(aVar.f11g, aVar.f12h.floatValue(), aVar.f6b, aVar.f7c, f10, e(), f())) == null) ? z0.g.l(aVar.g(), aVar.d(), f10) : num.intValue();
    }
