...
public class a {
    ...
    public static final /* synthetic */ boolean f3357b = false;
    ...
    public static void b(@l byte[] bArr, int i10) {
        if (bArr == null) {
            a(4);
        }
    ...
    @l
    public static byte[] c(@l String[] strArr) {
        if (strArr == null) {
            a(11);
        }
        int length = 0;
    ...
    @l
    public static byte[] d(@l byte[] bArr) {
        if (bArr == null) {
            a(13);
        }
    ...
    @l
    public static byte[] e(@l String[] strArr) {
        if (strArr == null) {
            a(7);
        }
    ...
    @l
    public static String[] f(@l String[] strArr) {
        if (strArr == null) {
            a(9);
        }
