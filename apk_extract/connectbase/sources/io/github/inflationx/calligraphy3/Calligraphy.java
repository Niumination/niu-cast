    ...
    public void onViewCreatedInternal(View view, Context context, AttributeSet attributeSet) {
        if (view instanceof TextView) {
            ...
            if (TextUtils.isEmpty(strResolveFontPath)) {
                ...
                strResolveFontPath = i10 != -1 ? CalligraphyUtils.pullFontPathFromTheme(context, styleForTextView[0], i10, this.mAttributeId) : CalligraphyUtils.pullFontPathFromTheme(context, styleForTextView[0], this.mAttributeId);
            }
            ...
            CalligraphyUtils.applyFontToTextView(context, textView, this.mCalligraphyConfig, strApplyFontMapper, z10);
        }
