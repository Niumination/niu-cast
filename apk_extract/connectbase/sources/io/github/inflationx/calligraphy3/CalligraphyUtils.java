...
public final class CalligraphyUtils {
    ...
    public static String pullFontPathFromTheme(Context context, int i10, int[] iArr) {
        if (i10 != -1 && iArr != null) {
    ...
    public static boolean applyFontToTextView(TextView textView, final Typeface typeface, boolean z10) {
    ...
    public static boolean applyFontToTextView(Context context, TextView textView, String str, boolean z10) {
        if (textView == null || context == null) {
            return false;
        }
        return applyFontToTextView(textView, TypefaceUtils.load(context.getAssets(), str), z10);
    }

    public static String pullFontPathFromTheme(Context context, int i10, int i11, int[] iArr) {
        TypedArray typedArrayObtainStyledAttributes;
        if (i10 != -1 && iArr != null) {
            Resources.Theme theme = context.getTheme();
            TypedValue typedValue = new TypedValue();
            theme.resolveAttribute(i10, typedValue, true);
            TypedArray typedArrayObtainStyledAttributes2 = theme.obtainStyledAttributes(typedValue.resourceId, new int[]{i11});
            try {
    ...
    public static void applyFontToTextView(Context context, TextView textView, CalligraphyConfig calligraphyConfig, boolean z10) {
        if (context == null || textView == null || calligraphyConfig == null || !calligraphyConfig.isFontSet()) {
            return;
        }
        applyFontToTextView(context, textView, calligraphyConfig.getFontPath(), z10);
    }
    ...
    public static void applyFontToTextView(Context context, TextView textView, CalligraphyConfig calligraphyConfig, String str, boolean z10) {
        if (context == null || textView == null || calligraphyConfig == null) {
            return;
        }
        if (TextUtils.isEmpty(str) || !applyFontToTextView(context, textView, str, z10)) {
            applyFontToTextView(context, textView, calligraphyConfig, z10);
        }
    }
}
