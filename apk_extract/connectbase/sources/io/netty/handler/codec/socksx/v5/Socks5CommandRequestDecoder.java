...
public class Socks5CommandRequestDecoder extends ReplayingDecoder<State> {
    ...
    public void decode(ChannelHandlerContext channelHandlerContext, ByteBuf byteBuf, List<Object> list) throws Exception {
        try {
            int i10 = AnonymousClass1.$SwitchMap$io$netty$handler$codec$socksx$v5$Socks5CommandRequestDecoder$State[state().ordinal()];
            if (i10 == 1) {
                ...
                list.add(new DefaultSocks5CommandRequest(socks5CommandTypeValueOf, socks5AddressTypeValueOf, this.addressDecoder.decodeAddress(socks5AddressTypeValueOf, byteBuf), ByteBufUtil.readUnsignedShortBE(byteBuf)));
