...
public class Socks5CommandStatus implements Comparable<Socks5CommandStatus> {
    ...
    public Socks5CommandStatus(int i10) {
        this(i10, "UNKNOWN");
    }

    public static Socks5CommandStatus valueOf(byte b10) {
        switch (b10) {
            case 0:
                return SUCCESS;
            case 1:
            ...
            default:
                return new Socks5CommandStatus(b10);
        }
    }
    ...
    public Socks5CommandStatus(int i10, String str) {
