...
public class Socks5InitialRequestDecoder extends ReplayingDecoder<State> {
    ...
    public void decode(ChannelHandlerContext channelHandlerContext, ByteBuf byteBuf, List<Object> list) throws Exception {
        try {
            int i10 = AnonymousClass1.$SwitchMap$io$netty$handler$codec$socksx$v5$Socks5InitialRequestDecoder$State[state().ordinal()];
            if (i10 == 1) {
                ...
                for (int i11 = 0; i11 < unsignedByte; i11++) {
                    socks5AuthMethodArr[i11] = Socks5AuthMethod.valueOf(byteBuf.readByte());
                }
