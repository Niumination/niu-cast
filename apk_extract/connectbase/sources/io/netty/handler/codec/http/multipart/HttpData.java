...
public interface HttpData extends InterfaceHttpData, ByteBufHolder {
    void addContent(ByteBuf byteBuf, boolean z10) throws IOException;

    void checkSize(long j10) throws IOException;
    ...
    ByteBuf getChunk(int i10) throws IOException;
