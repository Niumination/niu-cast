...
public class HttpServerKeepAliveHandler extends ChannelDuplexHandler {
    ...
    public void write(ChannelHandlerContext channelHandlerContext, Object obj, ChannelPromise channelPromise) throws Exception {
        ...
        ChannelPromise channelPromiseAddListener = channelPromise;
        if ((obj instanceof LastHttpContent) && !shouldKeepAlive()) {
            channelPromiseAddListener = channelPromise;
            channelPromiseAddListener = channelPromise.unvoid().addListener((GenericFutureListener<? extends Future<? super Void>>) ChannelFutureListener.CLOSE);
        }
        channelPromiseAddListener = channelPromise;
        super.write(channelHandlerContext, obj, channelPromiseAddListener);
    }
}
