...
public final class HttpHeaderValues {
    ...
    public static final AsciiString FILENAME = AsciiString.cached(f.b.f7967b);
    ...
    public static final AsciiString ZERO = AsciiString.cached(b.f7118g);
    ...
    public static final AsciiString TEXT_PLAIN = AsciiString.cached(HttpPostBodyUtil.DEFAULT_TEXT_CONTENT_TYPE);
