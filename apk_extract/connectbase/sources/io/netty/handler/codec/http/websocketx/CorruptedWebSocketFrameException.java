...
public final class CorruptedWebSocketFrameException extends CorruptedFrameException {
    ...
    public CorruptedWebSocketFrameException(WebSocketCloseStatus webSocketCloseStatus, String str, Throwable th2) {
        super(str == null ? webSocketCloseStatus.reasonText() : str, th2);
    ...
    public CorruptedWebSocketFrameException(WebSocketCloseStatus webSocketCloseStatus, Throwable th2) {
        this(webSocketCloseStatus, null, th2);
    }
}
