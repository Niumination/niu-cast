...
public class WebSocketServerHandshaker07 extends WebSocketServerHandshaker {
    ...
    public WebSocketServerHandshaker07(String str, String str2, boolean z10, int i10) {
    ...
    public FullHttpResponse newHandshakeResponse(FullHttpRequest fullHttpRequest, HttpHeaders httpHeaders) {
        ...
        if (internalLogger.isDebugEnabled()) {
            internalLogger.debug("WebSocket version 07 server handshake key: {}, response: {}.", str, strBase64);
        }
    ...
    public WebSocketServerHandshaker07(String str, String str2, boolean z10, int i10, boolean z11) {
