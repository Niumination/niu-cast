...
public abstract class HttpHeaders implements Iterable<Map.Entry<String, String>> {
    ...
    @Deprecated
    public static void addIntHeader(HttpMessage httpMessage, String str, int i10) {
        httpMessage.headers().add(str, (Object) Integer.valueOf(i10));
    }
    ...
    private static boolean containsCommaSeparatedTrimmed(CharSequence charSequence, CharSequence charSequence2, boolean z10) {
        if (z10) {
            int iIndexOf = AsciiString.indexOf(charSequence, StringUtil.COMMA, 0);
            if (iIndexOf != -1) {
                int i10 = 0;
                while (!AsciiString.contentEqualsIgnoreCase(AsciiString.trim(charSequence.subSequence(i10, iIndexOf)), charSequence2)) {
                    i10 = iIndexOf + 1;
                    iIndexOf = AsciiString.indexOf(charSequence, StringUtil.COMMA, i10);
                    if (iIndexOf == -1) {
                        if (i10 < charSequence.length() && AsciiString.contentEqualsIgnoreCase(AsciiString.trim(charSequence.subSequence(i10, charSequence.length())), charSequence2)) {
                            return true;
                        }
                    }
                }
            ...
            int iIndexOf2 = AsciiString.indexOf(charSequence, StringUtil.COMMA, 0);
            if (iIndexOf2 != -1) {
                int i11 = 0;
                while (!AsciiString.contentEquals(AsciiString.trim(charSequence.subSequence(i11, iIndexOf2)), charSequence2)) {
                    i11 = iIndexOf2 + 1;
                    iIndexOf2 = AsciiString.indexOf(charSequence, StringUtil.COMMA, i11);
                    if (iIndexOf2 == -1) {
                        if (i11 < charSequence.length() && AsciiString.contentEquals(AsciiString.trim(charSequence.subSequence(i11, charSequence.length())), charSequence2)) {
                            return true;
                        }
                    }
                }
    ...
    public static void setContentLength(HttpMessage httpMessage, long j10) {
        HttpUtil.setContentLength(httpMessage, j10);
    }
    ...
    @Deprecated
    public static void setIntHeader(HttpMessage httpMessage, String str, int i10) {
        httpMessage.headers().setInt(str, i10);
    }

    @Deprecated
    public static void setKeepAlive(HttpMessage httpMessage, boolean z10) {
        HttpUtil.setKeepAlive(httpMessage, z10);
    }
    ...
    public abstract HttpHeaders addInt(CharSequence charSequence, int i10);

    public abstract HttpHeaders addShort(CharSequence charSequence, short s10);
    ...
    public boolean containsValue(CharSequence charSequence, CharSequence charSequence2, boolean z10) {
        Iterator<? extends CharSequence> itValueCharSequenceIterator = valueCharSequenceIterator(charSequence);
        while (itValueCharSequenceIterator.hasNext()) {
            if (containsCommaSeparatedTrimmed(itValueCharSequenceIterator.next(), charSequence2, z10)) {
                return true;
            }
        }
        return false;
    ...
    public abstract int getInt(CharSequence charSequence, int i10);

    public abstract Integer getInt(CharSequence charSequence);

    public abstract Short getShort(CharSequence charSequence);

    public abstract short getShort(CharSequence charSequence, short s10);

    public abstract long getTimeMillis(CharSequence charSequence, long j10);
    ...
    public abstract HttpHeaders setInt(CharSequence charSequence, int i10);

    public abstract HttpHeaders setShort(CharSequence charSequence, short s10);
    ...
    @Deprecated
    public static void addIntHeader(HttpMessage httpMessage, CharSequence charSequence, int i10) {
        httpMessage.headers().addInt(charSequence, i10);
    }

    @Deprecated
    public static long getContentLength(HttpMessage httpMessage, long j10) {
        return HttpUtil.getContentLength(httpMessage, j10);
    }
    ...
    public static Date getDateHeader(HttpMessage httpMessage, CharSequence charSequence) throws ParseException {
        ...
        Date httpDate = DateFormatter.parseHttpDate(str);
        if (httpDate != null) {
            return httpDate;
        }
        throw new ParseException("header can't be parsed into a Date: ".concat(str), 0);
    }
    ...
    public static void set100ContinueExpected(HttpMessage httpMessage, boolean z10) {
        HttpUtil.set100ContinueExpected(httpMessage, z10);
    }

    @Deprecated
    public static void setDateHeader(HttpMessage httpMessage, CharSequence charSequence, Date date) {
        if (date != null) {
            httpMessage.headers().set(charSequence, DateFormatter.format(date));
        } else {
    ...
    @Deprecated
    public static void setIntHeader(HttpMessage httpMessage, CharSequence charSequence, int i10) {
        httpMessage.headers().setInt(charSequence, i10);
    }
    ...
    public boolean contains(String str, String str2, boolean z10) {
        Iterator<String> itValueStringIterator = valueStringIterator(str);
        if (z10) {
            while (itValueStringIterator.hasNext()) {
                if (itValueStringIterator.next().equalsIgnoreCase(str2)) {
                    return true;
                }
            }
            return false;
        ...
        while (itValueStringIterator.hasNext()) {
            if (itValueStringIterator.next().equals(str2)) {
                return true;
            }
        }
        return false;
    ...
    @Deprecated
    public static int getIntHeader(HttpMessage httpMessage, String str, int i10) {
        return httpMessage.headers().getInt(str, i10);
    }
    ...
    @Deprecated
    public static int getIntHeader(HttpMessage httpMessage, CharSequence charSequence, int i10) {
        return httpMessage.headers().getInt(charSequence, i10);
    }

    @Deprecated
    public static Date getDateHeader(HttpMessage httpMessage, CharSequence charSequence, Date date) {
        Date httpDate = DateFormatter.parseHttpDate(getHeader(httpMessage, charSequence));
        return httpDate != null ? httpDate : date;
    }

    public boolean contains(CharSequence charSequence, CharSequence charSequence2, boolean z10) {
        return contains(charSequence.toString(), charSequence2.toString(), z10);
    }
}
