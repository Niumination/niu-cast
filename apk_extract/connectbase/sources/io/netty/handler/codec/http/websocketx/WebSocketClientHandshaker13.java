...
public class WebSocketClientHandshaker13 extends WebSocketClientHandshaker {
    ...
    public WebSocketClientHandshaker13(URI uri, WebSocketVersion webSocketVersion, String str, boolean z10, HttpHeaders httpHeaders, int i10) {
    ...
    public FullHttpRequest newHandshakeRequest() {
        ...
        if (internalLogger.isDebugEnabled()) {
            internalLogger.debug("WebSocket version 13 client handshake key: {}, expected response: {}", strBase64, this.expectedChallengeResponseString);
        }
    ...
    public WebSocketClientHandshaker13(URI uri, WebSocketVersion webSocketVersion, String str, boolean z10, HttpHeaders httpHeaders, int i10, boolean z11, boolean z12) {
    ...
    public WebSocketClientHandshaker13(URI uri, WebSocketVersion webSocketVersion, String str, boolean z10, HttpHeaders httpHeaders, int i10, boolean z11, boolean z12, long j10) {
        this(uri, webSocketVersion, str, z10, httpHeaders, i10, z11, z12, j10, false);
    }

    public WebSocketClientHandshaker13(URI uri, WebSocketVersion webSocketVersion, String str, boolean z10, HttpHeaders httpHeaders, int i10, boolean z11, boolean z12, long j10, boolean z13) {
        this(uri, webSocketVersion, str, z10, httpHeaders, i10, z11, z12, j10, z13, true);
    }

    public WebSocketClientHandshaker13(URI uri, WebSocketVersion webSocketVersion, String str, boolean z10, HttpHeaders httpHeaders, int i10, boolean z11, boolean z12, long j10, boolean z13, boolean z14) {
