...
public class HttpClientUpgradeHandler extends HttpObjectAggregator implements ChannelOutboundHandler {
    ...
    public HttpClientUpgradeHandler(SourceCodec sourceCodec, UpgradeCodec upgradeCodec, int i10) {
        super(i10);
    ...
    private void setUpgradeRequestHeaders(ChannelHandlerContext channelHandlerContext, HttpRequest httpRequest) {
        ...
        sb2.append((CharSequence) HttpHeaderValues.UPGRADE);
        httpRequest.headers().add(HttpHeaderNames.CONNECTION, sb2.toString());
    }
