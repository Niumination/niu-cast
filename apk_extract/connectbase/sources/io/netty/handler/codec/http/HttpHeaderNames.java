...
public final class HttpHeaderNames {
    ...
    public static final AsciiString ACCEPT_ENCODING = AsciiString.cached(v0.f19376v);
    ...
    public static final AsciiString CONTENT_ENCODING = AsciiString.cached(v0.f19375u);
    ...
    public static final AsciiString FROM = AsciiString.cached(TypedValues.TransitionType.S_FROM);
    ...
    public static final AsciiString ORIGIN = AsciiString.cached(d.a.f11176d);
