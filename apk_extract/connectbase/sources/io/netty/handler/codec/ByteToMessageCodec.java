...
public abstract class ByteToMessageCodec<I> extends ChannelDuplexHandler {
    ...
    public final class Encoder extends MessageToByteEncoder<I> {
        ...
        @Override // io.netty.handler.codec.MessageToByteEncoder
        public void encode(ChannelHandlerContext channelHandlerContext, I i10, ByteBuf byteBuf) throws Exception {
            ByteToMessageCodec.this.encode(channelHandlerContext, i10, byteBuf);
        }
    }
    ...
    public ByteToMessageCodec(boolean z10) {
        ...
        this.encoder = new Encoder(z10);
    }

    public ByteToMessageCodec(Class<? extends I> cls, boolean z10) {
        this.decoder = new ByteToMessageDecoder() { // from class: io.netty.handler.codec.ByteToMessageCodec.1
            @Override // io.netty.handler.codec.ByteToMessageDecoder
            public void decode(ChannelHandlerContext channelHandlerContext, ByteBuf byteBuf, List<Object> list) throws Exception {
                ByteToMessageCodec.this.decode(channelHandlerContext, byteBuf, list);
