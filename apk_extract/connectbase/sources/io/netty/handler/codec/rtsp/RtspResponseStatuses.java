...
public final class RtspResponseStatuses {
    ...
    public static final HttpResponseStatus RTSP_VERSION_NOT_SUPPORTED = new HttpResponseStatus(TypedValues.PositionType.TYPE_SIZE_PERCENT, "RTSP Version not supported");
    ...
    public static HttpResponseStatus valueOf(int i10) {
        ...
        switch (i10) {
            ...
            default:
                return HttpResponseStatus.valueOf(i10);
        }
    }
}
