...
public final class RtspHeaderValues {
    ...
    public static final AsciiString PORT = AsciiString.cached(RtspHeaders.Values.PORT);
    ...
    public static final AsciiString URL = AsciiString.cached(RtspHeaders.Values.URL);
