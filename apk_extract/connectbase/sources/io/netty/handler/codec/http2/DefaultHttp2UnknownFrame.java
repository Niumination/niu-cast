...
public final class DefaultHttp2UnknownFrame extends DefaultByteBufHolder implements Http2UnknownFrame {
    ...
    public DefaultHttp2UnknownFrame(byte b10, Http2Flags http2Flags) {
        this(b10, http2Flags, Unpooled.EMPTY_BUFFER);
    }
    ...
    public int hashCode() {
        ...
        Http2FrameStream http2FrameStream = this.stream;
        return http2FrameStream != null ? (iHashCode * 31) + http2FrameStream.hashCode() : iHashCode;
    }
    ...
    public DefaultHttp2UnknownFrame(byte b10, Http2Flags http2Flags, ByteBuf byteBuf) {
        super(byteBuf);
        this.frameType = b10;
    ...
    @Override // io.netty.buffer.DefaultByteBufHolder, io.netty.util.ReferenceCounted
    public DefaultHttp2UnknownFrame retain(int i10) {
        super.retain(i10);
        return this;
    }
