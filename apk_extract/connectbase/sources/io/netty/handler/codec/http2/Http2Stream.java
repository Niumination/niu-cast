...
public interface Http2Stream {
    ...
    Http2Stream headersReceived(boolean z10);

    Http2Stream headersSent(boolean z10);
    ...
    Http2Stream open(boolean z10) throws Http2Exception;
    ...
    <V> V setProperty(Http2Connection.PropertyKey propertyKey, V v10);
