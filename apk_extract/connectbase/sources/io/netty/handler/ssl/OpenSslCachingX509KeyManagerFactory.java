...
public final class OpenSslCachingX509KeyManagerFactory extends KeyManagerFactory {
    ...
    public OpenSslCachingX509KeyManagerFactory(final KeyManagerFactory keyManagerFactory, int i10) {
        ...
        this.maxCachedEntries = ObjectUtil.checkPositive(i10, "maxCachedEntries");
    }
}
