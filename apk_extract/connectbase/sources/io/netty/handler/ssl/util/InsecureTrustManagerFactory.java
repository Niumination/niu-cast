...
public final class InsecureTrustManagerFactory extends SimpleTrustManagerFactory {
    ...
    private static final TrustManager f8336tm = new X509TrustManager() { // from class: io.netty.handler.ssl.util.InsecureTrustManagerFactory.1
    ...
    public TrustManager[] engineGetTrustManagers() {
        return new TrustManager[]{f8336tm};
    }
