...
public class MpscUnboundedArrayQueue<E> extends BaseMpscLinkedArrayQueue<E> {
    ...
    public MpscUnboundedArrayQueue(int i10) {
        super(i10);
    }
    ...
    @Override // io.netty.util.internal.shaded.org.jctools.queues.BaseMpscLinkedArrayQueue, io.netty.util.internal.shaded.org.jctools.queues.IndexedQueueSizeUtil.IndexedQueue, io.netty.util.internal.shaded.org.jctools.queues.MessagePassingQueue
    public int capacity() {
        return -1;
    }
