...
public class DomainNameMapping<V> implements Mapping<String, V> {
    ...
    @Deprecated
    public DomainNameMapping(V v10) {
        this(4, v10);
    }
    ...
    public DomainNameMapping<V> add(String str, V v10) {
        this.map.put(normalizeHostname((String) ObjectUtil.checkNotNull(str, "hostname")), (V) ObjectUtil.checkNotNull(v10, "output"));
        return this;
    }
    ...
    @Deprecated
    public DomainNameMapping(int i10, V v10) {
    ...
    public DomainNameMapping(Map<String, V> map, V v10) {
