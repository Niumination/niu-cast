...
public class LongObjectHashMap<V> implements LongObjectMap<V> {
    ...
    public final class MapEntry implements Map.Entry<Long, V> {
        ...
        public V setValue(V v10) {
            verifyExists();
            V v11 = (V) LongObjectHashMap.toExternal(LongObjectHashMap.this.values[this.entryIndex]);
            LongObjectHashMap.this.values[this.entryIndex] = LongObjectHashMap.toInternal(v10);
            return v11;
        }
    ...
    public final class PrimitiveIterator implements Iterator<LongObjectMap.PrimitiveEntry<V>>, LongObjectMap.PrimitiveEntry<V> {
        ...
        private void scanNext() {
            do {
                ...
                this.nextIndex = i10;
                if (i10 == LongObjectHashMap.this.values.length) {
                    return;
                }
        ...
        public void remove() {
            ...
            if (LongObjectHashMap.this.removeAt(i10)) {
    ...
    private int hashIndex(long j10) {
        return this.mask & hashCode(j10);
    }

    private int indexOf(long j10) {
        int iHashIndex = hashIndex(j10);
        int iProbeNext = iHashIndex;
        while (this.values[iProbeNext] != null) {
            if (j10 == this.keys[iProbeNext]) {
                return iProbeNext;
            }
    ...
    public boolean equals(Object obj) {
        ...
        while (true) {
            ...
            V v10 = vArr[i10];
            if (v10 != null) {
                Object obj2 = longObjectMap.get(this.keys[i10]);
                if (v10 == NULL_VALUE) {
                    if (obj2 != null) {
                        return false;
                    }
    ...
    public String keyToString(long j10) {
    ...
    public void putAll(Map<? extends Long, ? extends V> map) {
        ...
        while (true) {
            ...
            V v10 = vArr[i10];
            if (v10 != null) {
                put(longObjectHashMap.keys[i10], v10);
            }
            i10++;
        }
    }
    ...
    public int hashCode() {
        ...
        for (long j10 : this.keys) {
            iHashCode ^= hashCode(j10);
        }
        return iHashCode;
    }
    ...
    public V put(long j10, V v10) {
        ...
        do {
            ...
            if (obj == null) {
                this.keys[iProbeNext] = j10;
                objArr[iProbeNext] = toInternal(v10);
                growSize();
                return null;
            }
            if (this.keys[iProbeNext] == j10) {
                objArr[iProbeNext] = toInternal(v10);
    ...
    public V put(Long l10, V v10) {
        return put(objectToKey(l10), v10);
    }
}
