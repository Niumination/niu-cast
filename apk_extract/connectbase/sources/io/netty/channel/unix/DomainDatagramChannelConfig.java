...
public interface DomainDatagramChannelConfig extends ChannelConfig {
    ...
    @Override // io.netty.channel.ChannelConfig
    DomainDatagramChannelConfig setConnectTimeoutMillis(int i10);

    @Override // io.netty.channel.ChannelConfig
    @Deprecated
    DomainDatagramChannelConfig setMaxMessagesPerRead(int i10);
    ...
    DomainDatagramChannelConfig setSendBufferSize(int i10);

    @Override // io.netty.channel.ChannelConfig
    DomainDatagramChannelConfig setWriteBufferWaterMark(WriteBufferWaterMark writeBufferWaterMark);

    @Override // io.netty.channel.ChannelConfig
    DomainDatagramChannelConfig setWriteSpinCount(int i10);
}
