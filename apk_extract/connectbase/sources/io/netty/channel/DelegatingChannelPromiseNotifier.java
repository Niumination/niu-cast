...
public final class DelegatingChannelPromiseNotifier implements ChannelPromise, ChannelFutureListener {
    ...
    public DelegatingChannelPromiseNotifier(ChannelPromise channelPromise, boolean z10) {
    ...
    public boolean trySuccess(Void r10) {
        return this.delegate.trySuccess(r10);
    }
    ...
    public boolean await(long j10, TimeUnit timeUnit) throws InterruptedException {
        return this.delegate.await(j10, timeUnit);
    }

    @Override // io.netty.util.concurrent.Future
    public boolean awaitUninterruptibly(long j10, TimeUnit timeUnit) {
        return this.delegate.awaitUninterruptibly(j10, timeUnit);
    }

    @Override // io.netty.util.concurrent.Future
    public boolean await(long j10) throws InterruptedException {
        return this.delegate.await(j10);
    }

    @Override // io.netty.util.concurrent.Future
    public boolean awaitUninterruptibly(long j10) {
        return this.delegate.awaitUninterruptibly(j10);
    }
}
