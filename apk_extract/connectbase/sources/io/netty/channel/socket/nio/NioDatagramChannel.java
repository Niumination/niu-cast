...
public final class NioDatagramChannel extends AbstractNioMessageChannel implements DatagramChannel {
    ...
    public boolean doWriteMessage(Object obj, ChannelOutboundBuffer channelOutboundBuffer) throws Exception {
        ...
        ByteBuffer byteBufferInternalNioBuffer = byteBuf.nioBufferCount() == 1 ? byteBuf.internalNioBuffer(byteBuf.readerIndex(), i10) : byteBuf.nioBuffer(byteBuf.readerIndex(), i10);
            ...
            try {
                ...
                if (map != null && (list = map.get(inetAddress)) != null) {
                    ...
                    while (it.hasNext()) {
                        ...
                        if (networkInterface.equals(next.networkInterface())) {
                            if (inetAddress2 != null || next.sourceAddress() != null) {
                                if (inetAddress2 == null || !inetAddress2.equals(next.sourceAddress())) {
                                }
                            }
                            next.drop();
                            it.remove();
