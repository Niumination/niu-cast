...
class NioDatagramChannelConfig extends DefaultDatagramChannelConfig {
    ...
    public DatagramChannelConfig setLoopbackModeDisabled(boolean z10) {
        setOption0(IP_MULTICAST_LOOP, Boolean.valueOf(z10));
        return this;
    }
    ...
    public <T> boolean setOption(ChannelOption<T> channelOption, T t10) {
        return (PlatformDependent.javaVersion() < 7 || !(channelOption instanceof NioChannelOption)) ? super.setOption(channelOption, t10) : NioChannelOption.setOption(this.javaChannel, (NioChannelOption) channelOption, t10);
    }

    @Override // io.netty.channel.socket.DefaultDatagramChannelConfig, io.netty.channel.socket.DatagramChannelConfig
    public DatagramChannelConfig setTimeToLive(int i10) {
        setOption0(IP_MULTICAST_TTL, Integer.valueOf(i10));
        return this;
    }
