...
public final class EpollDomainDatagramChannelConfig extends EpollChannelConfig implements DomainDatagramChannelConfig {
    ...
    public EpollDomainDatagramChannelConfig setMaxMessagesPerWrite(int i10) {
        super.setMaxMessagesPerWrite(i10);
        return this;
    }

    @Override // io.netty.channel.unix.DomainDatagramChannelConfig
    public EpollDomainDatagramChannelConfig setSendBufferSize(int i10) {
        try {
            ((EpollDomainDatagramChannel) this.channel).socket.setSendBufferSize(i10);
            return this;
        } catch (IOException e10) {
            throw new ChannelException(e10);
        }
    ...
    public EpollDomainDatagramChannelConfig setAutoClose(boolean z10) {
    ...
    @Override // io.netty.channel.epoll.EpollChannelConfig, io.netty.channel.DefaultChannelConfig, io.netty.channel.ChannelConfig
    public EpollDomainDatagramChannelConfig setAutoRead(boolean z10) {
        super.setAutoRead(z10);
        return this;
    }

    @Override // io.netty.channel.epoll.EpollChannelConfig, io.netty.channel.DefaultChannelConfig, io.netty.channel.ChannelConfig
    public EpollDomainDatagramChannelConfig setConnectTimeoutMillis(int i10) {
    ...
    @Override // io.netty.channel.epoll.EpollChannelConfig, io.netty.channel.DefaultChannelConfig, io.netty.channel.ChannelConfig
    @Deprecated
    public EpollDomainDatagramChannelConfig setMaxMessagesPerRead(int i10) {
    ...
    @Override // io.netty.channel.epoll.EpollChannelConfig, io.netty.channel.DefaultChannelConfig, io.netty.channel.ChannelConfig
    public EpollDomainDatagramChannelConfig setWriteSpinCount(int i10) {
