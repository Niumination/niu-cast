...
public abstract class GeneratedMessageLite<MessageType extends GeneratedMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> extends AbstractMessageLite<MessageType, BuilderType> {
    ...
    public static abstract class ExtendableBuilder<MessageType extends ExtendableMessage<MessageType, BuilderType>, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends Builder<MessageType, BuilderType> implements ExtendableMessageOrBuilder<MessageType, BuilderType> {
        ...
        private FieldSet<ExtensionDescriptor> ensureExtensionsAreMutable() {
            ...
            FieldSet fieldSetClone = fieldSet.m27clone();
        ...
        public void copyOnWriteInternal() {
            ...
            if (((ExtendableMessage) this.instance).extensions != FieldSet.emptySet()) {
                ...
                ((ExtendableMessage) messagetype).extensions = ((ExtendableMessage) messagetype).extensions.m27clone();
            }
        }
    ...
    public int getSerializedSize(Schema schema) {
        if (isMutable()) {
            ...
            throw new IllegalStateException(a.a("serialized size must be non-negative, was ", iComputeSerializedSize));
        }
    ...
    public void setMemoizedSerializedSize(int size) {
        if (size < 0) {
            throw new IllegalStateException(a.a("serialized size must be non-negative, was ", size));
        }
    ...
    public static abstract class ExtendableMessage<MessageType extends ExtendableMessage<MessageType, BuilderType>, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends GeneratedMessageLite<MessageType, BuilderType> implements ExtendableMessageOrBuilder<MessageType, BuilderType> {
        ...
        private boolean parseExtension(CodedInputStream input, ExtensionRegistryLite extensionRegistry, GeneratedExtension<?, ?> extension, int tag, int fieldNumber) throws IOException {
            ...
            if (extension == null) {
                z11 = true;
                z10 = false;
            } else if (tagWireType == FieldSet.getWireFormatForFieldType(extension.descriptor.getLiteType(), false)) {
                z11 = false;
                z10 = false;
            } else {
            ...
            if (z10) {
                ...
                int i10 = AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$JavaType[extension.descriptor.getLiteJavaType().ordinal()];
                if (i10 == 1) {
                    ...
                    int i11 = input.readEnum();
                    Internal.EnumLite enumLiteFindValueByNumber2 = extension.descriptor.getEnumType().findValueByNumber(i11);
                    if (enumLiteFindValueByNumber2 == null) {
                        mergeVarintField(fieldNumber, i11);
                        return true;
                    }
        ...
        public FieldSet<ExtensionDescriptor> ensureExtensionsAreMutable() {
            if (this.extensions.isImmutable()) {
                this.extensions = this.extensions.m27clone();
            }
