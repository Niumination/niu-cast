...
public class InvalidProtocolBufferException extends IOException {
    ...
    public InvalidProtocolBufferException(Exception e10) {
        super(e10.getMessage(), e10);
        this.unfinishedMessage = null;
    }

    public InvalidProtocolBufferException(String description, Exception e10) {
        super(description, e10);
        this.unfinishedMessage = null;
    }

    public InvalidProtocolBufferException(IOException e10) {
        super(e10.getMessage(), e10);
        this.unfinishedMessage = null;
    }

    public InvalidProtocolBufferException(String description, IOException e10) {
        super(description, e10);
        this.unfinishedMessage = null;
    }
}
