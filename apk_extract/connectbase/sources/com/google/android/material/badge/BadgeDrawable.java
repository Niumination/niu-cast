...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    public static BadgeDrawable createFromResource(@NonNull Context context, @XmlRes int i10) {
        AttributeSet drawableXml = DrawableUtils.parseDrawableXml(context, i10, "badge");
    ...
    private void loadDefaultStateFromAttributes(Context context, AttributeSet attributeSet, @AttrRes int i10, @StyleRes int i11) {
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, R.styleable.Badge, i10, i11, new int[0]);
        ...
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.Badge_badgeRadius)) {
            this.badgeRadius = typedArrayObtainStyledAttributes.getDimensionPixelSize(R.styleable.Badge_badgeRadius, (int) this.badgeRadius);
        }
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.Badge_badgeWidePadding)) {
            this.badgeWidePadding = typedArrayObtainStyledAttributes.getDimensionPixelSize(R.styleable.Badge_badgeWidePadding, (int) this.badgeWidePadding);
        }
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.Badge_badgeWithTextRadius)) {
            this.badgeWithTextRadius = typedArrayObtainStyledAttributes.getDimensionPixelSize(R.styleable.Badge_badgeWithTextRadius, (int) this.badgeWithTextRadius);
        }
