...
public abstract class NavigationBarItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public static class ActiveIndicatorTransform {
        ...
        public float calculateAlpha(@FloatRange(from = 0.0d, to = 1.0d) float f10, @FloatRange(from = 0.0d, to = 1.0d) float f11) {
            return AnimationUtils.lerp(0.0f, 1.0f, f11 == 0.0f ? 0.8f : 0.0f, f11 == 0.0f ? 1.0f : 0.2f, f10);
        }

        public float calculateScaleX(@FloatRange(from = 0.0d, to = 1.0d) float f10, @FloatRange(from = 0.0d, to = 1.0d) float f11) {
            return AnimationUtils.lerp(SCALE_X_HIDDEN, 1.0f, f10);
        }

        public float calculateScaleY(@FloatRange(from = 0.0d, to = 1.0d) float f10, @FloatRange(from = 0.0d, to = 1.0d) float f11) {
            return 1.0f;
        }
        ...
        if (i10 != -1) {
            if (i10 == 0) {
                ...
                if (z10) {
                    ...
                    setViewScaleValues(textView5, f10, f10, 4);
                } else {
                    setViewTopMarginAndGravity(getIconOrContainer(), this.itemPaddingTop, 49);
                    TextView textView6 = this.largeLabel;
                    float f11 = this.scaleDownFactor;
                    setViewScaleValues(textView6, f11, f11, 4);
            ...
            if (z10) {
                ...
                setViewScaleValues(textView7, f12, f12, 4);
            } else {
                setViewTopMarginAndGravity(getIconOrContainer(), this.itemPaddingTop, 49);
                TextView textView8 = this.largeLabel;
                float f13 = this.scaleDownFactor;
                setViewScaleValues(textView8, f13, f13, 4);
                setViewScaleValues(this.smallLabel, 1.0f, 1.0f, 0);
            }
        }
        refreshDrawableState();
