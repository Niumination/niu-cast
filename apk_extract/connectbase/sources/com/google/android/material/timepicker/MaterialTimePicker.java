...
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.OnDoubleTapListener {
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder setMinute(@IntRange(from = 0, to = 60) int i10) {
    ...
    private Pair<Integer, Integer> dataForMode(int i10) {
        ...
        throw new IllegalArgumentException(a.a("no icon for mode: ", i10));
    }
    ...
    private TimePickerPresenter initializeOrRetrieveActivePresenterForMode(int i10, @NonNull TimePickerView timePickerView, @NonNull ViewStub viewStub) {
        if (i10 != 0) {
