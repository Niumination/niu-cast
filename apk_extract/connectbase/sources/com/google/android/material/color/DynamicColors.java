...
public class DynamicColors {
    ...
    public static class DynamicColorsActivityLifecycleCallbacks implements Application.ActivityLifecycleCallbacks {
        ...
        public DynamicColorsActivityLifecycleCallbacks(@StyleRes int i10, @NonNull Precondition precondition) {
    ...
    public static void applyIfAvailable(@NonNull Activity activity, @StyleRes int i10) {
        applyIfAvailable(activity, i10, ALWAYS_ALLOW);
    }

    public static void applyToActivitiesIfAvailable(@NonNull Application application, @StyleRes int i10) {
        applyToActivitiesIfAvailable(application, i10, ALWAYS_ALLOW);
    }
    ...
    public static void applyIfAvailable(@NonNull Activity activity, @StyleRes int i10, @NonNull Precondition precondition) {
        if (isDynamicColorAvailable()) {
            if (i10 == 0) {
    ...
    public static void applyToActivitiesIfAvailable(@NonNull Application application, @StyleRes int i10, @NonNull Precondition precondition) {
        application.registerActivityLifecycleCallbacks(new DynamicColorsActivityLifecycleCallbacks(i10, precondition));
    }
}
