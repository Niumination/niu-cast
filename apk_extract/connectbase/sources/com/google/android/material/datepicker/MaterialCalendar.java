    ...
    private void addActionsToMonthNavigation(@NonNull View view, @NonNull final MonthsPagerAdapter monthsPagerAdapter) {
        ...
        this.recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() { // from class: com.google.android.material.datepicker.MaterialCalendar.6
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int i10, int i11) {
                int iFindFirstVisibleItemPosition = i10 < 0 ? MaterialCalendar.this.getLayoutManager().findFirstVisibleItemPosition() : MaterialCalendar.this.getLayoutManager().findLastVisibleItemPosition();
                        ...
                        if (l10 != null && pair.second != null) {
                            ...
                            for (int i10 = spanCount; i10 <= spanCount2; i10++) {
                                ...
                                if (viewFindViewByPosition3 != null) {
                                    ...
                                    canvas.drawRect(i10 == spanCount ? (viewFindViewByPosition.getWidth() / 2) + viewFindViewByPosition.getLeft() : 0, top, i10 == spanCount2 ? (viewFindViewByPosition2.getWidth() / 2) + viewFindViewByPosition2.getLeft() : recyclerView.getWidth(), bottom, MaterialCalendar.this.calendarStyle.rangeFill);
                                }
                            }
                        }
                    }
