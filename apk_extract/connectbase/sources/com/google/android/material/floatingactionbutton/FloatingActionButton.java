...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable, CoordinatorLayout.AttachedBehavior {
    ...
    public class ShadowDelegateImpl implements ShadowViewDelegate {
        ...
        public void setShadowPadding(int i10, int i11, int i12, int i13) {
            ...
            floatingActionButton.setPadding(floatingActionButton.imagePadding + i10, FloatingActionButton.this.imagePadding + i11, FloatingActionButton.this.imagePadding + i12, FloatingActionButton.this.imagePadding + i13);
        }
    }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        int iMin = Math.min(resolveAdjustedSize(sizeDimension, i10), resolveAdjustedSize(sizeDimension, i11));
