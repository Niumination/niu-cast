...
public class TabLayout extends HorizontalScrollView {
        ...
        public void draw(@NonNull Canvas canvas) {
            ...
            if (TabLayout.this.tabSelectedIndicator.getBounds().width() > 0) {
                ...
                if (tabLayout.tabSelectedIndicatorColor != 0) {
                    ...
                    DrawableCompat.setTintList(drawableWrap, null);
                }
    ...
    public final class TabView extends LinearLayout {
        ...
        public void updateBackgroundDrawable(Context context) {
            ...
            if (TabLayout.this.tabRippleColorStateList != null) {
                ...
                rippleDrawable = new RippleDrawable(colorStateListConvertToRippleDrawableColor, gradientDrawable, z10 ? null : gradientDrawable3);
            }
    ...
    public Tab newTab() {
        ...
        if (tabCreateTabFromPool.f1789id != -1) {
            tabCreateTabFromPool.view.setId(tabCreateTabFromPool.f1789id);
        }
