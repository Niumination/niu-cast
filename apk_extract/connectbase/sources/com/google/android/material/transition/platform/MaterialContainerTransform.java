...
public final class MaterialContainerTransform extends Transition {
    ...
    public static final class TransitionDrawable extends Drawable {
        ...
        private void updateProgress(float f10) {
            ...
            float fLerp = TransitionUtils.lerp(0.0f, 1.0f, fFloatValue, fFloatValue2, f10);
            ...
            float f20 = (int) (fCalculateElevationDyMultiplier * f19);
            this.currentElevationDy = f20;
            this.shadowPaint.setShadowLayer(f19, (int) (fCalculateElevationDxMultiplier * f19), f20, SHADOW_COLOR);
    ...
    private static float getElevationOrDefault(float f10, View view) {
        return f10 != ELEVATION_NOT_SET ? f10 : ViewCompat.getElevation(view);
    }
    ...
    public Animator createAnimator(@NonNull ViewGroup viewGroup, @Nullable TransitionValues transitionValues, @Nullable TransitionValues transitionValues2) {
        ...
        if (transitionValues != null && transitionValues2 != null) {
            ...
            if (rectF != null && shapeAppearanceModel != null) {
                ...
                RectF rectFCalculateDrawableBounds = calculateDrawableBounds(viewFindAncestorById, view, f10, f11);
