...
public class FootActionBar extends FrameLayout {
    ...
    public static final String f2788d = "ActionBar";

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public static final ViewOutlineProvider f2789e = new a();

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public LinearLayout f2790a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public OverflowMenu f2791b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public ImageButton f2792c;
    ...
    public static void a(View view, Resources resources) {
        view.setOutlineProvider(f2789e);
    ...
    public void setOverMenuColor(int i10) {
        this.f2791b.setOverMenuColor(i10);
    }
    ...
    public FootActionBar(Context context, AttributeSet attributeSet, int i10, int i11) {
        ...
        this.f2791b = (OverflowMenu) findViewById(R.id.os_menu_btn);
        this.f2792c = (ImageButton) findViewById(R.id.os_menu_center);
        ...
        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.f2791b.getLayoutParams();
        if (i12 != -1) {
        ...
        if (drawable != null) {
            this.f2791b.setBackground(drawable);
        }
