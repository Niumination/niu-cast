...
public interface SendFileTransferListener extends IInterface {
    ...
    public static class Default implements SendFileTransferListener {
        ...
        @Override // com.transsion.connectx.sdk.SendFileTransferListener
        public void onConfirmRequestFile(List<String> list, String str, int i10) throws RemoteException {
        }
        ...
        @Override // com.transsion.connectx.sdk.SendFileTransferListener
        public void onFileTaskConfirmResult(int i10, String str, List<String> list) throws RemoteException {
        }
    ...
    void onConfirmRequestFile(List<String> list, String str, int i10) throws RemoteException;

    void onFailed(String str, int i10, String str2, int i11) throws RemoteException;

    void onFileTaskConfirmResult(int i10, String str, List<String> list) throws RemoteException;
