...
public class a {
    ...
    public static final class c implements ServiceConnection {
        ...
        /* JADX INFO: renamed from: b, reason: collision with root package name */
        public final LinkedBlockingQueue<IBinder> f10569b;

        public c() {
            this.f10568a = false;
            this.f10569b = new LinkedBlockingQueue<>(1);
        }
        ...
        public IBinder a() throws InterruptedException {
            ...
            this.f10568a = true;
            return this.f10569b.poll(10L, TimeUnit.SECONDS);
        }

        @Override // android.content.ServiceConnection
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            try {
                this.f10569b.put(iBinder);
    ...
    public static final class d implements IInterface {
        ...
        public IBinder f10570c;

        public d(IBinder iBinder) {
            this.f10570c = iBinder;
        }
        ...
        public String O() throws RemoteException {
            ...
            try {
                ...
                this.f10570c.transact(1, parcelObtain, parcelObtain2, 0);
        ...
        public boolean P(boolean z10) throws RemoteException {
            ...
            try {
                ...
                this.f10570c.transact(2, parcelObtain, parcelObtain2, 0);
                parcelObtain2.readException();
