...
public final class d<R> extends l<R> {
    ...
    @os.l
    public final nq.q<R> f21704g;

    @xm.f(c = "kotlinx.coroutines.selects.SelectBuilderImpl$getResult$1", f = "SelectOld.kt", i = {}, l = {43}, m = "invokeSuspend", n = {}, s = {})
    public static final class a extends xm.o implements jn.p<s0, um.d<? super l2>, Object> {
        ...
        public a(d<R> dVar, um.d<? super a> dVar2) {
            super(2, dVar2);
            this.this$0 = dVar;
        }
        ...
        public final Object invokeSuspend(@os.l Object obj) {
            ...
            try {
                ...
                p.c(this.this$0.f21704g, obj);
                this = l2.f10208a;
                return this;
            } catch (Throwable th2) {
                p.d(this.this$0.f21704g, th2);
                return l2.f10208a;
            }
        }
    ...
    public d(@os.l um.d<? super R> dVar) {
        super(dVar.getContext());
        this.f21704g = new nq.q<>(wm.c.e(dVar), 1);
    }

    @os.m
    @z0
    public final Object P() {
        if (this.f21704g.isCompleted()) {
            return this.f21704g.z();
        }
    ...
    @z0
    public final void Q(@os.l Throwable th2) {
        nq.q<R> qVar = this.f21704g;
