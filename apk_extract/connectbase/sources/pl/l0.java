...
public interface l0 extends l2 {
    ...
    public static final class a {
        ...
        public static <R> R b(@os.l l0 l0Var, R r10, @os.l jn.p<? super R, ? super um.g.b, ? extends R> pVar) {
            kn.l0.p(l0Var, "this");
            kn.l0.p(pVar, "operation");
            return (R) um.g.b.a.a(l0Var, r10, pVar);
        }

        @os.m
        public static <E extends um.g.b> E c(@os.l l0 l0Var, @os.l um.g.c<E> cVar) {
            kn.l0.p(l0Var, "this");
            kn.l0.p(cVar, cb.b.c.f1408o);
            return (E) um.g.b.a.b(l0Var, cVar);
        }

        @os.l
        public static um.g d(@os.l l0 l0Var, @os.l um.g.c<?> cVar) {
            kn.l0.p(l0Var, "this");
            kn.l0.p(cVar, cb.b.c.f1408o);
            return um.g.b.a.c(l0Var, cVar);
        }
        ...
        @os.l
        public static l2 e(@os.l l0 l0Var, @os.l l2 l2Var) {
            kn.l0.p(l0Var, "this");
            kn.l0.p(l2Var, "other");
            return l2Var;
        }
        ...
        @os.l
        public static um.g f(@os.l l0 l0Var, @os.l um.g gVar) {
            kn.l0.p(l0Var, "this");
            kn.l0.p(gVar, "context");
            return um.g.b.a.d(l0Var, gVar);
        }
    }
